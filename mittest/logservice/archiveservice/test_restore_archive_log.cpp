...
TEST(FakeArchivePieceContext, get_piece)
{
  ...
  FakeArchiveComponent round1;
  {
    ...
    round1.round_id_ = 2;
    round1.start_ts_ = 1005 * ONE_SECOND;
    round1.end_ts_ = 1051 * ONE_SECOND;
    round1.base_piece_id_ = 1;
    round1.piece_switch_interval_ = piece_switch_interval;
    round1.base_piece_ts_ = base_ts_1;
  ...
  FakeArchiveComponent round2;
  {
    ...
    round2.round_id_ = 4;
    round2.start_ts_ = 1051 * ONE_SECOND;
    round2.end_ts_ = 1095 * ONE_SECOND;
    round2.base_piece_id_ = 2;
    round2.piece_switch_interval_ = piece_switch_interval;
    round2.base_piece_ts_ = base_ts_1;
  ...
  FakeArchiveComponent round3;
  {
    ...
    round3.round_id_ = 5;
    round3.start_ts_ = 1200 * ONE_SECOND;
    round3.end_ts_ = 1295 * ONE_SECOND;
    round3.base_piece_id_ = 2;
    round3.piece_switch_interval_ = piece_switch_interval;
    round3.base_piece_ts_ = base_ts_1;
  ...
  ret = context->get_piece(log_ts, lsn, dest_id, round_id, piece_id, cur_file_id, offset, max_lsn);
  EXPECT_EQ(OB_SUCCESS, ret);
  ...
  ret = context->get_piece(log_ts + 3, lsn, dest_id, round_id, piece_id, cur_file_id, offset, max_lsn);
  EXPECT_EQ(OB_SUCCESS, ret);
  EXPECT_EQ(round_id, 2);
  ...
  ret = archive_context.get_piece(log_ts + 20, lsn, dest_id, round_id, piece_id, cur_file_id, offset, max_lsn);
  ...
  ret = archive_context.get_piece(log_ts, lsn, dest_id, round_id, piece_id, cur_file_id, offset, max_lsn);
  EXPECT_EQ(OB_SUCCESS, ret);
