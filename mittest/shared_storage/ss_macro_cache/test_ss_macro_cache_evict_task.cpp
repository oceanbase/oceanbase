...
TEST_F(TestSSMacroCacheEvictTask, evict_read_cache)
{
  ...
  ASSERT_EQ(OB_SUCCESS, disk_space_mgr->alloc_file_size(macro_cache_free_size, ObSSMacroCacheType::MACRO_BLOCK));
...
TEST_F(TestSSMacroCacheEvictTask, evict_tmp_file_write_cache)
{
  ...
  ASSERT_EQ(OB_SUCCESS, disk_space_mgr->alloc_file_size(macro_cache_free_size, ObSSMacroCacheType::TMP_FILE));
