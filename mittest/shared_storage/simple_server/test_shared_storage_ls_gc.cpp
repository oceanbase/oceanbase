      ...
      int64_t &last_gc_version)
{
  ...
  do {
    ...
    ObPrivateBlockGCHandler handler(RunCtx.ls_id_, RunCtx.ls_epoch_, RunCtx.tablet_id_, current_tablet_version, last_gc_version,
		    current_tablet_trans_seq, tablet_fingerprint, is_set_stop, is_transfer_out_deleted);
    ...
    const int64_t tablet_version)
{
  ...
  ObPrivateBlockGCHandler handler(RunCtx.ls_id_, RunCtx.ls_epoch_, RunCtx.tablet_id_, tablet_version,
		  -1/*last_gc_version*/, 0 /*transfer_seq*/, 0/*tablet_fingerprint*/, is_set_stop, false/*is_transfer_out_deleted*/);
