...
void TestLSMigrationParam::SetUp()
{
  ...
  sstable_meta_.basic_meta_.ddl_log_ts_ = 0;
  sstable_meta_.basic_meta_.filled_tx_log_ts_ = 0;
...
TEST_F(TestLSMigrationParam, test_migrate_sstable_param)
{
  ...
  sstable_param.basic_meta_.ddl_log_ts_                    = sstable_meta_.basic_meta_.ddl_log_ts_;
  sstable_param.basic_meta_.filled_tx_log_ts_              = sstable_meta_.basic_meta_.filled_tx_log_ts_;
...
TEST_F(TestLSMigrationParam, test_placeholder_storage_schema)
{
  ...
  ret = ObMigrationTabletParam::construct_placeholder_storage_schema(allocator, storage_schema);
  ASSERT_EQ(OB_SUCCESS, ret);
...
TEST_F(TestLSMigrationParam, test_migrate_tablet_param)
{
  ...
  ret = src_handle.get_obj()->init(src_key.ls_id_, src_key.tablet_id_, src_key.tablet_id_,
      empty_tablet_id, empty_tablet_id, ObTimeUtility::current_time(), 2022, table_schema,
