 ...
 */
 ...
 void TestScanBasic::mock_tablet_table_store(ObTableStoreIterator &table_store_iter, const bool reuse_tablet)
 {
   ...
   table_store_iter.resume();
   LOG_INFO("mock tablet table store", K(major_tables), K(minor_tables));
 }
 ...
 {
   return ctx.create_sstables(start_cg_idx, end_cg_idx);
 }
                                           ...
                                           ObTableHandleV2 &co_store)
 {
   ...
   OK(merger.merge_partition(merge_context, 0));
