...
TEST_F(TestTrans, basic)
{
  ...
  printf("mt size=%ld occ_size=%ld bree_item_count=%ld rec_log_ts=%ld end_log_ts=%ld\n", mt->get_size(), mt->get_occupied_size(), mt->get_btree_item_count(), mt->get_rec_log_ts(),mt->get_max_end_log_ts());
