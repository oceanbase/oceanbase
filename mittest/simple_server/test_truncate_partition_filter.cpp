    ...
    ObTruncatePartitionFilter &filter)
{
  ...
  truncate_info_array.init_for_first_creation(allocator_);
  ASSERT_EQ(OB_SUCCESS, truncate_info_array.append_with_deep_copy(truncate_info));
  ASSERT_EQ(OB_SUCCESS, filter.truncate_filter_executor_->switch_info(filter_factory, schema_rowkey_cnt_, cols_desc_, truncate_info_array));
}
...
TEST_F(ObTruncatePartitionFitlerTest, part_filter)
{
  ...
  ObTruncatePartitionFilter truncate_range_part_filter1(allocator_);
...
#define CHECK_RANGE_ROW(scn_val, part_val, truncate_filter, expected) \
  ...
  ObTruncatePartitionFilter truncate_range_part_filter2(allocator_);
  ...
  ObTruncatePartitionFilter truncate_range_part_filter3(allocator_);
  get_index_table_cols_param(false);
  ...
  ObTruncatePartitionFilter truncate_range_part_filter4(allocator_);
  get_index_table_cols_param(true);
  ...
  ObTruncatePartitionFilter truncate_range_columns_part_filter1(allocator_);
  get_index_table_cols_param(true);
...
#define CHECK_RANGE_COLUMNS_ROW(scn_val, part_val1, part_val2, truncate_filter, expected) \
  ...
  ObTruncatePartitionFilter truncate_range_columns_part_filter2(allocator_);
  get_index_table_cols_param(false);
  ...
  ObTruncatePartitionFilter truncate_range_columns_part_filter3(allocator_);
  get_index_table_cols_param(true);
  ...
  ObTruncatePartitionFilter truncate_range_columns_part_filter4(allocator_);
  ...
  ObTruncatePartitionFilter truncate_list_part_filter1(allocator_);
  get_index_table_cols_param(false);
...
#define CHECK_LIST_ROW(scn_val, part_val, truncate_filter, expected) \
  ...
  ObTruncatePartitionFilter truncate_list_part_filter2(allocator_);
  get_index_table_cols_param(true);
  ...
  ObTruncatePartitionFilter truncate_list_part_filter3(allocator_);
  get_index_table_cols_param(false);
  ...
  ObTruncatePartitionFilter truncate_list_part_filter4(allocator_);
  get_index_table_cols_param(true);
  ...
  ObTruncatePartitionFilter truncate_list_columns_part_filter1(allocator_);
  get_index_table_cols_param(true);
...
#define CHECK_LIST_COLUMNS_ROW(scn_val, part_val1, part_val2, truncate_filter, expected) \
  ...
  ObTruncatePartitionFilter truncate_list_columns_part_filter2(allocator_);
  get_index_table_cols_param(false);
  ...
  ObTruncatePartitionFilter truncate_list_columns_part_filter3(allocator_);
  get_index_table_cols_param(true);
...
TEST_F(ObTruncatePartitionFitlerTest, subpart_filter)
{
  ...
  ObTruncatePartitionFilter truncate_range_list_part_filter1(allocator_);
  get_index_table_cols_param(false);
  ...
  ObTruncatePartitionFilter truncate_range_list_part_filter2(allocator_);
  get_index_table_cols_param(true);
  ...
  ObTruncatePartitionFilter truncate_range_list_part_filter3(allocator_);
  get_index_table_cols_param(false);
...
#define CHECK_ROW(scn, range_column, flag)                                     \
  ...
  {
    ObTruncatePartitionFilter truncate_range_part_filter(allocator_);
    get_index_table_cols_param(false);
...
#define CHECK_ROW(scn, list_column, flag)                                      \
  ...
  {
    ObTruncatePartitionFilter truncate_list_part_filter(allocator_);
    get_index_table_cols_param(true);
