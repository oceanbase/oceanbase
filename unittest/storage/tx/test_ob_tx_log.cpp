...
TEST_F(TestObTxLog, tx_log_block_header)
{
  ...
  // reuse
  fill_block.get_header().set_log_entry_no(TEST_LOG_ENTRY_NO + 1);
  fill_block.get_header().clear_flags();
  ...
  EXPECT_EQ(TEST_ORG_CLUSTER_ID, replay_block_header2.get_org_cluster_id());
  EXPECT_EQ(TEST_CLUSTER_VERSION, replay_block_header2.get_cluster_version());
