    ...
    const common::ObIArray<ObColumnParam *> *cols_param)
{
  ...
  init_basic_info(schema_column_count, schema_rowkey_cnt, is_oracle_mode, is_cg_sstable, false /*is_cs_replica_compat*/, false /*is_delete_insert_table*/); // init basic info
