    ...
    const common::ObIArray<ObColumnParam *> *cols_param)
{
  ...
  init_basic_info(schema_column_count, schema_rowkey_cnt, is_oracle_mode, is_cg_sstable, false /*is_cs_replica_compat*/,
      false /*is_delete_insert_table*/, false/*is_global_index_table*/, 1 /* micro_block_format_version */, false/*mv_major_refresh_tablet*/); // init basic info
