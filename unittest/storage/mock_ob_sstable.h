...
public:
  ...
  MOCK_CONST_METHOD3(get_macro_range, int(const int64_t index, int64_t& macro_block_id, common::ObStoreRange& range));
  MOCK_METHOD2(open, int(const share::schema::ObTableSchema& schema, const int64_t data_version));
