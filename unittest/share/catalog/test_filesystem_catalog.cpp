...
class TestFilesystemCatalog : public ::testing::Test
{
public:
  TestFilesystemCatalog() = default;
  ~TestFilesystemCatalog() = default;
  common::ObArenaAllocator allocator_;
};

TEST_F(TestFilesystemCatalog, test_create_catalog)
{
  ParseNode warehouse;
  warehouse.str_len_ = 1;
  warehouse.str_value_ = " ";
  ParseNode *children[1];
  children[0] = &warehouse;

  ParseNode child_value;
  child_value.type_ = ObItemType::T_WAREHOUSE;
  ...
  share::ObFilesystemCatalogProperties properties;
