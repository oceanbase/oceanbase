...
TEST_F(TestHybridSearch, hybrid_search_with_minimum_should_match)
{
  ...
  common::ObString result = (
    ...
    "on _fts.__pk_increment = _vs.__pk_increment) ORDER BY _score DESC, _vs.__pk_increment LIMIT 10");
