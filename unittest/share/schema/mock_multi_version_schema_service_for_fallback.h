...
public:
  ...
  void get_tenant_schema(const int64_t tenant_id, ObSimpleTenantSchema& tenant);

  virtual int fallback_schema_mgr(ObSchemaMgr& schema_mgr, const int64_t schema_version);
};

int MockMultiVersionSchemaServiceForFallback::init(const int64_t slot_for_cache, const int64_t slot_for_liboblog)
{
...
int MockMultiVersionSchemaServiceForFallback::fallback_schema_mgr(ObSchemaMgr& schema_mgr, const int64_t schema_version)
{
  int ret = common::OB_SUCCESS;
...
void MockMultiVersionSchemaServiceForFallback::get_tenant_schema(const int64_t tenant_id, ObSimpleTenantSchema& tenant)
{
  char name[20];
