...
TEST_F(TestRestoreURIParser, test_basic)
{
  ...
  const char* uri_001 = "oss://071092/ob2.XX/"
                        "1001?timestamp=1495444477922616&host=xxx.com&access_id=111&access_key=222&restore_user=a&restore_pass=b";
...
TEST_F(TestRestoreURIParser, test_more)
{
  ...
  ASSERT_TRUE(
      0 == strcmp(arg.storage_info_,
               "timestamp=1495444477922616&host=xxx.com&access_id=111&access_key=222&restore_user=a&restore_pass=b"));
