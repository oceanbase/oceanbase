...
typedef libobcdc::ObLogSysTableHelper::ObServerTZInfoVersionInfo
    ObServerTZInfoVersionInfo;
...
public:
  ...
  typedef common::ObSEArray<ObServerVersionInfo, DEFAULT_RECORDS_NUM>
...
public:
  ...
  int query_tenant_list(common::ObIArray<uint64_t> &tenant_id_list,
