...
#define DEF_NUMBER_STDV_FULL64(ALGO, HASH_ALGO)                                                          \
  ...
  {                                                                                                      \
    ...
    for (int bucket_number = 0; bucket_number < DIFF_BUCKET_NUM; bucket_number++) {                      \
      ...
      OB_LOG(WARN,                                                                                       \
          "record average deviation of diff length",                                                     \
          K(BUCKET_NUM[bucket_number]),                                                                  \
          K(stdv_averagelength[bucket_number]),                                                          \
          K(deviation));                                                                                 \
    }                                                                                                    \
  }
...
const int CHARSET_NUM = 3;
ObCollationType collation_type[CHARSET_NUM] = {
    CS_TYPE_UTF8MB4_GENERAL_CI,
    CS_TYPE_UTF8MB4_BIN,
    CS_TYPE_BINARY,
};
const int BIN_CHARSET_NUM = 2;
ObCollationType bin_collation_type[BIN_CHARSET_NUM] = {CS_TYPE_UTF8MB4_BIN, CS_TYPE_BINARY};
