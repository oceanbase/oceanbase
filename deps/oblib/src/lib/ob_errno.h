...
constexpr int OB_CDC_STREAM_ALREADY_EXISTS = -12000;
constexpr int OB_CDC_STREAM_NOT_FOUND = -12001;
constexpr int OB_CDC_STREAM_STATE_NOT_MATCH = -12002;
constexpr int OB_CDC_STREAM_INVALID_ARGUMENT = -12003;
constexpr int OB_CDC_CLIENT_CHANNEL_OCCUPIED = -12004;
constexpr int OB_CDC_CLIENT_PARAM_MISMATCH = -12005;
constexpr int OB_CDC_CLIENT_CHANNEL_OUT_OF_RANGE = -12006;
constexpr int OB_CDC_CLIENT_NOT_ACTIVE = -12007;
