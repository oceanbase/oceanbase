...
const char* ObZstdCompressor::compressor_name = "zstd_1.0";
 ...
 * ----------------------------ObZstdCompressor---------------------------
 */
int ObZstdCompressor::compress(const char* src_buffer, const int64_t src_data_size, char* dst_buffer,
...
int ObZstdCompressor::decompress(const char* src_buffer, const int64_t src_data_size, char* dst_buffer,
    const int64_t dst_buffer_size, int64_t& dst_data_size)
{
  int ret = OB_SUCCESS;
...
int ObZstdCompressor::get_max_overflow_size(const int64_t src_data_size, int64_t& max_overflow_size) const
{
  int ret = OB_SUCCESS;
  if (src_data_size < 0) {
    ret = OB_INVALID_ARGUMENT;
