...
MEM_STATIC size_t ZSTD_decompressLegacy(
    void* dst, size_t dstCapacity, const void* src, size_t compressedSize, const void* dict, size_t dictSize)
{
...
MEM_STATIC size_t ZSTD_initLegacyStream(
    void** legacyContext, U32 prevVersion, U32 newVersion, const void* dict, size_t dictSize)
{
...
MEM_STATIC size_t ZSTD_decompressLegacyStream(
    void* legacyContext, U32 version, ZSTD_outBuffer* output, ZSTD_inBuffer* input)
{
  switch (version) {
    default:
    case 1:
