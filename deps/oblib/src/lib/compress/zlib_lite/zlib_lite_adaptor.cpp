...
int ObZlibLiteAdaptor::init(allocator alloc, deallocator dealloc)
{
  int ret = 0;
...
int ObZlibLiteAdaptor::compress(const char* src_buffer,
...
int ObZlibLiteAdaptor::decompress(const char* src_buffer,
                                  const int64_t src_data_size,
                                  char* dst_buffer,
                                  const int64_t dst_buffer_size)
{
