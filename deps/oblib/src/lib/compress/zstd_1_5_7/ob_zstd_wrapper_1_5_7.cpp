...
constexpr int OB_ZSTD_VERSION_157                    = 157;

static const int OB_ZSTD_COMPRESS_LEVEL = 1;

int ObZstdWrapper_1_5_7::compress(
...
int ObZstdWrapper_1_5_7::decompress(
    OB_ZSTD_customMem &ob_zstd_mem,
    const char *src_buffer,
    const size_t src_data_size,
    char *dst_buffer,
...
int ObZstdWrapper_1_5_7::create_cctx(OB_ZSTD_customMem &ob_zstd_mem, void *&ctx)
{
  int ret = OB_SUCCESS;
  size_t ret_code = 0;
  ZSTD_CCtx *cctx = NULL;
...
void ObZstdWrapper_1_5_7::free_cctx(void *&ctx)
{
  ZSTD_CCtx *cctx = static_cast<ZSTD_CCtx *>(ctx);
  ZSTD_freeCCtx(cctx);
}

void ObZstdWrapper_1_5_7::reset_cctx(void *&ctx, int reset_directive)
{
  ZSTD_CCtx *cctx = static_cast<ZSTD_CCtx *>(ctx);
  ZSTD_CCtx_reset(cctx, static_cast<ZSTD_ResetDirective>(reset_directive));
}

int ObZstdWrapper_1_5_7::compress_block(void *ctx, const char *src, const size_t src_size,
...
int ObZstdWrapper_1_5_7::create_dctx(OB_ZSTD_customMem &ob_zstd_mem, void *&ctx)
{
  int ret = OB_SUCCESS;
  size_t ret_code = 0;
  ZSTD_DCtx *dctx = NULL;
...
void ObZstdWrapper_1_5_7::free_dctx(void *&ctx)
{
  ZSTD_DCtx *dctx = static_cast<ZSTD_DCtx *>(ctx);
  ZSTD_freeDCtx(dctx);
}

int ObZstdWrapper_1_5_7::decompress_block(void *ctx, const char *src, const size_t src_size,
...
size_t ObZstdWrapper_1_5_7::compress_bound(const size_t src_size)
{
  return ZSTD_compressBound(src_size);
}

int ObZstdWrapper_1_5_7::insert_block(void *ctx, const void *block, const size_t block_size)
{
  int ret = OB_SUCCESS;
...
int ObZstdWrapper_1_5_7::create_stream_dctx(const OB_ZSTD_customMem &ob_zstd_mem, void *&ctx)
{
  int ret = OB_SUCCESS;
  size_t ret_code = 0;
...
void ObZstdWrapper_1_5_7::free_stream_dctx(void *&ctx)
{
  ZSTD_DStream *dctx = static_cast<ZSTD_DStream *>(ctx);
  ZSTD_freeDStream(dctx);
}

int ObZstdWrapper_1_5_7::decompress_stream(void *ctx, const char *src, const size_t src_size, size_t &consumed_size,
                                        char *dest, const size_t dest_capacity, size_t &decompressed_size)
{
  int ret = OB_SUCCESS;
...
int ObZstdWrapper_1_5_7::compress_stream(void *ctx, const char *src, const size_t src_size, size_t &consumed_size,
                                   char *dest, const size_t dest_capacity, size_t &compressed_size,
