...
#include "ob_zstd_compressor_1_5_7.h"
 ...
 * ----------------------------ObZstdCompressor---------------------------
 */
int ObZstdCompressor_1_5_7::compress(const char *src_buffer,
                               ...
                               int64_t &dst_data_size)
{
  ...
  } else if (OB_FAIL(ObZstdWrapper_1_5_7::compress(zstd_mem,
                                          src_buffer,
...
int ObZstdCompressor_1_5_7::decompress(const char *src_buffer,
                                 const int64_t src_data_size,
                                 char *dst_buffer,
                                 const int64_t dst_buffer_size,
                                 int64_t &dst_data_size)
{
  ...
  if (NULL == src_buffer
    ...
    LIB_LOG(WARN, "invalid decompress argument, ",
        K(ret), KP(src_buffer), K(src_data_size), KP(dst_buffer), K(dst_buffer_size));
  } else if (OB_FAIL(ObZstdWrapper_1_5_7::decompress(zstd_mem,
                                              src_buffer,
                                              src_data_size,
                                              dst_buffer,
                                              dst_buffer_size,
...
const char *ObZstdCompressor_1_5_7::get_compressor_name() const
{
  return all_compressor_name[ObCompressorType::ZSTD_1_5_7_COMPRESSOR];
}

ObCompressorType ObZstdCompressor_1_5_7::get_compressor_type() const
{
  return ObCompressorType::ZSTD_1_5_7_COMPRESSOR;
}
int ObZstdCompressor_1_5_7::get_max_overflow_size(const int64_t src_data_size,
