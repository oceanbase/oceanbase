...
public:
  ...
  virtual int stream_compress(void* ctx, const char* src_buffer, const int64_t src_data_size, char* dst_buffer,
  ...
  virtual int stream_decompress(void* ctx, const char* src_buffer, const int64_t src_data_size, char* dst_buffer,
      const int64_t dst_buffer_size, int64_t& dst_data_size) = 0;
