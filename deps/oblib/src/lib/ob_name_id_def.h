...
DEF_NAME(id, "id")
    ...
    DEF_NAME(palf_and_apply_service_info, "palf and apply service info")
    DEF_NAME(palf_stat, "palf stat")
    DEF_NAME(apply_stat, "apply stat")
    DEF_NAME(lob_length, "lob length")
    DEF_NAME(lob_offset, "lob offset")
    DEF_NAME(lob_len, "lob query len")
    DEF_NAME(lock_for_read_time, "lock_for_read_time")
    DEF_NAME(lock_for_read_count, "lock_for_read_count")
    DEF_NAME(memtable_write_throttle_time, "memtable_write_throttle_time")
    DEF_NAME(das_wait_remote_time, "das_wait_remote_time")
    DEF_NAME(sql_info, "sql_info")
    DEF_NAME(table_scan_monitor_info, "table_scan_monitor_info")
    DEF_NAME(io_read_bytes, "io_read_bytes")
    DEF_NAME(ssstore_read_bytes, "ssstore_read_bytes")
    DEF_NAME(base_read_row_cnt, "base_read_row_cnt")
    DEF_NAME(delta_read_row_cnt, "delta_read_row_cnt")
    DEF_NAME(op_name, "operator name")
    DEF_NAME(op_id, "operator id")
    DEF_NAME(operator_output, "operator output rows")
    DEF_NAME(operator_filtered, "operator filtered rows")
    DEF_NAME(is_buffer_table, "is buffer table")
    DEF_NAME(sql_trace_info, "sql trace info")
    DEF_NAME(sql_total_read_row_count, "sql total read row count")
    DEF_NAME(sql_output_row_count, "sql output row count")
    DEF_NAME(sql_pushdown_storage_filter_row_count, "sql pushdown storage filter row count")
    DEF_NAME(sql_buffer_table_info, "sql buffer table info")
    DEF_NAME(tmp_file_write_bytes, "tmp file write bytes")
    DEF_NAME_PAIR(retry_wait, "retry wait")
    DEF_NAME(local_retry_info, "local retry info")
    DEF_NAME(holder_tx_id, "holder tx id")
    DEF_NAME(holder_data_seq_num, "holder data seq num")
    DEF_NAME(holder_lock_timestamp, "holder lock timestamp")
    DEF_NAME(net_time_us, "net_time_us")
    DEF_NAME(sync_rpc_ts, "sync_rpc_ts")
    DEF_NAME(async_das_ts, "async_das_ts")
    ...
    DEF_NAME_PAIR(S_lob_outrow_query, "storage: lob outrow query")
