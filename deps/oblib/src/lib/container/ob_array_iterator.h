...
typename ObArrayImpl<T, BlockAllocatorT, auto_free, CallBack, ItemEncode>::const_iterator
    ObArrayImpl<T, BlockAllocatorT, auto_free, CallBack, ItemEncode>::begin() const
{
  return const_iterator(data_);
}
template <typename T, typename BlockAllocatorT, bool auto_free, typename CallBack, typename ItemEncode>
typename ObArrayImpl<T, BlockAllocatorT, auto_free, CallBack, ItemEncode>::const_iterator
    ObArrayImpl<T, BlockAllocatorT, auto_free, CallBack, ItemEncode>::end() const
{
  return const_iterator(data_ + count_);
}
template <typename T, typename BlockAllocatorT, bool auto_free, typename CallBack, typename ItemEncode>
typename ObArrayImpl<T, BlockAllocatorT, auto_free, CallBack, ItemEncode>::iterator
    ObArrayImpl<T, BlockAllocatorT, auto_free, CallBack, ItemEncode>::begin()
{
  return iterator(data_);
}
template <typename T, typename BlockAllocatorT, bool auto_free, typename CallBack, typename ItemEncode>
typename ObArrayImpl<T, BlockAllocatorT, auto_free, CallBack, ItemEncode>::iterator
    ObArrayImpl<T, BlockAllocatorT, auto_free, CallBack, ItemEncode>::end()
{
