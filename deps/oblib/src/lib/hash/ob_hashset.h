...
template <class _key_type, class _defendmode = ReadWriteDefendMode, class _hashfunc = hash_func<_key_type>,
    class _equal = equal_to<_key_type>, class _allocer = SimpleAllocer<typename HashSetTypes<_key_type>::AllocType>,
...
public:
  ...
  int create(
      int64_t bucket_num, const char* bucket_label, const char* node_label, uint64_t tenant_id = OB_SERVER_TENANT_ID)
  {
