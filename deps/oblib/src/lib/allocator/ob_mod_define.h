...
LABEL_ITEM_DEF(OB_TABLE_THROTTLE, TableThrot)
LABEL_ITEM_DEF(OB_TABLE_THROTTLE_MGR, TableThrotMgr)
LABEL_ITEM_DEF(OB_TABLE_HOTKEY, TableHtkey)
LABEL_ITEM_DEF(OB_VIRTUAL_TABLE_HOTKEY, TableHtkeyVtTbl)
