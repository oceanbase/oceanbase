...
private:
  // TODO(zhuixin.gsy) reduce 128*2M size to 32*2M, which is expanded temporarily for generating index blocks
  static const int64_t MAX_MEMORY_IN_MINI_MODE = 32 * OB_DEFAULT_MACRO_BLOCK_SIZE; //64MB
