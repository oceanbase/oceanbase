...
DBA_ERROR_EVENT(OB_BOOTSTRAP_SERVER_NOT_EMPTY)

/* replace sys tenant event */
// DBA INFO
DEFINE_DBA_EVENT_LIST_H(replace_sys,
  OB_REPLACE_SYS_BEGIN,
  OB_REPLACE_SYS_BASIC_CHECK_BEGIN,
  OB_REPLACE_SYS_BASIC_CHECK_SUCCESS,
  OB_REPLACE_SYS_INIT_BEGIN,
  OB_REPLACE_SYS_INIT_SUCCESS,
  OB_REPLACE_SYS_REPLACE_SSLOG_LS_BEGIN,
  OB_REPLACE_SYS_REPLACE_SSLOG_LS_SUCCESS,
  OB_REPLACE_SYS_REPLACE_SYS_LS_BEGIN,
  OB_REPLACE_SYS_REPLACE_SYS_LS_SUCCESS,
  OB_REPLACE_SYS_WAIT_SYS_TENANT_READY_BEGIN,
  OB_REPLACE_SYS_WAIT_SYS_TENANT_READY_SUCCESS,
  OB_REPLACE_SYS_CORRECT_TABLE_BEGIN,
  OB_REPLACE_SYS_CORRECT_TABLE_SUCCESS,
  OB_REPLACE_SYS_SUCCESS
);
DBA_ERROR_EVENT(OB_REPLACE_SYS_BASIC_CHECK_FAIL)
DBA_ERROR_EVENT(OB_REPLACE_SYS_INIT_FAIL)
DBA_ERROR_EVENT(OB_REPLACE_SYS_REPLACE_SSLOG_LS_FAIL)
DBA_ERROR_EVENT(OB_REPLACE_SYS_REPLACE_SYS_LS_FAIL)
DBA_ERROR_EVENT(OB_REPLACE_SYS_WAIT_SYS_TENANT_READY_FAIL)
DBA_ERROR_EVENT(OB_REPLACE_SYS_CORRECT_TABLE_FAIL)
DBA_ERROR_EVENT(OB_REPLACE_SYS_FAIL)
