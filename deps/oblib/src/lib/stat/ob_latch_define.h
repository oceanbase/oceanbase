...
LATCH_DEF(PARTITION_STORE_NEW_MEMTABLE_LOCK, 84, "partition store new memtable lock", LATCH_FIFO, 2000, 0, PARTITION_STORE_NEW_MEMTABLE_LOCK_WAIT, "partition store new memtable lock")
...
LATCH_DEF(MACRO_META_MAJOR_KEY_MAP_LOCK, 101, "macro block meta major key map lock", LATCH_FIFO, 2000, 0, MACRO_META_MAJOR_KEY_MAP_LOCK_WAIT, "macro block meta major key map lock")
