...
main() {
    ...
    vsag::ext::IndexHandler* index =
        vsag::ext::IndexHandler::Make("hnsw", hnsw_build_paramesters).value();

    vsag::ext::DatasetHandler* base = vsag::ext::DatasetHandler::Make();
    ...
    int64_t topk = 10;
    auto query = vsag::ext::DatasetHandler::Make();
