...
WAIT_EVENT_DEF(SCOND_TEMP_WRAPPER_WAIT, 13013, "wait to acquire scond temp", "timeout_us", "address", "", NETWORK, true, true)
WAIT_EVENT_DEF(BASE_LOG_WRITER_WRITE_COND_WAIT, 13014, "base log writer write cond wait", "timeout_us", "address", "", NETWORK, true, true)
WAIT_EVENT_DEF(BASE_LOG_WRITER_FLUSH_COND_WAIT, 13015, "base log writer flush cond wait", "timeout_us", "address", "", NETWORK, true, true)
...
WAIT_EVENT_DEF(BACKUP_ARCHIVE_JOB_SERVICE_COND_WAIT, 15251, "backup archive job service condition wait", "address", "", "", CONCURRENCY, true, true)
...
WAIT_EVENT_DEF(TABLE_LOAD_COORDINATOR_COND_WAIT, 18126, "table load coordinator condition wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(OB_COND_COND_WAIT, 18222, "ob cond cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(OB_MONITOR_COND_WAIT, 18223, "ob monitor cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(S_COND_TEMP_COND_WAIT, 18224, "s cond temp cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(LIGHTY_QUEUE_COND_WAIT, 18225, "lighty queue cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(OB_PRIORITY_QUEUE_COND_WAIT, 18226, "ob priority queue cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(OB_DTL_BASIC_CHANNEL_COND_WAIT, 18227, "ob dtl basic channel cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(JOIN_TABLE_CTX_COND_WAIT, 18228, "join table ctx cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(OB_HASH_TABLE_SHARED_TABLE_INFO_COND_WAIT, 18229, "ob hash table shared table info cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(OB_PX_WORK_NOTIFIER_COND_WAIT, 18230, "ob px work notifier cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(WIN_FUNC_INFO_COND_WAIT, 18231, "win func info cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(HASH_MAP_LOCK_WAIT, 18232, "hash map lock wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(SCHEMA_CONSTRUCT_TASK_WAIT, 18233, "schema construct task wait", "version", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(OB_LS_RECOVERY_STAT_HANDLER_REF_COND, 18234, "ls recovery stat handler ref cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(S2M_QUEUE_THREAD_COND_WAIT, 18235, "s2m queue thread cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(DDL_TRANS_CONTROLLER_WAIT_COND, 18236, "ddl trans controller wait cond", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(MAP_QUEUE_THREAD_COND_WAIT, 18237, "map queue thread cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(BLACK_LIST_THREAD_COND_WAIT, 18238, "black list thread cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(ARCHIVE_FETCHER_COND_WAIT, 18239, "archive fetcher cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(ARCHIVE_SENDER_COND_WAIT, 18240, "archive sender cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(ARCHIVE_LS_MGR_COND_WAIT, 18241, "archive ls mgr cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(OB_PL_DEBUG_WAIT_FOR_TRACED_COND_WAIT, 18242, "pl debug wait for traced cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(WRS_THREAD_COND_WAIT, 18243, "tenant weak read service thread cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(COMPRESS_TMP_FILE_COND_WAIT, 18244, "compress tmp file cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(FETCH_LOG_SRPC_COND_WAIT, 18245, "fetch log srpc cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(LOG_TIMER_COND_WAIT, 18246, "log timer cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(LOG_RESTORE_SERVICE_COND_WAIT, 18247, "log restore service cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(FETCH_LOG_WORKER_COND_WAIT, 18248, "fetch log worker cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(REMOTE_LOG_WRITER_COND_WAIT, 18249, "remote log writer cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(ARCHIVE_SEQUENCER_COND_WAIT, 18250, "archive sequencer cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(ARCHIVE_SERVICE_COND_WAIT, 18251, "archive service cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(PRIORITY_QUEUE_COND_WAIT, 18252, "priority queue cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(CDC_COMMON_COND_WAIT, 18253, "cdc common cond wait", "address", "", "", CONCURRENCY, true, true)
WAIT_EVENT_DEF(MULTI_FIXED_QUEUE_COND_WAIT, 18254, "multi fixed queue cond wait", "address", "", "", CONCURRENCY, true, true)
...
WAIT_EVENT_DEF(LAKE_TABLE_TASK_GROUP_COND_WAIT, 18270, "lake table task group cond wait", "address", "", "", CONCURRENCY, true, true)
