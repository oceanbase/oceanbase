...
////////////////////////////////////////////////////////////////
// Json types
enum Type { JT_NULL, JT_TRUE, JT_FALSE, JT_STRING, JT_NUMBER /*Only support integer now*/, JT_ARRAY, JT_OBJECT };
struct Pair;
struct Value;
...
public:
  ...
  void set_string(char* buf, int32_t buf_len)
  {
    str_.assign_ptr(buf, buf_len);
  }
  void object_add(Pair* pair)
  {
    obj_.add_last(pair);
  }
  void array_add(Value* v)
  {
    arr_.add_last(v);
  }
