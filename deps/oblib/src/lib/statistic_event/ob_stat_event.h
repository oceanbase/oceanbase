...
STAT_EVENT_ADD_DEF(SECONDARY_META_CACHE_HIT, "secondary meta cache hit", ObStatClassIds::CACHE, 50053, false, true, false)
STAT_EVENT_ADD_DEF(SECONDARY_META_CACHE_MISS, "secondary meta cache miss", ObStatClassIds::CACHE, 50054, false, true, false)
...
STAT_EVENT_ADD_DEF(HBASEAPI_CHECK_MUTATE_COUNT, "hbase check_mutate count", ObStatClassIds::TABLEAPI, 191025, true, true, false)
STAT_EVENT_ADD_DEF(HBASEAPI_CHECK_MUTATE_TIME, "hbase check_mutate time", ObStatClassIds::TABLEAPI, 191026, true, true, false)
STAT_EVENT_ADD_DEF(HBASEAPI_CHECK_MUTATE_ROW, "hbase check_mutate row count", ObStatClassIds::TABLEAPI, 191027, true, true, false)
...
STAT_EVENT_ADD_DEF(SS_TMPFILE_CACHE_HIT, "ss_tmpfile_cache hit count", ObStatClassIds::CACHE, 240017, true, true, false)
STAT_EVENT_ADD_DEF(SS_TMPFILE_CACHE_MISS, "ss_tmpfile_cache miss count", ObStatClassIds::CACHE, 240018, true, true, false)
...
STAT_EVENT_ADD_DEF(SS_MAJOR_MACRO_CACHE_HIT, "ss_major_macro_cache hit count", ObStatClassIds::CACHE, 240020, true, true, false)
STAT_EVENT_ADD_DEF(SS_MAJOR_MACRO_CACHE_MISS, "ss_major_macro_cache miss count", ObStatClassIds::CACHE, 240021, true, true, false)
...
STAT_EVENT_SET_DEF(SS_LOCAL_CACHE_TMPFILE_ALLOC_SIZE, "ss_local_cache tmpfile alloc disk size", ObStatClassIds::CACHE, 245003, false, true, false)
STAT_EVENT_SET_DEF(SS_LOCAL_CACHE_META_ALLOC_SIZE, "ss_local_cache meta file alloc disk size", ObStatClassIds::CACHE, 245004, false, true, false)
STAT_EVENT_SET_DEF(SS_LOCAL_CACHE_INCREMENTAL_DATA_ALLOC_SIZE, "ss_local_cache incremental data alloc disk size", ObStatClassIds::CACHE, 245005, false, true, false)
STAT_EVENT_SET_DEF(SS_LOCAL_CACHE_TMPFILE_USED_DISK_SIZE_W, "ss_local_cache tmpfile write cache used disk size", ObStatClassIds::CACHE, 245006, false, true, false)
STAT_EVENT_SET_DEF(SS_LOCAL_CACHE_TMPFILE_USED_DISK_SIZE_R, "ss_local_cache tmpfile read cache used disk size", ObStatClassIds::CACHE, 245007, false, true, false)
STAT_EVENT_SET_DEF(SS_LOCAL_CACHE_META_USED_DISK_SIZE, "ss_local_cache meta file used disk size", ObStatClassIds::CACHE, 245008, false, true, false)
STAT_EVENT_SET_DEF(SS_LOCAL_CACHE_INCREMENTAL_DATA_USED_DISK_SIZE, "ss_local_cache incremental data used disk size", ObStatClassIds::CACHE, 245009, false, true, false)
STAT_EVENT_SET_DEF(SS_LOCAL_CACHE_MAJOR_MACRO_USED_DISK_SIZE, "ss_local_cache major macro used disk size", ObStatClassIds::CACHE, 245010, false, true, false)
...
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_META_MAX_CAPACITY, "ss_macro_cache max capacity of the META_FILE type", ObStatClassIds::CACHE, 245022, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_META_USED_SIZE, "ss_macro_cache META_FILE used disk size", ObStatClassIds::CACHE, 245023, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_META_HIT_CNT, "ss_macro_cache META_FILE hit count", ObStatClassIds::CACHE, 245024, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_META_MISS_CNT, "ss_macro_cache META_FILE miss count", ObStatClassIds::CACHE, 245025, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_META_HIT_BYTES, "ss_macro_cache META_FILE hit bytes", ObStatClassIds::CACHE, 245026, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_META_MISS_BYTES, "ss_macro_cache META_FILE miss bytes", ObStatClassIds::CACHE, 245027, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_TMP_MAX_CAPACITY, "ss_macro_cache max capacity of the TMP_FILE type", ObStatClassIds::CACHE, 245028, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_TMP_USED_SIZE, "ss_macro_cache TMP_FILE used disk size", ObStatClassIds::CACHE, 245029, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_TMP_HIT_CNT, "ss_macro_cache TMP_FILE hit count", ObStatClassIds::CACHE, 245030, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_TMP_MISS_CNT, "ss_macro_cache TMP_FILE miss count", ObStatClassIds::CACHE, 245031, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_TMP_HIT_BYTES, "ss_macro_cache TMP_FILE hit bytes", ObStatClassIds::CACHE, 245032, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_TMP_MISS_BYTES, "ss_macro_cache TMP_FILE miss bytes", ObStatClassIds::CACHE, 245033, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_MACRO_MAX_CAPACITY, "ss_macro_cache max capacity of the MACRO_BLOCK type", ObStatClassIds::CACHE, 245034, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_MACRO_USED_SIZE, "ss_macro_cache MACRO_BLOCK used disk size", ObStatClassIds::CACHE, 245035, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_MACRO_HIT_CNT, "ss_macro_cache MACRO_BLOCK hit count", ObStatClassIds::CACHE, 245036, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_MACRO_MISS_CNT, "ss_macro_cache MACRO_BLOCK miss count", ObStatClassIds::CACHE, 245037, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_MACRO_HIT_BYTES, "ss_macro_cache MACRO_BLOCK hit bytes", ObStatClassIds::CACHE, 245038, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_MACRO_MISS_BYTES, "ss_macro_cache MACRO_BLOCK miss bytes", ObStatClassIds::CACHE, 245039, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_HOT_MACRO_MAX_CAPACITY, "ss_macro_cache max capacity of the HOT_TABLET_MACRO_BLOCK type", ObStatClassIds::CACHE, 245040, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_HOT_MACRO_USED_SIZE, "ss_macro_cache HOT_TABLET_MACRO_BLOCK used disk size", ObStatClassIds::CACHE, 245041, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_HOT_MACRO_HIT_CNT, "ss_macro_cache HOT_TABLET_MACRO_BLOCK hit count", ObStatClassIds::CACHE, 245042, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_HOT_MACRO_MISS_CNT, "ss_macro_cache HOT_TABLET_MACRO_BLOCK miss count", ObStatClassIds::CACHE, 245043, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_HOT_MACRO_HIT_BYTES, "ss_macro_cache HOT_TABLET_MACRO_BLOCK hit bytes", ObStatClassIds::CACHE, 245044, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_HOT_MACRO_MISS_BYTES, "ss_macro_cache HOT_TABLET_MACRO_BLOCK miss bytes", ObStatClassIds::CACHE, 245045, false, true, true)

STAT_EVENT_SET_DEF(SS_MACRO_CACHE_PRIVATE_MACRO_HIT_CNT, "ss_macro_cache private macro hit count", ObStatClassIds::CACHE, 245046, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_PRIVATE_MACRO_MISS_CNT, "ss_macro_cache private macro miss count", ObStatClassIds::CACHE, 245047, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_PRIVATE_MACRO_HIT_BYTES, "ss_macro_cache private macro hit bytes", ObStatClassIds::CACHE, 245048, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_PRIVATE_MACRO_MISS_BYTES, "ss_macro_cache private macro miss bytes", ObStatClassIds::CACHE, 245049, false, true, true)
STAT_EVENT_SET_DEF(SS_MACRO_CACHE_SHARED_MACRO_HIT_CNT, "ss_macro_cache shared macro hit count", ObStatClassIds::CACHE, 245050, false, true, true)
...
STAT_EVENT_SET_DEF(EXTERNAL_TABLE_DISK_CACHE_HIT_CNT, "external table disk cache hit count", ObStatClassIds::CACHE, 245054, false, true, true)
STAT_EVENT_SET_DEF(EXTERNAL_TABLE_DISK_CACHE_MISS_CNT, "external table disk cache miss count", ObStatClassIds::CACHE, 245055, false, true, true)
STAT_EVENT_SET_DEF(EXTERNAL_TABLE_DISK_CACHE_HIT_BYTES, "external table disk cache hit bytes", ObStatClassIds::CACHE, 245056, false, true, true)
STAT_EVENT_SET_DEF(EXTERNAL_TABLE_DISK_CACHE_MISS_BYTES, "external table disk cache miss bytes", ObStatClassIds::CACHE, 245057, false, true, true)
