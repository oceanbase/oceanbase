...
GLOBAL_ERRSIM_POINT_DEF(769, EN_SHARED_STORAGE_MICRO_CACHE_WRITE_SUPER_BLK_ERR, "ss macro cache write super block error");
GLOBAL_ERRSIM_POINT_DEF(770, EN_SHARED_STORAGE_MICRO_CACHE_READ_SUPER_BLK_ERR, "ss macro cache read super block error");
