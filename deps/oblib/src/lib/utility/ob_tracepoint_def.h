...
GLOBAL_ERRSIM_POINT_DEF(246, EN_SORT_IMPL_FORCE_DO_DUMP, "");
...
GLOBAL_ERRSIM_POINT_DEF(313, EN_DAS_SIMULATE_AGG_TASK_BUFF_LIMIT, "");
...
GLOBAL_ERRSIM_POINT_DEF(408, EN_SQL_SELECT_INTO_OP_RETRY, "");
...
GLOBAL_ERRSIM_POINT_DEF(2011, EN_CHECK_TX_CTX_LOCK, "trace transaction ctx's lock acquire");
...
GLOBAL_ERRSIM_POINT_DEF(2105, EN_ENABLE_CLEAN_INTERM_RES, "Used to prevent cleaning up interm results when an error occurs on the peer side.");
...
// WR && ASH
GLOBAL_ERRSIM_POINT_DEF(2210, EN_SQL_MEMORY_MRG_OPTION, "");
...
GLOBAL_ERRSIM_POINT_DEF(2305, EN_DISABLE_CONST_EXPR_CALC_OPT, "Disable optimization for calculable exprs");
