...
GLOBAL_ERRSIM_POINT_DEF(1306, EN_VEC_INDEX_HNSW_REBUILD_CHECK_TASK_FAIL, "");
GLOBAL_ERRSIM_POINT_DEF(1307, EN_VEC_MEM_SYNC_TASK_FAIL, "make background vector index mem sync fail, to test a stale adapter staying in service");
...
// AI/BatchFile Pipeline begin 2710 - 2730
