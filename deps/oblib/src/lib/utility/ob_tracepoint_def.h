...
GLOBAL_ERRSIM_POINT_DEF(218, EN_SLOG_CKPT_ERROR, "skip slog checkpoint");
...
// data_dict_service
GLOBAL_ERRSIM_POINT_DEF(291, EN_DICT_MODIFY_ITEM_RETENION, "Used to modify retetion of data_dict history");
...
GLOBAL_ERRSIM_POINT_DEF(320, EN_INSERTUP_MERGE_RANGE_OPT, "");
GLOBAL_ERRSIM_POINT_DEF(321, EN_MERGE_RANGE_OPT_THRESHOLD, "");
GLOBAL_ERRSIM_POINT_DEF(322, EN_INSERT_UP_MEMORY_LIMIT, "");
GLOBAL_ERRSIM_POINT_DEF(323, EN_INDEX_MERGE_SKIP_ID_THRESHOLD, "");
...
GLOBAL_ERRSIM_POINT_DEF(571, EN_PARTIAL_GROUP_BY_PUSHDOWN_CONTROLER, "Used to control partial group by pushdown.");
// 600-700 For PX use
...
GLOBAL_ERRSIM_POINT_DEF(767, EN_SHARED_STORAGE_DIR_DISK_OUTOF_SPACE_ERR, "dir disk outof space error");
GLOBAL_ERRSIM_POINT_DEF(768, EN_SHARED_STORAGE_MICRO_CACHE_ASSIGN_SUPER_BLK_ERR, "ss_micro_cache assign super_blk error");
GLOBAL_ERRSIM_POINT_DEF(769, EN_SHARED_STORAGE_MICRO_CACHE_WRITE_SUPER_BLK_ERR, "ss_micro_cache write super block error");
GLOBAL_ERRSIM_POINT_DEF(770, EN_SHARED_STORAGE_MICRO_CACHE_READ_SUPER_BLK_ERR, "ss_micro_cache read super block error");
GLOBAL_ERRSIM_POINT_DEF(771, EN_CALIBRATE_DISK_SPACE_SLEEP, "calibrate disk space task sleep");
GLOBAL_ERRSIM_POINT_DEF(772, EN_LOB_META_DML_FAILED, "lob meta dml failed");
GLOBAL_ERRSIM_POINT_DEF(773, EN_SHARED_STORAGE_MICRO_CACHE_ADD_MICRO_BLOCK_ERR, "ss_micro_cache add micro block error");
...
GLOBAL_ERRSIM_POINT_DEF(1119, EN_RESTORE_DAG_NET_PERCEIVE_FAILED, "");
...
GLOBAL_ERRSIM_POINT_DEF(1305, EN_VEC_INDEX_IVF_CENTER_TABLE_BUILD_ERR, "");
GLOBAL_ERRSIM_POINT_DEF(
    1307, EN_VEC_MEM_SYNC_TASK_FAIL,
    "make background vector index mem sync fail, to test a stale adapter staying in service");
...
GLOBAL_ERRSIM_POINT_DEF(2215, EN_FORCE_MONITORING_DUMP_ROWS, "Used to force dump output rows in monitoring dump operator.");
// WR && ASH
...
GLOBAL_ERRSIM_POINT_DEF(2309, EN_SQL_AUDIT_NOASYNC_FIXUP, "For disable sql audit async fixup");
GLOBAL_ERRSIM_POINT_DEF(2310, EN_COMMIT_TIME_DELAY_US, "For simulate async committing delay");
GLOBAL_ERRSIM_POINT_DEF(2311, EN_ENABLE_RES_MGR_SYS_STAT_ALL_METRICS, "Enable all metrics output for gv$res_mgr_sysstat, only cpu metric per group by default");
GLOBAL_ERRSIM_POINT_DEF(2312, EN_ENABLE_RES_MGR_SYS_STAT_ALL_GROUPS, "Enable all group output for gv$res_mgr_sysstat, only user-created resource groups by default");
// force dump
...
GLOBAL_ERRSIM_POINT_DEF(2454, EN_FILL_PS_CUROSR_ERROR, "inject error at fill ps cursor stage");
