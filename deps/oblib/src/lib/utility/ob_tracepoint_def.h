...
GLOBAL_ERRSIM_POINT_DEF(369, EN_DEDUCE_TYPE_IDEMPOTENCY_CHECK, "Used to check whether the type deduce result is idempotent");
...
GLOBAL_ERRSIM_POINT_DEF(751, EN_SHARED_STORAGE_MICRO_CACHE_WRITE_DISK_ERR, "ss_micro_cache write disk error");
