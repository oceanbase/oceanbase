...
#ifndef OCEANBASE_SQL_OB_JSON_COMMON
#define OCEANBASE_SQL_OB_JSON_COMMON
...
{
public:
  ObJsonBuffer(common::ObIAllocator *allocator);
  ~ObJsonBuffer();
...
private:
  static const int64_t JSON_BUFFER_INIT_STRING_LEN = 512;
  common::ObIAllocator *allocator_;
  char *data_;
  uint64_t len_;
  uint64_t cap_;

  DISALLOW_COPY_AND_ASSIGN(ObJsonBuffer);
};

} // namespace common
} // namespace oceanbase
#endif // OCEANBASE_SQL_OB_JSON_COMMON