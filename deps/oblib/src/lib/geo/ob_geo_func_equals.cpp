...
// cartesian tree (only multi type)
...
{
  return eval_equals_without_strategy<ObCartesianMultilinestring, ObCartesianMultilinestring>(g1, g2, result);
}
OB_GEO_FUNC_END;
