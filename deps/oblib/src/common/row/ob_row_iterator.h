...
inline ObSingleRowIteratorWrapper::ObSingleRowIteratorWrapper() : row_(NULL), iter_end_(false)
{}

inline ObSingleRowIteratorWrapper::ObSingleRowIteratorWrapper(ObNewRow* row) : row_(row), iter_end_(false)
{}
