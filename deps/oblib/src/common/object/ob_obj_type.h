                                             ...
                                             const int16_t precision)
{
  ...
  const static VecValueTypeClass maps[] = {
    ...
    VEC_TC_DEC_INT32,          // ObDecimalIntType // unused
    VEC_TC_STRING,             // ObVectorType
  };
...
inline bool ob_is_vector_type(ObObjType type) { return ObVectorType == type; }
