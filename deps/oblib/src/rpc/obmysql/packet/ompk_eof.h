...
public:
  ...
  inline void set_warning_count(const uint16_t count)
  {
    warning_count_ = count;
  }
  inline void set_server_status(const ObServerStatusFlags status)
  {
  ...
  inline ObServerStatusFlags get_server_status() const
  {
