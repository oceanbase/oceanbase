...
union Ob20ProtocolFlags {
  ...
  bool is_extra_info_exist() const
  {
    return 1 == st_flags_.OB_EXTRA_INFO_EXIST;
  }
  bool is_last_packet() const
  {
    return 1 == st_flags_.OB_IS_LAST_PACKET;
  }
  bool is_proxy_reroute() const
  {
    return 1 == st_flags_.OB_IS_PROXY_REROUTE;
  }
  ...
  struct Protocol20Flags {
    ...
    uint32_t OB_FLAG_RESERVED_NOT_USE : 29;
  } st_flags_;
};
...
public:
  ...
  {
    return hdr_.cp_hdr_.comp_len_;
  }
  inline uint8_t get_comp_seq() const
  {
    return hdr_.cp_hdr_.comp_seq_;
  }
  inline uint32_t get_uncomp_len() const
  {
    return hdr_.cp_hdr_.uncomp_len;
  }
  inline const char* get_cdata() const
  {
    return cdata_;
  }
  inline Ob20ProtocolFlags get_flags() const
  {
    return hdr_.flag_;
  }
  inline uint32_t get_payload_len() const
  {
    return hdr_.payload_len_;
  }
  ...
  inline uint8_t get_seq() const
  {
    return hdr_.pkt_seq_;
  }
  inline uint32_t get_request_id() const
  {
    return hdr_.request_id_;
  }
  inline void set_header(const Ob20ProtocolHeader& header)
  {
    hdr_ = header;
  }
  inline void set_content(const char* content, const Ob20ProtocolHeader& header, const Ob20ExtraInfo extra_info)
  {
    set_header(header);
    extra_info_ = extra_info;
    cdata_ = content;
  }
  const Ob20ExtraInfo& get_extra_info() const
  {
    return extra_info_;
  }
