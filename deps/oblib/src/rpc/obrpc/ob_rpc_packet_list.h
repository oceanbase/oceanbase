...
PCODE_DEF(OB_HA_GET_MICRO_BLOCK_CACHE_SIZE, 0x4C1)
PCODE_DEF(OB_HA_GET_MIGRATION_CACHE_JOB_INFO, 0x4C2)
PCODE_DEF(OB_HA_FETCH_MICRO_BLOCK_KEYS, 0x4C3)
...
PCODE_DEF(OB_DETECTOR_TIME_SYNC_MESSAGE, 0x9F3)
...
// PCODE_DEF(OB_CHECK_SERVER_EMPTY_WITH_RESULT, 0x1576)
...
PCODE_DEF(OB_SHARED_STORAGE_NET_THROT_PREDICT, 0x1610)
PCODE_DEF(OB_SHARED_STORAGE_NET_THROT_SET, 0x1611)
