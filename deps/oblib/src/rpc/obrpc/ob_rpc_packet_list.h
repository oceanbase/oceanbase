...
// PCODE_DEF(OB_TABLE_API_LOAD_BEGIN, 0x110A) // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_FINISH, 0x110B) // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_COMMIT, 0x110C) // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_ABORT, 0x110D) // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_GET_STATUS, 0x110E) // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD, 0x110F) // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_START_TRANS, 0x1110) // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_FINISH_TRANS, 0x1111) // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_ABANDON_TRANS, 0x1112) // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_GET_TRANS_STATUS, 0x1113) // not supported on 4.1.0 BP3

// PCODE_DEF(OB_TABLE_API_LOAD_PRE_BEGIN_PEER, 0x1114)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_CONFIRM_BEGIN_PEER, 0x1115)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_PRE_MERGE_PEER, 0x1116)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_START_MERGE_PEER, 0x1117)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_COMMIT_PEER, 0x1118)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_ABORT_PEER, 0x1119)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_GET_STATUS_PEER, 0x111A)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_PEER, 0x111B)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_PRE_START_TRANS_PEER, 0x111C)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_CONFIRM_START_TRANS_PEER, 0x111D)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_PRE_FINISH_TRANS_PEER, 0x111E)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_CONFIRM_FINISH_TRANS_PEER, 0x111F)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_ABANDON_TRANS_PEER, 0x1120)  // not supported on 4.1.0 BP3
// PCODE_DEF(OB_TABLE_API_LOAD_GET_TRANS_STATUS_PEER, 0x1121)  // not supported on 4.1.0 BP3
...
PCODE_DEF(OB_NOTIFY_ARCHIVE, 0x1429)
