...
//PCODE_DEF(OB_CANCEL_GATHER_STATS, 0x52E)//used to cancel gather stats by rpc, will patch later
...
#endif
PCODE_DEF(OB_QUICK_PREPARE, 0x933)
...
// kill client session.
// PCODE_DEF(OB_KILL_CLIENT_SESSION, 0x1608)
// obtain client session create time.
// PCODE_DEF(OB_CLIENT_SESSION_CONNECT_TIME, 0x1609)
