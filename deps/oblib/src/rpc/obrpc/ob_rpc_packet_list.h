...
PCODE_DEF(OB_PARALLEL_ALTER_TABLE, 0x27D)
PCODE_DEF(OB_PARALLEL_DROP_INDEX, 0x27E)
PCODE_DEF(OB_PARALLEL_RENAME_TABLE, 0x27F)
...
PCODE_DEF(OB_HA_CHECK_TRANSFER_OUT_TABLET_STATUS, 0x4CA)
#endif

PCODE_DEF(OB_HA_GET_LOCAL_CACHE_INFO, 0x4CB)
PCODE_DEF(OB_HA_GET_CACHE_JOB_INFO, 0x4CC)
PCODE_DEF(OB_HA_FETCH_LOCAL_CACHE_KEYS, 0x4CD)
PCODE_DEF(OB_HA_FETCH_LOCAL_CACHE_BLOCK, 0x4CE)
PCODE_DEF(OB_NOTIFY_UPLOAD_ROOT_KEY, 0x4CF)
PCODE_DEF(OB_HA_FETCH_MACRO_LOGIC_ID_INFO, 0x4D0)
PCODE_DEF(OB_HA_ADVANCE_SRC_LS_CHECKPOINT, 0x4D1)
PCODE_DEF(OB_HA_CLEAR_TRANSFER_META_INFO, 0x4D2)
// vector index migration RPCs
// PCODE_DEF(OB_HA_FETCH_VECTOR_INDEX_ADAPTOR_LIST, 0x4D3)
// PCODE_DEF(OB_HA_FETCH_VECTOR_INDEX_SEGMENT_METAS, 0x4D4)
// PCODE_DEF(OB_HA_REGISTER_VECTOR_INDEX_MIGRATION_PROCESSOR, 0x4D5)
// PCODE_DEF(OB_HA_FETCH_VECTOR_INDEX_MIGRATION_SEGMENT_DATA, 0x4D6)
// PCODE_DEF(OB_HA_RELEASE_VECTOR_INDEX_ADAPTOR_HANDLE, 0x4D7)
// PCODE_DEF(OB_HA_NOTIFY_VECTOR_INDEX_MIGRATION_PROCESSOR_DONE, 0x4D8)  // FARM COMPAT WHITELIST
...
PCODE_DEF(OB_BATCH_DETECT_SESSION_ALIVE, 0x565)
PCODE_DEF(OB_SERVER_UPDATE_CATALOG_STAT_CACHE, 0x566)
...
//PCODE_DEF(OB_BATCH_GEN_UNIQUE_ID, 0x662)
...
// hotspot redo
PCODE_DEF(OB_TX_HOTSPOT_REDO_DISPATCH, 0x67A)
PCODE_DEF(OB_TX_HOTSPOT_REDO_SUBMIT, 0x67B)
...
PCODE_DEF(OB_GET_LS_REPLICA_CHECKPOINT_INFO, 0x748)
...
PCODE_DEF(OB_LOG_TRANSPORT_REQ, 0x866)
PCODE_DEF(OB_LOG_SYNC_STANDBY_INFO, 0x867)
PCODE_DEF(OB_GET_LS_LOCATION, 0x868)
//PCODE_DEF(OB_CDC_GET_ARCHIVE_DEST, 0x869)
...
#endif
PCODE_DEF(OB_REMOVE_LOCK_PRIORITY, 0x937)
PCODE_DEF(OB_CHANGE_LS_SYNC_MODE, 0x938)
...
#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_TABLET_SPLIT_SCHEDULE, 0x971)
#endif
PCODE_DEF(OB_ALTER_RANDOM_DISTRIBUTION_PARTITION, 0x972)
PCODE_DEF(OB_BATCH_GET_TABLET_RANDOM, 0x973)
PCODE_DEF(OB_CLEAN_SPLITTED_TABLET_DDL, 0x974)
PCODE_DEF(OB_SYNC_TABLET_AUTOINC_SEQ_CACHE, 0x975)
//PCODE_DEF(OB_CLEAN_AND_UNHIDE_SPLITTED_TABLET_DDL, 0x976)
...
PCODE_DEF(OB_TABLE_SYC_FETCH_SESS_ID, 0x112A)
...
PCODE_DEF(OB_VALIDATE_BACKUP_LS_TASK, 0x1431)
PCODE_DEF(OB_VALIDATE_BACKUP_LS_TASK_RES, 0x1432)
PCODE_DEF(OB_CHECK_BACKUP_DEST_RW_CONSISTENCY, 0x1433)
PCODE_DEF(OB_CHECK_BACKUP_DEST_VALIDITY, 0x1434)
PCODE_DEF(OB_WRITE_BACKUP_DEST_FORMAT_FILE, 0x1435)
PCODE_DEF(OB_VALIDATE_BACKUP, 0x1436)
PCODE_DEF(OB_SS_HA_COPY_MACRO_BLOCKS, 0x1437)
PCODE_DEF(OB_SS_HA_DELETE_MACRO_BLOCKS, 0x1438)
PCODE_DEF(OB_BACKUP_ARCHIVE_LOG_ALL, 0x1439)
PCODE_DEF(OB_NOTIFY_BACKUP_ARCHIVE, 0x1440)
PCODE_DEF(OB_BACKUP_ARCHIVE_RESULT_REPORT, 0x1441)
...
PCODE_DEF(OB_LOG_REPORT_REPLAY_REACHING_MACHINE_REQ, 0x152A) // FARM COMPAT WHITELIST
PCODE_DEF(OB_LOG_NOTIFY_FOLLOWER_MOVE_OUT_FROM_RTO_GROUP_RESP, 0x152B) // FARM COMPAT WHITELIST
...
PCODE_DEF(OB_TABLE_MAJOR_FREEZE,  0x1559)
...
PCODE_DEF(OB_WR_ASYNC_UPDATE_SQLSTAT_TASK, 0x1585)
...
#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_SSWRITER_LEASE_ASYNC_REQ, 0x1643) // FARM COMPAT WHITELIST
PCODE_DEF(OB_SSWRITER_LEASE_ASYNC_RESP, 0x1644) // FARM COMPAT WHITELIST
#endif
// external catalog
...
#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_SSWRITER_LOCATION_REQ, 0x1647) // FARM COMPAT WHITELIST
PCODE_DEF(OB_SSWRITER_LOCATION_RESP, 0x1648) // FARM COMPAT WHITELIST
#endif
...
#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_GET_SSLOG_UID_REQUEST, 0x1658) // FARM COMPAT WHITELIST
#endif

#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_STUDY_MIN_SSTABLE_ROW_SCN, 0x165A)  // FARM COMPAT WHITELIST
#endif

PCODE_DEF(OB_DETECT_SSLOG_LS, 0x165E)
PCODE_DEF(OB_SET_MASTER_KEY, 0x1662)
...
// PCODE_DEF(OB_SWITCH_SS_GC_SERVICE, 0x1659)
// PCODE_DEF(OB_STUDY_MIN_SSTABLE_ROW_SCN, 0x165A)

// for location
PCODE_DEF(OB_CREATE_LOCATION, 0x165B)
PCODE_DEF(OB_DROP_LOCATION, 0x165C)
// mysql obj priv
...
PCODE_DEF(OB_CREATE_EXTERNAL_RESOURCE, 0x165F)
PCODE_DEF(OB_DROP_EXTERNAL_RESOURCE, 0x1660)
...
#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_GET_MIN_SS_GC_LAST_SUCC_SCN, 0x1667)                 // FARM COMPAT WHITELIST
PCODE_DEF(OB_GET_SS_GC_LAST_SUCC_SCNS, 0x1668)                    // FARM COMPAT WHITELIST
#endif
...
#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_DEL_SS_MACRO_CACHE, 0x1671)
PCODE_DEF(OB_DEL_SS_TABLET_MACRO_CACHE, 0x1672)
PCODE_DEF(OB_FLUSH_SS_LOCAL_CACHE, 0x1673)
#endif
PCODE_DEF(OB_ALTER_UDT_WITH_RES, 0x1674)

// for ai model
PCODE_DEF(OB_CREATE_AI_MODEL, 0x1675)
PCODE_DEF(OB_DROP_AI_MODEL, 0x1676)
PCODE_DEF(OB_CHECK_SERVER_ALIVE, 0x1677)

PCODE_DEF(OB_COLLECT_CN_CLOG_CKPT, 0x1678)
PCODE_DEF(OB_CHECK_SYS_TABLE_SCHEMA, 0x1679)
PCODE_DEF(OB_COLLECT_CN_TX_RECYCLE_SCN, 0x167A)

PCODE_DEF(OB_ADJUST_SS_GC_TABLET_VERSION_RETENTION_SCN, 0x167B)
...
PCODE_DEF(OB_CHECK_TABLET_EXIST, 0x1683)
PCODE_DEF(OB_GET_UNIT_INFO, 0x1684)

#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_PREWARM_SS_LOCAL_CACHE, 0x1685)
PCODE_DEF(OB_PUSH_SS_GC_LAST_SUCC_SCN, 0x1686)
#endif
...
#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_GET_SS_GC_DETECT_INFOS, 0x1689)
PCODE_DEF(OB_GET_SS_GC_START_SCN_ITEMS, 0x168A)
#endif

PCODE_DEF(OB_RUN_INSPECTION, 0x168B)
PCODE_DEF(OB_GET_INSPECTION_STATUS, 0x168C)

// for jar external resource management in Oracle Java UDF
PCODE_DEF(OB_ORA_UPLOAD_JAR, 0x168D)
PCODE_DEF(OB_ORA_DROP_JAR, 0x168E)

// for java policy
PCODE_DEF(OB_CREATE_JAVA_POLICY, 0x168F)
PCODE_DEF(OB_DROP_JAVA_POLICY, 0x1690)
PCODE_DEF(OB_MODIFY_JAVA_POLICY, 0x1691)

PCODE_DEF(OB_GET_TENANT_MEMORY_INFO, 0x1692)
#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_SS_GC_CHECK_HAS_LS, 0x1693)
#endif
...
// for custom fulltext dict
PCODE_DEF(OB_REFRESH_FULLTEXT_DICT, 0x1698) // FARM COMPAT WHITELIST

#ifdef OB_BUILD_SHARED_STORAGE
PCODE_DEF(OB_GET_SS_GC_V2_SAFE_SCN_MAP, 0x1699)
#endif
// for ai provider
PCODE_DEF(OB_REGISTER_PROVIDER, 0x169A)
PCODE_DEF(OB_UNREGISTER_PROVIDER, 0x169B)

// for ai gateway
PCODE_DEF(OB_CREATE_AI_GATEWAY, 0x169C)
PCODE_DEF(OB_ALTER_AI_GATEWAY, 0x169D)
PCODE_DEF(OB_DROP_AI_GATEWAY, 0x169E)

PCODE_DEF(OB_DROP_GTT_V2_SESSION_TABLET, 0x169F)
PCODE_DEF(OB_RUN_MVIEW_PENDING_TASK, 0x16A0)
PCODE_DEF(OB_SCHEDULE_MVIEW_REFRESH, 0x16A1)
PCODE_DEF(OB_KILL_MVIEW_REFRESH, 0x16A2)
PCODE_DEF(OB_ASYNC_GET_INSPECTION_STATUS, 0x16A3)

PCODE_DEF(OB_ALTER_PROVIDER, 0x16A4)
PCODE_DEF(OB_FORCE_REMOVE_LS_REPLICA, 0x16A5)
...
// CDC Instance RPC PCODE placeholders.
// PCODE_DEF(OB_CDC_INSTANCE_HEARTBEAT, 0x2000)
// PCODE_DEF(OB_CDC_VALIDATE_CLIENT_TOKEN, 0x2001)
// PCODE_DEF(OB_CDC_GET_STREAM_PLACEMENT_HEADER, 0x2002)
// PCODE_DEF(OB_CDC_ASSIGN_FETCH_TASK, 0x2003)
// PCODE_DEF(OB_CDC_ASSIGN_WORKER_TASK, 0x2004)
// PCODE_DEF(OB_CDC_NOTIFY_CHANNEL_CHANGE, 0x2005)
// PCODE_DEF(OB_CDC_BATCH_PUSH_MESSAGE, 0x2006)
// PCODE_DEF(OB_CDC_REGISTER_PUSH_TASK, 0x2007)
// PCODE_DEF(OB_CDC_FETCH_REDO_PAYLOAD_BY_LSN, 0x2008)
// PCODE_DEF(OB_CDC_PUSH_PART_TRANS_INFO, 0x2009)
// PCODE_DEF(OB_CDC_RECONCILE_DATA_RANGE_RUNTIME, 0x200A)
// PCODE_DEF(OB_CDC_FETCH_REDO_LOG, 0x2010)
// PCODE_DEF(OB_CDC_REFRESH_CONFIG, 0x2011)
// PCODE_DEF(OB_CDC_BUMP_STREAM_CHANNEL_EPOCH, 0x2012)
// PCODE_DEF(OB_CDC_FLOW_CONTROL_DATA_RANGE, 0x2013)
// PCODE_DEF(OB_CDC_HEALTH_HEARTBEAT, 0x2014)
PCODE_DEF(OB_CDC_RECONCILE_PROVIDER_SET, 0x2015)
//**** 注意：在此行之前增加新的RPC ID ******
//
//占位须知：
//
