...
ObLockWaitNode::ObLockWaitNode() :
  last_wait_hash_(0), need_wait_(false), addr_(NULL), recv_ts_(0), lock_ts_(0), lock_seq_(0),
  abs_timeout_(0), ls_id_(0), tablet_id_(common::OB_INVALID_ID), try_lock_times_(0), sessid_(0), assoc_sess_id_(0),
