...
T_FUN_SYS_SEARCH_INDEX_INNER_PATH = 1943,
  ...
  T_FUN_SYS_NCHR = 1954,
  T_FUN_SYS_SPLIT_BY_STRING = 1955,
  T_FUN_SYS_ORA_SYSEVENT = 1956,
  T_FUN_SYS_ORA_INSTANCE_NUM = 1957,
  T_FUN_SYS_ORA_DATABASE_NAME = 1958,
  T_FUN_SYS_ORA_DICT_OBJ_OWNER = 1959,
  T_FUN_SYS_ORA_DICT_OBJ_NAME = 1960,
  T_FUN_SYS_ORA_DICT_OBJ_TYPE = 1961,
  T_FUN_SYS_ORA_IS_ALTER_COLUMN = 1962,
  T_FUN_SYS_ORA_IS_DROP_COLUMN = 1963,
  T_FUN_SYS_ORA_IS_CREATING_NESTED_TABLE = 1964,
  T_FUN_SYS_ORA_WITH_GRANT_OPTION = 1965,
  T_FUN_SYS_ORA_DES_ENCRYPTED_PASSWORD = 1966,
  ...
  T_FUN_AVG_WEIGHTED = 2106,
  T_FUN_STRING_AGG = 2107,
  T_FUN_RETENTION = 2108, // FARM COMPAT WHITELIST
  T_FUN_ANY_VALUE = 2109,
  T_MAX_OP = 3000,
...
//  T_TG_EXECUTE_BLOCK,
  ...
  T_ALTER_SUBPARTITION_REORGANIZE = 4979,
  T_ALTER_SUBPARTITION_SPLIT = 4980,
