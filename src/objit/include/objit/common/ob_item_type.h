...
// please modify need_calc_json_as_text if other json functions are added
  ...
  T_FUN_SYS_ST_CENTROID = 1681,
  // gis expr should add above
  // please maintain is_geo_expr / is_mysql_geo_expr / is_priv_geo_expr if other gis expr added

  T_FUN_SYS_IS_JSON = 1781,
  T_FUN_SYS_JSON_EQUAL = 1782,
  T_FUN_SYS_JSON_QUERY = 1783,
  T_FUN_ORA_JSON_ARRAYAGG = 1784,
  T_FUN_ORA_JSON_OBJECTAGG = 1785,
  T_FUN_SYS_JSON_EXISTS = 1786,
  T_FUN_SYS_TREAT = 1787,
  T_NULLX_CLAUSE = 1788,   // null clause on json expr
  T_FUN_SYS_NLS_INITCAP = 1789,
  T_WEIGHT_STRING_LEVEL_PARAM = 1790, // `level 1-2` and `level 1,2,3` clause on json expr
  T_FUN_SYS_CURRENT_SCN = 1791,
  T_FUN_SYS_MAKEXML = 1792,
  T_FUN_SYS_XML_ELEMENT = 1793,
  T_FUN_SYS_XMLPARSE = 1794,
  T_FUN_ORA_XMLAGG = 1795,
  T_FUN_SYS_XML_ATTRIBUTES = 1796,
  T_FUN_SYS_XML_EXTRACTVALUE = 1797,
  T_FUN_SYS_XML_EXTRACT = 1798,
  T_FUN_SYS_XML_SERIALIZE = 1799,
  T_FUN_SYS_XMLCAST = 1800,
  T_FUN_SYS_XML_ATTRIBUTES_VALUES = 1801,
  T_FUN_SYS_UPDATE_XML = 1802,
  T_FUN_SYS_PRIV_MAKE_XML_BINARY = 1803,  // add only for xml dml rewrite
  ///< @note add new oracle only function type before this line

  T_FUN_SYS_TABLET_AUTOINC_NEXTVAL = 1804, // add only for heap table
  T_FUN_SYS_GENERATOR = 1805,
  T_FUN_SYS_ZIPF = 1806,
  T_FUN_SYS_NORMAL = 1807,
  T_FUN_SYS_UNIFORM = 1808,
  T_FUN_SYS_RANDOM = 1809,
  T_FUN_SYS_RANDSTR = 1810,
  T_FUN_SYS_END = 2000,
