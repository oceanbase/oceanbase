...
DEF_STR_FUNC_INIT(CS_TYPE_LATIN1_GERMAN1_CI, 11);
DEF_STR_FUNC_INIT(CS_TYPE_LATIN1_SWEDISH_CI, 12);
DEF_STR_FUNC_INIT(CS_TYPE_LATIN1_DANISH_CI, 13);
DEF_STR_FUNC_INIT(CS_TYPE_LATIN1_GERMAN2_CI, 14);
DEF_STR_FUNC_INIT(CS_TYPE_LATIN1_BIN, 15);
DEF_STR_FUNC_INIT(CS_TYPE_LATIN1_GENERAL_CI, 16);
DEF_STR_FUNC_INIT(CS_TYPE_LATIN1_GENERAL_CS, 17);
DEF_STR_FUNC_INIT(CS_TYPE_LATIN1_SPANISH_CI, 18);
