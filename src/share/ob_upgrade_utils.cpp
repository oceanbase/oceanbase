...
const uint64_t ObUpgradeChecker::UPGRADE_PATH_CURRENT[] = {
  ...
  CALC_VERSION(4UL, 4UL, 2UL, 4UL),  // 4.4.2.4
...
#define CONVERT_CLUSTER_VERSION_TO_DATA_VERSION(CLUSTER_VERSION, DATA_VERSION) \
    ...
    CONVERT_CLUSTER_VERSION_TO_DATA_VERSION(CLUSTER_VERSION_4_4_2_0, DATA_VERSION_4_4_2_0)
    CONVERT_CLUSTER_VERSION_TO_DATA_VERSION(CLUSTER_VERSION_4_4_2_1, DATA_VERSION_4_4_2_1)
    CONVERT_CLUSTER_VERSION_TO_DATA_VERSION(CLUSTER_VERSION_4_4_2_2, DATA_VERSION_4_4_2_2)
    CONVERT_CLUSTER_VERSION_TO_DATA_VERSION(CLUSTER_VERSION_4_4_2_3, DATA_VERSION_4_4_2_3)
    CONVERT_CLUSTER_VERSION_TO_DATA_VERSION(CLUSTER_VERSION_4_4_2_4, DATA_VERSION_4_4_2_4)
...
{
  return DATA_VERSION_4_3_3_0 <= data_version || DATA_VERSION_4_3_0_0 > data_version;
}
...
#define INIT_PROCESSOR_BY_VERSION(MAJOR, MINOR, MAJOR_PATCH, MINOR_PATCH) \
    ...
    INIT_PROCESSOR_BY_VERSION(4, 4, 2, 4);
...
int ObUpgradeFor4421Processor::post_upgrade()
{
  int ret = OB_SUCCESS;
  if (OB_FAIL(check_inner_stat())) {
    LOG_WARN("fail to check inner stat", KR(ret));
...
int ObUpgradeFor4421Processor::post_upgrade_for_schema_history_recycle_()
{
  int ret = OB_SUCCESS;
  bool is_primary_tenant = false;
  ObSchemaGetterGuard schema_guard;
...
int ObUpgradeFor4421Processor::post_upgrade_for_inspection_jobs_()
{
  int ret = OB_SUCCESS;
  bool is_primary_tenant = false;
  ObSchemaGetterGuard schema_guard;
