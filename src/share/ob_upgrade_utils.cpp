...
/* =========== 4258 upgrade processor begin ============= */

int ObUpgradeFor4258Processor::post_upgrade()
{
  int ret = OB_SUCCESS;
  if (OB_FAIL(check_inner_stat())) {
    LOG_WARN("fail to check inner stat", KR(ret));
...
int ObUpgradeFor4258Processor::post_upgrade_for_sys_table_progressive_merge_round_()
{
  int ret = OB_SUCCESS;
  ObSqlString sql;
