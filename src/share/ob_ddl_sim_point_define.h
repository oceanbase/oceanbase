...
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_UPDATE_MDS_FAILED, 133, "update mds failed", RET_ERR(OB_EAGAIN))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_UPDATE_MINOR_FAILED, 134, "update minor failed", RET_ERR(OB_EAGAIN))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_UPDATE_MAJOR_FAILED, 135, "update major failed", RET_ERR(OB_EAGAIN))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_DOWNLOAD_MDS_FAILED, 136, "download mds failed", RET_ERR(OB_EAGAIN))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_DOWNLOAD_MINOR_FAILED, 137, "download minor failed", RET_ERR(OB_EAGAIN))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_DOWNLOAD_MAJOR_FAILED, 138, "download major failed", RET_ERR(OB_EAGAIN))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_UPDATE_SOURCE_TABLET_FAILED, 139, "update source tablet failed", RET_ERR(OB_EAGAIN))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_DOWNLOAD_SSTABLE_SLOW, 140, "download sstables slow", SLEEP_MS(10 * 1000 * 60 /*10min*/, 1000 * 60 * 60 /*1h*/))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_UPDATE_MDS_SLOW, 141, "update mds slow", SLEEP_MS(10 * 1000 * 60 /*10min*/, 1000 * 60 * 30 /*30min*/))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_UPDATE_MINOR_SLOW, 142, "update minor slow", SLEEP_MS(10 * 1000 * 60 /*10min*/, 1000 * 60 * 30 /*30min*/))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL_SPLIT, SPLIT_UPDATE_MAJOR_SLOW, 143, "update major slow", SLEEP_MS(10 * 1000 * 60 /*10min*/, 1000 * 60 * 30 /*30min*/))
