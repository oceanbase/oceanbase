...
private:
  ...
  int64_t auto_fit_update_time_ms = 10 * 1000;
  ...
  static constexpr uint64_t INTERVAL_CHANGE_UNIT = 1000 * 10; // 10s
  ...
  static constexpr uint64_t UPDATE_TIME_FROM_CLIENT_MAX_INTERVAL =
      1000 * 60 * 10; // 10min
  static constexpr uint64_t MAX_NETWORK_DELAY = 100; // 100ms
};
