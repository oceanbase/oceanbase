...
SQL_MONITOR_STATNAME_DEF(BASE_READ_ROW_CNT, metric::Unit::INT, "total rows processed by major sstable", "total rows processed by major table", M_SUM | E_MIN | E_MAX, metric::Level::STANDARD)
