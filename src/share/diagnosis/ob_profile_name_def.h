...
OP_PROFILE_NAME_DEF(PHY_HYBRID_FUSION)
OP_PROFILE_NAME_DEF(PHY_RESCAN)
OP_PROFILE_NAME_DEF(PHY_STATISTICS_COLLECTOR)
OP_PROFILE_NAME_DEF(PHY_EXTERNAL_ROW_SAMPLE_SCAN)
OP_PROFILE_NAME_DEF(PHY_EXTERNAL_BLOCK_SAMPLE_SCAN)
OP_PROFILE_NAME_DEF(PHY_PX_ORDERED_RECEIVE)
OP_PROFILE_NAME_DEF(PHY_END)
#endif

#ifdef OTHER_PROFILE_NAME_DEF
OTHER_PROFILE_NAME_DEF(OTHER_PROFILE_NAME_BEGIN, "other profile name begin", 1000) /* 1000 */
...
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_PARTITION, "Partition")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_FUSION_ITER, "Fusion Iter")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_VEC_ITER, "Vector Iter")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_HYBRID_ITER, "Hybrid Iter")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_CONJUNCTION, "Conjunction Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_DISJUNCTION, "Disjunction Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_DISJUNCTION_FILTER, "Disjunction Filter Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_REQ_OPT, "Req Opt Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_REQ_EXCL, "Req Excl Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_SCALAR_INDEX_ROR, "Scalar Index ROR Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_SCALAR_PRIMARY_ROR, "Scalar Primary ROR Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_SCALAR_SCAN, "Scalar Scan Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_BITMAP, "Bitmap Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_SORT, "Sort Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_TOPK_COLLECT, "TopK Collect Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_DISJUNCTIVE_MAX, "Disjunctive Max Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_TOKEN, "Token Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_MATCH_PHRASE, "Match Phrase Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_DUMMY, "Dummy Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_BMW, "BMW Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_BMM, "BMM Op")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_VEC_HNSW_SCAN, "Vector Index HNSW Scan")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_PARALLEL_TASK, "Task")
OTHER_PROFILE_NAME_DEF(HYBRID_SEARCH_END, "hybrid search end", 1115)

OTHER_PROFILE_NAME_DEF(LAKE_TABLE_PARQUET_PAGE_MGR, "Lake Table ParquetPageMgr")
OTHER_PROFILE_NAME_DEF(LAKE_TABLE_ICEBERG_DELETE, "Lake Table Iceberg Delete")

// AI Rerank Profile
OTHER_PROFILE_NAME_DEF(AI_RERANK_BEGIN, "ai rerank begin", 1120)
OTHER_PROFILE_NAME_DEF(AI_RERANK, "AI Rerank")
OTHER_PROFILE_NAME_DEF(AI_RERANK_HTTP_REQUEST, "AI Rerank HTTP Request")
OTHER_PROFILE_NAME_DEF(AI_RERANK_BATCH_COUNT, "AI Rerank Batch Count")
OTHER_PROFILE_NAME_DEF(AI_RERANK_DOCUMENT_COUNT, "AI Rerank Document Count")
OTHER_PROFILE_NAME_DEF(AI_RERANK_API_CALL_COUNT, "AI Rerank API Call Count")
OTHER_PROFILE_NAME_DEF(AI_RERANK_END, "ai rerank end", 1126)
...
#define OTHER_PROFILE_GET_OTHER_MACRO(_1, _2, _3, NAME, ...) NAME
#define OTHER_PROFILE_NAME_DEF(...) \
  OTHER_PROFILE_GET_OTHER_MACRO(__VA_ARGS__, OTHER_PROFILE_NAME_DEF_3, OTHER_PROFILE_NAME_DEF_2)(__VA_ARGS__)
#define OTHER_PROFILE_NAME_DEF_2(enum_type, desc) enum_type,
#define OTHER_PROFILE_NAME_DEF_3(enum_type, desc, val) enum_type = val,
#include "share/diagnosis/ob_profile_name_def.h"
#undef OTHER_PROFILE_NAME_DEF_2
#undef OTHER_PROFILE_NAME_DEF_3
#undef OTHER_PROFILE_NAME_DEF
#undef OTHER_PROFILE_GET_OTHER_MACRO
};
