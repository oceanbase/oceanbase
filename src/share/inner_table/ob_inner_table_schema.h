...
struct ALL_VIRTUAL_PLAN_STAT_CDE {
  enum {
    ...
    PLAN_SET_ID,
    CREATE_REASON,
    BASE_TABLE_LOCATION_CONSTRAINT,
    DUPLICATE_TABLE_REPLICA_CONSTRAINT,
    STRICT_LOCATION_CONSTRAINT,
    NON_STRICT_LOCATION_CONSTRAINT,
    PARAMS_VALUE
  };
};
...
public:
  ...
  static int all_external_resource_schema(share::schema::ObTableSchema &table_schema);
  static int all_external_resource_history_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_tenant_macro_block_ha_task_schema(share::schema::ObTableSchema &table_schema);
  static int all_tenant_macro_block_ha_task_progress_schema(share::schema::ObTableSchema &table_schema);
  static int all_tenant_macro_block_ha_task_history_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_catalog_table_stat_schema(share::schema::ObTableSchema &table_schema);
  static int all_catalog_column_stat_schema(share::schema::ObTableSchema &table_schema);
  static int all_catalog_table_opt_stat_gather_history_schema(share::schema::ObTableSchema &table_schema);
  static int all_audit_log_encryption_password_schema(share::schema::ObTableSchema &table_schema);
  static int all_optstat_catalog_user_prefs_schema(share::schema::ObTableSchema &table_schema);
  static int all_optstat_catalog_global_prefs_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_ss_tablet_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_ls_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_sstable_mgr_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_ls_tablet_reorganization_info_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_existing_tablet_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_existing_sstable_mgr_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_diagnose_info_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_sswriter_group_stat_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_sswriter_lease_mgr_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_ls_migration_task_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_notify_tasks_stat_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_notify_tablets_stat_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_external_resource_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_external_resource_history_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_logservice_cluster_info_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_gc_status_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_macro_block_ha_task_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_macro_block_ha_task_progress_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_macro_block_ha_task_history_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_catalog_table_opt_stat_gather_history_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_audit_log_encryption_password_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_optstat_catalog_user_prefs_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_optstat_catalog_global_prefs_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_table_opt_stat_invalidate_plan_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_kv_ttl_task_ora_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_kv_ttl_task_history_ora_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_sswriter_group_stat_ora_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_sswriter_lease_mgr_ora_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_tenant_location_real_agent_ora_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_tenant_objauth_mysql_real_agent_ora_schema(share::schema::ObTableSchema &table_schema);
  static int tenant_virtual_list_file_ora_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_tablet_meta_ora_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_ls_meta_ora_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_sstable_mgr_ora_schema(share::schema::ObTableSchema &table_schema);
  static int all_virtual_ss_ls_tablet_reorganization_info_ora_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_virtual_macro_block_ha_task_ora_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int dba_ob_tenant_flashback_log_scn_schema(share::schema::ObTableSchema &table_schema);
  static int cdb_ob_tenant_flashback_log_scn_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int dba_ob_external_resources_schema(share::schema::ObTableSchema &table_schema);
  static int cdb_ob_external_resources_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int v_ob_hms_client_pool_stat_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int cdb_ob_ttl_task_history_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int dba_ob_external_tab_statistics_schema(share::schema::ObTableSchema &table_schema);
  static int dba_ob_external_tab_col_statistics_schema(share::schema::ObTableSchema &table_schema);
  static int dba_ob_external_part_col_statistics_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int dba_ob_tenant_flashback_log_scn_ora_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int gv_ob_result_cache_objects_ora_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int dba_ob_ttl_tasks_ora_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_external_resource_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_external_resource_history_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_tenant_macro_block_ha_task_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_tenant_macro_block_ha_task_progress_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_tenant_macro_block_ha_task_history_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_catalog_table_stat_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_catalog_column_stat_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_catalog_table_opt_stat_gather_history_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_audit_log_encryption_password_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_optstat_catalog_user_prefs_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  static int all_optstat_catalog_global_prefs_aux_lob_meta_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_external_resource_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  static int all_external_resource_history_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_tenant_macro_block_ha_task_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  static int all_tenant_macro_block_ha_task_progress_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  static int all_tenant_macro_block_ha_task_history_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_catalog_table_stat_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  static int all_catalog_column_stat_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  static int all_catalog_table_opt_stat_gather_history_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  static int all_audit_log_encryption_password_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  static int all_optstat_catalog_user_prefs_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  static int all_optstat_catalog_global_prefs_aux_lob_piece_schema(share::schema::ObTableSchema &table_schema);
  ...
  static int all_tablet_to_global_temporary_table_idx_temp_table_id_session_id_schema(share::schema::ObTableSchema &table_schema);
...
const schema_create_func sys_table_schema_creators [] = {
  ...
  ObInnerTableSchema::all_external_resource_schema,
  ObInnerTableSchema::all_external_resource_history_schema,
  ...
  ObInnerTableSchema::all_tenant_macro_block_ha_task_schema,
  ObInnerTableSchema::all_tenant_macro_block_ha_task_progress_schema,
  ObInnerTableSchema::all_tenant_macro_block_ha_task_history_schema,
  ...
  ObInnerTableSchema::all_catalog_table_stat_schema,
  ObInnerTableSchema::all_catalog_column_stat_schema,
  ObInnerTableSchema::all_catalog_table_opt_stat_gather_history_schema,
  ObInnerTableSchema::all_audit_log_encryption_password_schema,
  ObInnerTableSchema::all_optstat_catalog_user_prefs_schema,
  ObInnerTableSchema::all_optstat_catalog_global_prefs_schema,
...
const schema_create_func virtual_table_schema_creators [] = {
  ...
  ObInnerTableSchema::all_virtual_ss_tablet_meta_schema,
  ObInnerTableSchema::all_virtual_ss_ls_meta_schema,
  ObInnerTableSchema::all_virtual_ss_sstable_mgr_schema,
  ObInnerTableSchema::all_virtual_ss_ls_tablet_reorganization_info_schema,
  ObInnerTableSchema::all_virtual_ss_existing_tablet_meta_schema,
  ObInnerTableSchema::all_virtual_ss_existing_sstable_mgr_schema,
  ObInnerTableSchema::all_virtual_ss_diagnose_info_schema,
  ...
  ObInnerTableSchema::all_virtual_sswriter_group_stat_schema,
  ObInnerTableSchema::all_virtual_sswriter_lease_mgr_schema,
  ...
  ObInnerTableSchema::all_virtual_ls_migration_task_schema,
  ObInnerTableSchema::all_virtual_ss_notify_tasks_stat_schema,
  ObInnerTableSchema::all_virtual_ss_notify_tablets_stat_schema,
  ...
  ObInnerTableSchema::all_virtual_external_resource_schema,
  ObInnerTableSchema::all_virtual_external_resource_history_schema,
  ObInnerTableSchema::all_virtual_ccl_rule_history_schema,
  ObInnerTableSchema::all_virtual_tenant_vector_mem_info_schema,
  ObInnerTableSchema::all_virtual_logservice_cluster_info_schema,
  ObInnerTableSchema::all_virtual_ss_gc_status_schema,
  ...
  ObInnerTableSchema::all_virtual_macro_block_ha_task_schema,
  ObInnerTableSchema::all_virtual_macro_block_ha_task_progress_schema,
  ObInnerTableSchema::all_virtual_macro_block_ha_task_history_schema,
  ...
  ObInnerTableSchema::all_virtual_catalog_table_opt_stat_gather_history_schema,
  ObInnerTableSchema::all_virtual_audit_log_encryption_password_schema,
  ObInnerTableSchema::all_virtual_optstat_catalog_user_prefs_schema,
  ObInnerTableSchema::all_virtual_optstat_catalog_global_prefs_schema,
  ObInnerTableSchema::all_virtual_tenant_worker_group_schema,
  ObInnerTableSchema::all_virtual_keyword_schema,
  ObInnerTableSchema::all_virtual_table_opt_stat_invalidate_plan_schema,
  ...
  ObInnerTableSchema::all_virtual_kv_ttl_task_ora_schema,
  ObInnerTableSchema::all_virtual_kv_ttl_task_history_ora_schema,
  ...
  ObInnerTableSchema::all_virtual_sswriter_group_stat_ora_schema,
  ObInnerTableSchema::all_virtual_sswriter_lease_mgr_ora_schema,
  ...
  ObInnerTableSchema::all_virtual_tenant_location_real_agent_ora_schema,
  ObInnerTableSchema::all_virtual_tenant_objauth_mysql_real_agent_ora_schema,
  ObInnerTableSchema::tenant_virtual_list_file_ora_schema,
  ObInnerTableSchema::all_virtual_ss_tablet_meta_ora_schema,
  ObInnerTableSchema::all_virtual_ss_ls_meta_ora_schema,
  ObInnerTableSchema::all_virtual_ss_sstable_mgr_ora_schema,
  ObInnerTableSchema::all_virtual_ss_ls_tablet_reorganization_info_ora_schema,
  ...
  ObInnerTableSchema::all_virtual_macro_block_ha_task_ora_schema,
...
const schema_create_func sys_view_schema_creators [] = {
  ...
  ObInnerTableSchema::dba_ob_tenant_flashback_log_scn_schema,
  ObInnerTableSchema::cdb_ob_tenant_flashback_log_scn_schema,
  ...
  ObInnerTableSchema::dba_ob_external_resources_schema,
  ObInnerTableSchema::cdb_ob_external_resources_schema,
  ...
  ObInnerTableSchema::v_ob_hms_client_pool_stat_schema,
  ...
  ObInnerTableSchema::cdb_ob_ttl_task_history_schema,
  ...
  ObInnerTableSchema::dba_ob_external_tab_statistics_schema,
  ObInnerTableSchema::dba_ob_external_tab_col_statistics_schema,
  ObInnerTableSchema::dba_ob_external_part_col_statistics_schema,
  ...
  ObInnerTableSchema::dba_ob_tenant_flashback_log_scn_ora_schema,
  ...
  ObInnerTableSchema::gv_ob_result_cache_objects_ora_schema,
  ...
  ObInnerTableSchema::dba_ob_ttl_tasks_ora_schema,
...
const schema_create_func sys_index_table_schema_creators [] = {
  ...
  ObInnerTableSchema::all_external_resource_idx_name_dbid_external_resource_schema,
  ...
  ObInnerTableSchema::all_tablet_to_global_temporary_table_idx_temp_table_id_session_id_schema,
...
const uint64_t tenant_space_tables [] = {
  ...
  OB_ALL_EXTERNAL_RESOURCE_TID,
  OB_ALL_EXTERNAL_RESOURCE_HISTORY_TID,
  ...
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_TID,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_TID,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_TID,
  ...
  OB_ALL_CATALOG_TABLE_STAT_TID,
  OB_ALL_CATALOG_COLUMN_STAT_TID,
  OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_TID,
  OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_TID,
  OB_ALL_OPTSTAT_CATALOG_USER_PREFS_TID,
  OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_TID,
  ...
  OB_ALL_VIRTUAL_SS_TABLET_META_TID,
  OB_ALL_VIRTUAL_SS_LS_META_TID,
  OB_ALL_VIRTUAL_SS_SSTABLE_MGR_TID,
  ...
  OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_TID,
  OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_TID,
  ...
  OB_ALL_VIRTUAL_SS_NOTIFY_TASKS_STAT_TID,
  ...
  OB_ALL_VIRTUAL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_TID,
  OB_ALL_VIRTUAL_TENANT_WORKER_GROUP_TID,
  OB_ALL_VIRTUAL_KEYWORD_TID,
  OB_ALL_VIRTUAL_TABLE_OPT_STAT_INVALIDATE_PLAN_TID,
  ...
  OB_ALL_VIRTUAL_KV_TTL_TASK_ORA_TID,
  OB_ALL_VIRTUAL_KV_TTL_TASK_HISTORY_ORA_TID,
  ...
  OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_ORA_TID,
  OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_ORA_TID,
  ...
  OB_ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA_TID,
  OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_TID,
  OB_TENANT_VIRTUAL_LIST_FILE_ORA_TID,
  OB_ALL_VIRTUAL_SS_TABLET_META_ORA_TID,
  OB_ALL_VIRTUAL_SS_LS_META_ORA_TID,
  OB_ALL_VIRTUAL_SS_SSTABLE_MGR_ORA_TID,
  ...
  OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_ORA_TID,
  ...
  OB_V_OB_PLUGINS_TID,
  OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_TID,
  ...
  OB_DBA_OB_EXTERNAL_RESOURCES_TID,
  ...
  OB_DBA_OB_EXTERNAL_TAB_STATISTICS_TID,
  OB_DBA_OB_EXTERNAL_TAB_COL_STATISTICS_TID,
  OB_DBA_OB_EXTERNAL_PART_COL_STATISTICS_TID,
  ...
  OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_ORA_TID,
  ...
  OB_GV_OB_RESULT_CACHE_OBJECTS_ORA_TID,
  ...
  OB_ALL_EXTERNAL_RESOURCE_IDX_NAME_DBID_EXTERNAL_RESOURCE_TID,
  OB_ALL_AI_MODEL_ENDPOINT_IDX_ENDPOINT_NAME_TID,
  OB_ALL_AI_MODEL_ENDPOINT_IDX_AI_MODEL_NAME_TID,
  OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_IDX_TEMP_TABLE_ID_SESSION_ID_TID,
  ...
  OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_META_TID,
  OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_META_TID,
  ...
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_META_TID,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_META_TID,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_META_TID,
  ...
  OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_META_TID,
  OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_META_TID,
  OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_META_TID,
  OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_AUX_LOB_META_TID,
  OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_META_TID,
  OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_META_TID,
  ...
  OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_PIECE_TID,
  OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_PIECE_TID,
  ...
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_PIECE_TID,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_PIECE_TID,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_PIECE_TID,
  ...
  OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_PIECE_TID,
  OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_PIECE_TID,
  OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_PIECE_TID,
  OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_AUX_LOB_PIECE_TID,
  OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_PIECE_TID,
  OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_PIECE_TID,
...
const char* const tenant_space_table_names [] = {
  ...
  OB_ALL_EXTERNAL_RESOURCE_TNAME,
  ...
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_TNAME,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_TNAME,
  ...
  OB_ALL_CATALOG_TABLE_STAT_TNAME,
  OB_ALL_CATALOG_COLUMN_STAT_TNAME,
  OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_TNAME,
  OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_TNAME,
  OB_ALL_OPTSTAT_CATALOG_USER_PREFS_TNAME,
  OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_TNAME,
  ...
  OB_ALL_VIRTUAL_SS_LS_META_TNAME,
  OB_ALL_VIRTUAL_SS_SSTABLE_MGR_TNAME,
  OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_TNAME,
  OB_ALL_VIRTUAL_SS_EXISTING_TABLET_META_TNAME,
  OB_ALL_VIRTUAL_SS_EXISTING_SSTABLE_MGR_TNAME,
  OB_ALL_VIRTUAL_SS_DIAGNOSE_INFO_TNAME,
  ...
  OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_TNAME,
  OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_TNAME,
  ...
  OB_ALL_VIRTUAL_SS_NOTIFY_TASKS_STAT_TNAME,
  OB_ALL_VIRTUAL_SS_NOTIFY_TABLETS_STAT_TNAME,
  ...
  OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_TNAME,
  OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_TNAME,
  OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_TNAME,
  ...
  OB_ALL_VIRTUAL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_TNAME,
  OB_ALL_VIRTUAL_TENANT_WORKER_GROUP_TNAME,
  OB_ALL_VIRTUAL_KEYWORD_TNAME,
  OB_ALL_VIRTUAL_TABLE_OPT_STAT_INVALIDATE_PLAN_TNAME,
  ...
  OB_ALL_VIRTUAL_KV_TTL_TASK_ORA_TNAME,
  OB_ALL_VIRTUAL_KV_TTL_TASK_HISTORY_ORA_TNAME,
  ...
  OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_ORA_TNAME,
  OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_ORA_TNAME,
  ...
  OB_ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA_TNAME,
  OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_TNAME,
  OB_TENANT_VIRTUAL_LIST_FILE_ORA_TNAME,
  OB_ALL_VIRTUAL_SS_TABLET_META_ORA_TNAME,
  OB_ALL_VIRTUAL_SS_LS_META_ORA_TNAME,
  OB_ALL_VIRTUAL_SS_SSTABLE_MGR_ORA_TNAME,
  OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_ORA_TNAME,
  ...
  OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_ORA_TNAME,
  ...
  OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_TNAME,
  ...
  OB_DBA_OB_EXTERNAL_RESOURCES_TNAME,
  ...
  OB_DBA_OB_EXTERNAL_TAB_STATISTICS_TNAME,
  OB_DBA_OB_EXTERNAL_TAB_COL_STATISTICS_TNAME,
  OB_DBA_OB_EXTERNAL_PART_COL_STATISTICS_TNAME,
  ...
  OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_ORA_TNAME,
  ...
  OB_GV_OB_RESULT_CACHE_OBJECTS_ORA_TNAME,
  ...
  OB_ALL_EXTERNAL_RESOURCE_IDX_NAME_DBID_EXTERNAL_RESOURCE_TNAME,
  OB_ALL_AI_MODEL_ENDPOINT_IDX_ENDPOINT_NAME_TNAME,
  OB_ALL_AI_MODEL_ENDPOINT_IDX_AI_MODEL_NAME_TNAME,
  OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_IDX_TEMP_TABLE_ID_SESSION_ID_TNAME,
  ...
  OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_META_TNAME,
  OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_META_TNAME,
  ...
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_META_TNAME,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_META_TNAME,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_META_TNAME,
  ...
  OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_META_TNAME,
  OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_META_TNAME,
  OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_META_TNAME,
  OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_AUX_LOB_META_TNAME,
  OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_META_TNAME,
  OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_META_TNAME,
  ...
  OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_PIECE_TNAME,
  OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_PIECE_TNAME,
  ...
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_PIECE_TNAME,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_PIECE_TNAME,
  OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_PIECE_TNAME,
  ...
  OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_PIECE_TNAME,
  OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_PIECE_TNAME,
  OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_PIECE_TNAME,
  OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_AUX_LOB_PIECE_TNAME,
  OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_PIECE_TNAME,
  OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_PIECE_TNAME,
...
LOBMapping const lob_aux_table_mappings [] = {
...

  {
    ...
    OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_META_TID,
    OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_tenant_flashback_log_scn_aux_lob_meta_schema,
    ObInnerTableSchema::all_tenant_flashback_log_scn_aux_lob_piece_schema
  },
...

  {
    ...
    OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_META_TID,
    OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_external_resource_aux_lob_meta_schema,
    ObInnerTableSchema::all_external_resource_aux_lob_piece_schema
  },

  {
    ...
    OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_META_TID,
    OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_external_resource_history_aux_lob_meta_schema,
    ObInnerTableSchema::all_external_resource_history_aux_lob_piece_schema
  },
...

  {
    ...
    OB_ALL_TENANT_SS_STORAGE_STAT_AUX_LOB_META_TID,
    OB_ALL_TENANT_SS_STORAGE_STAT_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_tenant_ss_storage_stat_aux_lob_meta_schema,
    ObInnerTableSchema::all_tenant_ss_storage_stat_aux_lob_piece_schema
  },
...

  {
    ...
    OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_META_TID,
    OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_tenant_macro_block_ha_task_aux_lob_meta_schema,
    ObInnerTableSchema::all_tenant_macro_block_ha_task_aux_lob_piece_schema
  },

  {
    ...
    OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_META_TID,
    OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_tenant_macro_block_ha_task_progress_aux_lob_meta_schema,
    ObInnerTableSchema::all_tenant_macro_block_ha_task_progress_aux_lob_piece_schema
  },

  {
    ...
    OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_META_TID,
    OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_tenant_macro_block_ha_task_history_aux_lob_meta_schema,
    ObInnerTableSchema::all_tenant_macro_block_ha_task_history_aux_lob_piece_schema
  },

  {
    ...
    OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_AUX_LOB_META_TID,
    OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_tablet_to_global_temporary_table_aux_lob_meta_schema,
    ObInnerTableSchema::all_tablet_to_global_temporary_table_aux_lob_piece_schema
  },
...

  {
    ...
    OB_ALL_ROUTINE_LOAD_JOB_AUX_LOB_META_TID,
    OB_ALL_ROUTINE_LOAD_JOB_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_routine_load_job_aux_lob_meta_schema,
    ObInnerTableSchema::all_routine_load_job_aux_lob_piece_schema
  },
...

  {
    ...
    OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_META_TID,
    OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_catalog_table_stat_aux_lob_meta_schema,
    ObInnerTableSchema::all_catalog_table_stat_aux_lob_piece_schema
  },

  {
    ...
    OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_META_TID,
    OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_catalog_column_stat_aux_lob_meta_schema,
    ObInnerTableSchema::all_catalog_column_stat_aux_lob_piece_schema
  },

  {
    ...
    OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_META_TID,
    OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_catalog_table_opt_stat_gather_history_aux_lob_meta_schema,
    ObInnerTableSchema::all_catalog_table_opt_stat_gather_history_aux_lob_piece_schema
  },
...

  {
    ...
    OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_META_TID,
    OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_optstat_catalog_user_prefs_aux_lob_meta_schema,
    ObInnerTableSchema::all_optstat_catalog_user_prefs_aux_lob_piece_schema
  },

  {
    ...
    OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_META_TID,
    OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_optstat_catalog_global_prefs_aux_lob_meta_schema,
    ObInnerTableSchema::all_optstat_catalog_global_prefs_aux_lob_piece_schema
  },

  {
    ...
    OB_ALL_TABLE_OPT_STAT_INVALIDATE_PLAN_AUX_LOB_META_TID,
    OB_ALL_TABLE_OPT_STAT_INVALIDATE_PLAN_AUX_LOB_PIECE_TID,
    ObInnerTableSchema::all_table_opt_stat_invalidate_plan_aux_lob_meta_schema,
    ObInnerTableSchema::all_table_opt_stat_invalidate_plan_aux_lob_piece_schema
  },
