...
const int64_t OB_SYS_TABLE_COUNT = 269;
const int64_t OB_VIRTUAL_TABLE_COUNT = 770;
const int64_t OB_SYS_VIEW_COUNT = 839;
const int64_t OB_SYS_TENANT_TABLE_COUNT = 1883;
const int64_t OB_CORE_SCHEMA_VERSION = 1;
const int64_t OB_BOOTSTRAP_SCHEMA_VERSION = 1886;
