...
const int64_t OB_SYS_TABLE_COUNT = 353;
const int64_t OB_VIRTUAL_TABLE_COUNT = 996;
const int64_t OB_SYS_VIEW_COUNT = 1113;
const int64_t OB_SYS_TENANT_TABLE_COUNT = 2467;
const int64_t OB_CORE_SCHEMA_VERSION = 1;
const int64_t OB_BOOTSTRAP_SCHEMA_VERSION = 2470;
