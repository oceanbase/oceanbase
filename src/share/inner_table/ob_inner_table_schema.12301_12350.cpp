...
int ObInnerTableSchema::all_virtual_ash_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ObObj weight_default;
    weight_default.set_int(1);
    ADD_COLUMN_SCHEMA_T("WEIGHT", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      false, //is_autoincrement
      weight_default,
      weight_default); //default_value
  }

  if (OB_SUCC(ret)) {
    ObObj is_wr_weight_sample_default;
    is_wr_weight_sample_default.set_tinyint(false);
    ADD_COLUMN_SCHEMA_T("IS_WR_WEIGHT_SAMPLE", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      false, //is_nullable
      false, //is_autoincrement
      is_wr_weight_sample_default,
      is_wr_weight_sample_default); //default_value
  }
...
int ObInnerTableSchema::all_virtual_ash_all_virtual_ash_i1_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ObObj weight_default;
    weight_default.set_int(1);
    ADD_COLUMN_SCHEMA_T_WITH_COLUMN_FLAGS("WEIGHT", //column_name
  ...
  if (OB_SUCC(ret)) {
    ObObj is_wr_weight_sample_default;
    is_wr_weight_sample_default.set_tinyint(false);
    ADD_COLUMN_SCHEMA_T_WITH_COLUMN_FLAGS("IS_WR_WEIGHT_SAMPLE", //column_name
...
int ObInnerTableSchema::all_virtual_log_restore_source_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ObObj recovery_delay_default;
    recovery_delay_default.set_int(0);
    ADD_COLUMN_SCHEMA_T("recovery_delay", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      recovery_delay_default); //default_value
  }
  table_schema.set_index_using_type(USING_BTREE);
  table_schema.set_row_store_type(ENCODING_ROW_STORE);
  table_schema.set_store_format(OB_STORE_FORMAT_DYNAMIC_MYSQL);
