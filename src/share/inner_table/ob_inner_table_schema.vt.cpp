...
bool vt_mapping_init()
{
   ...
   {
   int64_t idx = OB_ALL_VIRTUAL_ROUTINE_LOAD_JOB_REAL_AGENT_ORA_IDX_ROUTINE_LOAD_JOB_NAME_REAL_AGENT_TID - start_idx;
   VTMapping &tmp_vt_mapping = vt_mappings[idx];
   tmp_vt_mapping.mapping_tid_ = OB_ALL_ROUTINE_LOAD_JOB_IDX_ROUTINE_LOAD_JOB_NAME_TID;
   tmp_vt_mapping.is_real_vt_ = true;
   }
