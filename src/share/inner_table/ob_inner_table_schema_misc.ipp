...
case OB_ALL_USER_PROXY_ROLE_INFO_HISTORY_TID: {
  ...
  break;
    ...
    case OB_ALL_VIRTUAL_DBA_OB_SOURCE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_DBA_OB_SOURCE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_DBA_OB_SOURCE_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_DBA_OB_SOURCE_ORACLE_SCHEMA_VERSION); break;
