...
case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_TID:
case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_TID:
case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_TID:
...
case OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_TID:
...
case OB_ALL_VIRTUAL_TENANT_SS_STORAGE_STAT_TID:
...
case OB_ALL_VIRTUAL_WR_SQLSTAT_V2_TID:
...
case OB_ALL_VIRTUAL_ZONE_MERGE_INFO_TID:
  ...
  BEGIN_CREATE_VT_ITER_SWITCH_LAMBDA
    ...
    case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIteratePrivateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create iterate private virtual table iterator failed", KR(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_TID, meta_record_in_sys, index_schema, params))) {
        SERVER_LOG(WARN, "iterate private virtual table iter init failed", KR(ret));
        iter->~ObIteratePrivateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIteratePrivateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create iterate private virtual table iterator failed", KR(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_TID, meta_record_in_sys, index_schema, params))) {
        SERVER_LOG(WARN, "iterate private virtual table iter init failed", KR(ret));
        iter->~ObIteratePrivateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIteratePrivateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create iterate private virtual table iterator failed", KR(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_TID, meta_record_in_sys, index_schema, params))) {
        SERVER_LOG(WARN, "iterate private virtual table iter init failed", KR(ret));
        iter->~ObIteratePrivateVirtualTable();
        allocator.free(iter);
        iter = NULL;
  ...
  BEGIN_CREATE_VT_ITER_SWITCH_LAMBDA
    case OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIteratePrivateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create iterate private virtual table iterator failed", KR(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_FLASHBACK_LOG_SCN_TID, meta_record_in_sys, index_schema, params))) {
        SERVER_LOG(WARN, "iterate private virtual table iter init failed", KR(ret));
        iter->~ObIteratePrivateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_TENANT_SS_STORAGE_STAT_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIteratePrivateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create iterate private virtual table iterator failed", KR(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_SS_STORAGE_STAT_TID, meta_record_in_sys, index_schema, params))) {
        SERVER_LOG(WARN, "iterate private virtual table iter init failed", KR(ret));
        iter->~ObIteratePrivateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_WR_SQLSTAT_V2_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIteratePrivateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create iterate private virtual table iterator failed", KR(ret));
      } else if (OB_FAIL(iter->init(OB_WR_SQLSTAT_V2_TID, meta_record_in_sys, index_schema, params))) {
        SERVER_LOG(WARN, "iterate private virtual table iter init failed", KR(ret));
        iter->~ObIteratePrivateVirtualTable();
        allocator.free(iter);
        iter = NULL;
...
case OB_ALL_VIRTUAL_AI_BATCH_TASK_TID:
case OB_ALL_VIRTUAL_AI_BATCH_TASK_HISTORY_TID:
case OB_ALL_VIRTUAL_AI_GATEWAY_TID:
case OB_ALL_VIRTUAL_AI_GATEWAY_HISTORY_TID:
case OB_ALL_VIRTUAL_AI_MODEL_TID:
case OB_ALL_VIRTUAL_AI_MODEL_HISTORY_TID:
case OB_ALL_VIRTUAL_AI_MODEL_PROFILE_TID:
case OB_ALL_VIRTUAL_AI_MODEL_PROVIDER_TID:
case OB_ALL_VIRTUAL_AI_MODEL_PROVIDER_HISTORY_TID:
...
case OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_TID:
case OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_HISTORY_TID:
...
case OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_TID:
...
case OB_ALL_VIRTUAL_VECTOR_INDEX_TASK_HISTORY_TID:
  ...
  BEGIN_CREATE_VT_ITER_SWITCH_LAMBDA
    case OB_ALL_VIRTUAL_AI_BATCH_TASK_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_AI_BATCH_TASK_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
    ...
    case OB_ALL_VIRTUAL_AI_BATCH_TASK_HISTORY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_AI_BATCH_TASK_HISTORY_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_AI_GATEWAY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_AI_GATEWAY_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_AI_GATEWAY_HISTORY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_AI_GATEWAY_HISTORY_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_AI_MODEL_PROFILE_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_AI_MODEL_PROFILE_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_AI_MODEL_PROVIDER_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_AI_MODEL_PROVIDER_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_AI_MODEL_PROVIDER_HISTORY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_AI_MODEL_PROVIDER_HISTORY_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
  ...
  BEGIN_CREATE_VT_ITER_SWITCH_LAMBDA
    ...
    case OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_EXTERNAL_RESOURCE_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_HISTORY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_EXTERNAL_RESOURCE_HISTORY_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
  ...
  BEGIN_CREATE_VT_ITER_SWITCH_LAMBDA
    ...
    case OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_OBJECT_BALANCE_WEIGHT_TID, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
...
case OB_ALL_SS_GC_RESERVED_SNAPSHOT_TID:
case OB_ALL_SS_GC_RESERVED_SNAPSHOT_AUX_LOB_META_TID:
case OB_ALL_SS_GC_RESERVED_SNAPSHOT_AUX_LOB_PIECE_TID:
...
case OB_ALL_TENANT_FLASHBACK_LOG_SCN_TID:
case OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_META_TID:
case OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_PIECE_TID:
...
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_TID:
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_IDX_HA_TASK_STATUS_TID:
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_META_TID:
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_PIECE_TID:
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_TID:
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_META_TID:
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_PIECE_TID:
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_TID:
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_META_TID:
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_PIECE_TID:
...
case OB_ALL_TENANT_SS_STORAGE_STAT_TID:
case OB_ALL_TENANT_SS_STORAGE_STAT_AUX_LOB_META_TID:
case OB_ALL_TENANT_SS_STORAGE_STAT_AUX_LOB_PIECE_TID:
...
case OB_WR_SQLSTAT_V2_TID:
case OB_WR_SQLSTAT_V2_AUX_LOB_META_TID:
case OB_WR_SQLSTAT_V2_AUX_LOB_PIECE_TID:
...
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_IDX_HA_TASK_STATUS_TID:
case OB_ALL_AI_MODEL_PROVIDER_IDX_AI_MODEL_PROVIDER_NAME_TID:
case OB_ALL_AI_MODEL_PROFILE_IDX_AI_MODEL_PROFILE_NAME_TID:
case OB_ALL_AI_GATEWAY_IDX_AI_GATEWAY_NAME_TID:
case OB_ALL_AI_BATCH_TASK_IDX_AI_BATCH_TASK_DDL_TASK_ID_TID:
case OB_ALL_AI_BATCH_TASK_HISTORY_IDX_AI_BATCH_TASK_HISTORY_DDL_TASK_ID_TID:
...
case OB_ALL_AI_MODEL_PROVIDER_TID:
...
case OB_ALL_AI_BATCH_TASK_HISTORY_TID:
case OB_ALL_AI_MODEL_ENDPOINT_TID:
...
case OB_ALL_EXTERNAL_RESOURCE_TID:
case OB_ALL_COLUMN_TID:
case OB_ALL_BACKUP_SET_FILES_TID:
case OB_ALL_AI_BATCH_TASK_TID:
...
case OB_ALL_AI_MODEL_PROFILE_TID:
...
case OB_ALL_AI_MODEL_PROVIDER_TID: {
  if (FAILEDx(index_tids.push_back(OB_ALL_AI_MODEL_PROVIDER_IDX_AI_MODEL_PROVIDER_NAME_TID))) {
    LOG_WARN("fail to push back index tid", KR(ret));
  }
  break;
}
...
case OB_ALL_AI_GATEWAY_TID: {
  if (FAILEDx(index_tids.push_back(OB_ALL_AI_GATEWAY_IDX_AI_GATEWAY_NAME_TID))) {
    LOG_WARN("fail to push back index tid", KR(ret));
  }
  break;
}
...
case OB_ALL_AI_BATCH_TASK_HISTORY_TID: {
  if (FAILEDx(index_tids.push_back(OB_ALL_AI_BATCH_TASK_HISTORY_IDX_AI_BATCH_TASK_HISTORY_DDL_TASK_ID_TID))) {
    LOG_WARN("fail to push back index tid", KR(ret));
  }
  break;
}
...
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_TID: {
  if (FAILEDx(index_tids.push_back(OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_IDX_HA_TASK_STATUS_TID))) {
    LOG_WARN("fail to push back index tid", KR(ret));
  }
  break;
}
...
case OB_ALL_EXTERNAL_RESOURCE_TID: {
  if (FAILEDx(index_tids.push_back(OB_ALL_EXTERNAL_RESOURCE_IDX_NAME_DBID_EXTERNAL_RESOURCE_TID))) {
    LOG_WARN("fail to push back index tid", KR(ret));
  }
  break;
}
...
case OB_ALL_AI_BATCH_TASK_TID: {
  if (FAILEDx(index_tids.push_back(OB_ALL_AI_BATCH_TASK_IDX_AI_BATCH_TASK_DDL_TASK_ID_TID))) {
    LOG_WARN("fail to push back index tid", KR(ret));
  }
  break;
}
...
case OB_ALL_AI_MODEL_PROFILE_TID: {
  if (FAILEDx(index_tids.push_back(OB_ALL_AI_MODEL_PROFILE_IDX_AI_MODEL_PROFILE_NAME_TID))) {
    LOG_WARN("fail to push back index tid", KR(ret));
  }
  break;
}
...
case OB_ALL_AI_MODEL_PROVIDER_TID: {
  index_schema.reset();
  if (FAILEDx(ObInnerTableSchema::all_ai_model_provider_idx_ai_model_provider_name_schema(index_schema))) {
    LOG_WARN("fail to create index schema", KR(ret), K(tenant_id), K(data_table_id));
  } else if (OB_FAIL(append_table_(tenant_id, index_schema, tables))) {
    LOG_WARN("fail to append", KR(ret), K(tenant_id), K(data_table_id));
  }
...
case OB_ALL_AI_GATEWAY_TID: {
  index_schema.reset();
  if (FAILEDx(ObInnerTableSchema::all_ai_gateway_idx_ai_gateway_name_schema(index_schema))) {
    LOG_WARN("fail to create index schema", KR(ret), K(tenant_id), K(data_table_id));
  } else if (OB_FAIL(append_table_(tenant_id, index_schema, tables))) {
    LOG_WARN("fail to append", KR(ret), K(tenant_id), K(data_table_id));
  }
...
case OB_ALL_AI_BATCH_TASK_HISTORY_TID: {
  index_schema.reset();
  if (FAILEDx(ObInnerTableSchema::all_ai_batch_task_history_idx_ai_batch_task_history_ddl_task_id_schema(index_schema))) {
    LOG_WARN("fail to create index schema", KR(ret), K(tenant_id), K(data_table_id));
  } else if (OB_FAIL(append_table_(tenant_id, index_schema, tables))) {
    LOG_WARN("fail to append", KR(ret), K(tenant_id), K(data_table_id));
  }
...
case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_TID: {
  index_schema.reset();
  if (FAILEDx(ObInnerTableSchema::all_tenant_macro_block_ha_task_idx_ha_task_status_schema(index_schema))) {
    LOG_WARN("fail to create index schema", KR(ret), K(tenant_id), K(data_table_id));
  } else if (OB_FAIL(append_table_(tenant_id, index_schema, tables))) {
    LOG_WARN("fail to append", KR(ret), K(tenant_id), K(data_table_id));
  }
...
case OB_ALL_EXTERNAL_RESOURCE_TID: {
  index_schema.reset();
  if (FAILEDx(ObInnerTableSchema::all_external_resource_idx_name_dbid_external_resource_schema(index_schema))) {
    LOG_WARN("fail to create index schema", KR(ret), K(tenant_id), K(data_table_id));
  } else if (OB_FAIL(append_table_(tenant_id, index_schema, tables))) {
    LOG_WARN("fail to append", KR(ret), K(tenant_id), K(data_table_id));
  }
...
case OB_ALL_AI_BATCH_TASK_TID: {
  index_schema.reset();
  if (FAILEDx(ObInnerTableSchema::all_ai_batch_task_idx_ai_batch_task_ddl_task_id_schema(index_schema))) {
    LOG_WARN("fail to create index schema", KR(ret), K(tenant_id), K(data_table_id));
  } else if (OB_FAIL(append_table_(tenant_id, index_schema, tables))) {
    LOG_WARN("fail to append", KR(ret), K(tenant_id), K(data_table_id));
  }
...
case OB_ALL_AI_MODEL_PROFILE_TID: {
  index_schema.reset();
  if (FAILEDx(ObInnerTableSchema::all_ai_model_profile_idx_ai_model_profile_name_schema(index_schema))) {
    LOG_WARN("fail to create index schema", KR(ret), K(tenant_id), K(data_table_id));
  } else if (OB_FAIL(append_table_(tenant_id, index_schema, tables))) {
    LOG_WARN("fail to append", KR(ret), K(tenant_id), K(data_table_id));
  }
...
case OB_ALL_USER_PROXY_ROLE_INFO_HISTORY_TID: {
  ...
  break;
    ...
    LOG_WARN("add index id failed", KR(ret), K(tenant_id));
  } else if (OB_FAIL(table_ids.push_back(OB_ALL_EXTERNAL_RESOURCE_IDX_NAME_DBID_EXTERNAL_RESOURCE_TID))) {
    LOG_WARN("add index id failed", KR(ret), K(tenant_id));
    ...
    LOG_WARN("add index id failed", KR(ret), K(tenant_id));
  } else if (OB_FAIL(table_ids.push_back(OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_IDX_HA_TASK_STATUS_TID))) {
    LOG_WARN("add index id failed", KR(ret), K(tenant_id));
  } else if (OB_FAIL(table_ids.push_back(OB_ALL_AI_MODEL_PROVIDER_IDX_AI_MODEL_PROVIDER_NAME_TID))) {
    LOG_WARN("add index id failed", KR(ret), K(tenant_id));
  } else if (OB_FAIL(table_ids.push_back(OB_ALL_AI_MODEL_PROFILE_IDX_AI_MODEL_PROFILE_NAME_TID))) {
    LOG_WARN("add index id failed", KR(ret), K(tenant_id));
  } else if (OB_FAIL(table_ids.push_back(OB_ALL_AI_GATEWAY_IDX_AI_GATEWAY_NAME_TID))) {
    LOG_WARN("add index id failed", KR(ret), K(tenant_id));
  } else if (OB_FAIL(table_ids.push_back(OB_ALL_AI_BATCH_TASK_IDX_AI_BATCH_TASK_DDL_TASK_ID_TID))) {
    LOG_WARN("add index id failed", KR(ret), K(tenant_id));
  } else if (OB_FAIL(table_ids.push_back(OB_ALL_AI_BATCH_TASK_HISTORY_IDX_AI_BATCH_TASK_HISTORY_DDL_TASK_ID_TID))) {
    LOG_WARN("add index id failed", KR(ret), K(tenant_id));
    ...
    case OB_ALL_OBJECT_BALANCE_WEIGHT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_OBJECT_BALANCE_WEIGHT_SCHEMA_VERSION); break;
    ...
    case OB_ALL_TENANT_FLASHBACK_LOG_SCN_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_FLASHBACK_LOG_SCN_SCHEMA_VERSION); break;
    ...
    case OB_ALL_BALANCE_JOB_DESCRIPTION_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_BALANCE_JOB_DESCRIPTION_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_LOCATION_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_LOCATION_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_LOCATION_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_LOCATION_HISTORY_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_OBJAUTH_MYSQL_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_OBJAUTH_MYSQL_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_OBJAUTH_MYSQL_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_OBJAUTH_MYSQL_HISTORY_SCHEMA_VERSION); break;
    case OB_ALL_EXTERNAL_RESOURCE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_EXTERNAL_RESOURCE_SCHEMA_VERSION); break;
    case OB_ALL_EXTERNAL_RESOURCE_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_EXTERNAL_RESOURCE_HISTORY_SCHEMA_VERSION); break;
    ...
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_SCHEMA_VERSION); break;
    ...
    case OB_ALL_AI_MODEL_PROVIDER_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_MODEL_PROVIDER_SCHEMA_VERSION); break;
    case OB_ALL_AI_MODEL_PROVIDER_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_MODEL_PROVIDER_HISTORY_SCHEMA_VERSION); break;
    case OB_ALL_AI_MODEL_PROFILE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_MODEL_PROFILE_SCHEMA_VERSION); break;
    case OB_ALL_AI_GATEWAY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_GATEWAY_SCHEMA_VERSION); break;
    case OB_ALL_AI_GATEWAY_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_GATEWAY_HISTORY_SCHEMA_VERSION); break;
    case OB_ALL_AI_BATCH_TASK_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_BATCH_TASK_SCHEMA_VERSION); break;
    case OB_ALL_AI_BATCH_TASK_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_BATCH_TASK_HISTORY_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_SS_TABLET_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_TABLET_META_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_LS_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_LS_META_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_SSTABLE_MGR_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_SSTABLE_MGR_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_EXISTING_TABLET_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_EXISTING_TABLET_META_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_EXISTING_SSTABLE_MGR_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_EXISTING_SSTABLE_MGR_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_DIAGNOSE_INFO_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_DIAGNOSE_INFO_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_LS_MIGRATION_TASK_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_LS_MIGRATION_TASK_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_NOTIFY_TASKS_STAT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_NOTIFY_TASKS_STAT_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_NOTIFY_TABLETS_STAT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_NOTIFY_TABLETS_STAT_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_TENANT_LOCATION_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_TENANT_LOCATION_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_TENANT_LOCATION_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_TENANT_LOCATION_HISTORY_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_OBJAUTH_MYSQL_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_OBJAUTH_MYSQL_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_OBJAUTH_MYSQL_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_OBJAUTH_MYSQL_HISTORY_SCHEMA_VERSION); break;
    case OB_TENANT_VIRTUAL_SHOW_CREATE_LOCATION_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_TENANT_VIRTUAL_SHOW_CREATE_LOCATION_SCHEMA_VERSION); break;
    case OB_TENANT_VIRTUAL_LIST_FILE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_TENANT_VIRTUAL_LIST_FILE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_HISTORY_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_LOGSERVICE_CLUSTER_INFO_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_LOGSERVICE_CLUSTER_INFO_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_GC_STATUS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_GC_STATUS_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_GC_DETECT_INFO_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_GC_DETECT_INFO_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_UNIT_MYSQL_SYS_AGENT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_UNIT_MYSQL_SYS_AGENT_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_AI_MODEL_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_AI_MODEL_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_AI_MODEL_PROVIDER_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_AI_MODEL_PROVIDER_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_AI_MODEL_PROFILE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_AI_MODEL_PROFILE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_AI_GATEWAY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_AI_GATEWAY_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_AI_BATCH_TASK_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_AI_BATCH_TASK_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_AI_BATCH_TASK_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_AI_BATCH_TASK_HISTORY_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_AI_MODEL_PROVIDER_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_AI_MODEL_PROVIDER_HISTORY_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_AI_GATEWAY_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_AI_GATEWAY_HISTORY_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_AI_GATEWAY_ENDPOINT_STAT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_AI_GATEWAY_ENDPOINT_STAT_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_REAL_AGENT_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_REAL_AGENT_ORACLE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_ORACLE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORACLE_SCHEMA_VERSION); break;
    case OB_TENANT_VIRTUAL_LIST_FILE_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_TENANT_VIRTUAL_LIST_FILE_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_TABLET_META_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_TABLET_META_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_LS_META_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_LS_META_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_SSTABLE_MGR_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_SSTABLE_MGR_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_ORACLE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_ORACLE_SCHEMA_VERSION); break;
    ...
    case OB_DBA_OB_OBJECT_BALANCE_WEIGHT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_OBJECT_BALANCE_WEIGHT_SCHEMA_VERSION); break;
    case OB_CDB_OB_OBJECT_BALANCE_WEIGHT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_OBJECT_BALANCE_WEIGHT_SCHEMA_VERSION); break;
    ...
    case OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_SCHEMA_VERSION); break;
    case OB_CDB_OB_TENANT_FLASHBACK_LOG_SCN_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_TENANT_FLASHBACK_LOG_SCN_SCHEMA_VERSION); break;
    ...
    case OB_DBA_OB_EXTERNAL_RESOURCES_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_EXTERNAL_RESOURCES_SCHEMA_VERSION); break;
    case OB_CDB_OB_EXTERNAL_RESOURCES_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_EXTERNAL_RESOURCES_SCHEMA_VERSION); break;
    ...
    case OB_V_OB_HMS_CLIENT_POOL_STAT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_V_OB_HMS_CLIENT_POOL_STAT_SCHEMA_VERSION); break;
    case OB_DBA_OB_AI_MODELS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_AI_MODELS_SCHEMA_VERSION); break;
    case OB_DBA_OB_AI_MODEL_ENDPOINTS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_AI_MODEL_ENDPOINTS_SCHEMA_VERSION); break;
    case OB_CDB_OB_AI_MODELS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_AI_MODELS_SCHEMA_VERSION); break;
    ...
    case OB_DBA_OB_AI_MODEL_PROVIDERS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_AI_MODEL_PROVIDERS_SCHEMA_VERSION); break;
    case OB_CDB_OB_AI_MODEL_PROVIDERS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_AI_MODEL_PROVIDERS_SCHEMA_VERSION); break;
    case OB_DBA_OB_AI_MODEL_PROFILES_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_AI_MODEL_PROFILES_SCHEMA_VERSION); break;
    case OB_CDB_OB_AI_MODEL_PROFILES_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_AI_MODEL_PROFILES_SCHEMA_VERSION); break;
    case OB_DBA_OB_AI_GATEWAYS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_AI_GATEWAYS_SCHEMA_VERSION); break;
    case OB_CDB_OB_AI_GATEWAYS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_AI_GATEWAYS_SCHEMA_VERSION); break;
    case OB_DBA_OB_AI_GATEWAY_ENDPOINTS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_AI_GATEWAY_ENDPOINTS_SCHEMA_VERSION); break;
    case OB_CDB_OB_AI_GATEWAY_ENDPOINTS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_AI_GATEWAY_ENDPOINTS_SCHEMA_VERSION); break;
    case OB_DBA_OB_AI_BATCH_TASKS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_AI_BATCH_TASKS_SCHEMA_VERSION); break;
    case OB_CDB_OB_AI_BATCH_TASKS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_AI_BATCH_TASKS_SCHEMA_VERSION); break;
    case OB_DBA_OB_AI_BATCH_TASK_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_AI_BATCH_TASK_HISTORY_SCHEMA_VERSION); break;
    case OB_CDB_OB_AI_BATCH_TASK_HISTORY_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_CDB_OB_AI_BATCH_TASK_HISTORY_SCHEMA_VERSION); break;
    case OB_GV_OB_AI_GATEWAY_ENDPOINT_STAT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_GV_OB_AI_GATEWAY_ENDPOINT_STAT_SCHEMA_VERSION); break;
    case OB_V_OB_AI_GATEWAY_ENDPOINT_STAT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_V_OB_AI_GATEWAY_ENDPOINT_STAT_SCHEMA_VERSION); break;
    ...
    case OB_DBA_OB_OBJECT_BALANCE_WEIGHT_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_OBJECT_BALANCE_WEIGHT_ORACLE_SCHEMA_VERSION); break;
    ...
    case OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_ORACLE_SCHEMA_VERSION); break;
    ...
    case OB_GV_OB_RESULT_CACHE_OBJECTS_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_GV_OB_RESULT_CACHE_OBJECTS_ORACLE_SCHEMA_VERSION); break;
    case OB_V_OB_RESULT_CACHE_OBJECTS_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_V_OB_RESULT_CACHE_OBJECTS_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_LOCATIONS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_LOCATIONS_ORACLE_SCHEMA_VERSION); break;
    case OB_V_OB_SS_SSTABLES_ORA_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_V_OB_SS_SSTABLES_ORACLE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_TENANT_LOCATION_IDX_LOCATION_NAME_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_550_IDX_LOCATION_NAME_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_OBJAUTH_MYSQL_IDX_OBJAUTH_MYSQL_USER_ID_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_552_IDX_OBJAUTH_MYSQL_USER_ID_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_OBJAUTH_MYSQL_IDX_OBJAUTH_MYSQL_OBJ_NAME_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_552_IDX_OBJAUTH_MYSQL_OBJ_NAME_SCHEMA_VERSION); break;
    ...
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_IDX_HA_TASK_STATUS_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_574_IDX_HA_TASK_STATUS_SCHEMA_VERSION); break;
    case OB_ALL_AI_MODEL_PROVIDER_IDX_AI_MODEL_PROVIDER_NAME_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_597_IDX_AI_MODEL_PROVIDER_NAME_SCHEMA_VERSION); break;
    case OB_ALL_AI_MODEL_PROFILE_IDX_AI_MODEL_PROFILE_NAME_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_599_IDX_AI_MODEL_PROFILE_NAME_SCHEMA_VERSION); break;
    case OB_ALL_AI_GATEWAY_IDX_AI_GATEWAY_NAME_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_600_IDX_AI_GATEWAY_NAME_SCHEMA_VERSION); break;
    case OB_ALL_AI_BATCH_TASK_IDX_AI_BATCH_TASK_DDL_TASK_ID_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_602_IDX_AI_BATCH_TASK_DDL_TASK_ID_SCHEMA_VERSION); break;
    case OB_ALL_AI_BATCH_TASK_HISTORY_IDX_AI_BATCH_TASK_HISTORY_DDL_TASK_ID_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_603_IDX_AI_BATCH_TASK_HISTORY_DDL_TASK_ID_SCHEMA_VERSION); break;
    ...
    case OB_ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA_IDX_LOCATION_NAME_REAL_AGENT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_15511_IDX_LOCATION_NAME_REAL_AGENT_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_IDX_OBJAUTH_MYSQL_USER_ID_REAL_AGENT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_15512_IDX_OBJAUTH_MYSQL_USER_ID_REAL_AGENT_ORACLE_SCHEMA_VERSION); break;
    case OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_IDX_OBJAUTH_MYSQL_OBJ_NAME_REAL_AGENT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_15512_IDX_OBJAUTH_MYSQL_OBJ_NAME_REAL_AGENT_ORACLE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_OBJECT_BALANCE_WEIGHT_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_OBJECT_BALANCE_WEIGHT_AUX_LOB_META_SCHEMA_VERSION); break;
    ...
    case OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_META_SCHEMA_VERSION); break;
    ...
    case OB_ALL_BALANCE_JOB_DESCRIPTION_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_BALANCE_JOB_DESCRIPTION_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_LOCATION_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_LOCATION_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_LOCATION_HISTORY_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_LOCATION_HISTORY_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_OBJAUTH_MYSQL_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_OBJAUTH_MYSQL_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_OBJAUTH_MYSQL_HISTORY_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_OBJAUTH_MYSQL_HISTORY_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_META_SCHEMA_VERSION); break;
    ...
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_META_SCHEMA_VERSION); break;
    ...
    case OB_ALL_AI_MODEL_PROVIDER_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_MODEL_PROVIDER_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_AI_MODEL_PROVIDER_HISTORY_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_MODEL_PROVIDER_HISTORY_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_AI_MODEL_PROFILE_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_MODEL_PROFILE_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_AI_GATEWAY_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_GATEWAY_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_AI_GATEWAY_HISTORY_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_GATEWAY_HISTORY_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_AI_BATCH_TASK_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_BATCH_TASK_AUX_LOB_META_SCHEMA_VERSION); break;
    case OB_ALL_AI_BATCH_TASK_HISTORY_AUX_LOB_META_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_BATCH_TASK_HISTORY_AUX_LOB_META_SCHEMA_VERSION); break;
    ...
    case OB_ALL_OBJECT_BALANCE_WEIGHT_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_OBJECT_BALANCE_WEIGHT_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_BALANCE_JOB_DESCRIPTION_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_BALANCE_JOB_DESCRIPTION_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_LOCATION_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_LOCATION_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_LOCATION_HISTORY_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_LOCATION_HISTORY_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_OBJAUTH_MYSQL_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_OBJAUTH_MYSQL_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_OBJAUTH_MYSQL_HISTORY_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_OBJAUTH_MYSQL_HISTORY_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    ...
    case OB_ALL_AI_MODEL_PROVIDER_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_MODEL_PROVIDER_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_AI_MODEL_PROVIDER_HISTORY_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_MODEL_PROVIDER_HISTORY_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_AI_MODEL_PROFILE_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_MODEL_PROFILE_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_AI_GATEWAY_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_GATEWAY_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_AI_GATEWAY_HISTORY_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_GATEWAY_HISTORY_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_AI_BATCH_TASK_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_BATCH_TASK_AUX_LOB_PIECE_SCHEMA_VERSION); break;
    case OB_ALL_AI_BATCH_TASK_HISTORY_AUX_LOB_PIECE_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_ALL_AI_BATCH_TASK_HISTORY_AUX_LOB_PIECE_SCHEMA_VERSION); break;
