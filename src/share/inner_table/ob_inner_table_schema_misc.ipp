...
case OB_ALL_VIRTUAL_USER_HISTORY_TID:
    ...
    case OB_ALL_VIRTUAL_BACKUP_BACKUPSET_TASK_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_BACKUP_BACKUPSET_TASK_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
    ...
    case OB_ALL_VIRTUAL_BACKUP_VALIDATION_TASK_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_BACKUP_VALIDATION_TASK_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_CONSTRAINT_COLUMN_HISTORY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_CONSTRAINT_COLUMN_HISTORY_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_DDL_OPERATION_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        ...
        SERVER_LOG(WARN, "set column_name with tenant_id failed",
                   K(ret), "column_name", "tablegroup_id");
      } else if (OB_FAIL(iter->set_column_name_with_tenant_id("table_id"))) {
        SERVER_LOG(WARN, "set column_name with tenant_id failed",
                   K(ret), "column_name", "table_id");
      } else {
    ...
    case OB_ALL_VIRTUAL_DEF_SUB_PART_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        ...
        SERVER_LOG(WARN, "set column_name with tenant_id failed",
                   K(ret), "column_name", "tablespace_id");
      } else {
       vt_iter = iter;
      }
      break;
    ...
    case OB_ALL_VIRTUAL_OBJECT_TYPE_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        ...
        SERVER_LOG(WARN, "set column_name with tenant_id failed",
                   K(ret), "column_name", "object_type_id");
      } else {
       vt_iter = iter;
      }
      break;
    ...
    case OB_ALL_VIRTUAL_PG_BACKUP_BACKUPSET_TASK_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_PG_BACKUP_BACKUPSET_TASK_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_PG_BACKUP_VALIDATION_TASK_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_PG_BACKUP_VALIDATION_TASK_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_SECURITY_AUDIT_HISTORY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_SECURITY_AUDIT_HISTORY_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_SECURITY_AUDIT_RECORD_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_SECURITY_AUDIT_RECORD_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_SEQUENCE_V2_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        ...
        SERVER_LOG(WARN, "set column_name with tenant_id failed",
                   K(ret), "column_name", "sequence_key");
      } else {
       vt_iter = iter;
      }
      break;
    ...
    case OB_ALL_VIRTUAL_SSTABLE_COLUMN_CHECKSUM_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_SSTABLE_COLUMN_CHECKSUM_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_TENANT_PLAN_BASELINE_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        ...
        SERVER_LOG(WARN, "set column_name with tenant_id failed",
                   K(ret), "column_name", "plan_baseline_id");
      } else if (OB_FAIL(iter->set_column_name_with_tenant_id("database_id"))) {
        SERVER_LOG(WARN, "set column_name with tenant_id failed",
                   K(ret), "column_name", "database_id");
      } else {
    ...
    case OB_ALL_VIRTUAL_TENANT_PLAN_BASELINE_HISTORY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_PLAN_BASELINE_HISTORY_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_TENANT_ROLE_GRANTEE_MAP_HISTORY_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_ROLE_GRANTEE_MAP_HISTORY_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_TENANT_USER_FAILED_LOGIN_STAT_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_USER_FAILED_LOGIN_STAT_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_TIME_ZONE_TRANSITION_TYPE_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        SERVER_LOG(WARN, "create virtual table iterator failed", K(ret));
      } else if (OB_FAIL(iter->init(OB_ALL_TENANT_TIME_ZONE_TRANSITION_TYPE_TID, record_real_tenant_id, index_schema, params))) {
        SERVER_LOG(WARN, "virtual table iter init failed", K(ret));
        iter->~ObIterateVirtualTable();
        allocator.free(iter);
        iter = NULL;
    ...
    case OB_ALL_VIRTUAL_TRIGGER_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        ...
        SERVER_LOG(WARN, "set column_name with tenant_id failed",
                   K(ret), "column_name", "base_object_id");
      } else {
       vt_iter = iter;
      }
      break;
    ...
    case OB_ALL_VIRTUAL_TYPE_ATTR_TID: {
      ...
      if (OB_FAIL(NEW_VIRTUAL_TABLE(ObIterateVirtualTable, iter))) {
        ...
        SERVER_LOG(WARN, "set column_name with tenant_id failed",
                   K(ret), "column_name", "type_attr_id");
      } else {
       vt_iter = iter;
      }
      break;
