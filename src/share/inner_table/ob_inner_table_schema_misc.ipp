...
case OB_ALL_USER_PROXY_ROLE_INFO_HISTORY_TID: {
  ...
  break;
    ...
    case OB_ALL_VIRTUAL_ROUTINE_LOAD_JOB_REAL_AGENT_ORA_IDX_ROUTINE_LOAD_JOB_NAME_REAL_AGENT_TID : schema_version = static_cast<int64_t>(ObHardCodeInnerTableSchemaVersion::OB_IDX_15546_IDX_ROUTINE_LOAD_JOB_NAME_REAL_AGENT_ORACLE_SCHEMA_VERSION); break;
