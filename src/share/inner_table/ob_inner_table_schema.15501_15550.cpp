...
int ObInnerTableSchema::all_virtual_sql_group_commit_stat_ora_schema(ObTableSchema &table_schema)
{
  int ret = OB_SUCCESS;
  uint64_t column_id = OB_APP_MIN_COLUMN_ID - 1;
  ...
  table_schema.set_tablegroup_id(OB_INVALID_ID);
  table_schema.set_database_id(OB_ORA_SYS_DATABASE_ID);
  table_schema.set_table_id(OB_ALL_VIRTUAL_SQL_GROUP_COMMIT_STAT_ORA_TID);
  table_schema.set_rowkey_split_pos(0);
  table_schema.set_is_use_bloomfilter(false);
  table_schema.set_progressive_merge_num(0);
  ...
  if (OB_SUCC(ret)) {
    if (OB_FAIL(table_schema.set_table_name(OB_ALL_VIRTUAL_SQL_GROUP_COMMIT_STAT_ORA_TNAME))) {
      LOG_ERROR("fail to set table_name", K(ret));
    }
  }
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("SINGLE_EXEC_COUNT", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("BATCH_EXEC_COUNT", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("BATCH_EXEC_REQ_CNT", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("SPLIT_COUNT", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("SPLIT_EXEC_REQ_CNT", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("GROUP_VALUE_COUNT", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("SQL_HASH", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
