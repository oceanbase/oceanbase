...
int ObInnerTableSchema::all_virtual_routine_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("external_routine_type", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("external_routine_entry", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("external_routine_url", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("external_routine_resource", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
...
int ObInnerTableSchema::all_virtual_tenant_profile_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ObObj password_rollover_time_default;
    password_rollover_time_default.set_int(-1);
    ADD_COLUMN_SCHEMA_T("password_rollover_time", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      false, //is_nullable
      false, //is_autoincrement
      password_rollover_time_default,
      password_rollover_time_default); //default_value
  }

  if (OB_SUCC(ret)) {
    ObObj idle_time_default;
    idle_time_default.set_int(-1);
    ADD_COLUMN_SCHEMA_T("idle_time", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      false, //is_autoincrement
      idle_time_default,
      idle_time_default); //default_value
  }

  if (OB_SUCC(ret)) {
    ObObj sessions_per_user_default;
    sessions_per_user_default.set_int(-1);
    ADD_COLUMN_SCHEMA_T("sessions_per_user", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      false, //is_nullable
      false, //is_autoincrement
      sessions_per_user_default,
      sessions_per_user_default); //default_value
  }
  table_schema.set_index_using_type(USING_BTREE);
  table_schema.set_row_store_type(ENCODING_ROW_STORE);
  table_schema.set_store_format(OB_STORE_FORMAT_DYNAMIC_MYSQL);
