...
int ObInnerTableSchema::tenant_virtual_outline_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ObObj format_sql_text_default;
    format_sql_text_default.set_lob_value(ObLongTextType, "", static_cast<int32_t>(strlen("")));
    ADD_COLUMN_SCHEMA_T("format_sql_text", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      false, //is_nullable
      false, //is_autoincrement
      format_sql_text_default,
      format_sql_text_default); //default_value
  }
