...
const uint64_t OB_ALL_VIRTUAL_DBA_OB_SOURCE_TID = 12571; // "__all_virtual_dba_ob_source"
...
const uint64_t OB_ALL_VIRTUAL_DBA_OB_SOURCE_ORA_TID = 15533; // "ALL_VIRTUAL_DBA_OB_SOURCE_ORA"
...
const char *const OB_ALL_VIRTUAL_DBA_OB_SOURCE_TNAME = "__all_virtual_dba_ob_source";
...
const char *const OB_ALL_VIRTUAL_DBA_OB_SOURCE_ORA_TNAME = "ALL_VIRTUAL_DBA_OB_SOURCE";
