...
const uint64_t OB_ALL_VECTOR_HNSW_INDEX_TID = 518; // "__all_vector_hnsw_index"
...
const uint64_t OB_ALL_VECTOR_HNSW_INDEX_AUX_LOB_META_TID = 50518; // "__all_vector_hnsw_index_aux_lob_meta"
...
const uint64_t OB_ALL_VECTOR_HNSW_INDEX_AUX_LOB_PIECE_TID = 60518; // "__all_vector_hnsw_index_aux_lob_piece"
...
const char *const OB_ALL_VECTOR_HNSW_INDEX_TNAME = "__all_vector_hnsw_index";
...
const char *const OB_ALL_VECTOR_HNSW_INDEX_AUX_LOB_META_TNAME = "__all_vector_hnsw_index_aux_lob_meta";
...
const char *const OB_ALL_VECTOR_HNSW_INDEX_AUX_LOB_PIECE_TNAME = "__all_vector_hnsw_index_aux_lob_piece";
