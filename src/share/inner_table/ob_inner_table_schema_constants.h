...
const uint64_t OB_ALL_VIRTUAL_ROUTINE_LOAD_JOB_REAL_AGENT_ORA_IDX_ROUTINE_LOAD_JOB_NAME_REAL_AGENT_TID = 15547; // "ALL_VIRTUAL_ROUTINE_LOAD_JOB_REAL_AGENT_ORA"
...
const char *const OB_ALL_VIRTUAL_ROUTINE_LOAD_JOB_REAL_AGENT_ORA_IDX_ROUTINE_LOAD_JOB_NAME_REAL_AGENT_TNAME = "__idx_15546_idx_routine_load_job_name_real_agent";
