...
const uint64_t OB_ALL_CREATING_FOREIGN_KEY_TID = 170; // "__all_creating_foreign_key"
...
const char *const OB_ALL_CREATING_FOREIGN_KEY_TNAME = "__all_creating_foreign_key";
