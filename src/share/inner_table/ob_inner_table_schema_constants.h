...
const uint64_t OB_ALL_VIRTUAL_KV_HOTKEY_STAT_TID = 12367; // "__all_virtual_kv_hotkey_stat"
...
const uint64_t OB_GV_OB_KV_HOTKEY_STAT_TID = 21367; // "GV$OB_KV_HOTKEY_STAT"
const uint64_t OB_V_OB_KV_HOTKEY_STAT_TID = 21368; // "V$OB_KV_HOTKEY_STAT"
...
const char *const OB_ALL_VIRTUAL_KV_HOTKEY_STAT_TNAME = "__all_virtual_kv_hotkey_stat";
...
const char *const OB_GV_OB_KV_HOTKEY_STAT_TNAME = "GV$OB_KV_HOTKEY_STAT";
const char *const OB_V_OB_KV_HOTKEY_STAT_TNAME = "V$OB_KV_HOTKEY_STAT";
