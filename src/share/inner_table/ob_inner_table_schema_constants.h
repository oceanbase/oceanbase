...
const uint64_t OB_ALL_OBJECT_BALANCE_WEIGHT_TID = 529; // "__all_object_balance_weight"
...
const uint64_t OB_ALL_TENANT_FLASHBACK_LOG_SCN_TID = 541; // "__all_tenant_flashback_log_scn"
...
const uint64_t OB_ALL_BALANCE_JOB_DESCRIPTION_TID = 549; // "__all_balance_job_description"
const uint64_t OB_ALL_TENANT_LOCATION_TID = 550; // "__all_tenant_location"
const uint64_t OB_ALL_TENANT_LOCATION_HISTORY_TID = 551; // "__all_tenant_location_history"
const uint64_t OB_ALL_TENANT_OBJAUTH_MYSQL_TID = 552; // "__all_tenant_objauth_mysql"
const uint64_t OB_ALL_TENANT_OBJAUTH_MYSQL_HISTORY_TID = 553; // "__all_tenant_objauth_mysql_history"
const uint64_t OB_ALL_EXTERNAL_RESOURCE_TID = 554; // "__all_external_resource"
const uint64_t OB_ALL_EXTERNAL_RESOURCE_HISTORY_TID = 555; // "__all_external_resource_history"
...
const uint64_t OB_ALL_BACKUP_VALIDATE_JOB_TID = 563; // "__all_backup_validate_job"
const uint64_t OB_ALL_BACKUP_VALIDATE_JOB_HISTORY_TID = 564; // "__all_backup_validate_job_history"
const uint64_t OB_ALL_BACKUP_VALIDATE_TASK_TID = 565; // "__all_backup_validate_task"
const uint64_t OB_ALL_BACKUP_VALIDATE_TASK_HISTORY_TID = 566; // "__all_backup_validate_task_history"
const uint64_t OB_ALL_BACKUP_VALIDATE_LS_TASK_TID = 567; // "__all_backup_validate_ls_task"
const uint64_t OB_ALL_BACKUP_VALIDATE_LS_TASK_HISTORY_TID = 568; // "__all_backup_validate_ls_task_history"
const uint64_t OB_ALL_TENANT_SS_STORAGE_STAT_TID = 569; // "__all_tenant_ss_storage_stat"
const uint64_t OB_ALL_AI_MODEL_TID = 570; // "__all_ai_model"
const uint64_t OB_ALL_AI_MODEL_HISTORY_TID = 571; // "__all_ai_model_history"
const uint64_t OB_ALL_AI_MODEL_ENDPOINT_TID = 572; // "__all_ai_model_endpoint"
const uint64_t OB_WR_ACTIVE_SESSION_HISTORY_V2_TID = 573; // "__wr_active_session_history_v2"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_TID = 574; // "__all_tenant_macro_block_ha_task"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_TID = 575; // "__all_tenant_macro_block_ha_task_progress"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_TID = 576; // "__all_tenant_macro_block_ha_task_history"
const uint64_t OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_TID = 577; // "__all_tablet_to_global_temporary_table"
const uint64_t OB_WR_SQLSTAT_V2_TID = 579; // "__wr_sqlstat_v2"
const uint64_t OB_ALL_LOB_CHECK_EXCEPTION_RESULT_TID = 580; // "__all_lob_check_exception_result"
const uint64_t OB_ALL_ROUTINE_LOAD_JOB_TID = 583; // "__all_routine_load_job"
const uint64_t OB_ALL_SS_GC_RESERVED_SNAPSHOT_TID = 584; // "__all_ss_gc_reserved_snapshot"
const uint64_t OB_ALL_TABLE_ARCHIVE_HISTORY_TID = 585; // "__all_table_archive_history"
const uint64_t OB_ALL_JAVA_POLICY_TID = 586; // "__all_java_policy"
const uint64_t OB_ALL_JAVA_POLICY_HISTORY_TID = 587; // "__all_java_policy_history"
const uint64_t OB_ALL_CATALOG_TABLE_STAT_TID = 588; // "__all_catalog_table_stat"
const uint64_t OB_ALL_CATALOG_COLUMN_STAT_TID = 589; // "__all_catalog_column_stat"
const uint64_t OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_TID = 590; // "__all_catalog_table_opt_stat_gather_history"
const uint64_t OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_TID = 591; // "__all_audit_log_encryption_password"
const uint64_t OB_ALL_OPTSTAT_CATALOG_USER_PREFS_TID = 593; // "__all_optstat_catalog_user_prefs"
const uint64_t OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_TID = 594; // "__all_optstat_catalog_global_prefs"
const uint64_t OB_ALL_TABLE_OPT_STAT_INVALIDATE_PLAN_TID = 596; // "__all_table_opt_stat_invalidate_plan"
const uint64_t OB_ALL_MVIEW_REFRESH_PENDING_TASK_TID = 604; // "__all_mview_refresh_pending_task"
...
const uint64_t OB_ALL_VIRTUAL_SS_TABLET_META_TID = 11124; // "__all_virtual_ss_tablet_meta"
const uint64_t OB_ALL_VIRTUAL_SS_LS_META_TID = 11125; // "__all_virtual_ss_ls_meta"
const uint64_t OB_ALL_VIRTUAL_SS_SSTABLE_MGR_TID = 11126; // "__all_virtual_ss_sstable_mgr"
const uint64_t OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_TID = 11127; // "__all_virtual_ss_ls_tablet_reorganization_info"
const uint64_t OB_ALL_VIRTUAL_SS_EXISTING_TABLET_META_TID = 11128; // "__all_virtual_ss_existing_tablet_meta"
const uint64_t OB_ALL_VIRTUAL_SS_EXISTING_SSTABLE_MGR_TID = 11129; // "__all_virtual_ss_existing_sstable_mgr"
const uint64_t OB_ALL_VIRTUAL_SS_DIAGNOSE_INFO_TID = 11130; // "__all_virtual_ss_diagnose_info"
...
const uint64_t OB_ALL_VIRTUAL_DEADLOCK_DETECTOR_STAT_TID = 12489; // "__all_virtual_deadlock_detector_stat"
...
const uint64_t OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_TID = 12509; // "__all_virtual_object_balance_weight"
...
const uint64_t OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_TID = 12520; // "__all_virtual_sswriter_group_stat"
const uint64_t OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_TID = 12521; // "__all_virtual_sswriter_lease_mgr"
const uint64_t OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_TID = 12522; // "__all_virtual_tenant_flashback_log_scn"
...
const uint64_t OB_ALL_VIRTUAL_LS_MIGRATION_TASK_TID = 12537; // "__all_virtual_ls_migration_task"
const uint64_t OB_ALL_VIRTUAL_SS_NOTIFY_TASKS_STAT_TID = 12538; // "__all_virtual_ss_notify_tasks_stat"
const uint64_t OB_ALL_VIRTUAL_SS_NOTIFY_TABLETS_STAT_TID = 12539; // "__all_virtual_ss_notify_tablets_stat"
const uint64_t OB_ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION_TID = 12540; // "__all_virtual_balance_job_description"
const uint64_t OB_ALL_VIRTUAL_TENANT_LOCATION_TID = 12541; // "__all_virtual_tenant_location"
const uint64_t OB_ALL_VIRTUAL_TENANT_LOCATION_HISTORY_TID = 12542; // "__all_virtual_tenant_location_history"
const uint64_t OB_ALL_VIRTUAL_OBJAUTH_MYSQL_TID = 12543; // "__all_virtual_objauth_mysql"
const uint64_t OB_ALL_VIRTUAL_OBJAUTH_MYSQL_HISTORY_TID = 12544; // "__all_virtual_objauth_mysql_history"
const uint64_t OB_TENANT_VIRTUAL_SHOW_CREATE_LOCATION_TID = 12545; // "__tenant_virtual_show_create_location"
const uint64_t OB_TENANT_VIRTUAL_LIST_FILE_TID = 12546; // "__tenant_virtual_list_file"
const uint64_t OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_TID = 12547; // "__all_virtual_external_resource"
const uint64_t OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_HISTORY_TID = 12548; // "__all_virtual_external_resource_history"
...
const uint64_t OB_ALL_VIRTUAL_LOGSERVICE_CLUSTER_INFO_TID = 12551; // "__all_virtual_logservice_cluster_info"
const uint64_t OB_ALL_VIRTUAL_SS_GC_STATUS_TID = 12552; // "__all_virtual_ss_gc_status"
const uint64_t OB_ALL_VIRTUAL_SS_GC_DETECT_INFO_TID = 12553; // "__all_virtual_ss_gc_detect_info"
const uint64_t OB_ALL_VIRTUAL_UNIT_MYSQL_SYS_AGENT_TID = 12554; // "__all_virtual_unit_mysql_sys_agent"
...
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_JOB_TID = 12563; // "__all_virtual_backup_validate_job"
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_JOB_HISTORY_TID = 12564; // "__all_virtual_backup_validate_job_history"
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_TASK_TID = 12565; // "__all_virtual_backup_validate_task"
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_TASK_HISTORY_TID = 12566; // "__all_virtual_backup_validate_task_history"
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_LS_TASK_TID = 12567; // "__all_virtual_backup_validate_ls_task"
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_LS_TASK_HISTORY_TID = 12568; // "__all_virtual_backup_validate_ls_task_history"
const uint64_t OB_ALL_VIRTUAL_TENANT_SS_STORAGE_STAT_TID = 12569; // "__all_virtual_tenant_ss_storage_stat"
const uint64_t OB_ALL_VIRTUAL_HMS_CLIENT_POOL_STAT_TID = 12570; // "__all_virtual_hms_client_pool_stat"
const uint64_t OB_ALL_VIRTUAL_SOURCE_TID = 12571; // "__all_virtual_source"
const uint64_t OB_ALL_VIRTUAL_AI_MODEL_TID = 12572; // "__all_virtual_ai_model"
const uint64_t OB_ALL_VIRTUAL_AI_MODEL_HISTORY_TID = 12573; // "__all_virtual_ai_model_history"
const uint64_t OB_ALL_VIRTUAL_AI_MODEL_ENDPOINT_TID = 12574; // "__all_virtual_ai_model_endpoint"
const uint64_t OB_ALL_VIRTUAL_SS_OBJECT_TYPE_IO_STAT_TID = 12575; // "__all_virtual_ss_object_type_io_stat"
const uint64_t OB_ALL_VIRTUAL_WR_ACTIVE_SESSION_HISTORY_V2_TID = 12576; // "__all_virtual_wr_active_session_history_v2"
const uint64_t OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_TID = 12577; // "__all_virtual_macro_block_ha_task"
const uint64_t OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_TID = 12578; // "__all_virtual_macro_block_ha_task_progress"
const uint64_t OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_TID = 12579; // "__all_virtual_macro_block_ha_task_history"
const uint64_t OB_ALL_VIRTUAL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_TID = 12580; // "__all_virtual_tablet_to_global_temporary_table"
const uint64_t OB_ALL_VIRTUAL_EXTERNAL_CATALOG_CLIENT_POOL_STAT_TID = 12581; // "__all_virtual_external_catalog_client_pool_stat"
const uint64_t OB_ALL_VIRTUAL_WR_SQLSTAT_V2_TID = 12582; // "__all_virtual_wr_sqlstat_v2"
const uint64_t OB_ALL_VIRTUAL_LOB_CHECK_EXCEPTION_RESULT_TID = 12583; // "__all_virtual_lob_check_exception_result"
const uint64_t OB_ALL_VIRTUAL_TABLET_WINDOW_LOOP_INFO_TID = 12586; // "__all_virtual_tablet_window_loop_info"
const uint64_t OB_ALL_VIRTUAL_TABLET_REPLICA_INFO_TID = 12587; // "__all_virtual_tablet_replica_info"
const uint64_t OB_ALL_VIRTUAL_ROUTINE_LOAD_JOB_TID = 12588; // "__all_virtual_routine_load_job"
const uint64_t OB_ALL_VIRTUAL_SS_MACRO_CACHE_INFO_TID = 12589; // "__all_virtual_ss_macro_cache_info"
const uint64_t OB_ALL_VIRTUAL_SS_LOCAL_CACHE_DIAGNOSE_INFO_TID = 12590; // "__all_virtual_ss_local_cache_diagnose_info"
const uint64_t OB_ALL_VIRTUAL_DDL_DAG_MONITOR_TID = 12591; // "__all_virtual_ddl_dag_monitor"
const uint64_t OB_ALL_VIRTUAL_VECTOR_SEGMENT_INFO_TID = 12592; // "__all_virtual_vector_segment_info"
const uint64_t OB_ALL_VIRTUAL_JAVA_POLICY_TID = 12594; // "__all_virtual_java_policy"
const uint64_t OB_ALL_VIRTUAL_JAVA_POLICY_HISTORY_TID = 12595; // "__all_virtual_java_policy_history"
const uint64_t OB_ALL_VIRTUAL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_TID = 12596; // "__all_virtual_catalog_table_opt_stat_gather_history"
const uint64_t OB_ALL_VIRTUAL_AUDIT_LOG_ENCRYPTION_PASSWORD_TID = 12599; // "__all_virtual_audit_log_encryption_password"
const uint64_t OB_ALL_VIRTUAL_OPTSTAT_CATALOG_USER_PREFS_TID = 12600; // "__all_virtual_optstat_catalog_user_prefs"
const uint64_t OB_ALL_VIRTUAL_OPTSTAT_CATALOG_GLOBAL_PREFS_TID = 12602; // "__all_virtual_optstat_catalog_global_prefs"
const uint64_t OB_ALL_VIRTUAL_TENANT_WORKER_GROUP_TID = 12603; // "__all_virtual_tenant_worker_group"
const uint64_t OB_ALL_VIRTUAL_KEYWORD_TID = 12604; // "__all_virtual_keyword"
const uint64_t OB_ALL_VIRTUAL_TABLE_OPT_STAT_INVALIDATE_PLAN_TID = 12608; // "__all_virtual_table_opt_stat_invalidate_plan"
const uint64_t OB_ALL_VIRTUAL_MVIEW_DEP_TID = 12616; // "__all_virtual_mview_dep"
const uint64_t OB_ALL_VIRTUAL_MVIEW_REFRESH_PENDING_TASK_TID = 12617; // "__all_virtual_mview_refresh_pending_task"
...
const uint64_t OB_ALL_VIRTUAL_KV_TTL_TASK_ORA_TID = 15263; // "ALL_VIRTUAL_KV_TTL_TASK_ORA"
const uint64_t OB_ALL_VIRTUAL_KV_TTL_TASK_HISTORY_ORA_TID = 15264; // "ALL_VIRTUAL_KV_TTL_TASK_HISTORY_ORA"
...
const uint64_t OB_ALL_VIRTUAL_COLUMN_GROUP_REAL_AGENT_ORA_TID = 15442; // "ALL_VIRTUAL_COLUMN_GROUP_REAL_AGENT_ORA"
...
const uint64_t OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_REAL_AGENT_ORA_TID = 15490; // "ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_REAL_AGENT_ORA"
...
const uint64_t OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_ORA_TID = 15498; // "ALL_VIRTUAL_SSWRITER_GROUP_STAT_ORA"
const uint64_t OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_ORA_TID = 15499; // "ALL_VIRTUAL_SSWRITER_LEASE_MGR_ORA"
const uint64_t OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_ORA_TID = 15502; // "ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_ORA"
...
const uint64_t OB_ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION_ORA_TID = 15510; // "ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION_ORA"
const uint64_t OB_ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA_TID = 15511; // "ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA"
const uint64_t OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_TID = 15512; // "ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA"
const uint64_t OB_TENANT_VIRTUAL_LIST_FILE_ORA_TID = 15516; // "TENANT_VIRTUAL_LIST_FILE_ORA"
const uint64_t OB_ALL_VIRTUAL_SS_TABLET_META_ORA_TID = 15517; // "ALL_VIRTUAL_SS_TABLET_META_ORA"
const uint64_t OB_ALL_VIRTUAL_SS_LS_META_ORA_TID = 15518; // "ALL_VIRTUAL_SS_LS_META_ORA"
const uint64_t OB_ALL_VIRTUAL_SS_SSTABLE_MGR_ORA_TID = 15519; // "ALL_VIRTUAL_SS_SSTABLE_MGR_ORA"
const uint64_t OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_ORA_TID = 15520; // "ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_ORA"
const uint64_t OB_ALL_VIRTUAL_SS_EXISTING_TABLET_META_ORA_TID = 15522; // "ALL_VIRTUAL_SS_EXISTING_TABLET_META_ORA"
const uint64_t OB_ALL_VIRTUAL_SS_EXISTING_SSTABLE_MGR_ORA_TID = 15523; // "ALL_VIRTUAL_SS_EXISTING_SSTABLE_MGR_ORA"
const uint64_t OB_ALL_VIRTUAL_UNIT_SYS_AGENT_TID = 15524; // "ALL_VIRTUAL_UNIT_SYS_AGENT"
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_JOB_ORA_TID = 15527; // "ALL_VIRTUAL_BACKUP_VALIDATE_JOB_ORA"
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_JOB_HISTORY_ORA_TID = 15528; // "ALL_VIRTUAL_BACKUP_VALIDATE_JOB_HISTORY_ORA"
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_TASK_ORA_TID = 15529; // "ALL_VIRTUAL_BACKUP_VALIDATE_TASK_ORA"
const uint64_t OB_ALL_VIRTUAL_BACKUP_VALIDATE_TASK_HISTORY_ORA_TID = 15530; // "ALL_VIRTUAL_BACKUP_VALIDATE_TASK_HISTORY_ORA"
const uint64_t OB_ALL_VIRTUAL_TENANT_SS_STORAGE_STAT_ORA_TID = 15531; // "ALL_VIRTUAL_TENANT_SS_STORAGE_STAT_ORA"
const uint64_t OB_ALL_VIRTUAL_HMS_CLIENT_POOL_STAT_ORA_TID = 15532; // "ALL_VIRTUAL_HMS_CLIENT_POOL_STAT_ORA"
const uint64_t OB_ALL_VIRTUAL_SOURCE_ORA_TID = 15533; // "ALL_VIRTUAL_SOURCE_ORA"
const uint64_t OB_ALL_VIRTUAL_SS_DIAGNOSE_INFO_ORA_TID = 15534; // "ALL_VIRTUAL_SS_DIAGNOSE_INFO_ORA"
const uint64_t OB_ALL_VIRTUAL_WR_ACTIVE_SESSION_HISTORY_V2_ORA_TID = 15535; // "ALL_VIRTUAL_WR_ACTIVE_SESSION_HISTORY_V2_ORA"
const uint64_t OB_ALL_VIRTUAL_WR_SQLSTAT_V2_ORA_TID = 15536; // "ALL_VIRTUAL_WR_SQLSTAT_V2_ORA"
const uint64_t OB_ALL_VIRTUAL_LOB_CHECK_EXCEPTION_RESULT_ORA_TID = 15537; // "ALL_VIRTUAL_LOB_CHECK_EXCEPTION_RESULT_ORA"
const uint64_t OB_ALL_VIRTUAL_SENSITIVE_RULE_REAL_AGENT_ORA_TID = 15538; // "ALL_VIRTUAL_SENSITIVE_RULE_REAL_AGENT_ORA"
const uint64_t OB_ALL_VIRTUAL_SENSITIVE_COLUMN_REAL_AGENT_ORA_TID = 15539; // "ALL_VIRTUAL_SENSITIVE_COLUMN_REAL_AGENT_ORA"
const uint64_t OB_ALL_VIRTUAL_TABLET_WINDOW_LOOP_INFO_ORA_TID = 15542; // "ALL_VIRTUAL_TABLET_WINDOW_LOOP_INFO_ORA"
const uint64_t OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_ORA_TID = 15543; // "ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_ORA"
const uint64_t OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_ORA_TID = 15544; // "ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_ORA"
const uint64_t OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_ORA_TID = 15545; // "ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_ORA"
const uint64_t OB_ALL_VIRTUAL_ROUTINE_LOAD_JOB_REAL_AGENT_ORA_TID = 15546; // "ALL_VIRTUAL_ROUTINE_LOAD_JOB_REAL_AGENT_ORA"
const uint64_t OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_REAL_AGENT_ORA_TID = 15550; // "ALL_VIRTUAL_EXTERNAL_RESOURCE_REAL_AGENT_ORA"
const uint64_t OB_ALL_VIRTUAL_JAVA_POLICY_REAL_AGENT_ORA_TID = 15551; // "ALL_VIRTUAL_JAVA_POLICY_REAL_AGENT_ORA"
const uint64_t OB_ALL_VIRTUAL_TENANT_WORKER_GROUP_ORA_TID = 15552; // "ALL_VIRTUAL_TENANT_WORKER_GROUP_ORA"
const uint64_t OB_ALL_VIRTUAL_KEYWORD_ORA_TID = 15553; // "ALL_VIRTUAL_KEYWORD_ORA"
const uint64_t OB_ALL_VIRTUAL_TABLE_OPT_STAT_INVALIDATE_PLAN_REAL_AGENT_ORA_TID = 15555; // "ALL_VIRTUAL_TABLE_OPT_STAT_INVALIDATE_PLAN_REAL_AGENT_ORA"
const uint64_t OB_ALL_VIRTUAL_SYS_VARIABLE_HISTORY_ORA_TID = 15556; // "ALL_VIRTUAL_SYS_VARIABLE_HISTORY_ORA"
const uint64_t OB_ALL_VIRTUAL_MVIEW_REFRESH_PENDING_TASK_REAL_AGENT_ORA_TID = 15557; // "ALL_VIRTUAL_MVIEW_REFRESH_PENDING_TASK_REAL_AGENT_ORA"
...
const uint64_t OB_DBA_OB_OBJECT_BALANCE_WEIGHT_TID = 21629; // "DBA_OB_OBJECT_BALANCE_WEIGHT"
const uint64_t OB_CDB_OB_OBJECT_BALANCE_WEIGHT_TID = 21630; // "CDB_OB_OBJECT_BALANCE_WEIGHT"
...
const uint64_t OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_TID = 21637; // "DBA_OB_TENANT_FLASHBACK_LOG_SCN"
const uint64_t OB_CDB_OB_TENANT_FLASHBACK_LOG_SCN_TID = 21638; // "CDB_OB_TENANT_FLASHBACK_LOG_SCN"
...
const uint64_t OB_DBA_OB_EXTERNAL_RESOURCES_TID = 21658; // "DBA_OB_EXTERNAL_RESOURCES"
const uint64_t OB_CDB_OB_EXTERNAL_RESOURCES_TID = 21659; // "CDB_OB_EXTERNAL_RESOURCES"
const uint64_t OB_V_OB_SS_SSTABLES_TID = 21660; // "V$OB_SS_SSTABLES"
...
const uint64_t OB_CDB_OB_BACKUP_VALIDATE_JOBS_TID = 21673; // "CDB_OB_BACKUP_VALIDATE_JOBS"
const uint64_t OB_CDB_OB_BACKUP_VALIDATE_JOB_HISTORY_TID = 21674; // "CDB_OB_BACKUP_VALIDATE_JOB_HISTORY"
const uint64_t OB_CDB_OB_BACKUP_VALIDATE_TASKS_TID = 21675; // "CDB_OB_BACKUP_VALIDATE_TASKS"
const uint64_t OB_CDB_OB_BACKUP_VALIDATE_TASK_HISTORY_TID = 21676; // "CDB_OB_BACKUP_VALIDATE_TASK_HISTORY"
const uint64_t OB_DBA_OB_BACKUP_VALIDATE_JOBS_TID = 21677; // "DBA_OB_BACKUP_VALIDATE_JOBS"
const uint64_t OB_DBA_OB_BACKUP_VALIDATE_JOB_HISTORY_TID = 21678; // "DBA_OB_BACKUP_VALIDATE_JOB_HISTORY"
const uint64_t OB_DBA_OB_BACKUP_VALIDATE_TASKS_TID = 21679; // "DBA_OB_BACKUP_VALIDATE_TASKS"
const uint64_t OB_DBA_OB_BACKUP_VALIDATE_TASK_HISTORY_TID = 21680; // "DBA_OB_BACKUP_VALIDATE_TASK_HISTORY"
...
const uint64_t OB_CDB_OB_SS_SPACE_USAGE_TID = 21685; // "CDB_OB_SS_SPACE_USAGE"
const uint64_t OB_DBA_OB_SS_SPACE_USAGE_TID = 21686; // "DBA_OB_SS_SPACE_USAGE"
const uint64_t OB_GV_OB_HMS_CLIENT_POOL_STAT_TID = 21687; // "GV$OB_HMS_CLIENT_POOL_STAT"
const uint64_t OB_V_OB_HMS_CLIENT_POOL_STAT_TID = 21688; // "V$OB_HMS_CLIENT_POOL_STAT"
const uint64_t OB_DBA_OB_AI_MODELS_TID = 21689; // "DBA_OB_AI_MODELS"
const uint64_t OB_DBA_OB_AI_MODEL_ENDPOINTS_TID = 21690; // "DBA_OB_AI_MODEL_ENDPOINTS"
const uint64_t OB_CDB_OB_AI_MODELS_TID = 21691; // "CDB_OB_AI_MODELS"
const uint64_t OB_CDB_OB_AI_MODEL_ENDPOINTS_TID = 21692; // "CDB_OB_AI_MODEL_ENDPOINTS"
const uint64_t OB_GV_OB_SS_OBJECT_TYPE_IO_STAT_TID = 21693; // "GV$OB_SS_OBJECT_TYPE_IO_STAT"
const uint64_t OB_V_OB_SS_OBJECT_TYPE_IO_STAT_TID = 21694; // "V$OB_SS_OBJECT_TYPE_IO_STAT"
const uint64_t OB_GV_OB_EXTERNAL_CATALOG_CLIENT_POOL_STAT_TID = 21695; // "GV$OB_EXTERNAL_CATALOG_CLIENT_POOL_STAT"
const uint64_t OB_V_OB_EXTERNAL_CATALOG_CLIENT_POOL_STAT_TID = 21696; // "V$OB_EXTERNAL_CATALOG_CLIENT_POOL_STAT"
const uint64_t OB_DBA_TABLES_TID = 21697; // "DBA_TABLES"
const uint64_t OB_DBA_OB_LOB_CHECK_TASKS_TID = 21698; // "DBA_OB_LOB_CHECK_TASKS"
const uint64_t OB_CDB_OB_LOB_CHECK_TASKS_TID = 21699; // "CDB_OB_LOB_CHECK_TASKS"
const uint64_t OB_DBA_OB_LOB_CHECK_EXCEPTION_RESULT_TID = 21700; // "DBA_OB_LOB_CHECK_EXCEPTION_RESULT"
const uint64_t OB_CDB_OB_LOB_CHECK_EXCEPTION_RESULT_TID = 21701; // "CDB_OB_LOB_CHECK_EXCEPTION_RESULT"
const uint64_t OB_DBA_OB_TTL_TASKS_TID = 21702; // "DBA_OB_TTL_TASKS"
const uint64_t OB_DBA_OB_TTL_TASK_HISTORY_TID = 21703; // "DBA_OB_TTL_TASK_HISTORY"
const uint64_t OB_CDB_OB_TTL_TASKS_TID = 21704; // "CDB_OB_TTL_TASKS"
const uint64_t OB_CDB_OB_TTL_TASK_HISTORY_TID = 21705; // "CDB_OB_TTL_TASK_HISTORY"
const uint64_t OB_GV_OB_TABLET_REPLICA_INFO_TID = 21708; // "GV$OB_TABLET_REPLICA_INFO"
const uint64_t OB_V_OB_TABLET_REPLICA_INFO_TID = 21709; // "V$OB_TABLET_REPLICA_INFO"
const uint64_t OB_DBA_OB_ROUTINE_LOAD_JOBS_TID = 21710; // "DBA_OB_ROUTINE_LOAD_JOBS"
const uint64_t OB_CDB_OB_ROUTINE_LOAD_JOBS_TID = 21711; // "CDB_OB_ROUTINE_LOAD_JOBS"
const uint64_t OB_GV_OB_SS_LOCAL_CACHE_DIAGNOSE_TID = 21712; // "GV$OB_SS_LOCAL_CACHE_DIAGNOSE"
const uint64_t OB_V_OB_SS_LOCAL_CACHE_DIAGNOSE_TID = 21713; // "V$OB_SS_LOCAL_CACHE_DIAGNOSE"
const uint64_t OB_GV_OB_SINDI_INDEX_INFO_TID = 21714; // "GV$OB_SINDI_INDEX_INFO"
const uint64_t OB_V_OB_SINDI_INDEX_INFO_TID = 21715; // "V$OB_SINDI_INDEX_INFO"
const uint64_t OB_GV_OB_HNSW_INDEX_SEGMENT_INFO_TID = 21716; // "GV$OB_HNSW_INDEX_SEGMENT_INFO"
const uint64_t OB_V_OB_HNSW_INDEX_SEGMENT_INFO_TID = 21717; // "V$OB_HNSW_INDEX_SEGMENT_INFO"
const uint64_t OB_DBA_JAVA_POLICY_TID = 21718; // "DBA_JAVA_POLICY"
const uint64_t OB_USER_JAVA_POLICY_TID = 21719; // "USER_JAVA_POLICY"
const uint64_t OB_DBA_SCHEDULER_RUNNING_JOBS_TID = 21720; // "DBA_SCHEDULER_RUNNING_JOBS"
const uint64_t OB_CDB_SCHEDULER_RUNNING_JOBS_TID = 21721; // "CDB_SCHEDULER_RUNNING_JOBS"
const uint64_t OB_CDB_SCHEDULER_JOBS_TID = 21722; // "CDB_SCHEDULER_JOBS"
const uint64_t OB_GV_OB_TENANT_WORKER_GROUPS_TID = 21723; // "GV$OB_TENANT_WORKER_GROUPS"
const uint64_t OB_V_OB_KEYWORDS_TID = 21724; // "V$OB_KEYWORDS"
const uint64_t OB_DBA_OB_EXTERNAL_TAB_STATISTICS_TID = 21725; // "DBA_OB_EXTERNAL_TAB_STATISTICS"
const uint64_t OB_DBA_OB_EXTERNAL_TAB_COL_STATISTICS_TID = 21726; // "DBA_OB_EXTERNAL_TAB_COL_STATISTICS"
const uint64_t OB_DBA_OB_EXTERNAL_PART_COL_STATISTICS_TID = 21727; // "DBA_OB_EXTERNAL_PART_COL_STATISTICS"
const uint64_t OB_DBA_OB_SYS_VARIABLE_HISTORY_TID = 21744; // "DBA_OB_SYS_VARIABLE_HISTORY"
const uint64_t OB_CDB_OB_SYS_VARIABLE_HISTORY_TID = 21745; // "CDB_OB_SYS_VARIABLE_HISTORY"
const uint64_t OB_CDB_MVIEW_DEPS_TID = 21746; // "CDB_MVIEW_DEPS"
const uint64_t OB_GV_OB_LS_MIGRATION_TASKS_TID = 21759; // "GV$OB_LS_MIGRATION_TASKS"
const uint64_t OB_V_OB_LS_MIGRATION_TASKS_TID = 21760; // "V$OB_LS_MIGRATION_TASKS"
...
const uint64_t OB_DBA_TABLES_ORA_TID = 25028; // "DBA_TABLES_ORA"
...
const uint64_t OB_DBA_SCHEDULER_RUNNING_JOBS_ORA_TID = 25271; // "DBA_SCHEDULER_RUNNING_JOBS_ORA"
...
const uint64_t OB_DBA_OB_OBJECT_BALANCE_WEIGHT_ORA_TID = 25304; // "DBA_OB_OBJECT_BALANCE_WEIGHT_ORA"
const uint64_t OB_USER_SCHEDULER_JOBS_ORA_TID = 25305; // "USER_SCHEDULER_JOBS_ORA"
const uint64_t OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_ORA_TID = 25306; // "DBA_OB_TENANT_FLASHBACK_LOG_SCN_ORA"
...
const uint64_t OB_DBA_OB_BACKUP_VALIDATE_JOBS_ORA_TID = 25311; // "DBA_OB_BACKUP_VALIDATE_JOBS_ORA"
const uint64_t OB_DBA_OB_BACKUP_VALIDATE_JOB_HISTORY_ORA_TID = 25312; // "DBA_OB_BACKUP_VALIDATE_JOB_HISTORY_ORA"
const uint64_t OB_DBA_OB_BACKUP_VALIDATE_TASKS_ORA_TID = 25313; // "DBA_OB_BACKUP_VALIDATE_TASKS_ORA"
const uint64_t OB_DBA_OB_BACKUP_VALIDATE_TASK_HISTORY_ORA_TID = 25314; // "DBA_OB_BACKUP_VALIDATE_TASK_HISTORY_ORA"
const uint64_t OB_DBA_OB_SS_SPACE_USAGE_ORA_TID = 25315; // "DBA_OB_SS_SPACE_USAGE_ORA"
...
const uint64_t OB_DBA_JAVA_POLICY_ORA_TID = 25319; // "DBA_JAVA_POLICY_ORA"
const uint64_t OB_USER_JAVA_POLICY_ORA_TID = 25320; // "USER_JAVA_POLICY_ORA"
const uint64_t OB_V_OB_KEYWORDS_ORA_TID = 25321; // "V$OB_KEYWORDS_ORA"
...
const uint64_t OB_GV_OB_RESULT_CACHE_OBJECTS_ORA_TID = 28275; // "GV$OB_RESULT_CACHE_OBJECTS_ORA"
const uint64_t OB_V_OB_RESULT_CACHE_OBJECTS_ORA_TID = 28276; // "V$OB_RESULT_CACHE_OBJECTS_ORA"
const uint64_t OB_ALL_LOCATIONS_TID = 28277; // "ALL_LOCATIONS"
const uint64_t OB_V_OB_SS_SSTABLES_ORA_TID = 28278; // "V$OB_SS_SSTABLES_ORA"
const uint64_t OB_DBA_OB_PL_OBJ_CACHE_STATUS_ORA_TID = 28279; // "DBA_OB_PL_OBJ_CACHE_STATUS_ORA"
const uint64_t OB_GV_OB_HMS_CLIENT_POOL_STAT_ORA_TID = 28283; // "GV$OB_HMS_CLIENT_POOL_STAT_ORA"
const uint64_t OB_V_OB_HMS_CLIENT_POOL_STAT_ORA_TID = 28284; // "V$OB_HMS_CLIENT_POOL_STAT_ORA"
const uint64_t OB_DBA_OB_LOB_CHECK_TASKS_ORA_TID = 28285; // "DBA_OB_LOB_CHECK_TASKS_ORA"
const uint64_t OB_DBA_OB_LOB_CHECK_EXCEPTION_RESULT_ORA_TID = 28287; // "DBA_OB_LOB_CHECK_EXCEPTION_RESULT_ORA"
const uint64_t OB_DBA_OB_SENSITIVE_RULES_ORA_TID = 28289; // "DBA_OB_SENSITIVE_RULES_ORA"
const uint64_t OB_DBA_OB_SENSITIVE_COLUMNS_ORA_TID = 28290; // "DBA_OB_SENSITIVE_COLUMNS_ORA"
const uint64_t OB_DBA_OB_SENSITIVE_RULE_PLAINACCESS_USERS_ORA_TID = 28291; // "DBA_OB_SENSITIVE_RULE_PLAINACCESS_USERS_ORA"
const uint64_t OB_DBA_OB_TTL_TASKS_ORA_TID = 28292; // "DBA_OB_TTL_TASKS_ORA"
const uint64_t OB_DBA_OB_TTL_TASK_HISTORY_ORA_TID = 28293; // "DBA_OB_TTL_TASK_HISTORY_ORA"
const uint64_t OB_DBA_OB_ROUTINE_LOAD_JOBS_ORA_TID = 28295; // "DBA_OB_ROUTINE_LOAD_JOBS_ORA"
const uint64_t OB_GV_OB_TENANT_WORKER_GROUPS_ORA_TID = 28296; // "GV$OB_TENANT_WORKER_GROUPS_ORA"
const uint64_t OB_DBA_OB_SYS_VARIABLE_HISTORY_ORA_TID = 28301; // "DBA_OB_SYS_VARIABLE_HISTORY_ORA"
...
const uint64_t OB_ALL_OBJECT_BALANCE_WEIGHT_AUX_LOB_META_TID = 50529; // "__all_object_balance_weight_aux_lob_meta"
...
const uint64_t OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_META_TID = 50541; // "__all_tenant_flashback_log_scn_aux_lob_meta"
...
const uint64_t OB_ALL_BALANCE_JOB_DESCRIPTION_AUX_LOB_META_TID = 50549; // "__all_balance_job_description_aux_lob_meta"
const uint64_t OB_ALL_TENANT_LOCATION_AUX_LOB_META_TID = 50550; // "__all_tenant_location_aux_lob_meta"
const uint64_t OB_ALL_TENANT_LOCATION_HISTORY_AUX_LOB_META_TID = 50551; // "__all_tenant_location_history_aux_lob_meta"
const uint64_t OB_ALL_TENANT_OBJAUTH_MYSQL_AUX_LOB_META_TID = 50552; // "__all_tenant_objauth_mysql_aux_lob_meta"
const uint64_t OB_ALL_TENANT_OBJAUTH_MYSQL_HISTORY_AUX_LOB_META_TID = 50553; // "__all_tenant_objauth_mysql_history_aux_lob_meta"
const uint64_t OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_META_TID = 50554; // "__all_external_resource_aux_lob_meta"
const uint64_t OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_META_TID = 50555; // "__all_external_resource_history_aux_lob_meta"
...
const uint64_t OB_ALL_BACKUP_VALIDATE_JOB_AUX_LOB_META_TID = 50563; // "__all_backup_validate_job_aux_lob_meta"
const uint64_t OB_ALL_BACKUP_VALIDATE_JOB_HISTORY_AUX_LOB_META_TID = 50564; // "__all_backup_validate_job_history_aux_lob_meta"
const uint64_t OB_ALL_BACKUP_VALIDATE_TASK_AUX_LOB_META_TID = 50565; // "__all_backup_validate_task_aux_lob_meta"
const uint64_t OB_ALL_BACKUP_VALIDATE_TASK_HISTORY_AUX_LOB_META_TID = 50566; // "__all_backup_validate_task_history_aux_lob_meta"
const uint64_t OB_ALL_BACKUP_VALIDATE_LS_TASK_AUX_LOB_META_TID = 50567; // "__all_backup_validate_ls_task_aux_lob_meta"
const uint64_t OB_ALL_BACKUP_VALIDATE_LS_TASK_HISTORY_AUX_LOB_META_TID = 50568; // "__all_backup_validate_ls_task_history_aux_lob_meta"
const uint64_t OB_ALL_TENANT_SS_STORAGE_STAT_AUX_LOB_META_TID = 50569; // "__all_tenant_ss_storage_stat_aux_lob_meta"
const uint64_t OB_ALL_AI_MODEL_AUX_LOB_META_TID = 50570; // "__all_ai_model_aux_lob_meta"
const uint64_t OB_ALL_AI_MODEL_HISTORY_AUX_LOB_META_TID = 50571; // "__all_ai_model_history_aux_lob_meta"
const uint64_t OB_ALL_AI_MODEL_ENDPOINT_AUX_LOB_META_TID = 50572; // "__all_ai_model_endpoint_aux_lob_meta"
const uint64_t OB_WR_ACTIVE_SESSION_HISTORY_V2_AUX_LOB_META_TID = 50573; // "__wr_active_session_history_v2_aux_lob_meta"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_META_TID = 50574; // "__all_tenant_macro_block_ha_task_aux_lob_meta"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_META_TID = 50575; // "__all_tenant_macro_block_ha_task_progress_aux_lob_meta"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_META_TID = 50576; // "__all_tenant_macro_block_ha_task_history_aux_lob_meta"
const uint64_t OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_AUX_LOB_META_TID = 50577; // "__all_tablet_to_global_temporary_table_aux_lob_meta"
const uint64_t OB_WR_SQLSTAT_V2_AUX_LOB_META_TID = 50579; // "__wr_sqlstat_v2_aux_lob_meta"
const uint64_t OB_ALL_LOB_CHECK_EXCEPTION_RESULT_AUX_LOB_META_TID = 50580; // "__all_lob_check_exception_result_aux_lob_meta"
const uint64_t OB_ALL_ROUTINE_LOAD_JOB_AUX_LOB_META_TID = 50583; // "__all_routine_load_job_aux_lob_meta"
const uint64_t OB_ALL_SS_GC_RESERVED_SNAPSHOT_AUX_LOB_META_TID = 50584; // "__all_ss_gc_reserved_snapshot_aux_lob_meta"
const uint64_t OB_ALL_TABLE_ARCHIVE_HISTORY_AUX_LOB_META_TID = 50585; // "__all_table_archive_history_aux_lob_meta"
const uint64_t OB_ALL_JAVA_POLICY_AUX_LOB_META_TID = 50586; // "__all_java_policy_aux_lob_meta"
const uint64_t OB_ALL_JAVA_POLICY_HISTORY_AUX_LOB_META_TID = 50587; // "__all_java_policy_history_aux_lob_meta"
const uint64_t OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_META_TID = 50588; // "__all_catalog_table_stat_aux_lob_meta"
const uint64_t OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_META_TID = 50589; // "__all_catalog_column_stat_aux_lob_meta"
const uint64_t OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_META_TID = 50590; // "__all_catalog_table_opt_stat_gather_history_aux_lob_meta"
const uint64_t OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_AUX_LOB_META_TID = 50591; // "__all_audit_log_encryption_password_aux_lob_meta"
const uint64_t OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_META_TID = 50593; // "__all_optstat_catalog_user_prefs_aux_lob_meta"
const uint64_t OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_META_TID = 50594; // "__all_optstat_catalog_global_prefs_aux_lob_meta"
const uint64_t OB_ALL_TABLE_OPT_STAT_INVALIDATE_PLAN_AUX_LOB_META_TID = 50596; // "__all_table_opt_stat_invalidate_plan_aux_lob_meta"
const uint64_t OB_ALL_MVIEW_REFRESH_PENDING_TASK_AUX_LOB_META_TID = 50604; // "__all_mview_refresh_pending_task_aux_lob_meta"
...
const uint64_t OB_ALL_OBJECT_BALANCE_WEIGHT_AUX_LOB_PIECE_TID = 60529; // "__all_object_balance_weight_aux_lob_piece"
...
const uint64_t OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_PIECE_TID = 60541; // "__all_tenant_flashback_log_scn_aux_lob_piece"
...
const uint64_t OB_ALL_BALANCE_JOB_DESCRIPTION_AUX_LOB_PIECE_TID = 60549; // "__all_balance_job_description_aux_lob_piece"
const uint64_t OB_ALL_TENANT_LOCATION_AUX_LOB_PIECE_TID = 60550; // "__all_tenant_location_aux_lob_piece"
const uint64_t OB_ALL_TENANT_LOCATION_HISTORY_AUX_LOB_PIECE_TID = 60551; // "__all_tenant_location_history_aux_lob_piece"
const uint64_t OB_ALL_TENANT_OBJAUTH_MYSQL_AUX_LOB_PIECE_TID = 60552; // "__all_tenant_objauth_mysql_aux_lob_piece"
const uint64_t OB_ALL_TENANT_OBJAUTH_MYSQL_HISTORY_AUX_LOB_PIECE_TID = 60553; // "__all_tenant_objauth_mysql_history_aux_lob_piece"
const uint64_t OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_PIECE_TID = 60554; // "__all_external_resource_aux_lob_piece"
const uint64_t OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_PIECE_TID = 60555; // "__all_external_resource_history_aux_lob_piece"
...
const uint64_t OB_ALL_BACKUP_VALIDATE_JOB_AUX_LOB_PIECE_TID = 60563; // "__all_backup_validate_job_aux_lob_piece"
const uint64_t OB_ALL_BACKUP_VALIDATE_JOB_HISTORY_AUX_LOB_PIECE_TID = 60564; // "__all_backup_validate_job_history_aux_lob_piece"
const uint64_t OB_ALL_BACKUP_VALIDATE_TASK_AUX_LOB_PIECE_TID = 60565; // "__all_backup_validate_task_aux_lob_piece"
const uint64_t OB_ALL_BACKUP_VALIDATE_TASK_HISTORY_AUX_LOB_PIECE_TID = 60566; // "__all_backup_validate_task_history_aux_lob_piece"
const uint64_t OB_ALL_BACKUP_VALIDATE_LS_TASK_AUX_LOB_PIECE_TID = 60567; // "__all_backup_validate_ls_task_aux_lob_piece"
const uint64_t OB_ALL_BACKUP_VALIDATE_LS_TASK_HISTORY_AUX_LOB_PIECE_TID = 60568; // "__all_backup_validate_ls_task_history_aux_lob_piece"
const uint64_t OB_ALL_TENANT_SS_STORAGE_STAT_AUX_LOB_PIECE_TID = 60569; // "__all_tenant_ss_storage_stat_aux_lob_piece"
const uint64_t OB_ALL_AI_MODEL_AUX_LOB_PIECE_TID = 60570; // "__all_ai_model_aux_lob_piece"
const uint64_t OB_ALL_AI_MODEL_HISTORY_AUX_LOB_PIECE_TID = 60571; // "__all_ai_model_history_aux_lob_piece"
const uint64_t OB_ALL_AI_MODEL_ENDPOINT_AUX_LOB_PIECE_TID = 60572; // "__all_ai_model_endpoint_aux_lob_piece"
const uint64_t OB_WR_ACTIVE_SESSION_HISTORY_V2_AUX_LOB_PIECE_TID = 60573; // "__wr_active_session_history_v2_aux_lob_piece"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_PIECE_TID = 60574; // "__all_tenant_macro_block_ha_task_aux_lob_piece"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_PIECE_TID = 60575; // "__all_tenant_macro_block_ha_task_progress_aux_lob_piece"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_PIECE_TID = 60576; // "__all_tenant_macro_block_ha_task_history_aux_lob_piece"
const uint64_t OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_AUX_LOB_PIECE_TID = 60577; // "__all_tablet_to_global_temporary_table_aux_lob_piece"
const uint64_t OB_WR_SQLSTAT_V2_AUX_LOB_PIECE_TID = 60579; // "__wr_sqlstat_v2_aux_lob_piece"
const uint64_t OB_ALL_LOB_CHECK_EXCEPTION_RESULT_AUX_LOB_PIECE_TID = 60580; // "__all_lob_check_exception_result_aux_lob_piece"
const uint64_t OB_ALL_ROUTINE_LOAD_JOB_AUX_LOB_PIECE_TID = 60583; // "__all_routine_load_job_aux_lob_piece"
const uint64_t OB_ALL_SS_GC_RESERVED_SNAPSHOT_AUX_LOB_PIECE_TID = 60584; // "__all_ss_gc_reserved_snapshot_aux_lob_piece"
const uint64_t OB_ALL_TABLE_ARCHIVE_HISTORY_AUX_LOB_PIECE_TID = 60585; // "__all_table_archive_history_aux_lob_piece"
const uint64_t OB_ALL_JAVA_POLICY_AUX_LOB_PIECE_TID = 60586; // "__all_java_policy_aux_lob_piece"
const uint64_t OB_ALL_JAVA_POLICY_HISTORY_AUX_LOB_PIECE_TID = 60587; // "__all_java_policy_history_aux_lob_piece"
const uint64_t OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_PIECE_TID = 60588; // "__all_catalog_table_stat_aux_lob_piece"
const uint64_t OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_PIECE_TID = 60589; // "__all_catalog_column_stat_aux_lob_piece"
const uint64_t OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_PIECE_TID = 60590; // "__all_catalog_table_opt_stat_gather_history_aux_lob_piece"
const uint64_t OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_AUX_LOB_PIECE_TID = 60591; // "__all_audit_log_encryption_password_aux_lob_piece"
const uint64_t OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_PIECE_TID = 60593; // "__all_optstat_catalog_user_prefs_aux_lob_piece"
const uint64_t OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_PIECE_TID = 60594; // "__all_optstat_catalog_global_prefs_aux_lob_piece"
const uint64_t OB_ALL_TABLE_OPT_STAT_INVALIDATE_PLAN_AUX_LOB_PIECE_TID = 60596; // "__all_table_opt_stat_invalidate_plan_aux_lob_piece"
const uint64_t OB_ALL_MVIEW_REFRESH_PENDING_TASK_AUX_LOB_PIECE_TID = 60604; // "__all_mview_refresh_pending_task_aux_lob_piece"
...
const uint64_t OB_ALL_VIRTUAL_TABLET_SSTABLE_MACRO_INFO_ALL_VIRTUAL_TABLET_SSTABLE_MACRO_INFO_I1_TID = 14988; // "__all_virtual_tablet_sstable_macro_info"
const uint64_t OB_ALL_VIRTUAL_TABLE_MGR_ALL_VIRTUAL_TABLE_MGR_I1_TID = 14987; // "__all_virtual_table_mgr"
...
const uint64_t OB_ALL_VIRTUAL_TABLE_MGR_ORA_ALL_VIRTUAL_TABLE_MGR_I1_TID = 19990; // "ALL_VIRTUAL_TABLE_MGR_ORA"
...
const uint64_t OB_ALL_TENANT_LOCATION_IDX_LOCATION_NAME_TID = 101116; // "__all_tenant_location"
const uint64_t OB_ALL_TENANT_OBJAUTH_MYSQL_IDX_OBJAUTH_MYSQL_USER_ID_TID = 101117; // "__all_tenant_objauth_mysql"
const uint64_t OB_ALL_TENANT_OBJAUTH_MYSQL_IDX_OBJAUTH_MYSQL_OBJ_NAME_TID = 101118; // "__all_tenant_objauth_mysql"
const uint64_t OB_ALL_EXTERNAL_RESOURCE_IDX_NAME_DBID_EXTERNAL_RESOURCE_TID = 101119; // "__all_external_resource"
const uint64_t OB_ALL_AI_MODEL_ENDPOINT_IDX_ENDPOINT_NAME_TID = 101120; // "__all_ai_model_endpoint"
const uint64_t OB_ALL_AI_MODEL_ENDPOINT_IDX_AI_MODEL_NAME_TID = 101121; // "__all_ai_model_endpoint"
const uint64_t OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_IDX_TEMP_TABLE_ID_SESSION_ID_TID = 101122; // "__all_tablet_to_global_temporary_table"
const uint64_t OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_IDX_TEMP_SESSION_ID_TABLE_ID_TID = 101123; // "__all_tablet_to_global_temporary_table"
const uint64_t OB_ALL_ROUTINE_LOAD_JOB_IDX_ROUTINE_LOAD_JOB_NAME_TID = 101124; // "__all_routine_load_job"
const uint64_t OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_IDX_HA_TASK_STATUS_TID = 101125; // "__all_tenant_macro_block_ha_task"
...
const uint64_t OB_ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA_IDX_LOCATION_NAME_REAL_AGENT_TID = 15513; // "ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA"
const uint64_t OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_IDX_OBJAUTH_MYSQL_USER_ID_REAL_AGENT_TID = 15514; // "ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA"
const uint64_t OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_IDX_OBJAUTH_MYSQL_OBJ_NAME_REAL_AGENT_TID = 15515; // "ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA"
...
const char *const OB_ALL_OBJECT_BALANCE_WEIGHT_TNAME = "__all_object_balance_weight";
...
const char *const OB_ALL_TENANT_FLASHBACK_LOG_SCN_TNAME = "__all_tenant_flashback_log_scn";
...
const char *const OB_ALL_BALANCE_JOB_DESCRIPTION_TNAME = "__all_balance_job_description";
...
const char *const OB_ALL_EXTERNAL_RESOURCE_TNAME = "__all_external_resource";
const char *const OB_ALL_EXTERNAL_RESOURCE_HISTORY_TNAME = "__all_external_resource_history";
...
const char *const OB_ALL_BACKUP_VALIDATE_JOB_TNAME = "__all_backup_validate_job";
const char *const OB_ALL_BACKUP_VALIDATE_JOB_HISTORY_TNAME = "__all_backup_validate_job_history";
const char *const OB_ALL_BACKUP_VALIDATE_TASK_TNAME = "__all_backup_validate_task";
const char *const OB_ALL_BACKUP_VALIDATE_TASK_HISTORY_TNAME = "__all_backup_validate_task_history";
const char *const OB_ALL_BACKUP_VALIDATE_LS_TASK_TNAME = "__all_backup_validate_ls_task";
const char *const OB_ALL_BACKUP_VALIDATE_LS_TASK_HISTORY_TNAME = "__all_backup_validate_ls_task_history";
const char *const OB_ALL_TENANT_SS_STORAGE_STAT_TNAME = "__all_tenant_ss_storage_stat";
...
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_TNAME = "__all_tenant_macro_block_ha_task";
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_TNAME = "__all_tenant_macro_block_ha_task_progress";
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_TNAME = "__all_tenant_macro_block_ha_task_history";
const char *const OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_TNAME = "__all_tablet_to_global_temporary_table";
const char *const OB_WR_SQLSTAT_V2_TNAME = "__wr_sqlstat_v2";
const char *const OB_ALL_LOB_CHECK_EXCEPTION_RESULT_TNAME = "__all_lob_check_exception_result";
const char *const OB_ALL_ROUTINE_LOAD_JOB_TNAME = "__all_routine_load_job";
const char *const OB_ALL_SS_GC_RESERVED_SNAPSHOT_TNAME = "__all_ss_gc_reserved_snapshot";
const char *const OB_ALL_TABLE_ARCHIVE_HISTORY_TNAME = "__all_table_archive_history";
const char *const OB_ALL_JAVA_POLICY_TNAME = "__all_java_policy";
const char *const OB_ALL_JAVA_POLICY_HISTORY_TNAME = "__all_java_policy_history";
const char *const OB_ALL_CATALOG_TABLE_STAT_TNAME = "__all_catalog_table_stat";
const char *const OB_ALL_CATALOG_COLUMN_STAT_TNAME = "__all_catalog_column_stat";
const char *const OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_TNAME = "__all_catalog_table_opt_stat_gather_history";
const char *const OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_TNAME = "__all_audit_log_encryption_password";
const char *const OB_ALL_OPTSTAT_CATALOG_USER_PREFS_TNAME = "__all_optstat_catalog_user_prefs";
const char *const OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_TNAME = "__all_optstat_catalog_global_prefs";
const char *const OB_ALL_TABLE_OPT_STAT_INVALIDATE_PLAN_TNAME = "__all_table_opt_stat_invalidate_plan";
const char *const OB_ALL_MVIEW_REFRESH_PENDING_TASK_TNAME = "__all_mview_refresh_pending_task";
...
const char *const OB_ALL_VIRTUAL_SS_TABLET_META_TNAME = "__all_virtual_ss_tablet_meta";
const char *const OB_ALL_VIRTUAL_SS_LS_META_TNAME = "__all_virtual_ss_ls_meta";
const char *const OB_ALL_VIRTUAL_SS_SSTABLE_MGR_TNAME = "__all_virtual_ss_sstable_mgr";
const char *const OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_TNAME = "__all_virtual_ss_ls_tablet_reorganization_info";
const char *const OB_ALL_VIRTUAL_SS_EXISTING_TABLET_META_TNAME = "__all_virtual_ss_existing_tablet_meta";
const char *const OB_ALL_VIRTUAL_SS_EXISTING_SSTABLE_MGR_TNAME = "__all_virtual_ss_existing_sstable_mgr";
const char *const OB_ALL_VIRTUAL_SS_DIAGNOSE_INFO_TNAME = "__all_virtual_ss_diagnose_info";
...
const char *const OB_ALL_VIRTUAL_DEADLOCK_DETECTOR_STAT_TNAME = "__all_virtual_deadlock_detector_stat";
...
const char *const OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_TNAME = "__all_virtual_object_balance_weight";
...
const char *const OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_TNAME = "__all_virtual_sswriter_group_stat";
const char *const OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_TNAME = "__all_virtual_sswriter_lease_mgr";
const char *const OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_TNAME = "__all_virtual_tenant_flashback_log_scn";
...
const char *const OB_ALL_VIRTUAL_LS_MIGRATION_TASK_TNAME = "__all_virtual_ls_migration_task";
const char *const OB_ALL_VIRTUAL_SS_NOTIFY_TASKS_STAT_TNAME = "__all_virtual_ss_notify_tasks_stat";
const char *const OB_ALL_VIRTUAL_SS_NOTIFY_TABLETS_STAT_TNAME = "__all_virtual_ss_notify_tablets_stat";
const char *const OB_ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION_TNAME = "__all_virtual_balance_job_description";
...
const char *const OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_TNAME = "__all_virtual_external_resource";
const char *const OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_HISTORY_TNAME = "__all_virtual_external_resource_history";
...
const char *const OB_ALL_VIRTUAL_LOGSERVICE_CLUSTER_INFO_TNAME = "__all_virtual_logservice_cluster_info";
const char *const OB_ALL_VIRTUAL_SS_GC_STATUS_TNAME = "__all_virtual_ss_gc_status";
const char *const OB_ALL_VIRTUAL_SS_GC_DETECT_INFO_TNAME = "__all_virtual_ss_gc_detect_info";
const char *const OB_ALL_VIRTUAL_UNIT_MYSQL_SYS_AGENT_TNAME = "__all_virtual_unit_mysql_sys_agent";
...
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_JOB_TNAME = "__all_virtual_backup_validate_job";
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_JOB_HISTORY_TNAME = "__all_virtual_backup_validate_job_history";
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_TASK_TNAME = "__all_virtual_backup_validate_task";
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_TASK_HISTORY_TNAME = "__all_virtual_backup_validate_task_history";
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_LS_TASK_TNAME = "__all_virtual_backup_validate_ls_task";
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_LS_TASK_HISTORY_TNAME = "__all_virtual_backup_validate_ls_task_history";
const char *const OB_ALL_VIRTUAL_TENANT_SS_STORAGE_STAT_TNAME = "__all_virtual_tenant_ss_storage_stat";
const char *const OB_ALL_VIRTUAL_HMS_CLIENT_POOL_STAT_TNAME = "__all_virtual_hms_client_pool_stat";
...
const char *const OB_ALL_VIRTUAL_SS_OBJECT_TYPE_IO_STAT_TNAME = "__all_virtual_ss_object_type_io_stat";
const char *const OB_ALL_VIRTUAL_WR_ACTIVE_SESSION_HISTORY_V2_TNAME = "__all_virtual_wr_active_session_history_v2";
const char *const OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_TNAME = "__all_virtual_macro_block_ha_task";
const char *const OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_TNAME = "__all_virtual_macro_block_ha_task_progress";
const char *const OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_TNAME = "__all_virtual_macro_block_ha_task_history";
const char *const OB_ALL_VIRTUAL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_TNAME = "__all_virtual_tablet_to_global_temporary_table";
const char *const OB_ALL_VIRTUAL_EXTERNAL_CATALOG_CLIENT_POOL_STAT_TNAME = "__all_virtual_external_catalog_client_pool_stat";
const char *const OB_ALL_VIRTUAL_WR_SQLSTAT_V2_TNAME = "__all_virtual_wr_sqlstat_v2";
const char *const OB_ALL_VIRTUAL_LOB_CHECK_EXCEPTION_RESULT_TNAME = "__all_virtual_lob_check_exception_result";
const char *const OB_ALL_VIRTUAL_TABLET_WINDOW_LOOP_INFO_TNAME = "__all_virtual_tablet_window_loop_info";
const char *const OB_ALL_VIRTUAL_TABLET_REPLICA_INFO_TNAME = "__all_virtual_tablet_replica_info";
const char *const OB_ALL_VIRTUAL_ROUTINE_LOAD_JOB_TNAME = "__all_virtual_routine_load_job";
const char *const OB_ALL_VIRTUAL_SS_MACRO_CACHE_INFO_TNAME = "__all_virtual_ss_macro_cache_info";
const char *const OB_ALL_VIRTUAL_SS_LOCAL_CACHE_DIAGNOSE_INFO_TNAME = "__all_virtual_ss_local_cache_diagnose_info";
const char *const OB_ALL_VIRTUAL_DDL_DAG_MONITOR_TNAME = "__all_virtual_ddl_dag_monitor";
const char *const OB_ALL_VIRTUAL_VECTOR_SEGMENT_INFO_TNAME = "__all_virtual_vector_segment_info";
const char *const OB_ALL_VIRTUAL_JAVA_POLICY_TNAME = "__all_virtual_java_policy";
const char *const OB_ALL_VIRTUAL_JAVA_POLICY_HISTORY_TNAME = "__all_virtual_java_policy_history";
const char *const OB_ALL_VIRTUAL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_TNAME = "__all_virtual_catalog_table_opt_stat_gather_history";
const char *const OB_ALL_VIRTUAL_AUDIT_LOG_ENCRYPTION_PASSWORD_TNAME = "__all_virtual_audit_log_encryption_password";
const char *const OB_ALL_VIRTUAL_OPTSTAT_CATALOG_USER_PREFS_TNAME = "__all_virtual_optstat_catalog_user_prefs";
const char *const OB_ALL_VIRTUAL_OPTSTAT_CATALOG_GLOBAL_PREFS_TNAME = "__all_virtual_optstat_catalog_global_prefs";
const char *const OB_ALL_VIRTUAL_TENANT_WORKER_GROUP_TNAME = "__all_virtual_tenant_worker_group";
const char *const OB_ALL_VIRTUAL_KEYWORD_TNAME = "__all_virtual_keyword";
const char *const OB_ALL_VIRTUAL_TABLE_OPT_STAT_INVALIDATE_PLAN_TNAME = "__all_virtual_table_opt_stat_invalidate_plan";
const char *const OB_ALL_VIRTUAL_MVIEW_DEP_TNAME = "__all_virtual_mview_dep";
const char *const OB_ALL_VIRTUAL_MVIEW_REFRESH_PENDING_TASK_TNAME = "__all_virtual_mview_refresh_pending_task";
...
const char *const OB_ALL_VIRTUAL_KV_TTL_TASK_ORA_TNAME = "ALL_VIRTUAL_KV_TTL_TASK";
const char *const OB_ALL_VIRTUAL_KV_TTL_TASK_HISTORY_ORA_TNAME = "ALL_VIRTUAL_KV_TTL_TASK_HISTORY";
...
const char *const OB_ALL_VIRTUAL_COLUMN_GROUP_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_COLUMN_GROUP_REAL_AGENT";
...
const char *const OB_ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_OBJECT_BALANCE_WEIGHT_REAL_AGENT";
...
const char *const OB_ALL_VIRTUAL_SSWRITER_GROUP_STAT_ORA_TNAME = "ALL_VIRTUAL_SSWRITER_GROUP_STAT";
const char *const OB_ALL_VIRTUAL_SSWRITER_LEASE_MGR_ORA_TNAME = "ALL_VIRTUAL_SSWRITER_LEASE_MGR";
const char *const OB_ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN_ORA_TNAME = "ALL_VIRTUAL_TENANT_FLASHBACK_LOG_SCN";
...
const char *const OB_ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION_ORA_TNAME = "ALL_VIRTUAL_BALANCE_JOB_DESCRIPTION";
const char *const OB_ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT";
const char *const OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT";
const char *const OB_TENANT_VIRTUAL_LIST_FILE_ORA_TNAME = "TENANT_VIRTUAL_LIST_FILE";
const char *const OB_ALL_VIRTUAL_SS_TABLET_META_ORA_TNAME = "ALL_VIRTUAL_SS_TABLET_META";
const char *const OB_ALL_VIRTUAL_SS_LS_META_ORA_TNAME = "ALL_VIRTUAL_SS_LS_META";
const char *const OB_ALL_VIRTUAL_SS_SSTABLE_MGR_ORA_TNAME = "ALL_VIRTUAL_SS_SSTABLE_MGR";
const char *const OB_ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO_ORA_TNAME = "ALL_VIRTUAL_SS_LS_TABLET_REORGANIZATION_INFO";
const char *const OB_ALL_VIRTUAL_SS_EXISTING_TABLET_META_ORA_TNAME = "ALL_VIRTUAL_SS_EXISTING_TABLET_META";
const char *const OB_ALL_VIRTUAL_SS_EXISTING_SSTABLE_MGR_ORA_TNAME = "ALL_VIRTUAL_SS_EXISTING_SSTABLE_MGR";
const char *const OB_ALL_VIRTUAL_UNIT_SYS_AGENT_TNAME = "ALL_VIRTUAL_UNIT_SYS_AGENT";
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_JOB_ORA_TNAME = "ALL_VIRTUAL_BACKUP_VALIDATE_JOB";
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_JOB_HISTORY_ORA_TNAME = "ALL_VIRTUAL_BACKUP_VALIDATE_JOB_HISTORY";
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_TASK_ORA_TNAME = "ALL_VIRTUAL_BACKUP_VALIDATE_TASK";
const char *const OB_ALL_VIRTUAL_BACKUP_VALIDATE_TASK_HISTORY_ORA_TNAME = "ALL_VIRTUAL_BACKUP_VALIDATE_TASK_HISTORY";
const char *const OB_ALL_VIRTUAL_TENANT_SS_STORAGE_STAT_ORA_TNAME = "ALL_VIRTUAL_TENANT_SS_STORAGE_STAT";
const char *const OB_ALL_VIRTUAL_HMS_CLIENT_POOL_STAT_ORA_TNAME = "ALL_VIRTUAL_HMS_CLIENT_POOL_STAT";
const char *const OB_ALL_VIRTUAL_SOURCE_ORA_TNAME = "ALL_VIRTUAL_SOURCE";
const char *const OB_ALL_VIRTUAL_SS_DIAGNOSE_INFO_ORA_TNAME = "ALL_VIRTUAL_SS_DIAGNOSE_INFO";
const char *const OB_ALL_VIRTUAL_WR_ACTIVE_SESSION_HISTORY_V2_ORA_TNAME = "ALL_VIRTUAL_WR_ACTIVE_SESSION_HISTORY_V2";
const char *const OB_ALL_VIRTUAL_WR_SQLSTAT_V2_ORA_TNAME = "ALL_VIRTUAL_WR_SQLSTAT_V2";
const char *const OB_ALL_VIRTUAL_LOB_CHECK_EXCEPTION_RESULT_ORA_TNAME = "ALL_VIRTUAL_LOB_CHECK_EXCEPTION_RESULT";
const char *const OB_ALL_VIRTUAL_SENSITIVE_RULE_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_SENSITIVE_RULE_REAL_AGENT";
const char *const OB_ALL_VIRTUAL_SENSITIVE_COLUMN_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_SENSITIVE_COLUMN_REAL_AGENT";
const char *const OB_ALL_VIRTUAL_TABLET_WINDOW_LOOP_INFO_ORA_TNAME = "ALL_VIRTUAL_TABLET_WINDOW_LOOP_INFO";
const char *const OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_ORA_TNAME = "ALL_VIRTUAL_MACRO_BLOCK_HA_TASK";
const char *const OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS_ORA_TNAME = "ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_PROGRESS";
const char *const OB_ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY_ORA_TNAME = "ALL_VIRTUAL_MACRO_BLOCK_HA_TASK_HISTORY";
const char *const OB_ALL_VIRTUAL_ROUTINE_LOAD_JOB_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_ROUTINE_LOAD_JOB_REAL_AGENT";
const char *const OB_ALL_VIRTUAL_EXTERNAL_RESOURCE_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_EXTERNAL_RESOURCE_REAL_AGENT";
const char *const OB_ALL_VIRTUAL_JAVA_POLICY_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_JAVA_POLICY_REAL_AGENT";
const char *const OB_ALL_VIRTUAL_TENANT_WORKER_GROUP_ORA_TNAME = "ALL_VIRTUAL_TENANT_WORKER_GROUP";
const char *const OB_ALL_VIRTUAL_KEYWORD_ORA_TNAME = "ALL_VIRTUAL_KEYWORD";
const char *const OB_ALL_VIRTUAL_TABLE_OPT_STAT_INVALIDATE_PLAN_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_TABLE_OPT_STAT_INVALIDATE_PLAN_REAL_AGENT";
const char *const OB_ALL_VIRTUAL_SYS_VARIABLE_HISTORY_ORA_TNAME = "ALL_VIRTUAL_SYS_VARIABLE_HISTORY";
const char *const OB_ALL_VIRTUAL_MVIEW_REFRESH_PENDING_TASK_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_MVIEW_REFRESH_PENDING_TASK_REAL_AGENT";
...
const char *const OB_DBA_OB_OBJECT_BALANCE_WEIGHT_TNAME = "DBA_OB_OBJECT_BALANCE_WEIGHT";
const char *const OB_CDB_OB_OBJECT_BALANCE_WEIGHT_TNAME = "CDB_OB_OBJECT_BALANCE_WEIGHT";
...
const char *const OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_TNAME = "DBA_OB_TENANT_FLASHBACK_LOG_SCN";
const char *const OB_CDB_OB_TENANT_FLASHBACK_LOG_SCN_TNAME = "CDB_OB_TENANT_FLASHBACK_LOG_SCN";
...
const char *const OB_DBA_OB_EXTERNAL_RESOURCES_TNAME = "DBA_OB_EXTERNAL_RESOURCES";
const char *const OB_CDB_OB_EXTERNAL_RESOURCES_TNAME = "CDB_OB_EXTERNAL_RESOURCES";
const char *const OB_V_OB_SS_SSTABLES_TNAME = "V$OB_SS_SSTABLES";
...
const char *const OB_CDB_OB_BACKUP_VALIDATE_JOBS_TNAME = "CDB_OB_BACKUP_VALIDATE_JOBS";
const char *const OB_CDB_OB_BACKUP_VALIDATE_JOB_HISTORY_TNAME = "CDB_OB_BACKUP_VALIDATE_JOB_HISTORY";
const char *const OB_CDB_OB_BACKUP_VALIDATE_TASKS_TNAME = "CDB_OB_BACKUP_VALIDATE_TASKS";
const char *const OB_CDB_OB_BACKUP_VALIDATE_TASK_HISTORY_TNAME = "CDB_OB_BACKUP_VALIDATE_TASK_HISTORY";
const char *const OB_DBA_OB_BACKUP_VALIDATE_JOBS_TNAME = "DBA_OB_BACKUP_VALIDATE_JOBS";
const char *const OB_DBA_OB_BACKUP_VALIDATE_JOB_HISTORY_TNAME = "DBA_OB_BACKUP_VALIDATE_JOB_HISTORY";
const char *const OB_DBA_OB_BACKUP_VALIDATE_TASKS_TNAME = "DBA_OB_BACKUP_VALIDATE_TASKS";
const char *const OB_DBA_OB_BACKUP_VALIDATE_TASK_HISTORY_TNAME = "DBA_OB_BACKUP_VALIDATE_TASK_HISTORY";
...
const char *const OB_CDB_OB_SS_SPACE_USAGE_TNAME = "CDB_OB_SS_SPACE_USAGE";
const char *const OB_DBA_OB_SS_SPACE_USAGE_TNAME = "DBA_OB_SS_SPACE_USAGE";
const char *const OB_GV_OB_HMS_CLIENT_POOL_STAT_TNAME = "GV$OB_HMS_CLIENT_POOL_STAT";
const char *const OB_V_OB_HMS_CLIENT_POOL_STAT_TNAME = "V$OB_HMS_CLIENT_POOL_STAT";
...
const char *const OB_GV_OB_SS_OBJECT_TYPE_IO_STAT_TNAME = "GV$OB_SS_OBJECT_TYPE_IO_STAT";
const char *const OB_V_OB_SS_OBJECT_TYPE_IO_STAT_TNAME = "V$OB_SS_OBJECT_TYPE_IO_STAT";
const char *const OB_GV_OB_EXTERNAL_CATALOG_CLIENT_POOL_STAT_TNAME = "GV$OB_EXTERNAL_CATALOG_CLIENT_POOL_STAT";
const char *const OB_V_OB_EXTERNAL_CATALOG_CLIENT_POOL_STAT_TNAME = "V$OB_EXTERNAL_CATALOG_CLIENT_POOL_STAT";
const char *const OB_DBA_TABLES_TNAME = "DBA_TABLES";
const char *const OB_DBA_OB_LOB_CHECK_TASKS_TNAME = "DBA_OB_LOB_CHECK_TASKS";
const char *const OB_CDB_OB_LOB_CHECK_TASKS_TNAME = "CDB_OB_LOB_CHECK_TASKS";
const char *const OB_DBA_OB_LOB_CHECK_EXCEPTION_RESULT_TNAME = "DBA_OB_LOB_CHECK_EXCEPTION_RESULT";
const char *const OB_CDB_OB_LOB_CHECK_EXCEPTION_RESULT_TNAME = "CDB_OB_LOB_CHECK_EXCEPTION_RESULT";
const char *const OB_DBA_OB_TTL_TASKS_TNAME = "DBA_OB_TTL_TASKS";
const char *const OB_DBA_OB_TTL_TASK_HISTORY_TNAME = "DBA_OB_TTL_TASK_HISTORY";
const char *const OB_CDB_OB_TTL_TASKS_TNAME = "CDB_OB_TTL_TASKS";
const char *const OB_CDB_OB_TTL_TASK_HISTORY_TNAME = "CDB_OB_TTL_TASK_HISTORY";
const char *const OB_GV_OB_TABLET_REPLICA_INFO_TNAME = "GV$OB_TABLET_REPLICA_INFO";
const char *const OB_V_OB_TABLET_REPLICA_INFO_TNAME = "V$OB_TABLET_REPLICA_INFO";
const char *const OB_DBA_OB_ROUTINE_LOAD_JOBS_TNAME = "DBA_OB_ROUTINE_LOAD_JOBS";
const char *const OB_CDB_OB_ROUTINE_LOAD_JOBS_TNAME = "CDB_OB_ROUTINE_LOAD_JOBS";
const char *const OB_GV_OB_SS_LOCAL_CACHE_DIAGNOSE_TNAME = "GV$OB_SS_LOCAL_CACHE_DIAGNOSE";
const char *const OB_V_OB_SS_LOCAL_CACHE_DIAGNOSE_TNAME = "V$OB_SS_LOCAL_CACHE_DIAGNOSE";
const char *const OB_GV_OB_SINDI_INDEX_INFO_TNAME = "GV$OB_SINDI_INDEX_INFO";
const char *const OB_V_OB_SINDI_INDEX_INFO_TNAME = "V$OB_SINDI_INDEX_INFO";
const char *const OB_GV_OB_HNSW_INDEX_SEGMENT_INFO_TNAME = "GV$OB_HNSW_INDEX_SEGMENT_INFO";
const char *const OB_V_OB_HNSW_INDEX_SEGMENT_INFO_TNAME = "V$OB_HNSW_INDEX_SEGMENT_INFO";
const char *const OB_DBA_JAVA_POLICY_TNAME = "DBA_JAVA_POLICY";
const char *const OB_USER_JAVA_POLICY_TNAME = "USER_JAVA_POLICY";
const char *const OB_DBA_SCHEDULER_RUNNING_JOBS_TNAME = "DBA_SCHEDULER_RUNNING_JOBS";
const char *const OB_CDB_SCHEDULER_RUNNING_JOBS_TNAME = "CDB_SCHEDULER_RUNNING_JOBS";
const char *const OB_CDB_SCHEDULER_JOBS_TNAME = "CDB_SCHEDULER_JOBS";
const char *const OB_GV_OB_TENANT_WORKER_GROUPS_TNAME = "GV$OB_TENANT_WORKER_GROUPS";
const char *const OB_V_OB_KEYWORDS_TNAME = "V$OB_KEYWORDS";
const char *const OB_DBA_OB_EXTERNAL_TAB_STATISTICS_TNAME = "DBA_OB_EXTERNAL_TAB_STATISTICS";
const char *const OB_DBA_OB_EXTERNAL_TAB_COL_STATISTICS_TNAME = "DBA_OB_EXTERNAL_TAB_COL_STATISTICS";
const char *const OB_DBA_OB_EXTERNAL_PART_COL_STATISTICS_TNAME = "DBA_OB_EXTERNAL_PART_COL_STATISTICS";
const char *const OB_DBA_OB_SYS_VARIABLE_HISTORY_TNAME = "DBA_OB_SYS_VARIABLE_HISTORY";
const char *const OB_CDB_OB_SYS_VARIABLE_HISTORY_TNAME = "CDB_OB_SYS_VARIABLE_HISTORY";
const char *const OB_CDB_MVIEW_DEPS_TNAME = "CDB_MVIEW_DEPS";
const char *const OB_GV_OB_LS_MIGRATION_TASKS_TNAME = "GV$OB_LS_MIGRATION_TASKS";
const char *const OB_V_OB_LS_MIGRATION_TASKS_TNAME = "V$OB_LS_MIGRATION_TASKS";
...
const char *const OB_DBA_TABLES_ORA_TNAME = "DBA_TABLES";
...
const char *const OB_DBA_SCHEDULER_RUNNING_JOBS_ORA_TNAME = "DBA_SCHEDULER_RUNNING_JOBS";
...
const char *const OB_DBA_OB_OBJECT_BALANCE_WEIGHT_ORA_TNAME = "DBA_OB_OBJECT_BALANCE_WEIGHT";
const char *const OB_USER_SCHEDULER_JOBS_ORA_TNAME = "USER_SCHEDULER_JOBS";
const char *const OB_DBA_OB_TENANT_FLASHBACK_LOG_SCN_ORA_TNAME = "DBA_OB_TENANT_FLASHBACK_LOG_SCN";
...
const char *const OB_DBA_OB_BACKUP_VALIDATE_JOBS_ORA_TNAME = "DBA_OB_BACKUP_VALIDATE_JOBS";
const char *const OB_DBA_OB_BACKUP_VALIDATE_JOB_HISTORY_ORA_TNAME = "DBA_OB_BACKUP_VALIDATE_JOB_HISTORY";
const char *const OB_DBA_OB_BACKUP_VALIDATE_TASKS_ORA_TNAME = "DBA_OB_BACKUP_VALIDATE_TASKS";
const char *const OB_DBA_OB_BACKUP_VALIDATE_TASK_HISTORY_ORA_TNAME = "DBA_OB_BACKUP_VALIDATE_TASK_HISTORY";
const char *const OB_DBA_OB_SS_SPACE_USAGE_ORA_TNAME = "DBA_OB_SS_SPACE_USAGE";
...
const char *const OB_DBA_JAVA_POLICY_ORA_TNAME = "DBA_JAVA_POLICY";
const char *const OB_USER_JAVA_POLICY_ORA_TNAME = "USER_JAVA_POLICY";
const char *const OB_V_OB_KEYWORDS_ORA_TNAME = "V$OB_KEYWORDS";
...
const char *const OB_GV_OB_RESULT_CACHE_OBJECTS_ORA_TNAME = "GV$OB_RESULT_CACHE_OBJECTS";
const char *const OB_V_OB_RESULT_CACHE_OBJECTS_ORA_TNAME = "V$OB_RESULT_CACHE_OBJECTS";
const char *const OB_ALL_LOCATIONS_TNAME = "ALL_LOCATIONS";
const char *const OB_V_OB_SS_SSTABLES_ORA_TNAME = "V$OB_SS_SSTABLES";
const char *const OB_DBA_OB_PL_OBJ_CACHE_STATUS_ORA_TNAME = "DBA_OB_PL_OBJ_CACHE_STATUS";
const char *const OB_GV_OB_HMS_CLIENT_POOL_STAT_ORA_TNAME = "GV$OB_HMS_CLIENT_POOL_STAT";
const char *const OB_V_OB_HMS_CLIENT_POOL_STAT_ORA_TNAME = "V$OB_HMS_CLIENT_POOL_STAT";
const char *const OB_DBA_OB_LOB_CHECK_TASKS_ORA_TNAME = "DBA_OB_LOB_CHECK_TASKS";
const char *const OB_DBA_OB_LOB_CHECK_EXCEPTION_RESULT_ORA_TNAME = "DBA_OB_LOB_CHECK_EXCEPTION_RESULT";
const char *const OB_DBA_OB_SENSITIVE_RULES_ORA_TNAME = "DBA_OB_SENSITIVE_RULES";
const char *const OB_DBA_OB_SENSITIVE_COLUMNS_ORA_TNAME = "DBA_OB_SENSITIVE_COLUMNS";
const char *const OB_DBA_OB_SENSITIVE_RULE_PLAINACCESS_USERS_ORA_TNAME = "DBA_OB_SENSITIVE_RULE_PLAINACCESS_USERS";
const char *const OB_DBA_OB_TTL_TASKS_ORA_TNAME = "DBA_OB_TTL_TASKS";
const char *const OB_DBA_OB_TTL_TASK_HISTORY_ORA_TNAME = "DBA_OB_TTL_TASK_HISTORY";
const char *const OB_DBA_OB_ROUTINE_LOAD_JOBS_ORA_TNAME = "DBA_OB_ROUTINE_LOAD_JOBS";
const char *const OB_GV_OB_TENANT_WORKER_GROUPS_ORA_TNAME = "GV$OB_TENANT_WORKER_GROUPS";
const char *const OB_DBA_OB_SYS_VARIABLE_HISTORY_ORA_TNAME = "DBA_OB_SYS_VARIABLE_HISTORY";
...
const char *const OB_ALL_OBJECT_BALANCE_WEIGHT_AUX_LOB_META_TNAME = "__all_object_balance_weight_aux_lob_meta";
...
const char *const OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_META_TNAME = "__all_tenant_flashback_log_scn_aux_lob_meta";
...
const char *const OB_ALL_BALANCE_JOB_DESCRIPTION_AUX_LOB_META_TNAME = "__all_balance_job_description_aux_lob_meta";
...
const char *const OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_META_TNAME = "__all_external_resource_aux_lob_meta";
const char *const OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_META_TNAME = "__all_external_resource_history_aux_lob_meta";
...
const char *const OB_ALL_BACKUP_VALIDATE_JOB_AUX_LOB_META_TNAME = "__all_backup_validate_job_aux_lob_meta";
const char *const OB_ALL_BACKUP_VALIDATE_JOB_HISTORY_AUX_LOB_META_TNAME = "__all_backup_validate_job_history_aux_lob_meta";
const char *const OB_ALL_BACKUP_VALIDATE_TASK_AUX_LOB_META_TNAME = "__all_backup_validate_task_aux_lob_meta";
const char *const OB_ALL_BACKUP_VALIDATE_TASK_HISTORY_AUX_LOB_META_TNAME = "__all_backup_validate_task_history_aux_lob_meta";
const char *const OB_ALL_BACKUP_VALIDATE_LS_TASK_AUX_LOB_META_TNAME = "__all_backup_validate_ls_task_aux_lob_meta";
const char *const OB_ALL_BACKUP_VALIDATE_LS_TASK_HISTORY_AUX_LOB_META_TNAME = "__all_backup_validate_ls_task_history_aux_lob_meta";
const char *const OB_ALL_TENANT_SS_STORAGE_STAT_AUX_LOB_META_TNAME = "__all_tenant_ss_storage_stat_aux_lob_meta";
...
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_META_TNAME = "__all_tenant_macro_block_ha_task_aux_lob_meta";
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_META_TNAME = "__all_tenant_macro_block_ha_task_progress_aux_lob_meta";
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_META_TNAME = "__all_tenant_macro_block_ha_task_history_aux_lob_meta";
const char *const OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_AUX_LOB_META_TNAME = "__all_tablet_to_global_temporary_table_aux_lob_meta";
const char *const OB_WR_SQLSTAT_V2_AUX_LOB_META_TNAME = "__wr_sqlstat_v2_aux_lob_meta";
const char *const OB_ALL_LOB_CHECK_EXCEPTION_RESULT_AUX_LOB_META_TNAME = "__all_lob_check_exception_result_aux_lob_meta";
const char *const OB_ALL_ROUTINE_LOAD_JOB_AUX_LOB_META_TNAME = "__all_routine_load_job_aux_lob_meta";
const char *const OB_ALL_SS_GC_RESERVED_SNAPSHOT_AUX_LOB_META_TNAME = "__all_ss_gc_reserved_snapshot_aux_lob_meta";
const char *const OB_ALL_TABLE_ARCHIVE_HISTORY_AUX_LOB_META_TNAME = "__all_table_archive_history_aux_lob_meta";
const char *const OB_ALL_JAVA_POLICY_AUX_LOB_META_TNAME = "__all_java_policy_aux_lob_meta";
const char *const OB_ALL_JAVA_POLICY_HISTORY_AUX_LOB_META_TNAME = "__all_java_policy_history_aux_lob_meta";
const char *const OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_META_TNAME = "__all_catalog_table_stat_aux_lob_meta";
const char *const OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_META_TNAME = "__all_catalog_column_stat_aux_lob_meta";
const char *const OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_META_TNAME = "__all_catalog_table_opt_stat_gather_history_aux_lob_meta";
const char *const OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_AUX_LOB_META_TNAME = "__all_audit_log_encryption_password_aux_lob_meta";
const char *const OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_META_TNAME = "__all_optstat_catalog_user_prefs_aux_lob_meta";
const char *const OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_META_TNAME = "__all_optstat_catalog_global_prefs_aux_lob_meta";
const char *const OB_ALL_TABLE_OPT_STAT_INVALIDATE_PLAN_AUX_LOB_META_TNAME = "__all_table_opt_stat_invalidate_plan_aux_lob_meta";
const char *const OB_ALL_MVIEW_REFRESH_PENDING_TASK_AUX_LOB_META_TNAME = "__all_mview_refresh_pending_task_aux_lob_meta";
...
const char *const OB_ALL_OBJECT_BALANCE_WEIGHT_AUX_LOB_PIECE_TNAME = "__all_object_balance_weight_aux_lob_piece";
...
const char *const OB_ALL_TENANT_FLASHBACK_LOG_SCN_AUX_LOB_PIECE_TNAME = "__all_tenant_flashback_log_scn_aux_lob_piece";
...
const char *const OB_ALL_BALANCE_JOB_DESCRIPTION_AUX_LOB_PIECE_TNAME = "__all_balance_job_description_aux_lob_piece";
...
const char *const OB_ALL_EXTERNAL_RESOURCE_AUX_LOB_PIECE_TNAME = "__all_external_resource_aux_lob_piece";
const char *const OB_ALL_EXTERNAL_RESOURCE_HISTORY_AUX_LOB_PIECE_TNAME = "__all_external_resource_history_aux_lob_piece";
...
const char *const OB_ALL_BACKUP_VALIDATE_JOB_AUX_LOB_PIECE_TNAME = "__all_backup_validate_job_aux_lob_piece";
const char *const OB_ALL_BACKUP_VALIDATE_JOB_HISTORY_AUX_LOB_PIECE_TNAME = "__all_backup_validate_job_history_aux_lob_piece";
const char *const OB_ALL_BACKUP_VALIDATE_TASK_AUX_LOB_PIECE_TNAME = "__all_backup_validate_task_aux_lob_piece";
const char *const OB_ALL_BACKUP_VALIDATE_TASK_HISTORY_AUX_LOB_PIECE_TNAME = "__all_backup_validate_task_history_aux_lob_piece";
const char *const OB_ALL_BACKUP_VALIDATE_LS_TASK_AUX_LOB_PIECE_TNAME = "__all_backup_validate_ls_task_aux_lob_piece";
const char *const OB_ALL_BACKUP_VALIDATE_LS_TASK_HISTORY_AUX_LOB_PIECE_TNAME = "__all_backup_validate_ls_task_history_aux_lob_piece";
const char *const OB_ALL_TENANT_SS_STORAGE_STAT_AUX_LOB_PIECE_TNAME = "__all_tenant_ss_storage_stat_aux_lob_piece";
...
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_AUX_LOB_PIECE_TNAME = "__all_tenant_macro_block_ha_task_aux_lob_piece";
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_PROGRESS_AUX_LOB_PIECE_TNAME = "__all_tenant_macro_block_ha_task_progress_aux_lob_piece";
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_HISTORY_AUX_LOB_PIECE_TNAME = "__all_tenant_macro_block_ha_task_history_aux_lob_piece";
const char *const OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_AUX_LOB_PIECE_TNAME = "__all_tablet_to_global_temporary_table_aux_lob_piece";
const char *const OB_WR_SQLSTAT_V2_AUX_LOB_PIECE_TNAME = "__wr_sqlstat_v2_aux_lob_piece";
const char *const OB_ALL_LOB_CHECK_EXCEPTION_RESULT_AUX_LOB_PIECE_TNAME = "__all_lob_check_exception_result_aux_lob_piece";
const char *const OB_ALL_ROUTINE_LOAD_JOB_AUX_LOB_PIECE_TNAME = "__all_routine_load_job_aux_lob_piece";
const char *const OB_ALL_SS_GC_RESERVED_SNAPSHOT_AUX_LOB_PIECE_TNAME = "__all_ss_gc_reserved_snapshot_aux_lob_piece";
const char *const OB_ALL_TABLE_ARCHIVE_HISTORY_AUX_LOB_PIECE_TNAME = "__all_table_archive_history_aux_lob_piece";
const char *const OB_ALL_JAVA_POLICY_AUX_LOB_PIECE_TNAME = "__all_java_policy_aux_lob_piece";
const char *const OB_ALL_JAVA_POLICY_HISTORY_AUX_LOB_PIECE_TNAME = "__all_java_policy_history_aux_lob_piece";
const char *const OB_ALL_CATALOG_TABLE_STAT_AUX_LOB_PIECE_TNAME = "__all_catalog_table_stat_aux_lob_piece";
const char *const OB_ALL_CATALOG_COLUMN_STAT_AUX_LOB_PIECE_TNAME = "__all_catalog_column_stat_aux_lob_piece";
const char *const OB_ALL_CATALOG_TABLE_OPT_STAT_GATHER_HISTORY_AUX_LOB_PIECE_TNAME = "__all_catalog_table_opt_stat_gather_history_aux_lob_piece";
const char *const OB_ALL_AUDIT_LOG_ENCRYPTION_PASSWORD_AUX_LOB_PIECE_TNAME = "__all_audit_log_encryption_password_aux_lob_piece";
const char *const OB_ALL_OPTSTAT_CATALOG_USER_PREFS_AUX_LOB_PIECE_TNAME = "__all_optstat_catalog_user_prefs_aux_lob_piece";
const char *const OB_ALL_OPTSTAT_CATALOG_GLOBAL_PREFS_AUX_LOB_PIECE_TNAME = "__all_optstat_catalog_global_prefs_aux_lob_piece";
const char *const OB_ALL_TABLE_OPT_STAT_INVALIDATE_PLAN_AUX_LOB_PIECE_TNAME = "__all_table_opt_stat_invalidate_plan_aux_lob_piece";
const char *const OB_ALL_MVIEW_REFRESH_PENDING_TASK_AUX_LOB_PIECE_TNAME = "__all_mview_refresh_pending_task_aux_lob_piece";
...
const char *const OB_ALL_VIRTUAL_TABLET_SSTABLE_MACRO_INFO_ALL_VIRTUAL_TABLET_SSTABLE_MACRO_INFO_I1_TNAME = "__idx_11056_all_virtual_tablet_sstable_macro_info_i1";
const char *const OB_ALL_VIRTUAL_TABLE_MGR_ALL_VIRTUAL_TABLE_MGR_I1_TNAME = "__idx_12034_all_virtual_table_mgr_i1";
...
const char *const OB_ALL_VIRTUAL_TABLE_MGR_ORA_ALL_VIRTUAL_TABLE_MGR_I1_TNAME = "__idx_15094_all_virtual_table_mgr_i1";
...
const char *const OB_ALL_TENANT_LOCATION_IDX_LOCATION_NAME_TNAME = "__idx_550_idx_location_name";
const char *const OB_ALL_TENANT_OBJAUTH_MYSQL_IDX_OBJAUTH_MYSQL_USER_ID_TNAME = "__idx_552_idx_objauth_mysql_user_id";
const char *const OB_ALL_TENANT_OBJAUTH_MYSQL_IDX_OBJAUTH_MYSQL_OBJ_NAME_TNAME = "__idx_552_idx_objauth_mysql_obj_name";
const char *const OB_ALL_EXTERNAL_RESOURCE_IDX_NAME_DBID_EXTERNAL_RESOURCE_TNAME = "__idx_554_idx_name_dbid_external_resource";
const char *const OB_ALL_AI_MODEL_ENDPOINT_IDX_ENDPOINT_NAME_TNAME = "__idx_572_idx_endpoint_name";
const char *const OB_ALL_AI_MODEL_ENDPOINT_IDX_AI_MODEL_NAME_TNAME = "__idx_572_idx_ai_model_name";
const char *const OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_IDX_TEMP_TABLE_ID_SESSION_ID_TNAME = "__idx_577_idx_temp_table_id_session_id";
const char *const OB_ALL_TABLET_TO_GLOBAL_TEMPORARY_TABLE_IDX_TEMP_SESSION_ID_TABLE_ID_TNAME = "__idx_577_idx_temp_session_id_table_id";
const char *const OB_ALL_ROUTINE_LOAD_JOB_IDX_ROUTINE_LOAD_JOB_NAME_TNAME = "__idx_583_idx_routine_load_job_name";
const char *const OB_ALL_TENANT_MACRO_BLOCK_HA_TASK_IDX_HA_TASK_STATUS_TNAME = "__idx_574_idx_ha_task_status";
...
const char *const OB_ALL_VIRTUAL_TENANT_LOCATION_REAL_AGENT_ORA_IDX_LOCATION_NAME_REAL_AGENT_TNAME = "__idx_15511_idx_location_name_real_agent";
const char *const OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_IDX_OBJAUTH_MYSQL_USER_ID_REAL_AGENT_TNAME = "__idx_15512_idx_objauth_mysql_user_id_real_agent";
const char *const OB_ALL_VIRTUAL_TENANT_OBJAUTH_MYSQL_REAL_AGENT_ORA_IDX_OBJAUTH_MYSQL_OBJ_NAME_REAL_AGENT_TNAME = "__idx_15512_idx_objauth_mysql_obj_name_real_agent";
