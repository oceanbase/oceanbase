...
const uint64_t OB_ALL_VIRTUAL_SPM_EVO_RESULT_REAL_AGENT_ORA_TID = 15466; // "ALL_VIRTUAL_SPM_EVO_RESULT_REAL_AGENT_ORA"
...
const char *const OB_ALL_VIRTUAL_SPM_EVO_RESULT_REAL_AGENT_ORA_TNAME = "ALL_VIRTUAL_SPM_EVO_RESULT_REAL_AGENT";
