...
const uint64_t OB_TENANT_VIRTUAL_EXTERNAL_TABLE_ERROR_TID = 12040; // "__tenant_virtual_external_table_error"
...
const char *const OB_TENANT_VIRTUAL_EXTERNAL_TABLE_ERROR_TNAME = "__tenant_virtual_external_table_error";
