...
int ObInnerTableSchema::all_virtual_tenant_scheduler_job_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ObObj allow_runs_in_restricted_mode_default;
    allow_runs_in_restricted_mode_default.set_tinyint(0);
    ADD_COLUMN_SCHEMA_T("allow_runs_in_restricted_mode", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      true, //is_nullable
      false, //is_autoincrement
      allow_runs_in_restricted_mode_default,
      allow_runs_in_restricted_mode_default); //default_value
  }
  table_schema.set_index_using_type(USING_BTREE);
  table_schema.set_row_store_type(ENCODING_ROW_STORE);
  table_schema.set_store_format(OB_STORE_FORMAT_DYNAMIC_MYSQL);
...
int ObInnerTableSchema::all_virtual_unit_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ObObj data_disk_allocated_default;
    data_disk_allocated_default.set_int(0);
    ADD_COLUMN_SCHEMA_T("data_disk_allocated", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      true, //is_nullable
      false, //is_autoincrement
      data_disk_allocated_default,
      data_disk_allocated_default); //default_value
  }
  if (OB_SUCC(ret)) {
    table_schema.get_part_option().set_part_num(1);
    table_schema.set_part_level(PARTITION_LEVEL_ONE);
...
int ObInnerTableSchema::all_virtual_merge_info_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ObObj merge_mode_default;
    merge_mode_default.set_int(0);
    ADD_COLUMN_SCHEMA_T("merge_mode", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      false, //is_autoincrement
      merge_mode_default,
      merge_mode_default); //default_value
  }
  table_schema.set_index_using_type(USING_BTREE);
  table_schema.set_row_store_type(ENCODING_ROW_STORE);
  table_schema.set_store_format(OB_STORE_FORMAT_DYNAMIC_MYSQL);
