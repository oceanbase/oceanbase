...
int ObInnerTableSchema::all_virtual_ai_gateway_endpoint_stat_schema(ObTableSchema &table_schema)
{
  int ret = OB_SUCCESS;
  uint64_t column_id = OB_APP_MIN_COLUMN_ID - 1;
  ...
  table_schema.set_tablegroup_id(OB_INVALID_ID);
  table_schema.set_database_id(OB_SYS_DATABASE_ID);
  table_schema.set_table_id(OB_ALL_VIRTUAL_AI_GATEWAY_ENDPOINT_STAT_TID);
  table_schema.set_rowkey_split_pos(0);
  table_schema.set_is_use_bloomfilter(false);
  table_schema.set_progressive_merge_num(0);
  ...
  if (OB_SUCC(ret)) {
    if (OB_FAIL(table_schema.set_table_name(OB_ALL_VIRTUAL_AI_GATEWAY_ENDPOINT_STAT_TNAME))) {
      LOG_ERROR("fail to set table_name", K(ret));
    }
  }
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("gateway_name", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("routing_status", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("failure_rate", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA_TS("blocked_until_ts", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA_TS("last_failed_ts", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
