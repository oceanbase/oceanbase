...
constexpr int OB_ERR_MULTIPLE_CONSTRAINTS_WITH_SAME_NAME = -5937;
constexpr int OB_ERR_NON_BOOLEAN_EXPR_FOR_CHECK_CONSTRAINT = -5938;
constexpr int OB_ERR_CHECK_CONSTRAINT_NOT_FOUND = -5939;
constexpr int OB_ERR_ALTER_CONSTRAINT_ENFORCEMENT_NOT_SUPPORTED = -5940;
constexpr int OB_ERR_CHECK_CONSTRAINT_REFERS_AUTO_INCREMENT_COLUMN = -5941;
constexpr int OB_ERR_CHECK_CONSTRAINT_NAMED_FUNCTION_IS_NOT_ALLOWED = -5942;
constexpr int OB_ERR_CHECK_CONSTRAINT_FUNCTION_IS_NOT_ALLOWED = -5943;
constexpr int OB_ERR_CHECK_CONSTRAINT_VARIABLES = -5944;
constexpr int OB_ERR_CHECK_CONSTRAINT_REFERS_UNKNOWN_COLUMN = -5945;
...
#define OB_ER_COMMIT_NOT_ALLOWED_IN_SF_OR_TRG__USER_ERROR_MSG "Explicit or implicit commit is not allowed in stored function."
...
#define OB_ERR_TABLE_IS_REFERENCED__USER_ERROR_MSG "Cannot delete or update a parent row: a foreign key constraint fails"
...
#define OB_ERR_DOWNGRADE_PARALLEL_MAX_SERVERS__USER_ERROR_MSG "parallel_max_servers downgrade due to insufficent cpu resource from %ld to %ld"
...
#define OB_ERR_MUTATING_TABLE_OPERATION__USER_ERROR_MSG "table '%.*s'.'%.*s' is mutating, trigger/function may not see it"
...
#define OB_NO_CS_SELECTED__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4053, No ChunkServer selected"
...
#define OB_CS_OUTOF_DISK_SPACE__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4184, ChunkServer out of disk space"
#define OB_COLUMN_GROUP_NOT_FOUND__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4185, Column group not found"
#define OB_CS_COMPRESS_LIB_ERROR__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4186, ChunkServer failed to get compress library"
...
#define OB_MAJOR_FREEZE_NOT_FINISHED__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4213, last major freeze not finish"
...
#define OB_ERR_TRUNCATED_WRONG_VALUE_FOR_FIELD__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4226, Incorrect integer value: '%.*s'"
...
#define OB_ERR_DISTRIBUTED_NOT_SUPPORTED__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4259, %s not supported"
...
#define OB_RAID_SUPER_BLOCK_NOT_MATCH__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4339, raid super block not match"
...
#define OB_MACHINE_RESOURCE_NOT_ENOUGH__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4624,  machine resource \'%s\' is not enough to hold a new unit"
#define OB_NOT_SERVER_CAN_HOLD_SOFTLY__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4625, not server can hole the unit and not over soft limit"
...
#define OB_INVALID_RESOURCE_UNIT__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -4659, invalid resource unit, %s\'s min value is %s"
...
#define OB_ERR_KEY_COLUMN_DOES_NOT_EXITS__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5211, Key column '%.*s' doesn't exist in table"
...
#define OB_ERR_CANT_EXECUTE_IN_READ_ONLY_TRANSACTION__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5220, Cannot execute statement in a READ ONLY transaction."
...
#define OB_ERR_VIEW_INVALID__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5231, View \'%.*s.%.*s\' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them"
...
#define OB_ERR_VIEW_WRONG_LIST__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5242, View's SELECT and view's field list have different column counts"
...
#define OB_NON_DEFAULT_VALUE_FOR_GENERATED_COLUMN__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5290, The value specified for generated column '%.*s' in table '%.*s' is not allowed"
...
#define OB_ERR_DROP_PARTITION_NON_EXISTENT__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5303, Error in list of partitions to %s"
...
#define OB_ERR_SCHEDULER_THREAD_NOT_ENOUGH__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5307, Scheduler thread number is not enough"
...
#define OB_ERR_SP_COND_MISMATCH__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5545, Undefined CONDITION: %.*s"
...
#define OB_ER_STMT_NOT_ALLOWED_IN_SF_OR_TRG__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5569, %s is not allowed in stored function"
...
#define OB_ER_COMMIT_NOT_ALLOWED_IN_SF_OR_TRG__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5576, Explicit or implicit commit is not allowed in stored function."
...
#define OB_ER_SP_NO_RETSET__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5579, Not allowed to return a result set in pl function"
...
#define OB_ER_SP_CANT_SET_AUTOCOMMIT__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5591, Not allowed to set autocommit from a stored function"
...
#define OB_ERR_DOWNGRADE_PARALLEL_MAX_SERVERS__ORA_USER_ERROR_MSG "ORA-00000: parallel_max_servers downgrade due to insufficent cpu resource from %ld to %ld"
...
#define OB_ERR_CANNOT_RENAME_SYSTEM_GENERATED_SEQUENCE__ORA_USER_ERROR_MSG "ORA-32798: cannot rename a system-generated sequence"
...
#define OB_ERR_MULTIPLE_CONSTRAINTS_WITH_SAME_NAME__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5937, Table has multiple constraints with the name \'%.*s\'. Please use constraint specific \'%.*s\' clause."
#define OB_ERR_NON_BOOLEAN_EXPR_FOR_CHECK_CONSTRAINT__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5938, An expression of non-boolean type specified to a check constraint \'%.*s\'"
#define OB_ERR_CHECK_CONSTRAINT_NOT_FOUND__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5939, Check constraint \'%.*s\' is not found in the table."
#define OB_ERR_ALTER_CONSTRAINT_ENFORCEMENT_NOT_SUPPORTED__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5940, Altering constraint enforcement is not supported for the constraint \'%.*s\'. Enforcement state alter is not supported for the PRIMARY, UNIQUE and FOREIGN KEY type constraints."
#define OB_ERR_CHECK_CONSTRAINT_REFERS_AUTO_INCREMENT_COLUMN__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5941, Check constraint \'%.*s\' cannot refer to an auto-increment column."
#define OB_ERR_CHECK_CONSTRAINT_NAMED_FUNCTION_IS_NOT_ALLOWED__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5942, An expression of a check constraint \'%.*s\' contains disallowed function: %.*s."
#define OB_ERR_CHECK_CONSTRAINT_FUNCTION_IS_NOT_ALLOWED__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5943, An expression of a check constraint \'%.*s\' contains disallowed function"
#define OB_ERR_CHECK_CONSTRAINT_VARIABLES__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5944, An expression of a check constraint \'%.*s\' cannot refer to a user or system variable."
#define OB_ERR_CHECK_CONSTRAINT_REFERS_UNKNOWN_COLUMN__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -5945, Check constraint \'%.*s\' refers to non-existing column \'%.*s\'."
...
#define OB_TRANS_STMT_TIMEOUT__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -6212, Statement is timeout"
...
#define OB_ERR_READ_ONLY_TRANSACTION__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -6226, Cannot execute statement in a READ ONLY transaction"
...
#define OB_ERR_DROP_TRUNCATE_PARTITION_REBUILD_INDEX__ORA_USER_ERROR_MSG "ORA-00600: internal error code, arguments: -9055, rebuild global index:'%.*s' failed when drop/truncate partitions"
...
#define OB_ERR_AUTONOMOUS_TRANSACTION_ILLEGAL__ORA_USER_ERROR_MSG "PLS-00710: Pragma AUTONOMOUS_TRANSACTION cannot be specified here"
...
#define OB_ERR_INIT_CONST_ILLEGAL__ORA_USER_ERROR_MSG "PLS-00322: Constant declarations should contain initialization assignments"
...
#define OB_ERR_TYPE_SPEC_NOT_EXIST__ORA_USER_ERROR_MSG "PLS-00304: cannot compile body of '%.*s' without its specification"
