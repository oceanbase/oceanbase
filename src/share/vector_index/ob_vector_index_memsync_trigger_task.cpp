...
bool ObVecIdxMemSyncTriggerExecutor::check_operation_allow()
{
  ...
  } else if (tenant_data_version < DATA_VERSION_4_3_5_5) {
    bret = false;
    LOG_DEBUG("memsync trigger task can not work with data version less than 4_3_5_5", K(tenant_data_version));
  }
  return bret;
}
