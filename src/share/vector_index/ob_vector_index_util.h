...
public:
  ...
  static inline bool is_enable_ivf_adaptive_or_iterative_filter()
  {
    ...
    return (GET_MIN_CLUSTER_VERSION() > MOCK_CLUSTER_VERSION_4_3_5_4 && GET_MIN_CLUSTER_VERSION() < CLUSTER_VERSION_4_4_0_0) || GET_MIN_CLUSTER_VERSION() >= CLUSTER_VERSION_4_4_2_0;
  }
