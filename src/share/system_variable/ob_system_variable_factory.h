...
class ObSysVarUseQueryCache : public ObEnumSysVar
{
public:
  const static char * USE_QUERY_CACHE_NAMES[];
public:
  ObSysVarUseQueryCache() : ObEnumSysVar(USE_QUERY_CACHE_NAMES, NULL, NULL, NULL, NULL, NULL) {}
  inline virtual ObSysVarClassType get_type() const { return SYS_VAR_USE_QUERY_CACHE; }
