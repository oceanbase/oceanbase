...
enum ObSysVarClassType
{
  ...
  SYS_VAR_PLSQL_CAN_TRANSFORM_SQL_TO_ASSIGN = 10755,
  SYS_VAR__JOIN_ORDER_ENUM_THRESHOLD = 10756,
  SYS_VAR__OPTIMIZER_MAX_PERMUTATIONS = 10757,
  SYS_VAR__IDP_STEP_REDUCTION_THRESHOLD = 10758,
  SYS_VAR_OB_ENABLE_PL_ASYNC_COMMIT = 10759,
  SYS_VAR_JSON_FLOAT_FULL_PRECISION = 10760,
  SYS_VAR_CACHING_SHA2_PASSWORD_DIGEST_ROUNDS = 10761,
  SYS_VAR_AP_QUERY_ROUTE_POLICY = 10762,
  SYS_VAR_AP_QUERY_COST_THRESHOLD = 10763,
  SYS_VAR_AP_QUERY_REPLICA_FALLBACK = 10764,
  SYS_VAR_OB_UDF_COST_FACTOR = 10765,
  SYS_VAR_OB_UDF_SELECTIVITY = 10766,
  SYS_VAR__ENABLE_PL_COMPOSITE_AS_SQL_UDT = 10767,
  SYS_VAR_OB_RESOURCE_GROUP = 10769,
};
