...
static struct VarsInit{
  VarsInit(){
    ...
    ObSysVars[84].info_ = "The default replica number of table per zone if not specified when creating table." ;
    ObSysVars[84].name_ = "ob_default_replica_num" ;
    ObSysVars[84].data_type_ = ObIntType ;
    ObSysVars[84].value_ = "1" ;
    ObSysVars[84].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[84].id_ = SYS_VAR_OB_DEFAULT_REPLICA_NUM ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_DEFAULT_REPLICA_NUM)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_DEFAULT_REPLICA_NUM] = 84 ;
    ObSysVars[84].alias_ = "OB_SV_DEFAULT_REPLICA_NUM" ;

    ObSysVars[85].info_ = "Indicate how many bytes the interm result manager can alloc most for this tenant" ;
    ObSysVars[85].name_ = "ob_interm_result_mem_limit" ;
    ObSysVars[85].data_type_ = ObIntType ;
    ObSysVars[85].value_ = "2147483648" ;
    ObSysVars[85].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[85].id_ = SYS_VAR_OB_INTERM_RESULT_MEM_LIMIT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_INTERM_RESULT_MEM_LIMIT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_INTERM_RESULT_MEM_LIMIT] = 85 ;
    ObSysVars[85].alias_ = "OB_SV_INTERM_RESULT_MEM_LIMIT" ;

    ObSysVars[86].info_ = "Indicate whether sql stmt hit right partition, readonly to user, modify by ob" ;
    ObSysVars[86].name_ = "ob_proxy_partition_hit" ;
    ObSysVars[86].data_type_ = ObIntType ;
    ObSysVars[86].value_ = "1" ;
    ObSysVars[86].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[86].id_ = SYS_VAR_OB_PROXY_PARTITION_HIT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PROXY_PARTITION_HIT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PROXY_PARTITION_HIT] = 86 ;
    ObSysVars[86].alias_ = "OB_SV_PROXY_PARTITION_HIT" ;

    ObSysVars[87].info_ = "log level in session" ;
    ObSysVars[87].name_ = "ob_log_level" ;
    ObSysVars[87].data_type_ = ObVarcharType ;
    ObSysVars[87].value_ = "disabled" ;
    ObSysVars[87].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[87].id_ = SYS_VAR_OB_LOG_LEVEL ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_LOG_LEVEL)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_LOG_LEVEL] = 87 ;
    ObSysVars[87].alias_ = "OB_SV_LOG_LEVEL" ;

    ObSysVars[88].info_ = "Max parellel sub request to chunkservers for one request" ;
    ObSysVars[88].name_ = "ob_max_parallel_degree" ;
    ObSysVars[88].data_type_ = ObIntType ;
    ObSysVars[88].value_ = "16" ;
    ObSysVars[88].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[88].id_ = SYS_VAR_OB_MAX_PARALLEL_DEGREE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_MAX_PARALLEL_DEGREE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_MAX_PARALLEL_DEGREE] = 88 ;
    ObSysVars[88].alias_ = "OB_SV_MAX_PARALLEL_DEGREE" ;

    ObSysVars[89].info_ = "Query timeout in microsecond(us)" ;
    ObSysVars[89].name_ = "ob_query_timeout" ;
    ObSysVars[89].data_type_ = ObIntType ;
    ObSysVars[89].value_ = "10000000" ;
    ...
    ObSysVars[89].id_ = SYS_VAR_OB_QUERY_TIMEOUT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_QUERY_TIMEOUT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_QUERY_TIMEOUT] = 89 ;
    ObSysVars[89].alias_ = "OB_SV_QUERY_TIMEOUT" ;

    ObSysVars[90].info_ = "read consistency level: 3=STRONG, 2=WEAK, 1=FROZEN" ;
    ObSysVars[90].name_ = "ob_read_consistency" ;
    ObSysVars[90].data_type_ = ObIntType ;
    ObSysVars[90].enum_names_ = "[u'', u'FROZEN', u'WEAK', u'STRONG']" ;
    ObSysVars[90].value_ = "3" ;
    ObSysVars[90].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[90].id_ = SYS_VAR_OB_READ_CONSISTENCY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_READ_CONSISTENCY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_READ_CONSISTENCY] = 90 ;
    ObSysVars[90].alias_ = "OB_SV_READ_CONSISTENCY" ;

    ObSysVars[91].info_ = "whether use transform in session" ;
    ObSysVars[91].name_ = "ob_enable_transformation" ;
    ObSysVars[91].data_type_ = ObIntType ;
    ObSysVars[91].value_ = "1" ;
    ObSysVars[91].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[91].id_ = SYS_VAR_OB_ENABLE_TRANSFORMATION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_TRANSFORMATION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_TRANSFORMATION] = 91 ;
    ObSysVars[91].alias_ = "OB_SV_ENABLE_TRANSFORMATION" ;

    ObSysVars[92].info_ = "The max duration of one transaction" ;
    ObSysVars[92].name_ = "ob_trx_timeout" ;
    ObSysVars[92].data_type_ = ObIntType ;
    ObSysVars[92].value_ = "100000000" ;
    ObSysVars[92].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[92].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_timeout_too_large" ;
    ObSysVars[92].id_ = SYS_VAR_OB_TRX_TIMEOUT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TRX_TIMEOUT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_TRX_TIMEOUT] = 92 ;
    ObSysVars[92].alias_ = "OB_SV_TRX_TIMEOUT" ;

    ObSysVars[93].info_ = "whether use plan cache in session" ;
    ObSysVars[93].name_ = "ob_enable_plan_cache" ;
    ObSysVars[93].data_type_ = ObIntType ;
    ObSysVars[93].value_ = "1" ;
    ObSysVars[93].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[93].id_ = SYS_VAR_OB_ENABLE_PLAN_CACHE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_PLAN_CACHE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_PLAN_CACHE] = 93 ;
    ObSysVars[93].alias_ = "OB_SV_ENABLE_PLAN_CACHE" ;

    ObSysVars[94].info_ = "whether can select from index table" ;
    ObSysVars[94].name_ = "ob_enable_index_direct_select" ;
    ObSysVars[94].data_type_ = ObIntType ;
    ObSysVars[94].value_ = "0" ;
    ObSysVars[94].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[94].id_ = SYS_VAR_OB_ENABLE_INDEX_DIRECT_SELECT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_INDEX_DIRECT_SELECT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_INDEX_DIRECT_SELECT] = 94 ;
    ObSysVars[94].alias_ = "OB_SV_ENABLE_INDEX_DIRECT_SELECT" ;

    ObSysVars[95].info_ = "this value is true if we have executed set transaction stmt, until a transaction commit(explicit or implicit) successfully" ;
    ObSysVars[95].name_ = "ob_proxy_set_trx_executed" ;
    ObSysVars[95].data_type_ = ObIntType ;
    ObSysVars[95].value_ = "0" ;
    ObSysVars[95].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[95].id_ = SYS_VAR_OB_PROXY_SET_TRX_EXECUTED ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PROXY_SET_TRX_EXECUTED)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PROXY_SET_TRX_EXECUTED] = 95 ;
    ObSysVars[95].alias_ = "OB_SV_PROXY_SET_TRX_EXECUTED" ;

    ObSysVars[96].info_ = "enable aggregation function to be push-downed through exchange nodes" ;
    ObSysVars[96].name_ = "ob_enable_aggregation_pushdown" ;
    ObSysVars[96].data_type_ = ObIntType ;
    ObSysVars[96].value_ = "1" ;
    ObSysVars[96].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[96].id_ = SYS_VAR_OB_ENABLE_AGGREGATION_PUSHDOWN ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_AGGREGATION_PUSHDOWN)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_AGGREGATION_PUSHDOWN] = 96 ;
    ObSysVars[96].alias_ = "OB_SV_ENABLE_AGGREGATION_PUSHDOWN" ;

    ObSysVars[97].info_ = "" ;
    ObSysVars[97].name_ = "ob_last_schema_version" ;
    ObSysVars[97].data_type_ = ObIntType ;
    ObSysVars[97].value_ = "0" ;
    ObSysVars[97].flags_ = ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[97].id_ = SYS_VAR_OB_LAST_SCHEMA_VERSION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_LAST_SCHEMA_VERSION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_LAST_SCHEMA_VERSION] = 97 ;
    ObSysVars[97].alias_ = "OB_SV_LAST_SCHEMA_VERSION" ;

    ObSysVars[98].info_ = "Global debug sync facility" ;
    ObSysVars[98].name_ = "ob_global_debug_sync" ;
    ObSysVars[98].data_type_ = ObVarcharType ;
    ObSysVars[98].value_ = "" ;
    ObSysVars[98].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[98].id_ = SYS_VAR_OB_GLOBAL_DEBUG_SYNC ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_GLOBAL_DEBUG_SYNC)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_GLOBAL_DEBUG_SYNC] = 98 ;
    ObSysVars[98].alias_ = "OB_SV_GLOBAL_DEBUG_SYNC" ;

    ObSysVars[99].info_ = "this value is global variables last modified time when server session create, used for proxy to judge whether global vars has changed between two server session" ;
    ObSysVars[99].name_ = "ob_proxy_global_variables_version" ;
    ObSysVars[99].data_type_ = ObIntType ;
    ObSysVars[99].value_ = "0" ;
    ObSysVars[99].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[99].id_ = SYS_VAR_OB_PROXY_GLOBAL_VARIABLES_VERSION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PROXY_GLOBAL_VARIABLES_VERSION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PROXY_GLOBAL_VARIABLES_VERSION] = 99 ;
    ObSysVars[99].alias_ = "OB_SV_PROXY_GLOBAL_VARIABLES_VERSION" ;

    ObSysVars[100].info_ = "control whether use trace log" ;
    ObSysVars[100].name_ = "ob_enable_trace_log" ;
    ObSysVars[100].data_type_ = ObIntType ;
    ObSysVars[100].value_ = "0" ;
    ObSysVars[100].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[100].id_ = SYS_VAR_OB_ENABLE_TRACE_LOG ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_TRACE_LOG)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_TRACE_LOG] = 100 ;
    ObSysVars[100].alias_ = "OB_SV_ENABLE_TRACE_LOG" ;

    ObSysVars[101].info_ = "" ;
    ObSysVars[101].name_ = "ob_enable_hash_group_by" ;
    ObSysVars[101].data_type_ = ObIntType ;
    ObSysVars[101].value_ = "1" ;
    ObSysVars[101].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[101].id_ = SYS_VAR_OB_ENABLE_HASH_GROUP_BY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_HASH_GROUP_BY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_HASH_GROUP_BY] = 101 ;
    ObSysVars[101].alias_ = "OB_SV_ENABLE_HASH_GROUP_BY" ;

    ObSysVars[102].info_ = "" ;
    ObSysVars[102].name_ = "ob_enable_blk_nestedloop_join" ;
    ...
    ObSysVars[102].id_ = SYS_VAR_OB_ENABLE_BLK_NESTEDLOOP_JOIN ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_BLK_NESTEDLOOP_JOIN)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_BLK_NESTEDLOOP_JOIN] = 102 ;
    ObSysVars[102].alias_ = "OB_SV_ENABLE_BLK_NESTEDLOOP_JOIN" ;

    ObSysVars[103].info_ = "" ;
    ObSysVars[103].name_ = "ob_bnl_join_cache_size" ;
    ObSysVars[103].data_type_ = ObIntType ;
    ObSysVars[103].value_ = "10485760" ;
    ObSysVars[103].min_val_ = "1" ;
    ObSysVars[103].max_val_ = "9223372036854775807" ;
    ObSysVars[103].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[103].id_ = SYS_VAR_OB_BNL_JOIN_CACHE_SIZE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_BNL_JOIN_CACHE_SIZE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_BNL_JOIN_CACHE_SIZE] = 103 ;
    ObSysVars[103].alias_ = "OB_SV_BNL_JOIN_CACHE_SIZE" ;

    ObSysVars[104].info_ = "Indicate current client session user privilege, readonly after modified by first observer" ;
    ObSysVars[104].name_ = "ob_proxy_user_privilege" ;
    ObSysVars[104].data_type_ = ObIntType ;
    ObSysVars[104].value_ = "0" ;
    ObSysVars[104].min_val_ = "0" ;
    ObSysVars[104].max_val_ = "9223372036854775807" ;
    ObSysVars[104].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[104].id_ = SYS_VAR_OB_PROXY_USER_PRIVILEGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PROXY_USER_PRIVILEGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PROXY_USER_PRIVILEGE] = 104 ;
    ObSysVars[104].alias_ = "OB_SV_PROXY_USER_PRIVILEGE" ;
    ...
    ObSysVars[105].base_class_ = "ObStrictRangeIntSysVar" ;
    ObSysVars[105].name_ = "ob_org_cluster_id" ;
    ObSysVars[105].data_type_ = ObIntType ;
    ObSysVars[105].value_ = "0" ;
    ObSysVars[105].min_val_ = "0" ;
    ObSysVars[105].max_val_ = "4294967295" ;
    ObSysVars[105].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[105].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_ob_org_cluster_id" ;
    ObSysVars[105].id_ = SYS_VAR_OB_ORG_CLUSTER_ID ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ORG_CLUSTER_ID)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ORG_CLUSTER_ID] = 105 ;
    ObSysVars[105].alias_ = "OB_SV_ORG_CLUSTER_ID" ;

    ObSysVars[106].info_ = "percentage of tenant memory resources that can be used by plan cache" ;
    ObSysVars[106].name_ = "ob_plan_cache_percentage" ;
    ObSysVars[106].data_type_ = ObIntType ;
    ObSysVars[106].value_ = "5" ;
    ObSysVars[106].min_val_ = "0" ;
    ObSysVars[106].max_val_ = "100" ;
    ObSysVars[106].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[106].id_ = SYS_VAR_OB_PLAN_CACHE_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PLAN_CACHE_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PLAN_CACHE_PERCENTAGE] = 106 ;
    ObSysVars[106].alias_ = "OB_SV_PLAN_CACHE_PERCENTAGE" ;

    ObSysVars[107].info_ = "memory usage percentage of plan_cache_limit at which plan cache eviction will be trigger" ;
    ObSysVars[107].name_ = "ob_plan_cache_evict_high_percentage" ;
    ObSysVars[107].data_type_ = ObIntType ;
    ObSysVars[107].value_ = "90" ;
    ObSysVars[107].min_val_ = "0" ;
    ObSysVars[107].max_val_ = "100" ;
    ObSysVars[107].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[107].id_ = SYS_VAR_OB_PLAN_CACHE_EVICT_HIGH_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PLAN_CACHE_EVICT_HIGH_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PLAN_CACHE_EVICT_HIGH_PERCENTAGE] = 107 ;
    ObSysVars[107].alias_ = "OB_SV_PLAN_CACHE_EVICT_HIGH_PERCENTAGE" ;

    ObSysVars[108].info_ = "memory usage percentage  of plan_cache_limit at which plan cache eviction will be stopped" ;
    ObSysVars[108].name_ = "ob_plan_cache_evict_low_percentage" ;
    ObSysVars[108].data_type_ = ObIntType ;
    ObSysVars[108].value_ = "50" ;
    ObSysVars[108].min_val_ = "0" ;
    ObSysVars[108].max_val_ = "100" ;
    ObSysVars[108].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[108].id_ = SYS_VAR_OB_PLAN_CACHE_EVICT_LOW_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PLAN_CACHE_EVICT_LOW_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PLAN_CACHE_EVICT_LOW_PERCENTAGE] = 108 ;
    ObSysVars[108].alias_ = "OB_SV_PLAN_CACHE_EVICT_LOW_PERCENTAGE" ;

    ObSysVars[109].info_ = "When the recycle bin is enabled, dropped tables and their dependent objects are placed in the recycle bin. When the recycle bin is disabled, dropped tables and their dependent objects are not placed in the recycle bin; they are just dropped." ;
    ObSysVars[109].name_ = "recyclebin" ;
    ObSysVars[109].data_type_ = ObIntType ;
    ObSysVars[109].value_ = "0" ;
    ObSysVars[109].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[109].id_ = SYS_VAR_RECYCLEBIN ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RECYCLEBIN)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_RECYCLEBIN] = 109 ;
    ObSysVars[109].alias_ = "OB_SV_RECYCLEBIN" ;

    ObSysVars[110].info_ = "Indicate features that observer supports, readonly after modified by first observer" ;
    ObSysVars[110].name_ = "ob_capability_flag" ;
    ObSysVars[110].data_type_ = ObUInt64Type ;
    ObSysVars[110].value_ = "0" ;
    ObSysVars[110].min_val_ = "0" ;
    ObSysVars[110].max_val_ = "18446744073709551615" ;
    ObSysVars[110].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[110].id_ = SYS_VAR_OB_CAPABILITY_FLAG ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_CAPABILITY_FLAG)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_CAPABILITY_FLAG] = 110 ;
    ObSysVars[110].alias_ = "OB_SV_CAPABILITY_FLAG" ;

    ObSysVars[111].info_ = "The parallel degree of a job in a query, which represent how many tasks of a job can be run parallelly" ;
    ObSysVars[111].name_ = "ob_stmt_parallel_degree" ;
    ObSysVars[111].data_type_ = ObIntType ;
    ObSysVars[111].value_ = "1" ;
    ObSysVars[111].min_val_ = "1" ;
    ObSysVars[111].max_val_ = "10240" ;
    ObSysVars[111].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[111].id_ = SYS_VAR_OB_STMT_PARALLEL_DEGREE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_STMT_PARALLEL_DEGREE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_STMT_PARALLEL_DEGREE] = 111 ;
    ObSysVars[111].alias_ = "OB_SV_STMT_PARALLEL_DEGREE" ;

    ObSysVars[112].info_ = "when query is with topk hint, is_result_accurate indicates whether the result is acuurate or not " ;
    ObSysVars[112].name_ = "is_result_accurate" ;
    ObSysVars[112].data_type_ = ObIntType ;
    ObSysVars[112].value_ = "1" ;
    ObSysVars[112].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[112].id_ = SYS_VAR_IS_RESULT_ACCURATE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_IS_RESULT_ACCURATE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_IS_RESULT_ACCURATE] = 112 ;
    ObSysVars[112].alias_ = "OB_SV_IS_RESULT_ACCURATE" ;

    ObSysVars[113].info_ = "The variable determines how OceanBase should handle an ambiguous boundary datetime value a case in which it is not clear whether the datetime is in standard or daylight saving time" ;
    ObSysVars[113].name_ = "error_on_overlap_time" ;
    ObSysVars[113].data_type_ = ObIntType ;
    ObSysVars[113].value_ = "0" ;
    ObSysVars[113].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[113].id_ = SYS_VAR_ERROR_ON_OVERLAP_TIME ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_ERROR_ON_OVERLAP_TIME)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_ERROR_ON_OVERLAP_TIME] = 113 ;
    ObSysVars[113].alias_ = "OB_SV_ERROR_ON_OVERLAP_TIME" ;

    ObSysVars[114].info_ = "What DBMS is OceanBase compatible with? MYSQL means it behaves like MySQL while ORACLE means it behaves like Oracle." ;
    ObSysVars[114].name_ = "ob_compatibility_mode" ;
    ObSysVars[114].data_type_ = ObIntType ;
    ObSysVars[114].enum_names_ = "[u'MYSQL', u'ORACLE']" ;
    ObSysVars[114].value_ = "0" ;
    ObSysVars[114].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::WITH_UPGRADE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[114].id_ = SYS_VAR_OB_COMPATIBILITY_MODE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_COMPATIBILITY_MODE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_COMPATIBILITY_MODE] = 114 ;
    ObSysVars[114].alias_ = "OB_SV_COMPATIBILITY_MODE" ;
    ...
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_CREATE_TABLE_STRICT_MODE] = 115 ;
    ObSysVars[115].alias_ = "OB_SV_CREATE_TABLE_STRICT_MODE" ;

    ObSysVars[116].info_ = "The percentage limitation of tenant memory for SQL execution." ;
    ObSysVars[116].name_ = "ob_sql_work_area_percentage" ;
    ObSysVars[116].data_type_ = ObIntType ;
    ObSysVars[116].value_ = "5" ;
    ObSysVars[116].min_val_ = "0" ;
    ObSysVars[116].max_val_ = "100" ;
    ObSysVars[116].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[116].id_ = SYS_VAR_OB_SQL_WORK_AREA_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_SQL_WORK_AREA_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_SQL_WORK_AREA_PERCENTAGE] = 116 ;
    ObSysVars[116].alias_ = "OB_SV_SQL_WORK_AREA_PERCENTAGE" ;

    ObSysVars[117].info_ = "The safe weak read snapshot version in one server" ;
    ObSysVars[117].on_update_func_ = "ObSysVarOnUpdateFuncs::update_safe_weak_read_snapshot" ;
    ObSysVars[117].name_ = "ob_safe_weak_read_snapshot" ;
    ObSysVars[117].data_type_ = ObIntType ;
    ObSysVars[117].value_ = "1" ;
    ObSysVars[117].min_val_ = "0" ;
    ObSysVars[117].max_val_ = "9223372036854775807" ;
    ObSysVars[117].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[117].id_ = SYS_VAR_OB_SAFE_WEAK_READ_SNAPSHOT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_SAFE_WEAK_READ_SNAPSHOT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_SAFE_WEAK_READ_SNAPSHOT] = 117 ;
    ObSysVars[117].alias_ = "OB_SV_SAFE_WEAK_READ_SNAPSHOT" ;

    ObSysVars[118].info_ = "the routing policy of obproxy/java client and observer internal retry, 1=READONLY_ZONE_FIRST, 2=ONLY_READONLY_ZONE, 3=UNMERGE_ZONE_FIRST, 4=UNMERGE_FOLLOWER_FIRST" ;
    ObSysVars[118].name_ = "ob_route_policy" ;
    ObSysVars[118].data_type_ = ObIntType ;
    ObSysVars[118].enum_names_ = "[u'', u'READONLY_ZONE_FIRST', u'ONLY_READONLY_ZONE', u'UNMERGE_ZONE_FIRST', u'UNMERGE_FOLLOWER_FIRST']" ;
    ObSysVars[118].value_ = "1" ;
    ObSysVars[118].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[118].id_ = SYS_VAR_OB_ROUTE_POLICY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ROUTE_POLICY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ROUTE_POLICY] = 118 ;
    ObSysVars[118].alias_ = "OB_SV_ROUTE_POLICY" ;

    ObSysVars[119].info_ = "whether do the checksum of the packet between the client and the server" ;
    ObSysVars[119].name_ = "ob_enable_transmission_checksum" ;
    ObSysVars[119].data_type_ = ObIntType ;
    ObSysVars[119].value_ = "1" ;
    ObSysVars[119].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::QUERY_SENSITIVE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[119].id_ = SYS_VAR_OB_ENABLE_TRANSMISSION_CHECKSUM ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_TRANSMISSION_CHECKSUM)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_TRANSMISSION_CHECKSUM] = 119 ;
    ObSysVars[119].alias_ = "OB_SV_ENABLE_TRANSMISSION_CHECKSUM" ;

    ObSysVars[120].info_ = "set to 1 (the default by MySQL), foreign key constraints are checked. If set to 0, foreign key constraints are ignored" ;
    ObSysVars[120].name_ = "foreign_key_checks" ;
    ObSysVars[120].data_type_ = ObIntType ;
    ObSysVars[120].value_ = "1" ;
    ObSysVars[120].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[120].id_ = SYS_VAR_FOREIGN_KEY_CHECKS ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_FOREIGN_KEY_CHECKS)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_FOREIGN_KEY_CHECKS] = 120 ;
    ObSysVars[120].alias_ = "OB_SV_FOREIGN_KEY_CHECKS" ;

    ObSysVars[121].info_ = "the trace id of current executing statement" ;
    ObSysVars[121].name_ = "ob_statement_trace_id" ;
    ObSysVars[121].data_type_ = ObVarcharType ;
    ObSysVars[121].value_ = "Y0-0" ;
    ObSysVars[121].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::INVISIBLE ;
    ObSysVars[121].id_ = SYS_VAR_OB_STATEMENT_TRACE_ID ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_STATEMENT_TRACE_ID)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_STATEMENT_TRACE_ID] = 121 ;
    ObSysVars[121].alias_ = "OB_SV_STATEMENT_TRACE_ID" ;

    ObSysVars[122].info_ = "Enable the flashback of table truncation." ;
    ObSysVars[122].name_ = "ob_enable_truncate_flashback" ;
    ObSysVars[122].data_type_ = ObIntType ;
    ObSysVars[122].value_ = "0" ;
    ObSysVars[122].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[122].id_ = SYS_VAR_OB_ENABLE_TRUNCATE_FLASHBACK ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_TRUNCATE_FLASHBACK)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_TRUNCATE_FLASHBACK] = 122 ;
    ObSysVars[122].alias_ = "OB_SV_ENABLE_TRUNCATE_FLASHBACK" ;

    ObSysVars[123].info_ = "ip white list for tenant, support % and _ and multi ip(separated by commas), support ip match and wild match" ;
    ObSysVars[123].name_ = "ob_tcp_invited_nodes" ;
    ObSysVars[123].data_type_ = ObVarcharType ;
    ObSysVars[123].value_ = "127.0.0.1,::1" ;
    ObSysVars[123].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[123].id_ = SYS_VAR_OB_TCP_INVITED_NODES ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TCP_INVITED_NODES)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_TCP_INVITED_NODES] = 123 ;
    ObSysVars[123].alias_ = "OB_SV_TCP_INVITED_NODES" ;

    ObSysVars[124].info_ = "current priority used for SQL throttling" ;
    ObSysVars[124].name_ = "sql_throttle_current_priority" ;
    ObSysVars[124].data_type_ = ObIntType ;
    ObSysVars[124].value_ = "100" ;
    ObSysVars[124].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[124].id_ = SYS_VAR_SQL_THROTTLE_CURRENT_PRIORITY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_CURRENT_PRIORITY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_CURRENT_PRIORITY] = 124 ;
    ObSysVars[124].alias_ = "OB_SV_SQL_THROTTLE_CURRENT_PRIORITY" ;

    ObSysVars[125].info_ = "sql throttle priority, query may not be allowed to execute if its priority isnt greater than this value." ;
    ObSysVars[125].name_ = "sql_throttle_priority" ;
    ObSysVars[125].data_type_ = ObIntType ;
    ObSysVars[125].value_ = "-1" ;
    ObSysVars[125].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[125].id_ = SYS_VAR_SQL_THROTTLE_PRIORITY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_PRIORITY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_PRIORITY] = 125 ;
    ObSysVars[125].alias_ = "OB_SV_SQL_THROTTLE_PRIORITY" ;

    ObSysVars[126].info_ = "query may not be allowed to execute if its rt isnt less than this value." ;
    ObSysVars[126].name_ = "sql_throttle_rt" ;
    ObSysVars[126].data_type_ = ObNumberType ;
    ObSysVars[126].value_ = "-1" ;
    ObSysVars[126].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[126].id_ = SYS_VAR_SQL_THROTTLE_RT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_RT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_RT] = 126 ;
    ObSysVars[126].alias_ = "OB_SV_SQL_THROTTLE_RT" ;

    ObSysVars[127].info_ = "query may not be allowed to execute if its CPU usage isnt less than this value." ;
    ObSysVars[127].name_ = "sql_throttle_cpu" ;
    ObSysVars[127].data_type_ = ObNumberType ;
    ObSysVars[127].value_ = "-1" ;
    ObSysVars[127].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[127].id_ = SYS_VAR_SQL_THROTTLE_CPU ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_CPU)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_CPU] = 127 ;
    ObSysVars[127].alias_ = "OB_SV_SQL_THROTTLE_CPU" ;

    ObSysVars[128].info_ = "query may not be allowed to execute if its number of IOs isnt less than this value." ;
    ObSysVars[128].name_ = "sql_throttle_io" ;
    ObSysVars[128].data_type_ = ObIntType ;
    ObSysVars[128].value_ = "-1" ;
    ObSysVars[128].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[128].id_ = SYS_VAR_SQL_THROTTLE_IO ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_IO)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_IO] = 128 ;
    ObSysVars[128].alias_ = "OB_SV_SQL_THROTTLE_IO" ;

    ObSysVars[129].info_ = "query may not be allowed to execute if its network usage isnt less than this value." ;
    ObSysVars[129].name_ = "sql_throttle_network" ;
    ObSysVars[129].data_type_ = ObNumberType ;
    ObSysVars[129].value_ = "-1" ;
    ObSysVars[129].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[129].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_sql_throttle_queue_time" ;
    ObSysVars[129].id_ = SYS_VAR_SQL_THROTTLE_NETWORK ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_NETWORK)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_NETWORK] = 129 ;
    ObSysVars[129].alias_ = "OB_SV_SQL_THROTTLE_NETWORK" ;

    ObSysVars[130].info_ = "query may not be allowed to execute if its number of logical reads isnt less than this value." ;
    ObSysVars[130].name_ = "sql_throttle_logical_reads" ;
    ObSysVars[130].data_type_ = ObIntType ;
    ObSysVars[130].value_ = "-1" ;
    ObSysVars[130].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[130].id_ = SYS_VAR_SQL_THROTTLE_LOGICAL_READS ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_LOGICAL_READS)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_LOGICAL_READS] = 130 ;
    ObSysVars[130].alias_ = "OB_SV_SQL_THROTTLE_LOGICAL_READS" ;

    ObSysVars[131].info_ = "auto_increment service cache size" ;
    ObSysVars[131].name_ = "auto_increment_cache_size" ;
    ObSysVars[131].data_type_ = ObIntType ;
    ObSysVars[131].value_ = "1000000" ;
    ObSysVars[131].min_val_ = "1" ;
    ObSysVars[131].max_val_ = "100000000" ;
    ObSysVars[131].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[131].id_ = SYS_VAR_AUTO_INCREMENT_CACHE_SIZE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_AUTO_INCREMENT_CACHE_SIZE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_AUTO_INCREMENT_CACHE_SIZE] = 131 ;
    ObSysVars[131].alias_ = "OB_SV_AUTO_INCREMENT_CACHE_SIZE" ;

    ObSysVars[132].info_ = "JIT execution engine mode, default is AUTO" ;
    ObSysVars[132].name_ = "ob_enable_jit" ;
    ObSysVars[132].data_type_ = ObIntType ;
    ObSysVars[132].enum_names_ = "[u'OFF', u'AUTO', u'FORCE']" ;
    ObSysVars[132].value_ = "0" ;
    ObSysVars[132].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[132].id_ = SYS_VAR_OB_ENABLE_JIT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_JIT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_JIT] = 132 ;
    ObSysVars[132].alias_ = "OB_SV_ENABLE_JIT" ;

    ObSysVars[133].info_ = "the percentage limitation of some temp tablespace size in tenant disk." ;
    ObSysVars[133].name_ = "ob_temp_tablespace_size_percentage" ;
    ObSysVars[133].data_type_ = ObIntType ;
    ObSysVars[133].value_ = "0" ;
    ObSysVars[133].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[133].id_ = SYS_VAR_OB_TEMP_TABLESPACE_SIZE_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TEMP_TABLESPACE_SIZE_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_TEMP_TABLESPACE_SIZE_PERCENTAGE] = 133 ;
    ObSysVars[133].alias_ = "OB_SV_TEMP_TABLESPACE_SIZE_PERCENTAGE" ;

    ObSysVars[134].info_ = "Enable use of adaptive cursor sharing" ;
    ObSysVars[134].name_ = "_optimizer_adaptive_cursor_sharing" ;
    ObSysVars[134].data_type_ = ObIntType ;
    ObSysVars[134].value_ = "0" ;
    ObSysVars[134].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[134].id_ = SYS_VAR__OPTIMIZER_ADAPTIVE_CURSOR_SHARING ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__OPTIMIZER_ADAPTIVE_CURSOR_SHARING)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__OPTIMIZER_ADAPTIVE_CURSOR_SHARING] = 134 ;
    ObSysVars[134].alias_ = "OB_SV__OPTIMIZER_ADAPTIVE_CURSOR_SHARING" ;

    ObSysVars[135].info_ = "the type of timestamp service" ;
    ObSysVars[135].name_ = "ob_timestamp_service" ;
    ObSysVars[135].data_type_ = ObIntType ;
    ObSysVars[135].enum_names_ = "[u'LTS', u'GTS', u'HA_GTS']" ;
    ObSysVars[135].value_ = "1" ;
    ObSysVars[135].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[135].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_timestamp_service" ;
    ObSysVars[135].id_ = SYS_VAR_OB_TIMESTAMP_SERVICE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TIMESTAMP_SERVICE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_TIMESTAMP_SERVICE] = 135 ;
    ObSysVars[135].alias_ = "OB_SV_TIMESTAMP_SERVICE" ;

    ObSysVars[136].info_ = "the dir to place plugin dll" ;
    ObSysVars[136].name_ = "plugin_dir" ;
    ObSysVars[136].data_type_ = ObVarcharType ;
    ObSysVars[136].value_ = "./plugin_dir/" ;
    ObSysVars[136].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY ;
    ObSysVars[136].id_ = SYS_VAR_PLUGIN_DIR ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PLUGIN_DIR)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_PLUGIN_DIR] = 136 ;
    ObSysVars[136].alias_ = "OB_SV_PLUGIN_DIR" ;

    ObSysVars[137].info_ = "specifies (in seconds) the low threshold value of undo retention." ;
    ObSysVars[137].name_ = "undo_retention" ;
    ObSysVars[137].data_type_ = ObIntType ;
    ObSysVars[137].value_ = "0" ;
    ObSysVars[137].min_val_ = "0" ;
    ObSysVars[137].max_val_ = "4294967295" ;
    ObSysVars[137].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[137].id_ = SYS_VAR_UNDO_RETENTION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_UNDO_RETENTION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_UNDO_RETENTION] = 137 ;
    ObSysVars[137].alias_ = "OB_SV_UNDO_RETENTION" ;

    ObSysVars[138].info_ = "auto use parallel execution" ;
    ObSysVars[138].name_ = "_ob_use_parallel_execution" ;
    ObSysVars[138].data_type_ = ObIntType ;
    ObSysVars[138].value_ = "1" ;
    ObSysVars[138].flags_ = ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::INVISIBLE ;
    ObSysVars[138].id_ = SYS_VAR__OB_USE_PARALLEL_EXECUTION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__OB_USE_PARALLEL_EXECUTION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__OB_USE_PARALLEL_EXECUTION] = 138 ;
    ObSysVars[138].alias_ = "OB_SV__OB_USE_PARALLEL_EXECUTION" ;
    ...
    ObSysVars[143].info_ = "number of threads created to run parallel statements for each observer." ;
    ObSysVars[143].name_ = "parallel_max_servers" ;
    ObSysVars[143].data_type_ = ObIntType ;
    ObSysVars[143].value_ = "0" ;
    ObSysVars[143].min_val_ = "0" ;
    ObSysVars[143].max_val_ = "1800" ;
    ObSysVars[143].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[143].id_ = SYS_VAR_PARALLEL_MAX_SERVERS ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PARALLEL_MAX_SERVERS)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_PARALLEL_MAX_SERVERS] = 143 ;
    ObSysVars[143].alias_ = "OB_SV_PARALLEL_MAX_SERVERS" ;
    ...
    ObSysVars[146].value_ = "120000000" ;
    ...
    ObSysVars[147].enum_names_ = "[u'aes-128-ecb', u'aes-192-ecb', u'aes-256-ecb', u'aes-128-cbc', u'aes-192-cbc', u'aes-256-cbc', u'aes-128-cfb1', u'aes-192-cfb1', u'aes-256-cfb1', u'aes-128-cfb8', u'aes-192-cfb8', u'aes-256-cfb8', u'aes-128-cfb128', u'aes-192-cfb128', u'aes-256-cfb128', u'aes-128-ofb', u'aes-192-ofb', u'aes-256-ofb']" ;
    ObSysVars[147].value_ = "0" ;
    ...
    ObSysVars[148].info_ = "specifies the default date format to use with the TO_CHAR and TO_DATE functions, (YYYY-MM-DD HH24:MI:SS) is Common value" ;
    ObSysVars[148].name_ = "nls_date_format" ;
    ObSysVars[148].data_type_ = ObVarcharType ;
    ObSysVars[148].value_ = "DD-MON-RR" ;
    ...
    ObSysVars[148].id_ = SYS_VAR_NLS_DATE_FORMAT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_DATE_FORMAT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_DATE_FORMAT] = 148 ;
    ObSysVars[148].alias_ = "OB_SV_NLS_DATE_FORMAT" ;

    ObSysVars[149].info_ = "specifies the default date format to use with the TO_CHAR and TO_TIMESTAMP functions, (YYYY-MM-DD HH24:MI:SS.FF) is Common value" ;
    ObSysVars[149].name_ = "nls_timestamp_format" ;
    ObSysVars[149].data_type_ = ObVarcharType ;
    ObSysVars[149].value_ = "DD-MON-RR HH.MI.SSXFF AM" ;
    ...
    ObSysVars[149].id_ = SYS_VAR_NLS_TIMESTAMP_FORMAT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_TIMESTAMP_FORMAT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_TIMESTAMP_FORMAT] = 149 ;
    ObSysVars[149].alias_ = "OB_SV_NLS_TIMESTAMP_FORMAT" ;

    ObSysVars[150].info_ = "specifies the default timestamp with time zone format to use with the TO_CHAR and TO_TIMESTAMP_TZ functions, (YYYY-MM-DD HH24:MI:SS.FF TZR TZD) is common value" ;
    ObSysVars[150].name_ = "nls_timestamp_tz_format" ;
    ObSysVars[150].data_type_ = ObVarcharType ;
    ObSysVars[150].value_ = "DD-MON-RR HH.MI.SSXFF AM TZR" ;
    ...
    ObSysVars[150].id_ = SYS_VAR_NLS_TIMESTAMP_TZ_FORMAT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_TIMESTAMP_TZ_FORMAT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_TIMESTAMP_TZ_FORMAT] = 150 ;
    ObSysVars[150].alias_ = "OB_SV_NLS_TIMESTAMP_TZ_FORMAT" ;

    ObSysVars[151].info_ = "percentage of tenant memory resources that can be used by tenant meta data" ;
    ObSysVars[151].name_ = "ob_reserved_meta_memory_percentage" ;
    ObSysVars[151].data_type_ = ObIntType ;
    ObSysVars[151].value_ = "10" ;
    ObSysVars[151].min_val_ = "1" ;
    ObSysVars[151].max_val_ = "100" ;
    ObSysVars[151].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[151].id_ = SYS_VAR_OB_RESERVED_META_MEMORY_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_RESERVED_META_MEMORY_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_RESERVED_META_MEMORY_PERCENTAGE] = 151 ;
    ObSysVars[151].alias_ = "OB_SV_RESERVED_META_MEMORY_PERCENTAGE" ;

    ObSysVars[152].info_ = "If set true, sql will update sys variable while schema version changed." ;
    ObSysVars[152].name_ = "ob_check_sys_variable" ;
    ObSysVars[152].data_type_ = ObIntType ;
    ObSysVars[152].value_ = "1" ;
    ObSysVars[152].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[152].id_ = SYS_VAR_OB_CHECK_SYS_VARIABLE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_CHECK_SYS_VARIABLE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_CHECK_SYS_VARIABLE] = 152 ;
    ObSysVars[152].alias_ = "OB_SV_CHECK_SYS_VARIABLE" ;

    ObSysVars[153].info_ = "specifies the default language of the database, used for messages, day and month names, the default sorting mechanism, the default values of NLS_DATE_LANGUAGE and NLS_SORT." ;
    ObSysVars[153].name_ = "nls_language" ;
    ObSysVars[153].data_type_ = ObVarcharType ;
    ObSysVars[153].value_ = "AMERICAN" ;
    ObSysVars[153].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::ORACLE_ONLY ;
    ObSysVars[153].id_ = SYS_VAR_NLS_LANGUAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_LANGUAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_LANGUAGE] = 153 ;
    ObSysVars[153].alias_ = "OB_SV_NLS_LANGUAGE" ;

    ObSysVars[154].info_ = "specifies the name of the territory whose conventions are to be followed for day and week numbering, establishes the default date format, the default decimal character and group separator, and the default ISO and local currency symbols." ;
    ObSysVars[154].name_ = "nls_territory" ;
    ObSysVars[154].data_type_ = ObVarcharType ;
    ObSysVars[154].value_ = "AMERICA" ;
    ObSysVars[154].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::ORACLE_ONLY ;
    ObSysVars[154].id_ = SYS_VAR_NLS_TERRITORY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_TERRITORY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_TERRITORY] = 154 ;
    ObSysVars[154].alias_ = "OB_SV_NLS_TERRITORY" ;

    ObSysVars[155].info_ = "specifies the collating sequence for character value comparison in various SQL operators and clauses." ;
    ObSysVars[155].name_ = "nls_sort" ;
    ...
    ObSysVars[155].id_ = SYS_VAR_NLS_SORT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_SORT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_SORT] = 155 ;
    ObSysVars[155].alias_ = "OB_SV_NLS_SORT" ;

    ObSysVars[156].info_ = "specifies the collation behavior of the database session. value can be BINARY | LINGUISTIC | ANSI" ;
    ObSysVars[156].name_ = "nls_comp" ;
    ObSysVars[156].data_type_ = ObVarcharType ;
    ObSysVars[156].value_ = "BINARY" ;
    ...
    ObSysVars[156].id_ = SYS_VAR_NLS_COMP ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_COMP)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_COMP] = 156 ;
    ObSysVars[156].alias_ = "OB_SV_NLS_COMP" ;

    ObSysVars[157].info_ = "specifies the default characterset of the database, This parameter defines the encoding of the data in the CHAR, VARCHAR2, LONG and CLOB columns of a table." ;
    ObSysVars[157].name_ = "nls_characterset" ;
    ObSysVars[157].data_type_ = ObVarcharType ;
    ObSysVars[157].value_ = "AL32UTF8" ;
    ObSysVars[157].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::ORACLE_ONLY | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::WITH_CREATE | ObSysVarFlag::READONLY ;
    ObSysVars[157].id_ = SYS_VAR_NLS_CHARACTERSET ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_CHARACTERSET)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_CHARACTERSET] = 157 ;
    ObSysVars[157].alias_ = "OB_SV_NLS_CHARACTERSET" ;

    ObSysVars[158].info_ = "specifies the default characterset of the database, This parameter defines the encoding of the data in the NCHAR, NVARCHAR2 and NCLOB columns of a table." ;
    ObSysVars[158].name_ = "nls_nchar_characterset" ;
    ObSysVars[158].data_type_ = ObVarcharType ;
    ObSysVars[158].value_ = "AL32UTF8" ;
    ObSysVars[158].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::ORACLE_ONLY | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[158].id_ = SYS_VAR_NLS_NCHAR_CHARACTERSET ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_NCHAR_CHARACTERSET)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_NCHAR_CHARACTERSET] = 158 ;
    ObSysVars[158].alias_ = "OB_SV_NLS_NCHAR_CHARACTERSET" ;
    ...
    ObSysVars[159].name_ = "nls_date_language" ;
    ObSysVars[159].data_type_ = ObVarcharType ;
    ObSysVars[159].value_ = "AMERICAN" ;
    ObSysVars[159].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::ORACLE_ONLY ;
    ObSysVars[159].id_ = SYS_VAR_NLS_DATE_LANGUAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_DATE_LANGUAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_DATE_LANGUAGE] = 159 ;
    ObSysVars[159].alias_ = "OB_SV_NLS_DATE_LANGUAGE" ;

    ObSysVars[160].info_ = "specifies the default length semantics to use for VARCHAR2 and CHAR table columns, user-defined object attributes, and PL/SQL variables in database objects created in the session. SYS user use BYTE intead of NLS_LENGTH_SEMANTICS." ;
    ObSysVars[160].name_ = "nls_length_semantics" ;
    ObSysVars[160].data_type_ = ObVarcharType ;
    ObSysVars[160].value_ = "BYTE" ;
    ...
    ObSysVars[160].id_ = SYS_VAR_NLS_LENGTH_SEMANTICS ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_LENGTH_SEMANTICS)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_LENGTH_SEMANTICS] = 160 ;
    ObSysVars[160].alias_ = "OB_SV_NLS_LENGTH_SEMANTICS" ;

    ObSysVars[161].info_ = "determines whether an error is reported when there is data loss during an implicit or explicit character type conversion between NCHAR/NVARCHAR2 and CHAR/VARCHAR2." ;
    ObSysVars[161].name_ = "nls_nchar_conv_excp" ;
    ObSysVars[161].data_type_ = ObVarcharType ;
    ObSysVars[161].value_ = "FALSE" ;
    ObSysVars[161].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::ORACLE_ONLY | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[161].id_ = SYS_VAR_NLS_NCHAR_CONV_EXCP ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_NCHAR_CONV_EXCP)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_NCHAR_CONV_EXCP] = 161 ;
    ObSysVars[161].alias_ = "OB_SV_NLS_NCHAR_CONV_EXCP" ;

    ObSysVars[162].info_ = "specifies which calendar system Oracle uses." ;
    ObSysVars[162].name_ = "nls_calendar" ;
    ObSysVars[162].data_type_ = ObVarcharType ;
    ObSysVars[162].value_ = "GREGORIAN" ;
    ...
    ObSysVars[162].id_ = SYS_VAR_NLS_CALENDAR ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_CALENDAR)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_CALENDAR] = 162 ;
    ObSysVars[162].alias_ = "OB_SV_NLS_CALENDAR" ;

    ObSysVars[163].info_ = "specifies the characters to use as the decimal character and group separator, overrides those characters defined implicitly by NLS_TERRITORY." ;
    ObSysVars[163].name_ = "nls_numeric_characters" ;
    ...
    ObSysVars[163].id_ = SYS_VAR_NLS_NUMERIC_CHARACTERS ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NLS_NUMERIC_CHARACTERS)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_NLS_NUMERIC_CHARACTERS] = 163 ;
    ObSysVars[163].alias_ = "OB_SV_NLS_NUMERIC_CHARACTERS" ;

    ObSysVars[164].info_ = "enable batching of the RHS IO in NLJ" ;
    ObSysVars[164].name_ = "_nlj_batching_enabled" ;
    ObSysVars[164].data_type_ = ObIntType ;
    ObSysVars[164].value_ = "1" ;
    ObSysVars[164].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[164].id_ = SYS_VAR__NLJ_BATCHING_ENABLED ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__NLJ_BATCHING_ENABLED)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__NLJ_BATCHING_ENABLED] = 164 ;
    ObSysVars[164].alias_ = "OB_SV__NLJ_BATCHING_ENABLED" ;

    ObSysVars[165].info_ = "The name of tracefile." ;
    ObSysVars[165].name_ = "tracefile_identifier" ;
    ObSysVars[165].data_type_ = ObVarcharType ;
    ObSysVars[165].value_ = "" ;
    ObSysVars[165].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[165].id_ = SYS_VAR_TRACEFILE_IDENTIFIER ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_TRACEFILE_IDENTIFIER)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_TRACEFILE_IDENTIFIER] = 165 ;
    ObSysVars[165].alias_ = "OB_SV_TRACEFILE_IDENTIFIER" ;

    ObSysVars[166].info_ = "ratio used to decide whether push down should be done in distribtued query optimization." ;
    ObSysVars[166].name_ = "_groupby_nopushdown_cut_ratio" ;
    ObSysVars[166].data_type_ = ObUInt64Type ;
    ObSysVars[166].value_ = "3" ;
    ...
    ObSysVars[166].id_ = SYS_VAR__GROUPBY_NOPUSHDOWN_CUT_RATIO ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__GROUPBY_NOPUSHDOWN_CUT_RATIO)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__GROUPBY_NOPUSHDOWN_CUT_RATIO] = 166 ;
    ObSysVars[166].alias_ = "OB_SV__GROUPBY_NOPUSHDOWN_CUT_RATIO" ;

    ObSysVars[167].info_ = "set the tq broadcasting fudge factor percentage." ;
    ObSysVars[167].name_ = "_px_broadcast_fudge_factor" ;
    ObSysVars[167].data_type_ = ObIntType ;
    ObSysVars[167].value_ = "100" ;
    ObSysVars[167].min_val_ = "0" ;
    ObSysVars[167].max_val_ = "100" ;
    ObSysVars[167].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[167].id_ = SYS_VAR__PX_BROADCAST_FUDGE_FACTOR ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__PX_BROADCAST_FUDGE_FACTOR)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__PX_BROADCAST_FUDGE_FACTOR] = 167 ;
    ObSysVars[167].alias_ = "OB_SV__PX_BROADCAST_FUDGE_FACTOR" ;

    ObSysVars[168].info_ = "statistic primary zone entity(table/tablegroup/database) count under tenant." ;
    ObSysVars[168].name_ = "_primary_zone_entity_count" ;
    ObSysVars[168].data_type_ = ObIntType ;
    ObSysVars[168].value_ = "-1" ;
    ObSysVars[168].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::INVISIBLE ;
    ObSysVars[168].id_ = SYS_VAR__PRIMARY_ZONE_ENTITY_COUNT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__PRIMARY_ZONE_ENTITY_COUNT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__PRIMARY_ZONE_ENTITY_COUNT] = 168 ;
    ObSysVars[168].alias_ = "OB_SV__PRIMARY_ZONE_ENTITY_COUNT" ;
    ...
    ObSysVars[169].value_ = "READ-COMMITTED" ;
    ...
    ObSysVars[178].info_ = "store trace info" ;
    ObSysVars[178].name_ = "ob_trace_info" ;
    ObSysVars[178].data_type_ = ObVarcharType ;
    ObSysVars[178].value_ = "" ;
    ObSysVars[178].flags_ = ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[178].id_ = SYS_VAR_OB_TRACE_INFO ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TRACE_INFO)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_TRACE_INFO] = 178 ;
    ObSysVars[178].alias_ = "OB_SV_TRACE_INFO" ;

    ObSysVars[179].info_ = "enable use of batched multi statement" ;
    ObSysVars[179].name_ = "ob_enable_batched_multi_statement" ;
    ObSysVars[179].data_type_ = ObIntType ;
    ObSysVars[179].value_ = "0" ;
    ObSysVars[179].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[179].id_ = SYS_VAR_OB_ENABLE_BATCHED_MULTI_STATEMENT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_BATCHED_MULTI_STATEMENT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_BATCHED_MULTI_STATEMENT] = 179 ;
    ObSysVars[179].alias_ = "OB_SV_ENABLE_BATCHED_MULTI_STATEMENT" ;
    ...
    ObSysVars[186].value_ = "ENABLE:ALL" ;
    ...
    ObSysVars[190].value_ = "3216672000000000" ;
    ...
    ObSysVars[197].info_ = "this value is true if we have executed set transaction stmt, until a transaction commit(explicit or implicit) successfully" ;
    ObSysVars[197].name_ = "_ob_proxy_session_temporary_table_used" ;
    ObSysVars[197].data_type_ = ObIntType ;
    ObSysVars[197].value_ = "0" ;
    ObSysVars[197].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[197].id_ = SYS_VAR__OB_PROXY_SESSION_TEMPORARY_TABLE_USED ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__OB_PROXY_SESSION_TEMPORARY_TABLE_USED)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__OB_PROXY_SESSION_TEMPORARY_TABLE_USED] = 197 ;
    ObSysVars[197].alias_ = "OB_SV__OB_PROXY_SESSION_TEMPORARY_TABLE_USED" ;
