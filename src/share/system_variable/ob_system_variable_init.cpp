...
static struct VarsInit{
  VarsInit(){
    ...
    [&] (){
      ObSysVars[234].default_value_ = "4.2.5.7" ;
    ...
    [&] (){
      ...
      ObSysVars[243].info_ = "whether use storage cardinality estimation in session" ;
      ObSysVars[243].name_ = "_enable_storage_cardinality_estimation" ;
      ObSysVars[243].data_type_ = ObIntType ;
      ObSysVars[243].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ...
    [&] (){
      ...
      ObSysVars[246].info_ = "Specifies whether InnoDB index statistics are persisted to disk." ;
      ObSysVars[246].name_ = "innodb_stats_persistent" ;
      ...
      ObSysVars[246].id_ = SYS_VAR_INNODB_STATS_PERSISTENT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_PERSISTENT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_PERSISTENT] = 246 ;
      ObSysVars[246].base_value_ = "1" ;
    ObSysVars[246].alias_ = "OB_SV_INNODB_STATS_PERSISTENT" ;
    }();

    [&] (){
      ObSysVars[247].default_value_ = "d:t:i:o,/tmp/mysqld.trace" ;
      ObSysVars[247].info_ = "This variable indicates the current debugging settings" ;
      ObSysVars[247].name_ = "debug" ;
      ObSysVars[247].data_type_ = ObVarcharType ;
      ObSysVars[247].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[247].id_ = SYS_VAR_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DEBUG] = 247 ;
      ObSysVars[247].base_value_ = "d:t:i:o,/tmp/mysqld.trace" ;
    ObSysVars[247].alias_ = "OB_SV_DEBUG" ;
    }();

    [&] (){
      ObSysVars[248].default_value_ = "0" ;
      ObSysVars[248].info_ = "Sets a debug flag for InnoDB change buffering. " ;
      ObSysVars[248].name_ = "innodb_change_buffering_debug" ;
      ObSysVars[248].data_type_ = ObIntType ;
      ObSysVars[248].min_val_ = "0" ;
      ObSysVars[248].max_val_ = "2" ;
      ObSysVars[248].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[248].id_ = SYS_VAR_INNODB_CHANGE_BUFFERING_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_CHANGE_BUFFERING_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_CHANGE_BUFFERING_DEBUG] = 248 ;
      ObSysVars[248].base_value_ = "0" ;
    ObSysVars[248].alias_ = "OB_SV_INNODB_CHANGE_BUFFERING_DEBUG" ;
    }();

    [&] (){
      ObSysVars[249].default_value_ = "0" ;
      ObSysVars[249].info_ = "Compresses all tables using a specified compression algorithm without having to define a COMPRESSION attribute for each table." ;
      ObSysVars[249].name_ = "innodb_compress_debug" ;
      ObSysVars[249].data_type_ = ObIntType ;
      ObSysVars[249].enum_names_ = "[u'NONE', u'ZLIB', u'LZ4', u'LZ4HC']" ;
      ObSysVars[249].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[249].id_ = SYS_VAR_INNODB_COMPRESS_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_COMPRESS_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_COMPRESS_DEBUG] = 249 ;
      ObSysVars[249].base_value_ = "0" ;
    ObSysVars[249].alias_ = "OB_SV_INNODB_COMPRESS_DEBUG" ;
    }();

    [&] (){
      ObSysVars[250].default_value_ = "1" ;
      ObSysVars[250].info_ = "Disables resizing of the InnoDB buffer pool" ;
      ObSysVars[250].name_ = "innodb_disable_resize_buffer_pool_debug" ;
      ObSysVars[250].data_type_ = ObIntType ;
      ObSysVars[250].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[250].id_ = SYS_VAR_INNODB_DISABLE_RESIZE_BUFFER_POOL_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DISABLE_RESIZE_BUFFER_POOL_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DISABLE_RESIZE_BUFFER_POOL_DEBUG] = 250 ;
      ObSysVars[250].base_value_ = "1" ;
    ObSysVars[250].alias_ = "OB_SV_INNODB_DISABLE_RESIZE_BUFFER_POOL_DEBUG" ;
    }();

    [&] (){
      ObSysVars[251].default_value_ = "0" ;
      ObSysVars[251].info_ = "set to 1 (the default by MySQL), foreign key constraints are checked. If set to 0, foreign key constraints are ignored" ;
      ObSysVars[251].name_ = "innodb_fil_make_page_dirty_debug" ;
      ...
      ObSysVars[251].id_ = SYS_VAR_INNODB_FIL_MAKE_PAGE_DIRTY_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FIL_MAKE_PAGE_DIRTY_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FIL_MAKE_PAGE_DIRTY_DEBUG] = 251 ;
      ObSysVars[251].base_value_ = "0" ;
    ObSysVars[251].alias_ = "OB_SV_INNODB_FIL_MAKE_PAGE_DIRTY_DEBUG" ;
    }();

    [&] (){
      ObSysVars[252].default_value_ = "0" ;
      ObSysVars[252].info_ = "Limits the number of records per B-tree page" ;
      ObSysVars[252].name_ = "innodb_limit_optimistic_insert_debug" ;
      ...
      ObSysVars[252].id_ = SYS_VAR_INNODB_LIMIT_OPTIMISTIC_INSERT_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LIMIT_OPTIMISTIC_INSERT_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LIMIT_OPTIMISTIC_INSERT_DEBUG] = 252 ;
      ObSysVars[252].base_value_ = "0" ;
    ObSysVars[252].alias_ = "OB_SV_INNODB_LIMIT_OPTIMISTIC_INSERT_DEBUG" ;
    }();

    [&] (){
      ObSysVars[253].default_value_ = "50" ;
      ObSysVars[253].info_ = "Defines a page-full percentage value for index pages that overrides the current MERGE_THRESHOLD setting for all indexes that are currently in the dictionary cache" ;
      ObSysVars[253].name_ = "innodb_merge_threshold_set_all_debug" ;
      ...
      ObSysVars[253].id_ = SYS_VAR_INNODB_MERGE_THRESHOLD_SET_ALL_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_MERGE_THRESHOLD_SET_ALL_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_MERGE_THRESHOLD_SET_ALL_DEBUG] = 253 ;
      ObSysVars[253].base_value_ = "50" ;
    ObSysVars[253].alias_ = "OB_SV_INNODB_MERGE_THRESHOLD_SET_ALL_DEBUG" ;
    }();

    [&] (){
      ObSysVars[254].default_value_ = "0" ;
      ObSysVars[254].info_ = "Saves a page number. Setting the innodb_fil_make_page_dirty_debug option dirties the page defined by innodb_saved_page_number_debug" ;
      ObSysVars[254].name_ = "innodb_saved_page_number_debug" ;
      ...
      ObSysVars[254].id_ = SYS_VAR_INNODB_SAVED_PAGE_NUMBER_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SAVED_PAGE_NUMBER_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SAVED_PAGE_NUMBER_DEBUG] = 254 ;
      ObSysVars[254].base_value_ = "0" ;
    ObSysVars[254].alias_ = "OB_SV_INNODB_SAVED_PAGE_NUMBER_DEBUG" ;
    }();

    [&] (){
      ObSysVars[255].default_value_ = "0" ;
      ObSysVars[255].info_ = "Pauses purging of delete-marked records while allowing the purge view to be updated" ;
      ObSysVars[255].name_ = "innodb_trx_purge_view_update_only_debug" ;
      ObSysVars[255].data_type_ = ObIntType ;
      ObSysVars[255].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[255].id_ = SYS_VAR_INNODB_TRX_PURGE_VIEW_UPDATE_ONLY_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_TRX_PURGE_VIEW_UPDATE_ONLY_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_TRX_PURGE_VIEW_UPDATE_ONLY_DEBUG] = 255 ;
      ObSysVars[255].base_value_ = "0" ;
    ObSysVars[255].alias_ = "OB_SV_INNODB_TRX_PURGE_VIEW_UPDATE_ONLY_DEBUG" ;
    }();

    [&] (){
      ObSysVars[256].default_value_ = "0" ;
      ObSysVars[256].info_ = "Sets a debug flag that limits TRX_RSEG_N_SLOTS to a given value for the trx_rsegf_undo_find_free function that looks for free slots for undo log segments" ;
      ObSysVars[256].name_ = "innodb_trx_rseg_n_slots_debug" ;
      ObSysVars[256].data_type_ = ObIntType ;
      ObSysVars[256].min_val_ = "0" ;
      ObSysVars[256].max_val_ = "1024" ;
      ObSysVars[256].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[256].id_ = SYS_VAR_INNODB_TRX_RSEG_N_SLOTS_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_TRX_RSEG_N_SLOTS_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_TRX_RSEG_N_SLOTS_DEBUG] = 256 ;
      ObSysVars[256].base_value_ = "0" ;
    ObSysVars[256].alias_ = "OB_SV_INNODB_TRX_RSEG_N_SLOTS_DEBUG" ;
    }();

    [&] (){
      ObSysVars[257].default_value_ = "256" ;
      ObSysVars[257].info_ = "Sets a soft upper limit for the number of cached stored routines per connection" ;
      ObSysVars[257].name_ = "stored_program_cache" ;
      ObSysVars[257].data_type_ = ObIntType ;
      ObSysVars[257].min_val_ = "16" ;
      ObSysVars[257].max_val_ = "524288" ;
      ObSysVars[257].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[257].id_ = SYS_VAR_STORED_PROGRAM_CACHE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_STORED_PROGRAM_CACHE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_STORED_PROGRAM_CACHE] = 257 ;
      ObSysVars[257].base_value_ = "256" ;
    ObSysVars[257].alias_ = "OB_SV_STORED_PROGRAM_CACHE" ;
    }();

    [&] (){
      ObSysVars[258].default_value_ = "0" ;
      ObSysVars[258].info_ = "specifies the compatible mode when the behaviors of MySQL 5.7 and MySQL 8.0 are different" ;
      ObSysVars[258].name_ = "ob_compatibility_control" ;
      ObSysVars[258].data_type_ = ObIntType ;
      ObSysVars[258].enum_names_ = "[u'MYSQL5.7', u'MYSQL8.0']" ;
      ObSysVars[258].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY ;
      ObSysVars[258].id_ = SYS_VAR_OB_COMPATIBILITY_CONTROL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_COMPATIBILITY_CONTROL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_COMPATIBILITY_CONTROL] = 258 ;
      ObSysVars[258].base_value_ = "0" ;
    ObSysVars[258].alias_ = "OB_SV_COMPATIBILITY_CONTROL" ;
    }();

    [&] (){
      ObSysVars[259].default_value_ = "17180000512" ;
      ObSysVars[259].info_ = "specifies the compatible verision when the behaviors of different release version are different" ;
      ...
      ObSysVars[259].id_ = SYS_VAR_OB_COMPATIBILITY_VERSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_COMPATIBILITY_VERSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_COMPATIBILITY_VERSION] = 259 ;
      ObSysVars[259].get_meta_type_func_ = "ObSysVarGetMetaTypeFuncs::get_meta_type_varchar" ;
      ObSysVars[259].base_value_ = "17180000512" ;
    ObSysVars[259].alias_ = "OB_SV_COMPATIBILITY_VERSION" ;
    }();

    [&] (){
      ObSysVars[260].default_value_ = "17180000512" ;
      ObSysVars[260].info_ = "specifies the security verision when the behaviors of different release version are different" ;
      ObSysVars[260].name_ = "ob_security_version" ;
      ...
      ObSysVars[260].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_security_version" ;
      ObSysVars[260].id_ = SYS_VAR_OB_SECURITY_VERSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_SECURITY_VERSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_SECURITY_VERSION] = 260 ;
      ObSysVars[260].get_meta_type_func_ = "ObSysVarGetMetaTypeFuncs::get_meta_type_varchar" ;
      ObSysVars[260].base_value_ = "17180000512" ;
    ObSysVars[260].alias_ = "OB_SV_SECURITY_VERSION" ;
    }();

    [&] (){
      ObSysVars[261].default_value_ = "1" ;
      ObSysVars[261].info_ = "Specifies the correlation model when the optimizer estimates cardinality" ;
      ObSysVars[261].name_ = "cardinality_estimation_model" ;
      ObSysVars[261].data_type_ = ObIntType ;
      ObSysVars[261].enum_names_ = "[u'INDEPENDENT', u'PARTIAL', u'FULL']" ;
      ObSysVars[261].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN ;
      ObSysVars[261].id_ = SYS_VAR_CARDINALITY_ESTIMATION_MODEL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CARDINALITY_ESTIMATION_MODEL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CARDINALITY_ESTIMATION_MODEL] = 261 ;
      ObSysVars[261].base_value_ = "1" ;
    ObSysVars[261].alias_ = "OB_SV_CARDINALITY_ESTIMATION_MODEL" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[499].name_ = "ndb_allow_copying_alter_table" ;
      ...
      ObSysVars[499].id_ = SYS_VAR_NDB_ALLOW_COPYING_ALTER_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_ALLOW_COPYING_ALTER_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_ALLOW_COPYING_ALTER_TABLE] = 499 ;
      ObSysVars[499].base_value_ = "0" ;
    ObSysVars[499].alias_ = "OB_SV_NDB_ALLOW_COPYING_ALTER_TABLE" ;
    }();

    [&] (){
      ObSysVars[500].default_value_ = "1" ;
      ObSysVars[500].info_ = "mock for mysql5.7" ;
      ObSysVars[500].name_ = "ndb_autoincrement_prefetch_sz" ;
      ...
      ObSysVars[500].id_ = SYS_VAR_NDB_AUTOINCREMENT_PREFETCH_SZ ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_AUTOINCREMENT_PREFETCH_SZ)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_AUTOINCREMENT_PREFETCH_SZ] = 500 ;
      ObSysVars[500].base_value_ = "1" ;
    ObSysVars[500].alias_ = "OB_SV_NDB_AUTOINCREMENT_PREFETCH_SZ" ;
    }();

    [&] (){
      ObSysVars[501].default_value_ = "65536" ;
      ObSysVars[501].info_ = "mock for mysql5.7" ;
      ObSysVars[501].name_ = "ndb_blob_read_batch_bytes" ;
      ...
      ObSysVars[501].id_ = SYS_VAR_NDB_BLOB_READ_BATCH_BYTES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_BLOB_READ_BATCH_BYTES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_BLOB_READ_BATCH_BYTES] = 501 ;
      ObSysVars[501].base_value_ = "65536" ;
    ObSysVars[501].alias_ = "OB_SV_NDB_BLOB_READ_BATCH_BYTES" ;
    }();

    [&] (){
      ObSysVars[502].default_value_ = "65536" ;
      ObSysVars[502].info_ = "mock for mysql5.7" ;
      ObSysVars[502].name_ = "ndb_blob_write_batch_bytes" ;
    ...
    [&] (){
      ...
      ObSysVars[513].id_ = SYS_VAR_NDB_FULLY_REPLICATED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_FULLY_REPLICATED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_FULLY_REPLICATED] = 513 ;
      ObSysVars[513].base_value_ = "0" ;
    ObSysVars[513].alias_ = "OB_SV_NDB_FULLY_REPLICATED" ;
    }();

    [&] (){
      ObSysVars[514].default_value_ = "0" ;
      ObSysVars[514].info_ = "mock for mysql5.7" ;
      ObSysVars[514].name_ = "ndb_index_stat_enable" ;
      ...
      ObSysVars[514].id_ = SYS_VAR_NDB_INDEX_STAT_ENABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_INDEX_STAT_ENABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_INDEX_STAT_ENABLE] = 514 ;
      ObSysVars[514].base_value_ = "0" ;
    ObSysVars[514].alias_ = "OB_SV_NDB_INDEX_STAT_ENABLE" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[516].name_ = "ndb_join_pushdown" ;
    ...
    [&] (){
      ...
      ObSysVars[535].id_ = SYS_VAR_NDB_USE_EXACT_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_USE_EXACT_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_USE_EXACT_COUNT] = 535 ;
      ObSysVars[535].base_value_ = "0" ;
    ObSysVars[535].alias_ = "OB_SV_NDB_USE_EXACT_COUNT" ;
    }();

    [&] (){
      ObSysVars[536].default_value_ = "0" ;
      ObSysVars[536].info_ = "mock for mysql5.7" ;
      ObSysVars[536].name_ = "ndb_use_transactions" ;
      ...
      ObSysVars[536].id_ = SYS_VAR_NDB_USE_TRANSACTIONS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_USE_TRANSACTIONS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_USE_TRANSACTIONS] = 536 ;
      ObSysVars[536].base_value_ = "0" ;
    ObSysVars[536].alias_ = "OB_SV_NDB_USE_TRANSACTIONS" ;
    }();

    [&] (){
      ObSysVars[537].default_value_ = "0" ;
      ObSysVars[537].info_ = "mock for mysql5.7" ;
      ObSysVars[537].name_ = "ndbinfo_max_bytes" ;
      ...
      ObSysVars[537].id_ = SYS_VAR_NDBINFO_MAX_BYTES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_MAX_BYTES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_MAX_BYTES] = 537 ;
      ObSysVars[537].base_value_ = "0" ;
    ObSysVars[537].alias_ = "OB_SV_NDBINFO_MAX_BYTES" ;
    }();

    [&] (){
      ObSysVars[538].default_value_ = "10" ;
      ObSysVars[538].info_ = "mock for mysql5.7" ;
      ObSysVars[538].name_ = "ndbinfo_max_rows" ;
    ...
    [&] (){
      ...
      ObSysVars[540].id_ = SYS_VAR_NDBINFO_SHOW_HIDDEN ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_SHOW_HIDDEN)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_SHOW_HIDDEN] = 540 ;
      ObSysVars[540].base_value_ = "0" ;
    ObSysVars[540].alias_ = "OB_SV_NDBINFO_SHOW_HIDDEN" ;
    }();

    [&] (){
      ObSysVars[541].default_value_ = "6" ;
      ObSysVars[541].info_ = "mock for mysql5.7" ;
      ObSysVars[541].name_ = "myisam_data_pointer_size" ;
      ObSysVars[541].data_type_ = ObIntType ;
      ObSysVars[541].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[541].id_ = SYS_VAR_MYISAM_DATA_POINTER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_DATA_POINTER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_DATA_POINTER_SIZE] = 541 ;
      ObSysVars[541].base_value_ = "6" ;
    ObSysVars[541].alias_ = "OB_SV_MYISAM_DATA_POINTER_SIZE" ;
    }();

    [&] (){
      ObSysVars[542].default_value_ = "9223372036853720064" ;
      ObSysVars[542].info_ = "mock for mysql5.7" ;
      ObSysVars[542].name_ = "myisam_max_sort_file_size" ;
      ObSysVars[542].data_type_ = ObIntType ;
      ObSysVars[542].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[542].id_ = SYS_VAR_MYISAM_MAX_SORT_FILE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_MAX_SORT_FILE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_MAX_SORT_FILE_SIZE] = 542 ;
      ObSysVars[542].base_value_ = "9223372036853720064" ;
    ObSysVars[542].alias_ = "OB_SV_MYISAM_MAX_SORT_FILE_SIZE" ;
    }();

    [&] (){
      ObSysVars[543].default_value_ = "1" ;
      ObSysVars[543].info_ = "mock for mysql5.7" ;
      ObSysVars[543].name_ = "myisam_repair_threads" ;
      ObSysVars[543].data_type_ = ObIntType ;
      ObSysVars[543].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[543].id_ = SYS_VAR_MYISAM_REPAIR_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_REPAIR_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_REPAIR_THREADS] = 543 ;
      ObSysVars[543].base_value_ = "1" ;
    ObSysVars[543].alias_ = "OB_SV_MYISAM_REPAIR_THREADS" ;
    }();

    [&] (){
      ObSysVars[544].default_value_ = "8388608" ;
      ObSysVars[544].info_ = "mock for mysql5.7" ;
      ObSysVars[544].name_ = "myisam_sort_buffer_size" ;
    ...
    [&] (){
      ...
      ObSysVars[547].id_ = SYS_VAR_PRELOAD_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PRELOAD_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PRELOAD_BUFFER_SIZE] = 547 ;
      ObSysVars[547].base_value_ = "32768" ;
    ObSysVars[547].alias_ = "OB_SV_PRELOAD_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[548].default_value_ = "131072" ;
      ObSysVars[548].info_ = "mock for mysql5.7" ;
      ObSysVars[548].name_ = "read_buffer_size" ;
      ...
      ObSysVars[548].id_ = SYS_VAR_READ_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_READ_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_READ_BUFFER_SIZE] = 548 ;
      ObSysVars[548].base_value_ = "131072" ;
    ObSysVars[548].alias_ = "OB_SV_READ_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[549].default_value_ = "262144" ;
      ObSysVars[549].info_ = "mock for mysql5.7" ;
      ObSysVars[549].name_ = "read_rnd_buffer_size" ;
    ...
    [&] (){
      ...
      ObSysVars[570].id_ = SYS_VAR_MAX_HEAP_TABLE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_HEAP_TABLE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_HEAP_TABLE_SIZE] = 570 ;
      ObSysVars[570].base_value_ = "16777216" ;
    ObSysVars[570].alias_ = "OB_SV_MAX_HEAP_TABLE_SIZE" ;
    }();

    [&] (){
      ObSysVars[571].default_value_ = "8388608" ;
      ObSysVars[571].info_ = "mock for mysql5.7" ;
      ObSysVars[571].name_ = "bulk_insert_buffer_size" ;
    ...
    [&] (){
      ...
      ObSysVars[602].id_ = SYS_VAR_HAVE_STATEMENT_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_HAVE_STATEMENT_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_HAVE_STATEMENT_TIMEOUT] = 602 ;
      ObSysVars[602].base_value_ = "1" ;
    ObSysVars[602].alias_ = "OB_SV_HAVE_STATEMENT_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[603].default_value_ = "*" ;
      ObSysVars[603].info_ = "mock for mysql5.7" ;
      ObSysVars[603].name_ = "mysqlx_bind_address" ;
      ...
      ObSysVars[603].id_ = SYS_VAR_MYSQLX_BIND_ADDRESS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_BIND_ADDRESS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_BIND_ADDRESS] = 603 ;
      ObSysVars[603].base_value_ = "*" ;
    ObSysVars[603].alias_ = "OB_SV_MYSQLX_BIND_ADDRESS" ;
    }();

    [&] (){
      ObSysVars[604].default_value_ = "33060" ;
      ObSysVars[604].info_ = "mock for mysql5.7" ;
      ObSysVars[604].name_ = "mysqlx_port" ;
      ...
      ObSysVars[604].id_ = SYS_VAR_MYSQLX_PORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_PORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_PORT] = 604 ;
      ObSysVars[604].base_value_ = "33060" ;
    ObSysVars[604].alias_ = "OB_SV_MYSQLX_PORT" ;
    }();

    [&] (){
      ObSysVars[605].default_value_ = "0" ;
      ObSysVars[605].info_ = "mock for mysql5.7" ;
      ObSysVars[605].name_ = "mysqlx_port_open_timeout" ;
      ...
      ObSysVars[605].id_ = SYS_VAR_MYSQLX_PORT_OPEN_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_PORT_OPEN_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_PORT_OPEN_TIMEOUT] = 605 ;
      ObSysVars[605].base_value_ = "0" ;
    ObSysVars[605].alias_ = "OB_SV_MYSQLX_PORT_OPEN_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[606].default_value_ = "/tmp/mysqlx.sock" ;
      ObSysVars[606].info_ = "mock for mysql5.7" ;
      ObSysVars[606].name_ = "mysqlx_socket" ;
      ...
      ObSysVars[606].id_ = SYS_VAR_MYSQLX_SOCKET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SOCKET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SOCKET] = 606 ;
      ObSysVars[606].base_value_ = "/tmp/mysqlx.sock" ;
    ObSysVars[606].alias_ = "OB_SV_MYSQLX_SOCKET" ;
    }();

    [&] (){
      ObSysVars[607].default_value_ = "" ;
      ObSysVars[607].info_ = "mock for mysql5.7" ;
      ObSysVars[607].name_ = "mysqlx_ssl_ca" ;
    ...
    [&] (){
      ...
      ObSysVars[608].id_ = SYS_VAR_MYSQLX_SSL_CAPATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CAPATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CAPATH] = 608 ;
      ObSysVars[608].base_value_ = "" ;
    ObSysVars[608].alias_ = "OB_SV_MYSQLX_SSL_CAPATH" ;
    }();

    [&] (){
      ObSysVars[609].default_value_ = "" ;
      ObSysVars[609].info_ = "mock for mysql5.7" ;
      ObSysVars[609].name_ = "mysqlx_ssl_cert" ;
      ...
      ObSysVars[609].id_ = SYS_VAR_MYSQLX_SSL_CERT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CERT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CERT] = 609 ;
      ObSysVars[609].base_value_ = "" ;
    ObSysVars[609].alias_ = "OB_SV_MYSQLX_SSL_CERT" ;
    }();

    [&] (){
      ObSysVars[610].default_value_ = "" ;
      ObSysVars[610].info_ = "mock for mysql5.7" ;
      ObSysVars[610].name_ = "mysqlx_ssl_cipher" ;
      ...
      ObSysVars[610].id_ = SYS_VAR_MYSQLX_SSL_CIPHER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CIPHER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CIPHER] = 610 ;
      ObSysVars[610].base_value_ = "" ;
    ObSysVars[610].alias_ = "OB_SV_MYSQLX_SSL_CIPHER" ;
    }();

    [&] (){
      ObSysVars[611].default_value_ = "" ;
      ObSysVars[611].info_ = "mock for mysql5.7" ;
      ObSysVars[611].name_ = "mysqlx_ssl_crl" ;
      ...
      ObSysVars[611].id_ = SYS_VAR_MYSQLX_SSL_CRL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CRL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CRL] = 611 ;
      ObSysVars[611].base_value_ = "" ;
    ObSysVars[611].alias_ = "OB_SV_MYSQLX_SSL_CRL" ;
    }();

    [&] (){
      ObSysVars[612].default_value_ = "" ;
      ObSysVars[612].info_ = "mock for mysql5.7" ;
      ObSysVars[612].name_ = "mysqlx_ssl_crlpath" ;
      ...
      ObSysVars[612].id_ = SYS_VAR_MYSQLX_SSL_CRLPATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CRLPATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CRLPATH] = 612 ;
      ObSysVars[612].base_value_ = "" ;
    ObSysVars[612].alias_ = "OB_SV_MYSQLX_SSL_CRLPATH" ;
    }();

    [&] (){
      ObSysVars[613].default_value_ = "" ;
      ObSysVars[613].info_ = "mock for mysql5.7" ;
      ObSysVars[613].name_ = "mysqlx_ssl_key" ;
      ...
      ObSysVars[613].id_ = SYS_VAR_MYSQLX_SSL_KEY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_KEY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_KEY] = 613 ;
      ObSysVars[613].base_value_ = "" ;
    ObSysVars[613].alias_ = "OB_SV_MYSQLX_SSL_KEY" ;
    }();

    [&] (){
      ObSysVars[614].default_value_ = "0" ;
      ObSysVars[614].info_ = "mock for mysql5.7" ;
      ObSysVars[614].name_ = "old" ;
      ...
      ObSysVars[614].id_ = SYS_VAR_OLD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OLD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OLD] = 614 ;
      ObSysVars[614].base_value_ = "0" ;
    ObSysVars[614].alias_ = "OB_SV_OLD" ;
    }();

    [&] (){
      ObSysVars[615].default_value_ = "-1" ;
      ObSysVars[615].info_ = "mock for mysql5.7" ;
      ObSysVars[615].name_ = "performance_schema_accounts_size" ;
      ...
      ObSysVars[615].id_ = SYS_VAR_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE] = 615 ;
      ObSysVars[615].base_value_ = "-1" ;
    ObSysVars[615].alias_ = "OB_SV_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[616].default_value_ = "10000" ;
      ObSysVars[616].info_ = "mock for mysql5.7" ;
      ObSysVars[616].name_ = "performance_schema_digests_size" ;
      ...
      ObSysVars[616].id_ = SYS_VAR_PERFORMANCE_SCHEMA_DIGESTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_DIGESTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_DIGESTS_SIZE] = 616 ;
      ObSysVars[616].base_value_ = "10000" ;
    ObSysVars[616].alias_ = "OB_SV_PERFORMANCE_SCHEMA_DIGESTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[617].default_value_ = "10000" ;
      ObSysVars[617].info_ = "mock for mysql5.7" ;
      ObSysVars[617].name_ = "performance_schema_events_stages_history_long_size" ;
      ...
      ObSysVars[617].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE] = 617 ;
      ObSysVars[617].base_value_ = "10000" ;
    ObSysVars[617].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[618].default_value_ = "10" ;
      ObSysVars[618].info_ = "mock for mysql5.7" ;
      ObSysVars[618].name_ = "performance_schema_events_stages_history_size" ;
      ...
      ObSysVars[618].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE] = 618 ;
      ObSysVars[618].base_value_ = "10" ;
    ObSysVars[618].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[619].default_value_ = "10000" ;
      ObSysVars[619].info_ = "mock for mysql5.7" ;
      ObSysVars[619].name_ = "performance_schema_events_statements_history_long_size" ;
      ...
      ObSysVars[619].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE] = 619 ;
      ObSysVars[619].base_value_ = "10000" ;
    ObSysVars[619].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[620].default_value_ = "10" ;
      ObSysVars[620].info_ = "mock for mysql5.7" ;
      ObSysVars[620].name_ = "performance_schema_events_statements_history_size" ;
      ...
      ObSysVars[620].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE] = 620 ;
      ObSysVars[620].base_value_ = "10" ;
    ObSysVars[620].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[621].default_value_ = "10000" ;
      ObSysVars[621].info_ = "mock for mysql5.7" ;
      ObSysVars[621].name_ = "performance_schema_events_transactions_history_long_size" ;
      ...
      ObSysVars[621].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE] = 621 ;
      ObSysVars[621].base_value_ = "10000" ;
    ObSysVars[621].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[622].default_value_ = "10" ;
      ObSysVars[622].info_ = "mock for mysql5.7" ;
      ObSysVars[622].name_ = "performance_schema_events_transactions_history_size" ;
      ...
      ObSysVars[622].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE] = 622 ;
      ObSysVars[622].base_value_ = "10" ;
    ObSysVars[622].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[623].default_value_ = "10000" ;
      ObSysVars[623].info_ = "mock for mysql5.7" ;
      ObSysVars[623].name_ = "performance_schema_events_waits_history_long_size" ;
      ...
      ObSysVars[623].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE] = 623 ;
      ObSysVars[623].base_value_ = "10000" ;
    ObSysVars[623].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[624].default_value_ = "10" ;
      ObSysVars[624].info_ = "mock for mysql5.7" ;
      ObSysVars[624].name_ = "performance_schema_events_waits_history_size" ;
      ...
      ObSysVars[624].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE] = 624 ;
      ObSysVars[624].base_value_ = "10" ;
    ObSysVars[624].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[625].default_value_ = "-1" ;
      ObSysVars[625].info_ = "mock for mysql5.7" ;
      ObSysVars[625].name_ = "performance_schema_hosts_size" ;
      ...
      ObSysVars[625].id_ = SYS_VAR_PERFORMANCE_SCHEMA_HOSTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_HOSTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_HOSTS_SIZE] = 625 ;
      ObSysVars[625].base_value_ = "-1" ;
    ObSysVars[625].alias_ = "OB_SV_PERFORMANCE_SCHEMA_HOSTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[626].default_value_ = "80" ;
      ObSysVars[626].info_ = "mock for mysql5.7" ;
      ObSysVars[626].name_ = "performance_schema_max_cond_classes" ;
      ...
      ObSysVars[626].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_CLASSES] = 626 ;
      ObSysVars[626].base_value_ = "80" ;
    ObSysVars[626].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_COND_CLASSES" ;
    }();

    [&] (){
      ObSysVars[627].default_value_ = "-1" ;
      ObSysVars[627].info_ = "mock for mysql5.7" ;
      ObSysVars[627].name_ = "performance_schema_max_cond_instances" ;
      ...
      ObSysVars[627].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES] = 627 ;
      ObSysVars[627].base_value_ = "-1" ;
    ObSysVars[627].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[628].default_value_ = "1024" ;
      ObSysVars[628].info_ = "mock for mysql5.7" ;
      ObSysVars[628].name_ = "performance_schema_max_digest_length" ;
      ...
      ObSysVars[628].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH] = 628 ;
      ObSysVars[628].base_value_ = "1024" ;
    ObSysVars[628].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH" ;
    }();

    [&] (){
      ObSysVars[629].default_value_ = "80" ;
      ObSysVars[629].info_ = "mock for mysql5.7" ;
      ObSysVars[629].name_ = "performance_schema_max_file_classes" ;
      ...
      ObSysVars[629].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES] = 629 ;
      ObSysVars[629].base_value_ = "80" ;
    ObSysVars[629].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES" ;
    }();

    [&] (){
      ObSysVars[630].default_value_ = "32768" ;
      ObSysVars[630].info_ = "mock for mysql5.7" ;
      ObSysVars[630].name_ = "performance_schema_max_file_handles" ;
      ...
      ObSysVars[630].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES] = 630 ;
      ObSysVars[630].base_value_ = "32768" ;
    ObSysVars[630].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES" ;
    }();

    [&] (){
      ObSysVars[631].default_value_ = "-1" ;
      ObSysVars[631].info_ = "mock for mysql5.7" ;
      ObSysVars[631].name_ = "performance_schema_max_file_instances" ;
      ...
      ObSysVars[631].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES] = 631 ;
      ObSysVars[631].base_value_ = "-1" ;
    ObSysVars[631].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[632].default_value_ = "-1" ;
      ObSysVars[632].info_ = "mock for mysql5.7" ;
      ObSysVars[632].name_ = "performance_schema_max_index_stat" ;
      ...
      ObSysVars[632].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_INDEX_STAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_INDEX_STAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_INDEX_STAT] = 632 ;
      ObSysVars[632].base_value_ = "-1" ;
    ObSysVars[632].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_INDEX_STAT" ;
    }();

    [&] (){
      ObSysVars[633].default_value_ = "320" ;
      ObSysVars[633].info_ = "mock for mysql5.7" ;
      ObSysVars[633].name_ = "performance_schema_max_memory_classes" ;
      ...
      ObSysVars[633].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES] = 633 ;
      ObSysVars[633].base_value_ = "320" ;
    ObSysVars[633].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES" ;
    }();

    [&] (){
      ObSysVars[634].default_value_ = "-1" ;
      ObSysVars[634].info_ = "mock for mysql5.7" ;
      ObSysVars[634].name_ = "performance_schema_max_metadata_locks" ;
      ...
      ObSysVars[634].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS] = 634 ;
      ObSysVars[634].base_value_ = "-1" ;
    ObSysVars[634].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS" ;
    }();

    [&] (){
      ObSysVars[635].default_value_ = "210" ;
      ObSysVars[635].info_ = "mock for mysql5.7" ;
      ObSysVars[635].name_ = "performance_schema_max_mutex_classes" ;
      ...
      ObSysVars[635].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES] = 635 ;
      ObSysVars[635].base_value_ = "210" ;
    ObSysVars[635].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES" ;
    }();

    [&] (){
      ObSysVars[636].default_value_ = "-1" ;
      ObSysVars[636].info_ = "mock for mysql5.7" ;
      ObSysVars[636].name_ = "performance_schema_max_mutex_instances" ;
      ...
      ObSysVars[636].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES] = 636 ;
      ObSysVars[636].base_value_ = "-1" ;
    ObSysVars[636].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[637].default_value_ = "-1" ;
      ObSysVars[637].info_ = "mock for mysql5.7" ;
      ObSysVars[637].name_ = "performance_schema_max_prepared_statements_instances" ;
      ...
      ObSysVars[637].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES] = 637 ;
      ObSysVars[637].base_value_ = "-1" ;
    ObSysVars[637].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[638].default_value_ = "-1" ;
      ObSysVars[638].info_ = "mock for mysql5.7" ;
      ObSysVars[638].name_ = "performance_schema_max_program_instances" ;
      ...
      ObSysVars[638].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES] = 638 ;
      ObSysVars[638].base_value_ = "-1" ;
    ObSysVars[638].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[639].default_value_ = "50" ;
      ObSysVars[639].info_ = "mock for mysql5.7" ;
      ObSysVars[639].name_ = "performance_schema_max_rwlock_classes" ;
      ...
      ObSysVars[639].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES] = 639 ;
      ObSysVars[639].base_value_ = "50" ;
    ObSysVars[639].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES" ;
    }();

    [&] (){
      ObSysVars[640].default_value_ = "-1" ;
      ObSysVars[640].info_ = "mock for mysql5.7" ;
      ObSysVars[640].name_ = "performance_schema_max_rwlock_instances" ;
      ...
      ObSysVars[640].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES] = 640 ;
      ObSysVars[640].base_value_ = "-1" ;
    ObSysVars[640].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[641].default_value_ = "10" ;
      ObSysVars[641].info_ = "mock for mysql5.7" ;
      ObSysVars[641].name_ = "performance_schema_max_socket_classes" ;
      ...
      ObSysVars[641].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES] = 641 ;
      ObSysVars[641].base_value_ = "10" ;
    ObSysVars[641].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES" ;
    }();

    [&] (){
      ObSysVars[642].default_value_ = "-1" ;
      ObSysVars[642].info_ = "mock for mysql5.7" ;
      ObSysVars[642].name_ = "performance_schema_max_socket_instances" ;
      ...
      ObSysVars[642].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES] = 642 ;
      ObSysVars[642].base_value_ = "-1" ;
    ObSysVars[642].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[643].default_value_ = "1024" ;
      ObSysVars[643].info_ = "mock for mysql5.7" ;
      ObSysVars[643].name_ = "performance_schema_max_sql_text_length" ;
      ...
      ObSysVars[643].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH] = 643 ;
      ObSysVars[643].base_value_ = "1024" ;
    ObSysVars[643].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH" ;
    }();

    [&] (){
      ObSysVars[644].default_value_ = "150" ;
      ObSysVars[644].info_ = "mock for mysql5.7" ;
      ObSysVars[644].name_ = "performance_schema_max_stage_classes" ;
      ...
      ObSysVars[644].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES] = 644 ;
      ObSysVars[644].base_value_ = "150" ;
    ObSysVars[644].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES" ;
    }();

    [&] (){
      ObSysVars[645].default_value_ = "193" ;
      ObSysVars[645].info_ = "mock for mysql5.7" ;
      ObSysVars[645].name_ = "performance_schema_max_statement_classes" ;
      ...
      ObSysVars[645].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES] = 645 ;
      ObSysVars[645].base_value_ = "193" ;
    ObSysVars[645].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES" ;
    }();

    [&] (){
      ObSysVars[646].default_value_ = "10" ;
      ObSysVars[646].info_ = "mock for mysql5.7" ;
      ObSysVars[646].name_ = "performance_schema_max_statement_stack" ;
      ...
      ObSysVars[646].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK] = 646 ;
      ObSysVars[646].base_value_ = "10" ;
    ObSysVars[646].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK" ;
    }();

    [&] (){
      ObSysVars[647].default_value_ = "-1" ;
      ObSysVars[647].info_ = "mock for mysql5.7" ;
      ObSysVars[647].name_ = "performance_schema_max_table_handles" ;
      ...
      ObSysVars[647].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES] = 647 ;
      ObSysVars[647].base_value_ = "-1" ;
    ObSysVars[647].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES" ;
    }();

    [&] (){
      ObSysVars[648].default_value_ = "-1" ;
      ObSysVars[648].info_ = "mock for mysql5.7" ;
      ObSysVars[648].name_ = "performance_schema_max_table_instances" ;
      ...
      ObSysVars[648].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES] = 648 ;
      ObSysVars[648].base_value_ = "-1" ;
    ObSysVars[648].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[649].default_value_ = "-1" ;
      ObSysVars[649].info_ = "mock for mysql5.7" ;
      ObSysVars[649].name_ = "performance_schema_max_table_lock_stat" ;
      ...
      ObSysVars[649].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT] = 649 ;
      ObSysVars[649].base_value_ = "-1" ;
    ObSysVars[649].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT" ;
    }();

    [&] (){
      ObSysVars[650].default_value_ = "50" ;
      ObSysVars[650].info_ = "mock for mysql5.7" ;
      ObSysVars[650].name_ = "performance_schema_max_thread_classes" ;
      ...
      ObSysVars[650].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES] = 650 ;
      ObSysVars[650].base_value_ = "50" ;
    ObSysVars[650].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES" ;
    }();

    [&] (){
      ObSysVars[651].default_value_ = "-1" ;
      ObSysVars[651].info_ = "mock for mysql5.7" ;
      ObSysVars[651].name_ = "performance_schema_max_thread_instances" ;
      ...
      ObSysVars[651].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES] = 651 ;
      ObSysVars[651].base_value_ = "-1" ;
    ObSysVars[651].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[652].default_value_ = "512" ;
      ObSysVars[652].info_ = "mock for mysql5.7" ;
      ObSysVars[652].name_ = "performance_schema_session_connect_attrs_size" ;
      ...
      ObSysVars[652].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE] = 652 ;
      ObSysVars[652].base_value_ = "512" ;
    ObSysVars[652].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE" ;
    }();

    [&] (){
      ObSysVars[653].default_value_ = "-1" ;
      ObSysVars[653].info_ = "mock for mysql5.7" ;
      ObSysVars[653].name_ = "performance_schema_setup_actors_size" ;
      ...
      ObSysVars[653].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE] = 653 ;
      ObSysVars[653].base_value_ = "-1" ;
    ObSysVars[653].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE" ;
    }();

    [&] (){
      ObSysVars[654].default_value_ = "-1" ;
      ObSysVars[654].info_ = "mock for mysql5.7" ;
      ObSysVars[654].name_ = "performance_schema_setup_objects_size" ;
      ...
      ObSysVars[654].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE] = 654 ;
      ObSysVars[654].base_value_ = "-1" ;
    ObSysVars[654].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[655].default_value_ = "-1" ;
      ObSysVars[655].info_ = "mock for mysql5.7" ;
      ObSysVars[655].name_ = "performance_schema_users_size" ;
      ...
      ObSysVars[655].id_ = SYS_VAR_PERFORMANCE_SCHEMA_USERS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_USERS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_USERS_SIZE] = 655 ;
      ObSysVars[655].base_value_ = "-1" ;
    ObSysVars[655].alias_ = "OB_SV_PERFORMANCE_SCHEMA_USERS_SIZE" ;
    }();

    [&] (){
      ObSysVars[656].default_value_ = "0" ;
      ObSysVars[656].info_ = "mock for mysql5.7" ;
      ObSysVars[656].name_ = "version_tokens_session_number" ;
      ...
      ObSysVars[656].id_ = SYS_VAR_VERSION_TOKENS_SESSION_NUMBER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_VERSION_TOKENS_SESSION_NUMBER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_VERSION_TOKENS_SESSION_NUMBER] = 656 ;
      ObSysVars[656].base_value_ = "0" ;
    ObSysVars[656].alias_ = "OB_SV_VERSION_TOKENS_SESSION_NUMBER" ;
    }();

    [&] (){
      ObSysVars[657].default_value_ = "80" ;
      ObSysVars[657].info_ = "mock for mysql5.7" ;
      ObSysVars[657].name_ = "back_log" ;
      ...
      ObSysVars[657].id_ = SYS_VAR_BACK_LOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BACK_LOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BACK_LOG] = 657 ;
      ObSysVars[657].base_value_ = "80" ;
    ObSysVars[657].alias_ = "OB_SV_BACK_LOG" ;
    }();

    [&] (){
      ObSysVars[658].default_value_ = "/usr/local/mysql/" ;
      ObSysVars[658].info_ = "mock for mysql5.7" ;
      ObSysVars[658].name_ = "basedir" ;
      ...
      ObSysVars[658].id_ = SYS_VAR_BASEDIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BASEDIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BASEDIR] = 658 ;
      ObSysVars[658].base_value_ = "/usr/local/mysql/" ;
    ObSysVars[658].alias_ = "OB_SV_BASEDIR" ;
    }();

    [&] (){
      ObSysVars[659].default_value_ = "*" ;
      ObSysVars[659].info_ = "mock for mysql5.7" ;
      ObSysVars[659].name_ = "bind_address" ;
    ...
    [&] (){
      ...
      ObSysVars[664].id_ = SYS_VAR_INNODB_NUMA_INTERLEAVE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_NUMA_INTERLEAVE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_NUMA_INTERLEAVE] = 664 ;
      ObSysVars[664].base_value_ = "0" ;
    ObSysVars[664].alias_ = "OB_SV_INNODB_NUMA_INTERLEAVE" ;
    }();

    [&] (){
      ObSysVars[665].default_value_ = "2000" ;
      ObSysVars[665].info_ = "mock for mysql5.7" ;
      ObSysVars[665].name_ = "innodb_open_files" ;
      ...
      ObSysVars[665].id_ = SYS_VAR_INNODB_OPEN_FILES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_OPEN_FILES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_OPEN_FILES] = 665 ;
      ObSysVars[665].base_value_ = "2000" ;
    ObSysVars[665].alias_ = "OB_SV_INNODB_OPEN_FILES" ;
    }();

    [&] (){
      ObSysVars[666].default_value_ = "1" ;
      ObSysVars[666].info_ = "mock for mysql5.7" ;
      ObSysVars[666].name_ = "innodb_page_cleaners" ;
      ...
      ObSysVars[666].id_ = SYS_VAR_INNODB_PAGE_CLEANERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_PAGE_CLEANERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_PAGE_CLEANERS] = 666 ;
      ObSysVars[666].base_value_ = "1" ;
    ObSysVars[666].alias_ = "OB_SV_INNODB_PAGE_CLEANERS" ;
    }();

    [&] (){
      ObSysVars[667].default_value_ = "4" ;
      ObSysVars[667].info_ = "mock for mysql5.7" ;
      ObSysVars[667].name_ = "innodb_purge_threads" ;
      ...
      ObSysVars[667].id_ = SYS_VAR_INNODB_PURGE_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_PURGE_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_PURGE_THREADS] = 667 ;
      ObSysVars[667].base_value_ = "4" ;
    ObSysVars[667].alias_ = "OB_SV_INNODB_PURGE_THREADS" ;
    }();

    [&] (){
      ObSysVars[668].default_value_ = "4" ;
      ObSysVars[668].info_ = "mock for mysql5.7" ;
      ObSysVars[668].name_ = "innodb_read_io_threads" ;
      ...
      ObSysVars[668].id_ = SYS_VAR_INNODB_READ_IO_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_READ_IO_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_READ_IO_THREADS] = 668 ;
      ObSysVars[668].base_value_ = "4" ;
    ObSysVars[668].alias_ = "OB_SV_INNODB_READ_IO_THREADS" ;
    }();

    [&] (){
      ObSysVars[669].default_value_ = "1" ;
      ObSysVars[669].info_ = "mock for mysql5.7" ;
      ObSysVars[669].name_ = "innodb_sync_array_size" ;
      ...
      ObSysVars[669].id_ = SYS_VAR_INNODB_SYNC_ARRAY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SYNC_ARRAY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SYNC_ARRAY_SIZE] = 669 ;
      ObSysVars[669].base_value_ = "1" ;
    ObSysVars[669].alias_ = "OB_SV_INNODB_SYNC_ARRAY_SIZE" ;
    }();

    [&] (){
      ObSysVars[670].default_value_ = "1" ;
      ObSysVars[670].info_ = "mock for mysql5.7" ;
      ObSysVars[670].name_ = "innodb_use_native_aio" ;
      ...
      ObSysVars[670].id_ = SYS_VAR_INNODB_USE_NATIVE_AIO ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_USE_NATIVE_AIO)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_USE_NATIVE_AIO] = 670 ;
      ObSysVars[670].base_value_ = "1" ;
    ObSysVars[670].alias_ = "OB_SV_INNODB_USE_NATIVE_AIO" ;
    }();

    [&] (){
      ObSysVars[671].default_value_ = "4" ;
      ObSysVars[671].info_ = "mock for mysql5.7" ;
      ObSysVars[671].name_ = "innodb_write_io_threads" ;
      ...
      ObSysVars[671].id_ = SYS_VAR_INNODB_WRITE_IO_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_WRITE_IO_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_WRITE_IO_THREADS] = 671 ;
      ObSysVars[671].base_value_ = "4" ;
    ObSysVars[671].alias_ = "OB_SV_INNODB_WRITE_IO_THREADS" ;
    }();

    [&] (){
      ObSysVars[672].default_value_ = "1" ;
      ObSysVars[672].info_ = "mock for mysql5.7" ;
      ObSysVars[672].name_ = "large_files_support" ;
      ...
      ObSysVars[672].id_ = SYS_VAR_LARGE_FILES_SUPPORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LARGE_FILES_SUPPORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LARGE_FILES_SUPPORT] = 672 ;
      ObSysVars[672].base_value_ = "1" ;
    ObSysVars[672].alias_ = "OB_SV_LARGE_FILES_SUPPORT" ;
    }();

    [&] (){
      ObSysVars[673].default_value_ = "0" ;
      ObSysVars[673].info_ = "mock for mysql5.7" ;
      ObSysVars[673].name_ = "large_pages" ;
    ...
    [&] (){
      ...
      ObSysVars[675].id_ = SYS_VAR_LOCKED_IN_MEMORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOCKED_IN_MEMORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOCKED_IN_MEMORY] = 675 ;
      ObSysVars[675].base_value_ = "0" ;
    ObSysVars[675].alias_ = "OB_SV_LOCKED_IN_MEMORY" ;
    }();

    [&] (){
      ObSysVars[676].default_value_ = "./obrd.16c.vd3-s2h6-n3.err" ;
      ObSysVars[676].info_ = "mock for mysql5.7" ;
      ObSysVars[676].name_ = "log_error" ;
      ...
      ObSysVars[676].id_ = SYS_VAR_LOG_ERROR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_ERROR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_ERROR] = 676 ;
      ObSysVars[676].base_value_ = "./obrd.16c.vd3-s2h6-n3.err" ;
    ObSysVars[676].alias_ = "OB_SV_LOG_ERROR" ;
    }();

    [&] (){
      ObSysVars[677].default_value_ = "0" ;
      ObSysVars[677].info_ = "mock for mysql5.7" ;
      ObSysVars[677].name_ = "named_pipe" ;
      ...
      ObSysVars[677].id_ = SYS_VAR_NAMED_PIPE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NAMED_PIPE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NAMED_PIPE] = 677 ;
      ObSysVars[677].base_value_ = "0" ;
    ObSysVars[677].alias_ = "OB_SV_NAMED_PIPE" ;
    }();
    ...
    [&] (){
      ObSysVars[679].default_value_ = "655360" ;
      ObSysVars[679].info_ = "mock for mysql5.7" ;
      ObSysVars[679].name_ = "open_files_limit" ;
      ...
      ObSysVars[679].id_ = SYS_VAR_OPEN_FILES_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPEN_FILES_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPEN_FILES_LIMIT] = 679 ;
      ObSysVars[679].base_value_ = "655360" ;
    ObSysVars[679].alias_ = "OB_SV_OPEN_FILES_LIMIT" ;
    }();

    [&] (){
      ObSysVars[680].default_value_ = "null" ;
      ObSysVars[680].info_ = "mock for mysql5.7" ;
      ObSysVars[680].name_ = "report_host" ;
    ...
    [&] (){
      ...
      ObSysVars[683].id_ = SYS_VAR_REPORT_USER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REPORT_USER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REPORT_USER] = 683 ;
      ObSysVars[683].base_value_ = "null" ;
    ObSysVars[683].alias_ = "OB_SV_REPORT_USER" ;
    }();

    [&] (){
      ObSysVars[684].default_value_ = "32" ;
      ObSysVars[684].info_ = "mock for mysql5.7" ;
      ObSysVars[684].name_ = "server_id_bits" ;
      ...
      ObSysVars[684].id_ = SYS_VAR_SERVER_ID_BITS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SERVER_ID_BITS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SERVER_ID_BITS] = 684 ;
      ObSysVars[684].base_value_ = "32" ;
    ObSysVars[684].alias_ = "OB_SV_SERVER_ID_BITS" ;
    }();

    [&] (){
      ObSysVars[685].default_value_ = "0" ;
      ObSysVars[685].info_ = "mock for mysql5.7" ;
      ObSysVars[685].name_ = "shared_memory" ;
      ...
      ObSysVars[685].id_ = SYS_VAR_SHARED_MEMORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHARED_MEMORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHARED_MEMORY] = 685 ;
      ObSysVars[685].base_value_ = "0" ;
    ObSysVars[685].alias_ = "OB_SV_SHARED_MEMORY" ;
    }();

    [&] (){
      ObSysVars[686].default_value_ = "MYSQL" ;
      ObSysVars[686].info_ = "mock for mysql5.7" ;
      ObSysVars[686].name_ = "shared_memory_base_name" ;
      ...
      ObSysVars[686].id_ = SYS_VAR_SHARED_MEMORY_BASE_NAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHARED_MEMORY_BASE_NAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHARED_MEMORY_BASE_NAME] = 686 ;
      ObSysVars[686].base_value_ = "MYSQL" ;
    ObSysVars[686].alias_ = "OB_SV_SHARED_MEMORY_BASE_NAME" ;
    }();

    [&] (){
      ObSysVars[687].default_value_ = "0" ;
      ObSysVars[687].info_ = "mock for mysql5.7" ;
      ObSysVars[687].name_ = "skip_name_resolve" ;
      ...
      ObSysVars[687].id_ = SYS_VAR_SKIP_NAME_RESOLVE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SKIP_NAME_RESOLVE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SKIP_NAME_RESOLVE] = 687 ;
      ObSysVars[687].base_value_ = "0" ;
    ObSysVars[687].alias_ = "OB_SV_SKIP_NAME_RESOLVE" ;
    }();

    [&] (){
      ObSysVars[688].default_value_ = "0" ;
      ObSysVars[688].info_ = "mock for mysql5.7" ;
      ObSysVars[688].name_ = "skip_networking" ;
    ...
    [&] (){
      ...
      ObSysVars[690].id_ = SYS_VAR_THREAD_POOL_ALGORITHM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_ALGORITHM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_ALGORITHM] = 690 ;
      ObSysVars[690].base_value_ = "0" ;
    ObSysVars[690].alias_ = "OB_SV_THREAD_POOL_ALGORITHM" ;
    }();

    [&] (){
      ObSysVars[691].default_value_ = "16" ;
      ObSysVars[691].info_ = "mock for mysql5.7" ;
      ObSysVars[691].name_ = "thread_pool_size" ;
      ...
      ObSysVars[691].id_ = SYS_VAR_THREAD_POOL_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_SIZE] = 691 ;
      ObSysVars[691].base_value_ = "16" ;
    ObSysVars[691].alias_ = "OB_SV_THREAD_POOL_SIZE" ;
    }();

    [&] (){
      ObSysVars[692].default_value_ = "262144" ;
      ObSysVars[692].info_ = "mock for mysql5.7" ;
      ObSysVars[692].name_ = "thread_stack" ;
      ...
      ObSysVars[692].id_ = SYS_VAR_THREAD_STACK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_STACK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_STACK] = 692 ;
      ObSysVars[692].base_value_ = "262144" ;
    ObSysVars[692].alias_ = "OB_SV_THREAD_STACK" ;
    }();

    [&] (){
      ObSysVars[693].default_value_ = "1" ;
      ObSysVars[693].info_ = "mock for mysql5.7" ;
      ObSysVars[693].name_ = "binlog_gtid_simple_recovery" ;
      ...
      ObSysVars[693].id_ = SYS_VAR_BINLOG_GTID_SIMPLE_RECOVERY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_GTID_SIMPLE_RECOVERY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_GTID_SIMPLE_RECOVERY] = 693 ;
      ObSysVars[693].base_value_ = "1" ;
    ObSysVars[693].alias_ = "OB_SV_BINLOG_GTID_SIMPLE_RECOVERY" ;
    }();

    [&] (){
      ObSysVars[694].default_value_ = "0" ;
      ObSysVars[694].info_ = "mock for mysql5.7" ;
      ObSysVars[694].name_ = "innodb_api_enable_binlog" ;
      ...
      ObSysVars[694].id_ = SYS_VAR_INNODB_API_ENABLE_BINLOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_API_ENABLE_BINLOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_API_ENABLE_BINLOG] = 694 ;
      ObSysVars[694].base_value_ = "0" ;
    ObSysVars[694].alias_ = "OB_SV_INNODB_API_ENABLE_BINLOG" ;
    }();

    [&] (){
      ObSysVars[695].default_value_ = "0" ;
      ObSysVars[695].info_ = "mock for mysql5.7" ;
      ObSysVars[695].name_ = "innodb_locks_unsafe_for_binlog" ;
      ...
      ObSysVars[695].id_ = SYS_VAR_INNODB_LOCKS_UNSAFE_FOR_BINLOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOCKS_UNSAFE_FOR_BINLOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOCKS_UNSAFE_FOR_BINLOG] = 695 ;
      ObSysVars[695].base_value_ = "0" ;
    ObSysVars[695].alias_ = "OB_SV_INNODB_LOCKS_UNSAFE_FOR_BINLOG" ;
    }();

    [&] (){
      ObSysVars[696].default_value_ = "16777216" ;
      ObSysVars[696].info_ = "mock for mysql5.7" ;
      ObSysVars[696].name_ = "innodb_log_buffer_size" ;
      ...
      ObSysVars[696].id_ = SYS_VAR_INNODB_LOG_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_BUFFER_SIZE] = 696 ;
      ObSysVars[696].base_value_ = "16777216" ;
    ObSysVars[696].alias_ = "OB_SV_INNODB_LOG_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[697].default_value_ = "2" ;
      ObSysVars[697].info_ = "mock for mysql5.7" ;
      ObSysVars[697].name_ = "innodb_log_files_in_group" ;
      ...
      ObSysVars[697].id_ = SYS_VAR_INNODB_LOG_FILES_IN_GROUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_FILES_IN_GROUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_FILES_IN_GROUP] = 697 ;
      ObSysVars[697].base_value_ = "2" ;
    ObSysVars[697].alias_ = "OB_SV_INNODB_LOG_FILES_IN_GROUP" ;
    }();

    [&] (){
      ObSysVars[698].default_value_ = "50331648" ;
      ObSysVars[698].info_ = "mock for mysql5.7" ;
      ObSysVars[698].name_ = "innodb_log_file_size" ;
      ...
      ObSysVars[698].id_ = SYS_VAR_INNODB_LOG_FILE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_FILE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_FILE_SIZE] = 698 ;
      ObSysVars[698].base_value_ = "50331648" ;
    ObSysVars[698].alias_ = "OB_SV_INNODB_LOG_FILE_SIZE" ;
    }();

    [&] (){
      ObSysVars[699].default_value_ = "./" ;
      ObSysVars[699].info_ = "mock for mysql5.7" ;
      ObSysVars[699].name_ = "innodb_log_group_home_dir" ;
      ObSysVars[699].data_type_ = ObVarcharType ;
      ObSysVars[699].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[699].id_ = SYS_VAR_INNODB_LOG_GROUP_HOME_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_GROUP_HOME_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_GROUP_HOME_DIR] = 699 ;
      ObSysVars[699].base_value_ = "./" ;
    ObSysVars[699].alias_ = "OB_SV_INNODB_LOG_GROUP_HOME_DIR" ;
    }();

    [&] (){
      ObSysVars[700].default_value_ = "./" ;
      ObSysVars[700].info_ = "mock for mysql5.7" ;
      ObSysVars[700].name_ = "innodb_undo_directory" ;
      ...
      ObSysVars[700].id_ = SYS_VAR_INNODB_UNDO_DIRECTORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_UNDO_DIRECTORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_UNDO_DIRECTORY] = 700 ;
      ObSysVars[700].base_value_ = "./" ;
    ObSysVars[700].alias_ = "OB_SV_INNODB_UNDO_DIRECTORY" ;
    }();

    [&] (){
      ObSysVars[701].default_value_ = "0" ;
      ObSysVars[701].info_ = "mock for mysql5.7" ;
      ObSysVars[701].name_ = "innodb_undo_tablespaces" ;
      ...
      ObSysVars[701].id_ = SYS_VAR_INNODB_UNDO_TABLESPACES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_UNDO_TABLESPACES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_UNDO_TABLESPACES] = 701 ;
      ObSysVars[701].base_value_ = "0" ;
    ObSysVars[701].alias_ = "OB_SV_INNODB_UNDO_TABLESPACES" ;
    }();

    [&] (){
      ObSysVars[702].default_value_ = "null" ;
      ObSysVars[702].info_ = "mock for mysql5.7" ;
      ObSysVars[702].name_ = "log_bin_basename" ;
      ...
      ObSysVars[702].id_ = SYS_VAR_LOG_BIN_BASENAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_BIN_BASENAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_BIN_BASENAME] = 702 ;
      ObSysVars[702].base_value_ = "null" ;
    ObSysVars[702].alias_ = "OB_SV_LOG_BIN_BASENAME" ;
    }();

    [&] (){
      ObSysVars[703].default_value_ = "null" ;
      ObSysVars[703].info_ = "mock for mysql5.7" ;
      ObSysVars[703].name_ = "log_bin_index" ;
      ...
      ObSysVars[703].id_ = SYS_VAR_LOG_BIN_INDEX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_BIN_INDEX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_BIN_INDEX] = 703 ;
      ObSysVars[703].base_value_ = "null" ;
    ObSysVars[703].alias_ = "OB_SV_LOG_BIN_INDEX" ;
    }();

    [&] (){
      ObSysVars[704].default_value_ = "0" ;
      ObSysVars[704].info_ = "mock for mysql5.7" ;
      ObSysVars[704].name_ = "log_slave_updates" ;
      ObSysVars[704].data_type_ = ObIntType ;
      ObSysVars[704].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[704].id_ = SYS_VAR_LOG_SLAVE_UPDATES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_SLAVE_UPDATES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_SLAVE_UPDATES] = 704 ;
      ObSysVars[704].base_value_ = "0" ;
    ObSysVars[704].alias_ = "OB_SV_LOG_SLAVE_UPDATES" ;
    }();

    [&] (){
      ObSysVars[705].default_value_ = "null" ;
      ObSysVars[705].info_ = "mock for mysql5.7" ;
      ObSysVars[705].name_ = "relay_log" ;
      ...
      ObSysVars[705].id_ = SYS_VAR_RELAY_LOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG] = 705 ;
      ObSysVars[705].base_value_ = "null" ;
    ObSysVars[705].alias_ = "OB_SV_RELAY_LOG" ;
    }();

    [&] (){
      ObSysVars[706].default_value_ = "/usr/local/mysql/data/obrd-relay-bin" ;
      ObSysVars[706].info_ = "mock for mysql5.7" ;
      ObSysVars[706].name_ = "relay_log_basename" ;
      ObSysVars[706].data_type_ = ObVarcharType ;
      ObSysVars[706].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[706].id_ = SYS_VAR_RELAY_LOG_BASENAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_BASENAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_BASENAME] = 706 ;
      ObSysVars[706].base_value_ = "/usr/local/mysql/data/obrd-relay-bin" ;
    ObSysVars[706].alias_ = "OB_SV_RELAY_LOG_BASENAME" ;
    }();

    [&] (){
      ObSysVars[707].default_value_ = "/usr/local/mysql/data/obrd-relay-bin.index" ;
      ObSysVars[707].info_ = "mock for mysql5.7" ;
      ObSysVars[707].name_ = "relay_log_index" ;
      ...
      ObSysVars[707].id_ = SYS_VAR_RELAY_LOG_INDEX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_INDEX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_INDEX] = 707 ;
      ObSysVars[707].base_value_ = "/usr/local/mysql/data/obrd-relay-bin.index" ;
    ObSysVars[707].alias_ = "OB_SV_RELAY_LOG_INDEX" ;
    }();

    [&] (){
      ObSysVars[708].default_value_ = "relay-log.info" ;
      ObSysVars[708].info_ = "mock for mysql5.7" ;
      ObSysVars[708].name_ = "relay_log_info_file" ;
      ...
      ObSysVars[708].id_ = SYS_VAR_RELAY_LOG_INFO_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_INFO_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_INFO_FILE] = 708 ;
      ObSysVars[708].base_value_ = "relay-log.info" ;
    ObSysVars[708].alias_ = "OB_SV_RELAY_LOG_INFO_FILE" ;
    }();

    [&] (){
      ObSysVars[709].default_value_ = "0" ;
      ObSysVars[709].info_ = "mock for mysql5.7" ;
      ObSysVars[709].name_ = "relay_log_recovery" ;
      ...
      ObSysVars[709].id_ = SYS_VAR_RELAY_LOG_RECOVERY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_RECOVERY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_RECOVERY] = 709 ;
      ObSysVars[709].base_value_ = "0" ;
    ObSysVars[709].alias_ = "OB_SV_RELAY_LOG_RECOVERY" ;
    }();

    [&] (){
      ObSysVars[710].default_value_ = "0" ;
      ObSysVars[710].info_ = "mock for mysql5.7" ;
      ObSysVars[710].name_ = "relay_log_space_limit" ;
      ...
      ObSysVars[710].id_ = SYS_VAR_RELAY_LOG_SPACE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_SPACE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_SPACE_LIMIT] = 710 ;
      ObSysVars[710].base_value_ = "0" ;
    ObSysVars[710].alias_ = "OB_SV_RELAY_LOG_SPACE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[711].default_value_ = "0" ;
      ObSysVars[711].info_ = "This variable specifies how to use delayed key writes. It applies only to MyISAM tables. Delayed key writing causes key buffers not to be flushed between writes, merely simulates MySQL 5.7" ;
      ObSysVars[711].name_ = "delay_key_write" ;
      ObSysVars[711].data_type_ = ObIntType ;
      ObSysVars[711].enum_names_ = "[u'ON', u'OFF', u'ALL']" ;
      ObSysVars[711].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[711].id_ = SYS_VAR_DELAY_KEY_WRITE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DELAY_KEY_WRITE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DELAY_KEY_WRITE] = 711 ;
      ObSysVars[711].base_value_ = "0" ;
    ObSysVars[711].alias_ = "OB_SV_DELAY_KEY_WRITE" ;
    }();

    [&] (){
      ObSysVars[712].default_value_ = "0" ;
      ObSysVars[712].info_ = "When this option is enabled, index key prefixes longer than 767 bytes (up to 3072 bytes) are allowed for InnoDB tables that use DYNAMIC or COMPRESSED row format, merely simulates MySQL 5.7" ;
      ObSysVars[712].name_ = "innodb_large_prefix" ;
      ObSysVars[712].data_type_ = ObIntType ;
      ObSysVars[712].enum_names_ = "[u'ON', u'OFF']" ;
      ObSysVars[712].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[712].id_ = SYS_VAR_INNODB_LARGE_PREFIX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LARGE_PREFIX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LARGE_PREFIX] = 712 ;
      ObSysVars[712].base_value_ = "0" ;
    ObSysVars[712].alias_ = "OB_SV_INNODB_LARGE_PREFIX" ;
    }();

    [&] (){
      ObSysVars[713].default_value_ = "8388608" ;
      ObSysVars[713].info_ = "The size of the buffer used for index blocks, merely simulates MySQL 5.7" ;
      ObSysVars[713].name_ = "key_buffer_size" ;
      ...
      ObSysVars[713].id_ = SYS_VAR_KEY_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_BUFFER_SIZE] = 713 ;
      ObSysVars[713].base_value_ = "8388608" ;
    ObSysVars[713].alias_ = "OB_SV_KEY_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[714].default_value_ = "300" ;
      ObSysVars[714].info_ = "This value controls the demotion of buffers from the hot sublist of a key cache to the warm sublist. Lower values cause demotion to happen more quickly, merely simulates MySQL 5.7" ;
      ObSysVars[714].name_ = "key_cache_age_threshold" ;
      ObSysVars[714].data_type_ = ObUInt64Type ;
      ObSysVars[714].min_val_ = "100" ;
      ObSysVars[714].max_val_ = "18446744073709551516" ;
      ObSysVars[714].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[714].id_ = SYS_VAR_KEY_CACHE_AGE_THRESHOLD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_CACHE_AGE_THRESHOLD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_CACHE_AGE_THRESHOLD] = 714 ;
      ObSysVars[714].base_value_ = "300" ;
    ObSysVars[714].alias_ = "OB_SV_KEY_CACHE_AGE_THRESHOLD" ;
    }();

    [&] (){
      ObSysVars[715].default_value_ = "100" ;
      ObSysVars[715].info_ = "The division point between the hot and warm sublists of the key cache buffer list, merely simulates MySQL 5.7" ;
      ObSysVars[715].name_ = "key_cache_division_limit" ;
      ObSysVars[715].data_type_ = ObIntType ;
      ObSysVars[715].min_val_ = "1" ;
      ObSysVars[715].max_val_ = "100" ;
      ObSysVars[715].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[715].id_ = SYS_VAR_KEY_CACHE_DIVISION_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_CACHE_DIVISION_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_CACHE_DIVISION_LIMIT] = 715 ;
      ObSysVars[715].base_value_ = "100" ;
    ObSysVars[715].alias_ = "OB_SV_KEY_CACHE_DIVISION_LIMIT" ;
    }();

    [&] (){
      ObSysVars[716].default_value_ = "18446744073709551615" ;
      ObSysVars[716].info_ = "Limit the assumed maximum number of seeks when looking up rows based on a key, merely simulates MySQL 5.7" ;
      ObSysVars[716].name_ = "max_seeks_for_key" ;
      ObSysVars[716].data_type_ = ObUInt64Type ;
      ObSysVars[716].min_val_ = "1" ;
      ObSysVars[716].max_val_ = "18446744073709551615" ;
      ObSysVars[716].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[716].id_ = SYS_VAR_MAX_SEEKS_FOR_KEY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_SEEKS_FOR_KEY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_SEEKS_FOR_KEY] = 716 ;
      ObSysVars[716].base_value_ = "18446744073709551615" ;
    ObSysVars[716].alias_ = "OB_SV_MAX_SEEKS_FOR_KEY" ;
    }();

    [&] (){
      ObSysVars[717].default_value_ = "0" ;
      ObSysVars[717].info_ = "When this variable is enabled, the server does not use the optimized method of processing an ALTER TABLE operation, merely simulates MySQL 5.7" ;
      ObSysVars[717].name_ = "old_alter_table" ;
      ObSysVars[717].data_type_ = ObIntType ;
      ObSysVars[717].enum_names_ = "[u'OFF', u'ON']" ;
      ObSysVars[717].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[717].id_ = SYS_VAR_OLD_ALTER_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OLD_ALTER_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OLD_ALTER_TABLE] = 717 ;
      ObSysVars[717].base_value_ = "0" ;
    ObSysVars[717].alias_ = "OB_SV_OLD_ALTER_TABLE" ;
    }();

    [&] (){
      ObSysVars[718].default_value_ = "-1" ;
      ObSysVars[718].info_ = "The number of table definitions that can be stored in the table definition cache, merely simulates MySQL 5.7" ;
      ObSysVars[718].name_ = "table_definition_cache" ;
      ObSysVars[718].data_type_ = ObIntType ;
      ObSysVars[718].min_val_ = "400" ;
      ObSysVars[718].max_val_ = "524288" ;
      ObSysVars[718].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[718].id_ = SYS_VAR_TABLE_DEFINITION_CACHE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_TABLE_DEFINITION_CACHE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_TABLE_DEFINITION_CACHE] = 718 ;
      ObSysVars[718].base_value_ = "-1" ;
    ObSysVars[718].alias_ = "OB_SV_TABLE_DEFINITION_CACHE" ;
    }();

    [&] (){
      ObSysVars[719].default_value_ = "1048576" ;
      ObSysVars[719].info_ = "The sort buffer size for online DDL operations that create or rebuild secondary indexes, merely simulates MySQL 5.7" ;
      ObSysVars[719].name_ = "innodb_sort_buffer_size" ;
      ObSysVars[719].data_type_ = ObIntType ;
      ObSysVars[719].min_val_ = "65536" ;
      ObSysVars[719].max_val_ = "67108864" ;
      ObSysVars[719].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[719].id_ = SYS_VAR_INNODB_SORT_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SORT_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SORT_BUFFER_SIZE] = 719 ;
      ObSysVars[719].base_value_ = "1048576" ;
    ObSysVars[719].alias_ = "OB_SV_INNODB_SORT_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[720].default_value_ = "1024" ;
      ObSysVars[720].info_ = "The size in bytes of blocks in the key cache, merely simulates MySQL 5.7" ;
      ObSysVars[720].name_ = "key_cache_block_size" ;
      ObSysVars[720].data_type_ = ObIntType ;
      ObSysVars[720].min_val_ = "512" ;
      ObSysVars[720].max_val_ = "16384" ;
      ObSysVars[720].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[720].id_ = SYS_VAR_KEY_CACHE_BLOCK_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_CACHE_BLOCK_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_CACHE_BLOCK_SIZE] = 720 ;
      ObSysVars[720].base_value_ = "1024" ;
    ObSysVars[720].alias_ = "OB_SV_KEY_CACHE_BLOCK_SIZE" ;
    }();

    [&] (){
      ObSysVars[721].default_value_ = "0" ;
      ObSysVars[721].info_ = "Use this variable to select the interface mode for the OBKV tenant. You can select one of 'ALL, TABLEAPI, HBASE, REDIS, NONE', where 'ALL' is the default and 'NONE' represents the non-OBKV interface mode." ;
      ObSysVars[721].name_ = "ob_kv_mode" ;
      ObSysVars[721].data_type_ = ObIntType ;
      ObSysVars[721].enum_names_ = "[u'ALL', u'TABLEAPI', u'HBASE', u'REDIS', u'NONE']" ;
      ObSysVars[721].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY ;
      ObSysVars[721].id_ = SYS_VAR_OB_KV_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_KV_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_KV_MODE] = 721 ;
      ObSysVars[721].base_value_ = "0" ;
    ObSysVars[721].alias_ = "OB_SV_KV_MODE" ;
    }();
    ...
    [&] (){
      ObSysVars[821].default_value_ = "/run/observer.pid" ;
      ObSysVars[821].info_ = "The path name of the file in which the server writes its process ID" ;
      ObSysVars[821].name_ = "pid_file" ;
      ObSysVars[821].data_type_ = ObVarcharType ;
      ObSysVars[821].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[821].id_ = SYS_VAR_PID_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PID_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PID_FILE] = 821 ;
      ObSysVars[821].base_value_ = "/run.observer.pid" ;
    ObSysVars[821].alias_ = "OB_SV_PID_FILE" ;
    }();

    [&] (){
      ObSysVars[822].default_value_ = "3306" ;
      ObSysVars[822].info_ = "The number of the port on which the server listens for TCP/IP connections" ;
      ObSysVars[822].name_ = "port" ;
      ...
      ObSysVars[822].id_ = SYS_VAR_PORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PORT] = 822 ;
      ObSysVars[822].base_value_ = "3306" ;
    ObSysVars[822].alias_ = "OB_SV_PORT" ;
    }();

    [&] (){
      ObSysVars[823].default_value_ = "/run/sql.sock" ;
      ObSysVars[823].info_ = "the name of the socket file that is used for local client connections" ;
      ObSysVars[823].name_ = "socket" ;
      ...
      ObSysVars[823].id_ = SYS_VAR_SOCKET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SOCKET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SOCKET] = 823 ;
      ObSysVars[823].base_value_ = "/run/sql.sock" ;
