...
static struct VarsInit{
  VarsInit(){
    ...
    ObSysVars[84].info_ = "The default storage engine of OceanBase" ;
    ObSysVars[84].name_ = "default_storage_engine" ;
    ObSysVars[84].data_type_ = ObVarcharType ;
    ObSysVars[84].value_ = "OceanBase" ;
    ObSysVars[84].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
    ObSysVars[84].id_ = SYS_VAR_DEFAULT_STORAGE_ENGINE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DEFAULT_STORAGE_ENGINE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_DEFAULT_STORAGE_ENGINE] = 84 ;
    ObSysVars[84].alias_ = "OB_SV_DEFAULT_STORAGE_ENGINE" ;

    ObSysVars[85].info_ = "The default replica number of table per zone if not specified when creating table." ;
    ObSysVars[85].name_ = "ob_default_replica_num" ;
    ObSysVars[85].data_type_ = ObIntType ;
    ObSysVars[85].value_ = "1" ;
    ObSysVars[85].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[85].id_ = SYS_VAR_OB_DEFAULT_REPLICA_NUM ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_DEFAULT_REPLICA_NUM)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_DEFAULT_REPLICA_NUM] = 85 ;
    ObSysVars[85].alias_ = "OB_SV_DEFAULT_REPLICA_NUM" ;

    ObSysVars[86].info_ = "Indicate how many bytes the interm result manager can alloc most for this tenant" ;
    ObSysVars[86].name_ = "ob_interm_result_mem_limit" ;
    ObSysVars[86].data_type_ = ObIntType ;
    ObSysVars[86].value_ = "2147483648" ;
    ObSysVars[86].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[86].id_ = SYS_VAR_OB_INTERM_RESULT_MEM_LIMIT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_INTERM_RESULT_MEM_LIMIT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_INTERM_RESULT_MEM_LIMIT] = 86 ;
    ObSysVars[86].alias_ = "OB_SV_INTERM_RESULT_MEM_LIMIT" ;

    ObSysVars[87].info_ = "Indicate whether sql stmt hit right partition, readonly to user, modify by ob" ;
    ObSysVars[87].name_ = "ob_proxy_partition_hit" ;
    ObSysVars[87].data_type_ = ObIntType ;
    ObSysVars[87].value_ = "1" ;
    ObSysVars[87].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[87].id_ = SYS_VAR_OB_PROXY_PARTITION_HIT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PROXY_PARTITION_HIT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PROXY_PARTITION_HIT] = 87 ;
    ObSysVars[87].alias_ = "OB_SV_PROXY_PARTITION_HIT" ;

    ObSysVars[88].info_ = "log level in session" ;
    ObSysVars[88].name_ = "ob_log_level" ;
    ObSysVars[88].data_type_ = ObVarcharType ;
    ObSysVars[88].value_ = "disabled" ;
    ObSysVars[88].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[88].id_ = SYS_VAR_OB_LOG_LEVEL ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_LOG_LEVEL)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_LOG_LEVEL] = 88 ;
    ObSysVars[88].alias_ = "OB_SV_LOG_LEVEL" ;

    ObSysVars[89].info_ = "Max parellel sub request to chunkservers for one request" ;
    ObSysVars[89].name_ = "ob_max_parallel_degree" ;
    ObSysVars[89].data_type_ = ObIntType ;
    ObSysVars[89].value_ = "16" ;
    ObSysVars[89].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[89].id_ = SYS_VAR_OB_MAX_PARALLEL_DEGREE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_MAX_PARALLEL_DEGREE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_MAX_PARALLEL_DEGREE] = 89 ;
    ObSysVars[89].alias_ = "OB_SV_MAX_PARALLEL_DEGREE" ;

    ObSysVars[90].info_ = "Query timeout in microsecond(us)" ;
    ObSysVars[90].name_ = "ob_query_timeout" ;
    ObSysVars[90].data_type_ = ObIntType ;
    ObSysVars[90].value_ = "10000000" ;
    ObSysVars[90].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[90].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_timeout_too_large" ;
    ObSysVars[90].id_ = SYS_VAR_OB_QUERY_TIMEOUT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_QUERY_TIMEOUT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_QUERY_TIMEOUT] = 90 ;
    ObSysVars[90].alias_ = "OB_SV_QUERY_TIMEOUT" ;

    ObSysVars[91].info_ = "read consistency level: 3=STRONG, 2=WEAK, 1=FROZEN" ;
    ObSysVars[91].name_ = "ob_read_consistency" ;
    ObSysVars[91].data_type_ = ObIntType ;
    ObSysVars[91].enum_names_ = "[u'', u'FROZEN', u'WEAK', u'STRONG']" ;
    ObSysVars[91].value_ = "3" ;
    ObSysVars[91].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[91].id_ = SYS_VAR_OB_READ_CONSISTENCY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_READ_CONSISTENCY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_READ_CONSISTENCY] = 91 ;
    ObSysVars[91].alias_ = "OB_SV_READ_CONSISTENCY" ;

    ObSysVars[92].info_ = "whether use transform in session" ;
    ObSysVars[92].name_ = "ob_enable_transformation" ;
    ObSysVars[92].data_type_ = ObIntType ;
    ObSysVars[92].value_ = "1" ;
    ObSysVars[92].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[92].id_ = SYS_VAR_OB_ENABLE_TRANSFORMATION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_TRANSFORMATION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_TRANSFORMATION] = 92 ;
    ObSysVars[92].alias_ = "OB_SV_ENABLE_TRANSFORMATION" ;

    ObSysVars[93].info_ = "The max duration of one transaction" ;
    ObSysVars[93].name_ = "ob_trx_timeout" ;
    ObSysVars[93].data_type_ = ObIntType ;
    ObSysVars[93].value_ = "100000000" ;
    ObSysVars[93].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[93].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_timeout_too_large" ;
    ObSysVars[93].id_ = SYS_VAR_OB_TRX_TIMEOUT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TRX_TIMEOUT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_TRX_TIMEOUT] = 93 ;
    ObSysVars[93].alias_ = "OB_SV_TRX_TIMEOUT" ;

    ObSysVars[94].info_ = "whether use plan cache in session" ;
    ObSysVars[94].name_ = "ob_enable_plan_cache" ;
    ObSysVars[94].data_type_ = ObIntType ;
    ObSysVars[94].value_ = "1" ;
    ObSysVars[94].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[94].id_ = SYS_VAR_OB_ENABLE_PLAN_CACHE ;
    ...
    ObSysVars[94].alias_ = "OB_SV_ENABLE_PLAN_CACHE" ;

    ObSysVars[95].info_ = "whether can select from index table" ;
    ObSysVars[95].name_ = "ob_enable_index_direct_select" ;
    ObSysVars[95].data_type_ = ObIntType ;
    ObSysVars[95].value_ = "0" ;
    ObSysVars[95].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[95].id_ = SYS_VAR_OB_ENABLE_INDEX_DIRECT_SELECT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_INDEX_DIRECT_SELECT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_INDEX_DIRECT_SELECT] = 95 ;
    ObSysVars[95].alias_ = "OB_SV_ENABLE_INDEX_DIRECT_SELECT" ;

    ObSysVars[96].info_ = "this value is true if we have executed set transaction stmt, until a transaction commit(explicit or implicit) successfully" ;
    ObSysVars[96].name_ = "ob_proxy_set_trx_executed" ;
    ...
    ObSysVars[96].id_ = SYS_VAR_OB_PROXY_SET_TRX_EXECUTED ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PROXY_SET_TRX_EXECUTED)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PROXY_SET_TRX_EXECUTED] = 96 ;
    ObSysVars[96].alias_ = "OB_SV_PROXY_SET_TRX_EXECUTED" ;

    ObSysVars[97].info_ = "enable aggregation function to be push-downed through exchange nodes" ;
    ObSysVars[97].name_ = "ob_enable_aggregation_pushdown" ;
    ObSysVars[97].data_type_ = ObIntType ;
    ObSysVars[97].value_ = "1" ;
    ObSysVars[97].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[97].id_ = SYS_VAR_OB_ENABLE_AGGREGATION_PUSHDOWN ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_AGGREGATION_PUSHDOWN)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_AGGREGATION_PUSHDOWN] = 97 ;
    ObSysVars[97].alias_ = "OB_SV_ENABLE_AGGREGATION_PUSHDOWN" ;

    ObSysVars[98].info_ = "" ;
    ObSysVars[98].name_ = "ob_last_schema_version" ;
    ObSysVars[98].data_type_ = ObIntType ;
    ObSysVars[98].value_ = "0" ;
    ObSysVars[98].flags_ = ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[98].id_ = SYS_VAR_OB_LAST_SCHEMA_VERSION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_LAST_SCHEMA_VERSION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_LAST_SCHEMA_VERSION] = 98 ;
    ObSysVars[98].alias_ = "OB_SV_LAST_SCHEMA_VERSION" ;

    ObSysVars[99].info_ = "Global debug sync facility" ;
    ObSysVars[99].name_ = "ob_global_debug_sync" ;
    ObSysVars[99].data_type_ = ObVarcharType ;
    ObSysVars[99].value_ = "" ;
    ObSysVars[99].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[99].id_ = SYS_VAR_OB_GLOBAL_DEBUG_SYNC ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_GLOBAL_DEBUG_SYNC)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_GLOBAL_DEBUG_SYNC] = 99 ;
    ObSysVars[99].alias_ = "OB_SV_GLOBAL_DEBUG_SYNC" ;

    ObSysVars[100].info_ = "this value is global variables last modified time when server session create, used for proxy to judge whether global vars has changed between two server session" ;
    ObSysVars[100].name_ = "ob_proxy_global_variables_version" ;
    ...
    ObSysVars[100].id_ = SYS_VAR_OB_PROXY_GLOBAL_VARIABLES_VERSION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PROXY_GLOBAL_VARIABLES_VERSION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PROXY_GLOBAL_VARIABLES_VERSION] = 100 ;
    ObSysVars[100].alias_ = "OB_SV_PROXY_GLOBAL_VARIABLES_VERSION" ;

    ObSysVars[101].info_ = "control whether use trace log" ;
    ObSysVars[101].name_ = "ob_enable_trace_log" ;
    ...
    ObSysVars[101].id_ = SYS_VAR_OB_ENABLE_TRACE_LOG ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_TRACE_LOG)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_TRACE_LOG] = 101 ;
    ObSysVars[101].alias_ = "OB_SV_ENABLE_TRACE_LOG" ;

    ObSysVars[102].info_ = "" ;
    ObSysVars[102].name_ = "ob_enable_hash_group_by" ;
    ObSysVars[102].data_type_ = ObIntType ;
    ObSysVars[102].value_ = "1" ;
    ...
    ObSysVars[102].id_ = SYS_VAR_OB_ENABLE_HASH_GROUP_BY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_HASH_GROUP_BY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_HASH_GROUP_BY] = 102 ;
    ObSysVars[102].alias_ = "OB_SV_ENABLE_HASH_GROUP_BY" ;

    ObSysVars[103].info_ = "" ;
    ObSysVars[103].name_ = "ob_enable_blk_nestedloop_join" ;
    ...
    ObSysVars[103].id_ = SYS_VAR_OB_ENABLE_BLK_NESTEDLOOP_JOIN ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_BLK_NESTEDLOOP_JOIN)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_BLK_NESTEDLOOP_JOIN] = 103 ;
    ObSysVars[103].alias_ = "OB_SV_ENABLE_BLK_NESTEDLOOP_JOIN" ;

    ObSysVars[104].info_ = "" ;
    ObSysVars[104].name_ = "ob_bnl_join_cache_size" ;
    ObSysVars[104].data_type_ = ObIntType ;
    ObSysVars[104].value_ = "10485760" ;
    ObSysVars[104].min_val_ = "1" ;
    ...
    ObSysVars[104].id_ = SYS_VAR_OB_BNL_JOIN_CACHE_SIZE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_BNL_JOIN_CACHE_SIZE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_BNL_JOIN_CACHE_SIZE] = 104 ;
    ObSysVars[104].alias_ = "OB_SV_BNL_JOIN_CACHE_SIZE" ;

    ObSysVars[105].info_ = "Indicate current client session user privilege, readonly after modified by first observer" ;
    ObSysVars[105].name_ = "ob_proxy_user_privilege" ;
    ObSysVars[105].data_type_ = ObIntType ;
    ObSysVars[105].value_ = "0" ;
    ObSysVars[105].min_val_ = "0" ;
    ObSysVars[105].max_val_ = "9223372036854775807" ;
    ObSysVars[105].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[105].id_ = SYS_VAR_OB_PROXY_USER_PRIVILEGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PROXY_USER_PRIVILEGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PROXY_USER_PRIVILEGE] = 105 ;
    ObSysVars[105].alias_ = "OB_SV_PROXY_USER_PRIVILEGE" ;
    ...
    ObSysVars[106].base_class_ = "ObStrictRangeIntSysVar" ;
    ObSysVars[106].name_ = "ob_org_cluster_id" ;
    ObSysVars[106].data_type_ = ObIntType ;
    ObSysVars[106].value_ = "0" ;
    ObSysVars[106].min_val_ = "0" ;
    ObSysVars[106].max_val_ = "4294967295" ;
    ObSysVars[106].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[106].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_ob_org_cluster_id" ;
    ObSysVars[106].id_ = SYS_VAR_OB_ORG_CLUSTER_ID ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ORG_CLUSTER_ID)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ORG_CLUSTER_ID] = 106 ;
    ObSysVars[106].alias_ = "OB_SV_ORG_CLUSTER_ID" ;

    ObSysVars[107].info_ = "percentage of tenant memory resources that can be used by plan cache" ;
    ObSysVars[107].name_ = "ob_plan_cache_percentage" ;
    ObSysVars[107].data_type_ = ObIntType ;
    ObSysVars[107].value_ = "5" ;
    ...
    ObSysVars[107].id_ = SYS_VAR_OB_PLAN_CACHE_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PLAN_CACHE_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PLAN_CACHE_PERCENTAGE] = 107 ;
    ObSysVars[107].alias_ = "OB_SV_PLAN_CACHE_PERCENTAGE" ;

    ObSysVars[108].info_ = "memory usage percentage of plan_cache_limit at which plan cache eviction will be trigger" ;
    ObSysVars[108].name_ = "ob_plan_cache_evict_high_percentage" ;
    ObSysVars[108].data_type_ = ObIntType ;
    ObSysVars[108].value_ = "90" ;
    ...
    ObSysVars[108].id_ = SYS_VAR_OB_PLAN_CACHE_EVICT_HIGH_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PLAN_CACHE_EVICT_HIGH_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PLAN_CACHE_EVICT_HIGH_PERCENTAGE] = 108 ;
    ObSysVars[108].alias_ = "OB_SV_PLAN_CACHE_EVICT_HIGH_PERCENTAGE" ;

    ObSysVars[109].info_ = "memory usage percentage  of plan_cache_limit at which plan cache eviction will be stopped" ;
    ObSysVars[109].name_ = "ob_plan_cache_evict_low_percentage" ;
    ObSysVars[109].data_type_ = ObIntType ;
    ObSysVars[109].value_ = "50" ;
    ...
    ObSysVars[109].id_ = SYS_VAR_OB_PLAN_CACHE_EVICT_LOW_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_PLAN_CACHE_EVICT_LOW_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_PLAN_CACHE_EVICT_LOW_PERCENTAGE] = 109 ;
    ObSysVars[109].alias_ = "OB_SV_PLAN_CACHE_EVICT_LOW_PERCENTAGE" ;

    ObSysVars[110].info_ = "When the recycle bin is enabled, dropped tables and their dependent objects are placed in the recycle bin. When the recycle bin is disabled, dropped tables and their dependent objects are not placed in the recycle bin; they are just dropped." ;
    ObSysVars[110].name_ = "recyclebin" ;
    ObSysVars[110].data_type_ = ObIntType ;
    ObSysVars[110].value_ = "0" ;
    ObSysVars[110].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[110].id_ = SYS_VAR_RECYCLEBIN ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RECYCLEBIN)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_RECYCLEBIN] = 110 ;
    ObSysVars[110].alias_ = "OB_SV_RECYCLEBIN" ;

    ObSysVars[111].info_ = "Indicate features that observer supports, readonly after modified by first observer" ;
    ObSysVars[111].name_ = "ob_capability_flag" ;
    ObSysVars[111].data_type_ = ObUInt64Type ;
    ObSysVars[111].value_ = "0" ;
    ObSysVars[111].min_val_ = "0" ;
    ObSysVars[111].max_val_ = "18446744073709551615" ;
    ObSysVars[111].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[111].id_ = SYS_VAR_OB_CAPABILITY_FLAG ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_CAPABILITY_FLAG)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_CAPABILITY_FLAG] = 111 ;
    ObSysVars[111].alias_ = "OB_SV_CAPABILITY_FLAG" ;

    ObSysVars[112].info_ = "The parallel degree of a job in a query, which represent how many tasks of a job can be run parallelly" ;
    ObSysVars[112].name_ = "ob_stmt_parallel_degree" ;
    ObSysVars[112].data_type_ = ObIntType ;
    ObSysVars[112].value_ = "1" ;
    ObSysVars[112].min_val_ = "1" ;
    ObSysVars[112].max_val_ = "10240" ;
    ...
    ObSysVars[112].id_ = SYS_VAR_OB_STMT_PARALLEL_DEGREE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_STMT_PARALLEL_DEGREE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_STMT_PARALLEL_DEGREE] = 112 ;
    ObSysVars[112].alias_ = "OB_SV_STMT_PARALLEL_DEGREE" ;
    ...
    ObSysVars[115].info_ = "What DBMS is OceanBase compatible with? MYSQL means it behaves like MySQL while ORACLE means it behaves like Oracle." ;
    ObSysVars[115].name_ = "ob_compatibility_mode" ;
    ObSysVars[115].data_type_ = ObIntType ;
    ObSysVars[115].enum_names_ = "[u'MYSQL', u'ORACLE']" ;
    ObSysVars[115].value_ = "0" ;
    ObSysVars[115].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::WITH_UPGRADE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[115].id_ = SYS_VAR_OB_COMPATIBILITY_MODE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_COMPATIBILITY_MODE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_COMPATIBILITY_MODE] = 115 ;
    ObSysVars[115].alias_ = "OB_SV_COMPATIBILITY_MODE" ;

    ObSysVars[116].info_ = "If set true, create all the replicas according to the locality or the operation will fail." ;
    ObSysVars[116].name_ = "ob_create_table_strict_mode" ;
    ObSysVars[116].data_type_ = ObIntType ;
    ObSysVars[116].value_ = "0" ;
    ObSysVars[116].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[116].id_ = SYS_VAR_OB_CREATE_TABLE_STRICT_MODE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_CREATE_TABLE_STRICT_MODE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_CREATE_TABLE_STRICT_MODE] = 116 ;
    ObSysVars[116].alias_ = "OB_SV_CREATE_TABLE_STRICT_MODE" ;

    ObSysVars[117].info_ = "The percentage limitation of tenant memory for SQL execution." ;
    ObSysVars[117].name_ = "ob_sql_work_area_percentage" ;
    ObSysVars[117].data_type_ = ObIntType ;
    ObSysVars[117].value_ = "5" ;
    ObSysVars[117].min_val_ = "0" ;
    ObSysVars[117].max_val_ = "100" ;
    ObSysVars[117].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[117].id_ = SYS_VAR_OB_SQL_WORK_AREA_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_SQL_WORK_AREA_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_SQL_WORK_AREA_PERCENTAGE] = 117 ;
    ObSysVars[117].alias_ = "OB_SV_SQL_WORK_AREA_PERCENTAGE" ;

    ObSysVars[118].info_ = "The safe weak read snapshot version in one server" ;
    ObSysVars[118].on_update_func_ = "ObSysVarOnUpdateFuncs::update_safe_weak_read_snapshot" ;
    ObSysVars[118].name_ = "ob_safe_weak_read_snapshot" ;
    ObSysVars[118].data_type_ = ObIntType ;
    ObSysVars[118].value_ = "1" ;
    ObSysVars[118].min_val_ = "0" ;
    ObSysVars[118].max_val_ = "9223372036854775807" ;
    ObSysVars[118].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INVISIBLE ;
    ObSysVars[118].id_ = SYS_VAR_OB_SAFE_WEAK_READ_SNAPSHOT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_SAFE_WEAK_READ_SNAPSHOT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_SAFE_WEAK_READ_SNAPSHOT] = 118 ;
    ObSysVars[118].alias_ = "OB_SV_SAFE_WEAK_READ_SNAPSHOT" ;

    ObSysVars[119].info_ = "the routing policy of obproxy/java client and observer internal retry, 1=READONLY_ZONE_FIRST, 2=ONLY_READONLY_ZONE, 3=UNMERGE_ZONE_FIRST, 4=UNMERGE_FOLLOWER_FIRST" ;
    ObSysVars[119].name_ = "ob_route_policy" ;
    ObSysVars[119].data_type_ = ObIntType ;
    ObSysVars[119].enum_names_ = "[u'', u'READONLY_ZONE_FIRST', u'ONLY_READONLY_ZONE', u'UNMERGE_ZONE_FIRST', u'UNMERGE_FOLLOWER_FIRST']" ;
    ObSysVars[119].value_ = "1" ;
    ObSysVars[119].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[119].id_ = SYS_VAR_OB_ROUTE_POLICY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ROUTE_POLICY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ROUTE_POLICY] = 119 ;
    ObSysVars[119].alias_ = "OB_SV_ROUTE_POLICY" ;

    ObSysVars[120].info_ = "whether do the checksum of the packet between the client and the server" ;
    ObSysVars[120].name_ = "ob_enable_transmission_checksum" ;
    ObSysVars[120].data_type_ = ObIntType ;
    ObSysVars[120].value_ = "1" ;
    ObSysVars[120].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::QUERY_SENSITIVE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[120].id_ = SYS_VAR_OB_ENABLE_TRANSMISSION_CHECKSUM ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_TRANSMISSION_CHECKSUM)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_TRANSMISSION_CHECKSUM] = 120 ;
    ObSysVars[120].alias_ = "OB_SV_ENABLE_TRANSMISSION_CHECKSUM" ;

    ObSysVars[121].info_ = "set to 1 (the default by MySQL), foreign key constraints are checked. If set to 0, foreign key constraints are ignored" ;
    ObSysVars[121].name_ = "foreign_key_checks" ;
    ...
    ObSysVars[121].id_ = SYS_VAR_FOREIGN_KEY_CHECKS ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_FOREIGN_KEY_CHECKS)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_FOREIGN_KEY_CHECKS] = 121 ;
    ObSysVars[121].alias_ = "OB_SV_FOREIGN_KEY_CHECKS" ;

    ObSysVars[122].info_ = "the trace id of current executing statement" ;
    ObSysVars[122].name_ = "ob_statement_trace_id" ;
    ObSysVars[122].data_type_ = ObVarcharType ;
    ObSysVars[122].value_ = "Y0-0" ;
    ObSysVars[122].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::INVISIBLE ;
    ObSysVars[122].id_ = SYS_VAR_OB_STATEMENT_TRACE_ID ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_STATEMENT_TRACE_ID)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_STATEMENT_TRACE_ID] = 122 ;
    ObSysVars[122].alias_ = "OB_SV_STATEMENT_TRACE_ID" ;

    ObSysVars[123].info_ = "Enable the flashback of table truncation." ;
    ObSysVars[123].name_ = "ob_enable_truncate_flashback" ;
    ObSysVars[123].data_type_ = ObIntType ;
    ObSysVars[123].value_ = "0" ;
    ObSysVars[123].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[123].id_ = SYS_VAR_OB_ENABLE_TRUNCATE_FLASHBACK ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_TRUNCATE_FLASHBACK)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_TRUNCATE_FLASHBACK] = 123 ;
    ObSysVars[123].alias_ = "OB_SV_ENABLE_TRUNCATE_FLASHBACK" ;

    ObSysVars[124].info_ = "ip white list for tenant, support % and _ and multi ip(separated by commas), support ip match and wild match" ;
    ObSysVars[124].name_ = "ob_tcp_invited_nodes" ;
    ObSysVars[124].data_type_ = ObVarcharType ;
    ObSysVars[124].value_ = "127.0.0.1,::1" ;
    ObSysVars[124].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[124].id_ = SYS_VAR_OB_TCP_INVITED_NODES ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TCP_INVITED_NODES)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_TCP_INVITED_NODES] = 124 ;
    ObSysVars[124].alias_ = "OB_SV_TCP_INVITED_NODES" ;

    ObSysVars[125].info_ = "current priority used for SQL throttling" ;
    ObSysVars[125].name_ = "sql_throttle_current_priority" ;
    ObSysVars[125].data_type_ = ObIntType ;
    ObSysVars[125].value_ = "100" ;
    ObSysVars[125].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[125].id_ = SYS_VAR_SQL_THROTTLE_CURRENT_PRIORITY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_CURRENT_PRIORITY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_CURRENT_PRIORITY] = 125 ;
    ObSysVars[125].alias_ = "OB_SV_SQL_THROTTLE_CURRENT_PRIORITY" ;

    ObSysVars[126].info_ = "sql throttle priority, query may not be allowed to execute if its priority isnt greater than this value." ;
    ObSysVars[126].name_ = "sql_throttle_priority" ;
    ObSysVars[126].data_type_ = ObIntType ;
    ObSysVars[126].value_ = "-1" ;
    ObSysVars[126].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[126].id_ = SYS_VAR_SQL_THROTTLE_PRIORITY ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_PRIORITY)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_PRIORITY] = 126 ;
    ObSysVars[126].alias_ = "OB_SV_SQL_THROTTLE_PRIORITY" ;

    ObSysVars[127].info_ = "query may not be allowed to execute if its rt isnt less than this value." ;
    ObSysVars[127].name_ = "sql_throttle_rt" ;
    ObSysVars[127].data_type_ = ObNumberType ;
    ObSysVars[127].value_ = "-1" ;
    ObSysVars[127].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[127].id_ = SYS_VAR_SQL_THROTTLE_RT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_RT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_RT] = 127 ;
    ObSysVars[127].alias_ = "OB_SV_SQL_THROTTLE_RT" ;

    ObSysVars[128].info_ = "query may not be allowed to execute if its CPU usage isnt less than this value." ;
    ObSysVars[128].name_ = "sql_throttle_cpu" ;
    ObSysVars[128].data_type_ = ObNumberType ;
    ObSysVars[128].value_ = "-1" ;
    ObSysVars[128].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[128].id_ = SYS_VAR_SQL_THROTTLE_CPU ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_CPU)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_CPU] = 128 ;
    ObSysVars[128].alias_ = "OB_SV_SQL_THROTTLE_CPU" ;

    ObSysVars[129].info_ = "query may not be allowed to execute if its number of IOs isnt less than this value." ;
    ObSysVars[129].name_ = "sql_throttle_io" ;
    ObSysVars[129].data_type_ = ObIntType ;
    ObSysVars[129].value_ = "-1" ;
    ObSysVars[129].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[129].id_ = SYS_VAR_SQL_THROTTLE_IO ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_IO)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_IO] = 129 ;
    ObSysVars[129].alias_ = "OB_SV_SQL_THROTTLE_IO" ;

    ObSysVars[130].info_ = "query may not be allowed to execute if its network usage isnt less than this value." ;
    ObSysVars[130].name_ = "sql_throttle_network" ;
    ObSysVars[130].data_type_ = ObNumberType ;
    ObSysVars[130].value_ = "-1" ;
    ObSysVars[130].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[130].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_sql_throttle_queue_time" ;
    ObSysVars[130].id_ = SYS_VAR_SQL_THROTTLE_NETWORK ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_NETWORK)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_NETWORK] = 130 ;
    ObSysVars[130].alias_ = "OB_SV_SQL_THROTTLE_NETWORK" ;

    ObSysVars[131].info_ = "query may not be allowed to execute if its number of logical reads isnt less than this value." ;
    ObSysVars[131].name_ = "sql_throttle_logical_reads" ;
    ObSysVars[131].data_type_ = ObIntType ;
    ObSysVars[131].value_ = "-1" ;
    ObSysVars[131].flags_ = ObSysVarFlag::GLOBAL_SCOPE ;
    ObSysVars[131].id_ = SYS_VAR_SQL_THROTTLE_LOGICAL_READS ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_THROTTLE_LOGICAL_READS)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_SQL_THROTTLE_LOGICAL_READS] = 131 ;
    ObSysVars[131].alias_ = "OB_SV_SQL_THROTTLE_LOGICAL_READS" ;

    ObSysVars[132].info_ = "auto_increment service cache size" ;
    ObSysVars[132].name_ = "auto_increment_cache_size" ;
    ObSysVars[132].data_type_ = ObIntType ;
    ObSysVars[132].value_ = "1000000" ;
    ObSysVars[132].min_val_ = "1" ;
    ObSysVars[132].max_val_ = "100000000" ;
    ObSysVars[132].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[132].id_ = SYS_VAR_AUTO_INCREMENT_CACHE_SIZE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_AUTO_INCREMENT_CACHE_SIZE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_AUTO_INCREMENT_CACHE_SIZE] = 132 ;
    ObSysVars[132].alias_ = "OB_SV_AUTO_INCREMENT_CACHE_SIZE" ;

    ObSysVars[133].info_ = "JIT execution engine mode, default is AUTO" ;
    ObSysVars[133].name_ = "ob_enable_jit" ;
    ObSysVars[133].data_type_ = ObIntType ;
    ObSysVars[133].enum_names_ = "[u'OFF', u'AUTO', u'FORCE']" ;
    ObSysVars[133].value_ = "0" ;
    ObSysVars[133].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INFLUENCE_PLAN ;
    ObSysVars[133].id_ = SYS_VAR_OB_ENABLE_JIT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_JIT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_JIT] = 133 ;
    ObSysVars[133].alias_ = "OB_SV_ENABLE_JIT" ;

    ObSysVars[134].info_ = "the percentage limitation of some temp tablespace size in tenant disk." ;
    ObSysVars[134].name_ = "ob_temp_tablespace_size_percentage" ;
    ObSysVars[134].data_type_ = ObIntType ;
    ObSysVars[134].value_ = "0" ;
    ObSysVars[134].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
    ObSysVars[134].id_ = SYS_VAR_OB_TEMP_TABLESPACE_SIZE_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TEMP_TABLESPACE_SIZE_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_TEMP_TABLESPACE_SIZE_PERCENTAGE] = 134 ;
    ObSysVars[134].alias_ = "OB_SV_TEMP_TABLESPACE_SIZE_PERCENTAGE" ;

    ObSysVars[135].info_ = "Enable use of adaptive cursor sharing" ;
    ObSysVars[135].name_ = "_optimizer_adaptive_cursor_sharing" ;
    ObSysVars[135].data_type_ = ObIntType ;
    ObSysVars[135].value_ = "0" ;
    ObSysVars[135].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[135].id_ = SYS_VAR__OPTIMIZER_ADAPTIVE_CURSOR_SHARING ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__OPTIMIZER_ADAPTIVE_CURSOR_SHARING)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__OPTIMIZER_ADAPTIVE_CURSOR_SHARING] = 135 ;
    ObSysVars[135].alias_ = "OB_SV__OPTIMIZER_ADAPTIVE_CURSOR_SHARING" ;

    ObSysVars[136].info_ = "the type of timestamp service" ;
    ObSysVars[136].name_ = "ob_timestamp_service" ;
    ObSysVars[136].data_type_ = ObIntType ;
    ObSysVars[136].enum_names_ = "[u'LTS', u'GTS', u'HA_GTS']" ;
    ObSysVars[136].value_ = "1" ;
    ObSysVars[136].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[136].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_timestamp_service" ;
    ObSysVars[136].id_ = SYS_VAR_OB_TIMESTAMP_SERVICE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TIMESTAMP_SERVICE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_TIMESTAMP_SERVICE] = 136 ;
    ObSysVars[136].alias_ = "OB_SV_TIMESTAMP_SERVICE" ;

    ObSysVars[137].info_ = "the dir to place plugin dll" ;
    ObSysVars[137].name_ = "plugin_dir" ;
    ObSysVars[137].data_type_ = ObVarcharType ;
    ObSysVars[137].value_ = "./plugin_dir/" ;
    ObSysVars[137].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY ;
    ObSysVars[137].id_ = SYS_VAR_PLUGIN_DIR ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PLUGIN_DIR)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_PLUGIN_DIR] = 137 ;
    ObSysVars[137].alias_ = "OB_SV_PLUGIN_DIR" ;
    ...
    ObSysVars[138].id_ = SYS_VAR_UNDO_RETENTION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_UNDO_RETENTION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_UNDO_RETENTION] = 138 ;
    ObSysVars[138].alias_ = "OB_SV_UNDO_RETENTION" ;

    ObSysVars[139].info_ = "auto use parallel execution" ;
    ObSysVars[139].name_ = "_ob_use_parallel_execution" ;
    ObSysVars[139].data_type_ = ObIntType ;
    ObSysVars[139].value_ = "1" ;
    ObSysVars[139].flags_ = ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::INVISIBLE ;
    ObSysVars[139].id_ = SYS_VAR__OB_USE_PARALLEL_EXECUTION ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__OB_USE_PARALLEL_EXECUTION)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__OB_USE_PARALLEL_EXECUTION] = 139 ;
    ObSysVars[139].alias_ = "OB_SV__OB_USE_PARALLEL_EXECUTION" ;

    ObSysVars[140].info_ = "The limited percentage of tenant memory for sql audit" ;
    ObSysVars[140].name_ = "ob_sql_audit_percentage" ;
    ObSysVars[140].data_type_ = ObIntType ;
    ObSysVars[140].value_ = "3" ;
    ObSysVars[140].min_val_ = "0" ;
    ObSysVars[140].max_val_ = "100" ;
    ObSysVars[140].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[140].id_ = SYS_VAR_OB_SQL_AUDIT_PERCENTAGE ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_SQL_AUDIT_PERCENTAGE)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_SQL_AUDIT_PERCENTAGE] = 140 ;
    ObSysVars[140].alias_ = "OB_SV_SQL_AUDIT_PERCENTAGE" ;

    ObSysVars[141].info_ = "wether use sql audit in session" ;
    ObSysVars[141].name_ = "ob_enable_sql_audit" ;
    ObSysVars[141].data_type_ = ObIntType ;
    ObSysVars[141].value_ = "1" ;
    ObSysVars[141].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[141].id_ = SYS_VAR_OB_ENABLE_SQL_AUDIT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_SQL_AUDIT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_SQL_AUDIT] = 141 ;
    ObSysVars[141].alias_ = "OB_SV_ENABLE_SQL_AUDIT" ;
    ...
    ObSysVars[144].info_ = "number of threads created to run parallel statements for each observer." ;
    ObSysVars[144].name_ = "parallel_max_servers" ;
    ObSysVars[144].data_type_ = ObIntType ;
    ObSysVars[144].value_ = "0" ;
    ObSysVars[144].min_val_ = "0" ;
    ObSysVars[144].max_val_ = "1800" ;
    ObSysVars[144].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[144].id_ = SYS_VAR_PARALLEL_MAX_SERVERS ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PARALLEL_MAX_SERVERS)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_PARALLEL_MAX_SERVERS] = 144 ;
    ObSysVars[144].alias_ = "OB_SV_PARALLEL_MAX_SERVERS" ;
    ...
    ObSysVars[147].value_ = "120000000" ;
    ...
    ObSysVars[148].enum_names_ = "[u'aes-128-ecb', u'aes-192-ecb', u'aes-256-ecb', u'aes-128-cbc', u'aes-192-cbc', u'aes-256-cbc', u'aes-128-cfb1', u'aes-192-cfb1', u'aes-256-cfb1', u'aes-128-cfb8', u'aes-192-cfb8', u'aes-256-cfb8', u'aes-128-cfb128', u'aes-192-cfb128', u'aes-256-cfb128', u'aes-128-ofb', u'aes-192-ofb', u'aes-256-ofb']" ;
    ObSysVars[148].value_ = "0" ;
    ...
    ObSysVars[149].value_ = "DD-MON-RR" ;
    ...
    ObSysVars[150].value_ = "DD-MON-RR HH.MI.SSXFF AM" ;
    ...
    ObSysVars[151].value_ = "DD-MON-RR HH.MI.SSXFF AM TZR" ;
    ...
    ObSysVars[163].value_ = "GREGORIAN" ;
    ...
    ObSysVars[165].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::INFLUENCE_PLAN ;
    ...
    ObSysVars[169].info_ = "statistic primary zone entity(table/tablegroup/database) count under tenant." ;
    ObSysVars[169].name_ = "_primary_zone_entity_count" ;
    ObSysVars[169].data_type_ = ObIntType ;
    ObSysVars[169].value_ = "-1" ;
    ObSysVars[169].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::INVISIBLE ;
    ObSysVars[169].id_ = SYS_VAR__PRIMARY_ZONE_ENTITY_COUNT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__PRIMARY_ZONE_ENTITY_COUNT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR__PRIMARY_ZONE_ENTITY_COUNT] = 169 ;
    ObSysVars[169].alias_ = "OB_SV__PRIMARY_ZONE_ENTITY_COUNT" ;
    ...
    ObSysVars[170].value_ = "READ-COMMITTED" ;
    ...
    ObSysVars[180].info_ = "enable use of batched multi statement" ;
    ObSysVars[180].name_ = "ob_enable_batched_multi_statement" ;
    ObSysVars[180].data_type_ = ObIntType ;
    ObSysVars[180].value_ = "0" ;
    ObSysVars[180].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
    ObSysVars[180].id_ = SYS_VAR_OB_ENABLE_BATCHED_MULTI_STATEMENT ;
    cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_BATCHED_MULTI_STATEMENT)) ;
    ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_BATCHED_MULTI_STATEMENT] = 180 ;
    ObSysVars[180].alias_ = "OB_SV_ENABLE_BATCHED_MULTI_STATEMENT" ;
    ...
    ObSysVars[187].value_ = "ENABLE:ALL" ;
    ...
    ObSysVars[191].value_ = "3216672000000000" ;
