...
static struct VarsInit{
  VarsInit(){
    ...
    [&] (){
      ObSysVars[234].default_value_ = "4.4.2.0" ;
    ...
    [&] (){
      ...
      ObSysVars[839].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INFLUENCE_PL ;
