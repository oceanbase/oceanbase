...
static struct VarsInit{
  VarsInit(){
    ...
    [&] (){
      ...
      ObSysVars[839].info_ = "Whether the PL/SQL async response is used" ;
      ObSysVars[839].name_ = "ob_enable_pl_async_commit" ;
      ...
      ObSysVars[839].id_ = SYS_VAR_OB_ENABLE_PL_ASYNC_COMMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_PL_ASYNC_COMMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_PL_ASYNC_COMMIT] = 839 ;
      ObSysVars[839].base_value_ = "0" ;
    ObSysVars[839].alias_ = "OB_SV_ENABLE_PL_ASYNC_COMMIT" ;
    }();
