...
public:
  enum ObITaskType
  {
    ...
    TASK_TYPE_TABLE_FINISH_BACKFILL = 55,
    ...
    TASK_TYPE_BACKUP_LS_LOG_GROUP_TASK = 73,
    TASK_TYPE_BACKUP_LS_LOG_TASK = 74,
    TASK_TYPE_BACKUP_LS_LOG_FILE_TASK = 75,
    TASK_TYPE_BACKUP_LS_LOG_FINISH_TASK = 76,
    TASK_TYPE_BACKUP_LS_LOG_GROUP_FINISH_TASK = 77,
    TASK_TYPE_MAX,
  };
