...
DAG_SCHEDULER_DAG_PRIO_DEF(DAG_PRIO_MDS_COMPACTION_HIGH, 2, "PRIO_MDS_COMPACTION_HIGH", PRIO_MDS_COMPACTION_HIGH)
#ifdef OB_BUILD_SHARED_STORAGE
...
DAG_SCHEDULER_DAG_PRIO_DEF(DAG_PRIO_MDS_COMPACTION_MID, 2, "PRIO_MDS_COMPACTION_MID", PRIO_MDS_COMPACTION_MID)
