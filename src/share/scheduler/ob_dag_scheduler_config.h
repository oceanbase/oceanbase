...
DAG_SCHEDULER_DAG_NET_TYPE_DEF(DAG_NET_DATA_BACKUP_VALIDATION, "DAG_NET_DATA_BACKUP_VALIDATION")
DAG_SCHEDULER_DAG_NET_TYPE_DEF(DAG_NET_LOG_ARCHIVE_VALIDATION, "DAG_NET_LOG_ARCHIVE_VALIDATION")
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_BACKUP_LS_LOG_GROUP_FINISH, ObDagPrio::DAG_PRIO_HA_LOW, ObSysTaskType::BACKUP_TASK, "BACKUP_COMPLEMENT_LOG_LS_GROUP_FINISH", "BACKUP")
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_PREPARE_LOG_ARCHIVE_VALIDATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::BACKUP_VALIDATION_TASK, "PREPARE_LOG_ARCHIVE_VALIDATION", "BACKUP")
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_BACKUP_PIECE_VALIDATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::BACKUP_VALIDATION_TASK, "BACKUP_PIECE_VALIDATION", "BACKUP")
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_FINISH_LOG_ARCHIVE_VALIDATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::BACKUP_VALIDATION_TASK, "FINISH_LOG_ARCHIVE_VALIDATION", "BACKUP")
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_PREPARE_DATA_BACKUP_VALIDATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::BACKUP_VALIDATION_TASK, "PREPARE_DATA_BACKUP_VALIDATION", "BACKUP")
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_BACKUP_SET_META_VALIDATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::BACKUP_VALIDATION_TASK, "BACKUP_SET_META_VALIDATION", "BACKUP")
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_BACKUP_TABLET_GROUP_VALIDATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::BACKUP_VALIDATION_TASK, "BACKUP_TABLET_GROUP_VALIDATION", "BACKUP")
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_FINISH_DATA_BACKUP_VALIDATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::BACKUP_VALIDATION_TASK, "FINISH_DATA_BACKUP_VALIDATION", "BACKUP")
// DAG_TYPE_BACKUP_VALIDATION END
