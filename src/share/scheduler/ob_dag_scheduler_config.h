...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_BACKUP_TABLET_VALIDATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::BACKUP_VALIDATION_TASK, "BACKUP_TABLET_VALIDATION", "BACKUP")
