...
#ifdef OB_BUILD_SHARED_STORAGE
DAG_SCHEDULER_DAG_PRIO_DEF(DAG_PRIO_INC_SSTABLE_UPLOAD, DEFAULT_COMPACTION_HIGH_THREAD_CNT, "PRIO_INC_SSTABLE_UPLOAD", DEFAULT_FUNCTION)
#endif
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_TABLET_CHECK_CONVERT, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::MIGRATION_TASK, "TABLET_CHECKE_CONVERT", "MIGRATE",
    true, 3, {"tenant_id", "ls_id", "op_type"})
#ifdef OB_BUILD_SHARED_STORAGE
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_SS_INITIAL_MIGRATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::MIGRATION_TASK, "SS_INITIAL_MIGRATION", "MIGRATE",
    true, 3, {"tenant_id", "ls_id", "op_type"})
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_SS_START_MIGRATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::MIGRATION_TASK, "SS_START_MIGRATION", "MIGRATE",
    true, 3, {"tenant_id", "ls_id", "op_type"})
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_SS_FINISH_MIGRATION, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::MIGRATION_TASK, "SS_FINISH_MIGRATION", "MIGRATE",
    true, 3, {"tenant_id", "ls_id", "op_type"})
#endif
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_INC_SSTABLE_UPLOAD, ObDagPrio::DAG_PRIO_INC_SSTABLE_UPLOAD, ObSysTaskType::INC_SSTABLE_UPLOAD_TASK, "INC_SSTABLE_UPLOAD","INC_UPLOAD",
    false, 5, {"ls_id", "tablet_id", "table_type", "start_scn", "end_scn"})
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_ATTACH_SHARED_SSTABLE, ObDagPrio::DAG_PRIO_INC_SSTABLE_UPLOAD, ObSysTaskType::ATTACH_SHARED_SSTABLE_TASK, "ATTACH_SHARED_SSTABLE", "ATTACH_SHARED_SSTABLE",
