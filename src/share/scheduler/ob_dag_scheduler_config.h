...
// DAG_SCHEDULER_DAG_TYPE_DEF(DAG_NET_TYPE_ENUM, DAG_NET_TYPE_STR)
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_MINOR_MERGE, ObDagPrio::DAG_PRIO_COMPACTION_MID, ObSysTaskType::SSTABLE_MINOR_MERGE_TASK, "MINOR_MERGE", "COMPACTION")
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_RESTORE, ObDagPrio::DAG_PRIO_HA_LOW, ObSysTaskType::RESTORE_TASK, "RESTORE", "RESTORE")
