...
public:
  ...
  // ai model profile
  static int alter_ai_model_profile(ObArenaAllocator &allocator, const ObString &model_str, const ObIJsonBase &alter_jbase);
  static int drop_ai_model_profile(const ObString &model_str);
