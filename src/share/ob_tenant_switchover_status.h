...
IS_TENANT_STATUS(PREPARE_FLASHBACK_FOR_LOSSLESS_FAILOVER_TO_PRIMARY_STATUS, prepare_flashback_for_lossless_failover_to_primary)
...
static const ObTenantSwitchoverStatus PREPARE_FLASHBACK_FOR_LOSSLESS_FAILOVER_TO_PRIMARY_SWITCHOVER_STATUS(ObTenantSwitchoverStatus::PREPARE_FLASHBACK_FOR_LOSSLESS_FAILOVER_TO_PRIMARY_STATUS);
