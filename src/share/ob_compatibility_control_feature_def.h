...
DEF_COMPAT_CONTROL_FEATURE(ENABLE_PL_COMPOSITE_AS_SQL_UDT,
    "Whether to use SQL UDT for PL complex types in SQL scope to optimize memory",
    CLUSTER_VERSION_4_4_2_3)
DEF_COMPAT_CONTROL_FEATURE(PL_CHAR_BINARY_PADDING,
    "Whether to use the new PL CHAR and BINARY padding behavior",
    CLUSTER_VERSION_4_4_2_3)
...
DEF_COMPAT_CONTROL_FEATURE(UTF8MB4_DEFAULT_COLLATION_COMPAT,
    ...
    CLUSTER_VERSION_4_4_2_2)
DEF_COMPAT_CONTROL_FEATURE(MYSQL_USERNAME_LENGTH_32,
