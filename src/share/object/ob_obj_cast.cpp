                       ...
                       const ObObj &in, ObObj &out, const ObCastMode cast_mode)
{
  ...
  if (!is_enum_set_with_subschema(in)) {
    ...
    if (OB_FAIL(common_enumset_string(in, params, text_result))) {
      ...
      LOG_WARN("string_date failed", K(ret), K(es_str));
    }
  }
  return ret;
}
                       ...
                       const ObObj &in, ObObj &out, const ObCastMode cast_mode)
{
  ...
  if (!is_enum_set_with_subschema(in)) {
    ...
    if (OB_FAIL(common_enumset_string(in, params, text_result))) {
      ...
      LOG_WARN("string_time failed", K(ret), K(es_str));
    }
  }
  return ret;
}
                       ...
                       const ObObj &in, ObObj &out, const ObCastMode cast_mode)
{
  ...
  if (!is_enum_set_with_subschema(in)) {
    ...
    if (OB_FAIL(common_enumset_string(in, params, text_result))) {
      ...
      LOG_WARN("string_text failed", K(ret), K(es_str));
    }
  }
  return ret;
}
                       ...
                       const ObObj &in, ObObj &out, const ObCastMode cast_mode)
{
  ...
  if (!is_enum_set_with_subschema(in)) {
    ...
    if (OB_FAIL(common_enumset_string(in, params, text_result))) {
      ...
      LOG_WARN("string_lob failed", K(ret), K(es_str));
    }
  }
  return ret;
}
                       ...
                       const ObObj &in, ObObj &out, const ObCastMode cast_mode)
{
  ...
  if (!is_enum_set_with_subschema(in)) {
    ...
    if (OB_FAIL(common_enumset_string(in, params, text_result))) {
      ...
      LOG_WARN("string_json failed", K(ret), K(es_str));
    }
  }
  return ret;
}
