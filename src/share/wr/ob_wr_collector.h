...
public:
  ObWrSqlStat() {
    ...
    muti_query_total_ = 0;
    muti_query_delta_ = 0;
    muti_query_batch_total_ = 0;
    muti_query_batch_delta_ = 0;
    full_table_scan_total_ = 0;
    full_table_scan_delta_ = 0;
    error_count_total_ = 0;
    error_count_delta_ = 0;
    source_ip_[0] = '\0';
    source_ip_[46] = '\0';
    source_port_ = 0;
    route_miss_total_ = 0;
  ...
  int64_t muti_query_total_;
  int64_t muti_query_delta_;
  int64_t muti_query_batch_total_;
  int64_t muti_query_batch_delta_;
  int64_t full_table_scan_total_;
  int64_t full_table_scan_delta_;
  int64_t error_count_total_;
  int64_t error_count_delta_;
