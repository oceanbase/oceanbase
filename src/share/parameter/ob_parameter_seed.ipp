...
DEF_INT(lcl_time_skew_rate, OB_CLUSTER_PARAMETER, "0", 
        "every 100ms the clock skews lcl_time_skew_rate ms",
        ObParameterAttr(Section::TRANS, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_INT(lcl_time_client_offset, OB_CLUSTER_PARAMETER, "0", 
        "client add some offset between 0 and lcl_time_client_offset ms",
        ObParameterAttr(Section::TRANS, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
