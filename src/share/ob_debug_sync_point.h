...
#define OB_DEBUG_SYNC_POINT_DEF(ACT)                               \
    ...
    ACT(BEFORE_DDL_WRITE_START_LOG,)\
    ...
    ACT(BEFORE_CHECK_CLEAN_AND_CANCEL_DRTASK,)\
    ...
    ACT(BEFORE_COMPLETE_MIGRATION_CLEAR_DAG_NET_CTX,)\
    ...
    ACT(AFTER_INC_DDL_THREAD_COUNT,)\
    ACT(AFTER_HOTSPOT_LOCK_FOR_READ_OWNER_SNAPSHOT,)\
