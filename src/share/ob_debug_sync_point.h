...
#define OB_DEBUG_SYNC_POINT_DEF(ACT)                               \
    ...
    ACT(BACKUP_DELETE_AFTER_LOCK_POLICY_TABLE_LOG_ONLY,)\
    ...
    ACT(BACKUP_DELETE_BEFORE_MARK_DELETED_IN_NEW_LEADER,)\
    ACT(BACKUP_DELETE_BEFORE_MARK_DELETED_IN_OLD_LEADER,)\
    ...
    ACT(BEFORE_MAJOR_BACKUP_PREPARE_TASK,)\
    ACT(AFTER_BACKUP_PREPARE_TABLET,)\
    ...
    ACT(BEFORE_SWITCHING_TO_STANDBY,)\
    ...
    ACT(AFTER_DDL_OBJ_LOCK,)\
    ACT(BEFORE_DDL_POST_LOCK_OBJECTS_BY_ID,)\
    ...
    ACT(BEFORE_PARTITION_BALANCE_END,)\
    ...
    ACT(AFTER_TRANSFER_LOCK_TABLE_FOR_ORACLE_TMP_TABLE_V2,)\
    ACT(BEFORE_TRANSFER_PROCESS_INIT_TASK,)\
    ...
    ACT(BEFORE_SEMI_SYNC_TRANSPORT_RAW_WRITE,)\
    ...
    ACT(BEFORE_TRANSFER_UPDATE_ALL_SESSION_TABLET_TO_TEMPORARY_TABLE,)\
    ACT(GTT_V2_BEFORE_ADD_SESSION_TABLET,)\
    ...
    ACT(AFTER_TRANSFER_UPDATE_ALL_SESSION_TABLET_TO_TEMPORARY_TABLE,)\
    ...
    ACT(BEFORE_PROMOTE_PRE_MPT_LOAD_FOR_UPDATE,)\
    ...
    ACT(AFTER_CHANGE_SYS_LS_ACCESS_MODE_TO_RAW_RW,)\
    ...
    ACT(HANG_IN_CLONE_USER_POST_CHECK,)\
    ...
    ACT(BUILD_VECTOR_INDEX_PREPARE_AUX_INDEX_TABLES,)\
    ACT(LOAD_VECTOR_INDEX_ASYNC_TASK,)\
    ACT(START_VECTOR_INDEX_ASYNC_TASK,)\
    ...
    ACT(AFTER_GRANT_POOLS_BEFORE_GET_SERVERS,)\
    ACT(BEFORE_CREATE_TENANT_FILL_USER_LS_INFO,)\
    ACT(BEFORE_FINISH_CREATE_TENANT,)\
    ...
    ACT(BEFORE_MV_EXECUTE_REFRESH_SQL,)\
    ...
    ACT(AFTER_PRODUCER_CREATE_WITH_SSTABLETS,)\
    ACT(BEFORE_SS_TRANSFER_REFRESH,)\
    ACT(BEFORE_SS_TRANSFER_UPDATE_TABLET_STATUS,)\
    ACT(BEFORE_SS_TRANSFER_REPLACE,)\
    ACT(BEFORE_DELETE_TABLET_IN_META_SERVICE,)\
    ACT(BEFORE_UPGRADE_JOB,)\
    ACT(BEFORE_UPGRADE_SYS_VARIABLE,)\
    ACT(AFTER_UPGRADE_SYS_VARIABLE,)\
    ACT(BEFORE_UPGRADE_SYSTEM_TABLE,)\
    ACT(AFTER_UPGRADE_SYSTEM_TABLE,)\
    ACT(BEFORE_UPGRADE_VIRTUAL_SCHEMA,)\
    ACT(AFTER_UPGRADE_VIRTUAL_SCHEMA,)\
    ACT(AFTER_UPGRADE_VIRTUAL_SCHEMA_REFRESH_SCHEMA,)\
    ACT(BEFORE_SS_TRANSFER_UPLOAD,)\
    ACT(BEFORE_SS_TRANSFER_BACKFILL_TX,)\
    ACT(AFTER_LOCK_MVIEW_IN_REFRESH,)\
    ACT(REBUILD_INDEX_WAIT_REFRESH_RELATED_MVIEWS,)\
    ACT(REBUILD_INDEX_WAIT_CREATE_TASK_FINISH,)\
    ACT(REBUILD_INDEX_WAIT_DROP_TASK_FINISH,)\
    ACT(BEFORE_NESTED_MV_GET_SCN,)\
    ACT(BEFORE_NESTED_MV_REFRESH,)\
    ACT(LOAD_INNER_TABLE_SCHEMA,)\
    ACT(BEFORE_SCHEDULE_REPLACE_LS,)\
    ACT(BEFORE_GENERATE_SINGLE_REPLICA_TASK,)\
    ACT(BEFORE_SS_START_MIGRATION_TASK,)\
    ACT(BUILD_MVIEW_BEFORE_BUILD_MLOG,)\
    ACT(BUILD_MVIEW_AFTER_BUILD_MLOG,)\
    ACT(BUILD_MVIEW_BEFORE_COMPLETE_REFRESH,)\
    ACT(BEFORE_RESTORE_PRE,)\
    ACT(BEFORE_GET_TENANT_INFO,)\
    ACT(AFTER_GET_MTL_TENANT_LOCK,)\
    ACT(CREATE_INDEX_ON_EMPTY_TABLE,)\
    ACT(BACKUP_INFO_TASK_BEFORE_GET_NEXT_BATCH,)\
    ACT(BEFORE_RENEW_TENANT_SERVERS_CACHE,)\
    ACT(BEFORE_CHECK_INTERVAL_PARTITION_EXIST,)\
    ACT(AFTER_SEND_ALTER_TABLE,)\
    ACT(BEFORE_ADD_INTERVAL_PARTITION,)\
    ACT(BEFORE_TRASNFER_TABLET_RESTORE_STAT,)\
    ACT(BEFORE_UPDATE_PIECE_TO_ACTIVE,)\
    ACT(AFTER_TRY_INC_DDL_COUNT,)\
    ACT(BEFORE_INSPECTION_CHECK_CANCEL,)\
    ACT(MPT_BEFORE_SET_LS_TO_SYNC,)\
    ACT(MPT_BEFORE_SET_LS_TO_PRE_ASYNC,)\
    ACT(MPT_BEFORE_SET_LS_TO_ASYNC,)\
    ACT(STOP_COMMON_LS_SERVICE,)\
    ACT(STOP_PROTECTION_MODE_MGR,)\
    ACT(BEFORE_ADVANCE_META_TENANT_PROTECTION_STAT,)\
    ACT(BEFORE_CREATE_LS_SET_SYNC_MODE,)\
    ACT(BEFORE_CREATE_LS_GET_TENANT_INFO,)\
    ACT(AFTER_CREATE_LS_GET_TENANT_INFO,)\
    ACT(AFTER_CREATE_LS_SET_SYNC_MODE,)\
    ACT(BEFORE_SCHEDULE_TABLET_FUNC,)\
    ACT(BEFORE_TABLET_SPLIT_MAJOR_SSTABLE,)\
    ACT(LS_GC_AFTER_SUBMIT_OFFLINE_LOG,)\
    /* logservice::ObLogTransportTaskQueue test sync points */ \
    ACT(LOG_TP_QUEUE_PUSH_BEFORE_QUEUE_LOCK,)\
    ACT(LOG_TP_QUEUE_PUSH_AFTER_QUEUE_LOCK,)\
    ACT(LOG_TP_QUEUE_PUSH_BEFORE_ADVANCE_BASE,)\
    ACT(LOG_TP_QUEUE_PUSH_AFTER_ADVANCE_BASE,)\
    ACT(LOG_TP_QUEUE_PUSH_BEFORE_SW_GET,)\
    ACT(LOG_TP_QUEUE_PUSH_AFTER_SW_GET,)\
    ACT(LOG_TP_QUEUE_PUSH_BEFORE_DUP_CHECK,)\
    ACT(LOG_TP_QUEUE_PUSH_AFTER_DUP_CHECK,)\
    ACT(LOG_TP_QUEUE_PUSH_BEFORE_SET_SLOT,)\
    ACT(LOG_TP_QUEUE_PUSH_AFTER_SET_SLOT,)\
    ACT(LOG_TP_QUEUE_PROCESS_BEFORE_QUEUE_LOCK,)\
    ACT(LOG_TP_QUEUE_PROCESS_AFTER_QUEUE_LOCK,)\
    ACT(LOG_TP_QUEUE_PROCESS_BEFORE_ADVANCE_BASE,)\
    ACT(LOG_TP_QUEUE_PROCESS_AFTER_ADVANCE_BASE,)\
    ACT(LOG_TP_QUEUE_PROCESS_BEFORE_SLIDE,)\
    ACT(LOG_TP_QUEUE_PROCESS_AFTER_SLIDE,)\
    ACT(LOG_TP_QUEUE_TRY_INIT_BASE_BEFORE_TRUNCATE_RESET,)\
    ACT(LOG_TP_QUEUE_TRY_INIT_BASE_AFTER_TRUNCATE_RESET,)\
    ACT(LOG_TP_QUEUE_EVICT_IN_RANGE_BEFORE_SW_GET,)\
    ACT(LOG_TP_QUEUE_EVICT_IN_RANGE_AFTER_SW_GET,)\
    ACT(LOG_TP_QUEUE_EVICT_IN_RANGE_BEFORE_SLOT_RESET,)\
    ACT(LOG_TP_QUEUE_EVICT_IN_RANGE_AFTER_SLOT_RESET,)\
    ACT(LOG_TP_QUEUE_SLIDING_CB_BEFORE_RAW_WRITE,)\
    ACT(LOG_TP_QUEUE_SLIDING_CB_AFTER_RAW_WRITE,)\
    ACT(LOG_TP_QUEUE_SLOT_RESET_BEGIN,)\
    ACT(LOG_TP_QUEUE_SLOT_RESET_END,)\
    ACT(LOG_TP_QUEUE_CLEAR_BEFORE_QUEUE_LOCK,)\
    ACT(LOG_TP_QUEUE_CLEAR_AFTER_QUEUE_LOCK,)\
    ACT(LOG_TP_QUEUE_CLEAR_BEFORE_TRUNCATE,)\
    ACT(LOG_TP_QUEUE_CLEAR_AFTER_TRUNCATE,)\
    ACT(BEFORE_REPLACE_OLD_ADAPTOR,)\
    ACT(VECTOR_INDEX_QUERY_BEFORE_GET_ADAPTOR,)\
    ACT(VECTOR_INDEX_QUERY_BEFORE_LOCK,)\
    ACT(ASYNC_TASK_BEFORE_REPLACE_OLD_ADAPTOR,)\
    ACT(BEFORE_UPDATE_LS_MIGRATION_STATUS_WAIT,)\
    ACT(BEFORE_INIT_MIGRATION_TASK,)\
    ACT(BEFORE_TRANSFER_BUILD_TABLET_WITH_BATCH_TABLES,)\
    ACT(AFTER_CLASSIFY_REUSE_SESSION_TABLETS,)\
    ACT(AFTER_TRUNCATE_FREEZE_BEFORE_MDS_REGISTER,)\
    ACT(BEFORE_TRUNCATE_CAS_TABLET,)\
    ACT(BEFORE_CREATE_GTT_INDEX_SESSION_TABLET_FOR_STATS,)\
    ACT(AFTER_GET_GTT_DML_TABLET_ID,)\
    ACT(BEFORE_TRUNCATE_TABLET_DO_WORK,)\
    ACT(BEFORE_MAJOR_UPDATE_TABLET,)\
    ACT(AFTER_GET_DROP_GTT_V2_SESSION_TABLETS,)\
    ACT(AFTER_REUSE_GTT_V2_UPDATE_INNER_TABLE,)\
    ACT(AFTER_CLEANUP_INACTIVE_TRX_SESSION_TABLETS,)\
    ACT(AFTER_GET_DROP_GTT_V2_CREATOR_SESSION_TABLETS,)\
