...
#define OB_DEBUG_SYNC_POINT_DEF(ACT)                               \
    ...
    ACT(BEFORE_LS_REMOVE_MEMBER_TASK_PROCESS,)\
    ...
    ACT(BEFORE_COPY_TABLE_DEPENDENTS_RPC_IN_LOAD,)\
    ACT(BEFORE_FINISH_REDEF_TABLE_RPC_IN_LOAD,)\
    ACT(BEFORE_BUILD_DDL_SINGLE_REPLICA_RESPONSE_IN_LOAD,)\
    ...
    ACT(BEFORE_UPDATE_TABLET_HA_DATA_STATUS,)\
    ...
    ACT(BEFORE_DELETE_FTS_DDL_TASK_RECORD,)\
    ...
    ACT(BEFORE_REPLACE_WITH_FULL_PARTIAL_ADAPTER,)\
    ACT(BEFORE_REPLACE_WITH_COMPLETE_ADAPTER,)\
    ACT(BEFORE_DESERIALIZE_SNAP_DATA,)\
    ...
    ACT(AFTER_GET_BACKUP_DATA_LS_SNAPSHOT_FOR_SPECIFIED_SERVER,)\
    ACT(BEFORE_BACKUP_CHANGE_TURN_COMMIT_FOR_SPECIFIED_SERVER,)\
    ACT(BEFORE_INDEX_BUILD_RELEASE_SNAPSHOT,)\
    ACT(AFTER_PARALLEL_ALTER_TABLE_LOCK_OBJ,)\
