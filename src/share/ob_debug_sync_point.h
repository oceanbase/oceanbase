...
#define OB_DEBUG_SYNC_POINT_DEF(ACT)                               \
    ...
    ACT(COMPACTION_TTL_CHECK_META_TABLE,)\
    ...
    ACT(BACKUP_DELETE_MACRO_TASK_STATUS_DOING,)\
    ...
    ACT(CREATE_VECTOR_INDEX_SUCCESS,)\
    ...
    ACT(BEFORE_SEND_LS_TASK_TO_OBSERVER,)\
    ...
    ACT(AFTER_ADD_ONE_MACRO_DELETE_TASK,)\
    ACT(AFTER_BACKUP_META_FINISH,)\
    ACT(HA_MACRO_TASK_STATUS_BEFORE_DOING,)\
    ...
    ACT(AFTER_DDL_RETRY_WRITE_COMPLETE,)\
    ACT(AFTER_DDL_RETRY_REPORT_CHECKSUM,)\
    ...
    ACT(ASYNC_VEC_TASK_BEFORE_EXECUTE_INSERT,)\
    ACT(PARALLEL_VEC_TASK_EXECUTE_INSERT,)\
    ACT(PARALLEL_VEC_TASK_EXECUTE_EXCHANGE,)\
    ACT(PARALLEL_VEC_TASK_EXECUTE_CLEAN,)\
    ACT(VEC_SCHED_AFTER_PUSH_BEFORE_UPDATE,)\
    ...
    ACT(AFTER_UPDATE_TABLET_RESTORE_STATUS,)\
    ACT(BEFORE_REPLACE_REMOTE_INC_MAJOR_DDL,)\
    ...
    ACT(BEFORE_DDL_MERGE_ASSEMBLE_TASK,)\
    ACT(BEFORE_GC_TABLET,)\
    ...
    ACT(BEFORE_VEC_DELTA_BUF_CANCELLED,)\
    ACT(BEFORE_VEC_SCAN_VID_CANCELLED,)\
    ACT(VEC_VBITMAP_AFTER_COMPLETE_LOCK,)\
    ACT(BEFORE_VEC_UTILS_GET_DATA_CANCELLED,)\
    ACT(BEFORE_VEC_UTILS_GET_DATA_WITHOUT_VID_CANCELLED,)\
    ACT(BEFORE_VEC_SERIALIZE_GET_DATA_CANCELLED,)\
    ACT(BEFORE_VEC_VERIFY_ROW_CANCELLED,)\
    ACT(BEFORE_VEC_PROCESS_IVF_AUX_INFO_CANCELLED,)\
    ACT(BEFORE_LOB_CHECK_SCHEDULER_RUN,)\
    ACT(BEFORE_LOB_REPAIR_SCHEDULER_RUN,)\
    ACT(BEFORE_DO_EMBEDDING_TASK,)\
    ACT(BEFORE_COMPLETE_EMBEDDING_TASK,)\
    ACT(REFRESH_MEMDATA_INIT,)\
    ACT(REFRESH_MEMDATA_BEFORE_SYNC_SNAPSHOT,)\
    ACT(REFRESH_MEMDATA_AFTER_SYNC_SNAPSHOT,)\
    ACT(REFRESH_MEMDATA_BEFORE_SYNC_VBITMAP,)\
    ACT(REFRESH_MEMDATA_AFTER_SYNC_VBITMAP,)\
    ACT(BEFORE_REPLACE_OLD_ADAPTOR,)\
    ACT(BEFORE_VECTOR_INDEX_FREEZE_COMMIT,)\
    ACT(BEFORE_VECTOR_INDEX_FREEZE_SERIALIZE,)\
    ACT(BEFORE_VECTOR_INDEX_FREEZE_DESERIALIZE,)\
    ACT(BEFORE_VECTOR_INDEX_MERGE_COMMIT,)\
    ACT(BEFORE_VECTOR_INDEX_MERGE_INNER_SQL,)\
    ACT(BEFORE_VECTOR_INDEX_MERGE_DESERIALIZE,)\
    ACT(BEFORE_SS_RESTORE_DATA,)\
    ACT(BEFORE_BACKUP_DISABLE_SS_GC,)\
    ACT(SS_HA_MACRO_TASK_CANCEL_BEFORE_COMPLETE_CLEANUP,)\
    ACT(SS_HA_MACRO_TASK_BEFORE_DELETE_EXISTING_TASKS,)\
    ACT(SS_HA_MACRO_TASK_BEFORE_INIT_TO_RUNNING,)\
    ACT(SS_HA_MACRO_TASK_BEFORE_INIT_TO_COMPLETE,)\
    ACT(SS_HA_MACRO_TASK_BEFORE_RUNNING_TO_COMPLETE,)\
    ACT(SS_HA_MACRO_TASK_BEFORE_RUNNING_TO_FAILED,)\
    ACT(SS_HA_MACRO_TASK_BEFORE_COMPLETE_CLEANUP,)\
    ACT(SS_HA_MACRO_TASK_BEFORE_FAILED_CLEANUP,)\
    ACT(SS_HA_MACRO_TASK_AFTER_SUBMIT_TO_SCHEDULER,)\
    ACT(BEFORE_MACRO_TASK_REPORT_RESULT,)\
    ACT(VECTOR_INDEX_QUERY_BEFORE_GET_ADAPTOR,)\
    ACT(VECTOR_INDEX_QUERY_BEFORE_LOCK,)\
    ACT(AFTER_VECTOR_INDEX_MIGRATION_CREATE_ADAPTOR,)\
    ACT(AFTER_VECTOR_INDEX_MIGRATION_HOLD_SRC_ADAPTOR,)\
    ACT(BEFORE_CLEAN_DEPRECATED_ADAPTERS,)\
    ACT(ASYNC_TASK_BEFORE_REPLACE_OLD_ADAPTOR,)\
    ACT(BEFORE_VEC_INDEX_SERIALIZE,)\
    ACT(BEFORE_BUILD_SNAP_INDEX,)\
    ACT(BEFORE_DESTROY_COLLECT_ADAPTERS,)\
    ACT(VECTOR_INDEX_BUILDER_INIT_BEFORE_LOCK,)\
    ACT(VECTOR_INDEX_BUILDER_FREE_AFTER_VID,)\
    ACT(VECTOR_INDEX_BUILDER_INIT_AFTER_ALLOC,)\
    ACT(BEFORE_VECTOR_INDEX_COMPLETE_BITMAP_REPLACE,)\
    ACT(BEFORE_VECTOR_INDEX_VBITMAP_SCN_ACCESS,)\
