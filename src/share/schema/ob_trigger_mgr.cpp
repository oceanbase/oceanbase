...
ObTriggerMgr::ObTriggerMgr()
    : local_allocator_(ObModIds::OB_SCHEMA_GETTER_GUARD),
      ...
      trigger_infos_(0, NULL, ObModIds::OB_SCHEMA_TRIGGER_INFO_VECTOR),
      trigger_id_map_(ObModIds::OB_SCHEMA_TRIGGER_ID_MAP),
      trigger_name_map_(ObModIds::OB_SCHEMA_TRIGGER_NAME_MAP),
      is_inited_(false)
{
}
