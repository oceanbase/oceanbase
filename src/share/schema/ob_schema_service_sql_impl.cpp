...
ObSchemaServiceSQLImpl::ObSchemaServiceSQLImpl()
    : mysql_proxy_(NULL),
      ...
      ai_provider_service_(*this),
      ai_gateway_service_(*this),
...
GET_ALL_SCHEMA_FUNC_DEFINE(ai_provider, ObAIProviderSchema);
GET_ALL_SCHEMA_FUNC_DEFINE(ai_gateway, ObAIGatewaySchema);
...
FETCH_NEW_SCHEMA_ID(AI_PROVIDER, ai_provider);
FETCH_NEW_SCHEMA_ID(AI_GATEWAY, ai_gateway);
...
GET_BATCH_SCHEMAS_FUNC_DEFINE(ai_provider, ObAIProviderSchema);
GET_BATCH_SCHEMAS_FUNC_DEFINE(ai_gateway, ObAIGatewaySchema);
...
#include "ob_schema_service_sql_impl_for_ai.ipp"
