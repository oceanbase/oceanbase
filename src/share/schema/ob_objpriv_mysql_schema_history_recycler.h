...
#ifndef OCEANBASE_SHARE_SCHEMA_OB_OBJPRIV_MYSQL_SCHEMA_HISTORY_RECYCLER_H_
#define OCEANBASE_SHARE_SCHEMA_OB_OBJPRIV_MYSQL_SCHEMA_HISTORY_RECYCLER_H_
...
#endif // OCEANBASE_SHARE_SCHEMA_OB_OBJPRIV_MYSQL_SCHEMA_HISTORY_RECYCLER_H_
