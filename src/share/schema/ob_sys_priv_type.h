...
/* sensitive rule */
OB_SYS_PRIV_TYPE_DEF(PRIV_ID_CREATE_SENSITIVE_RULE, "CREATE SENSITIVE RULE")
OB_SYS_PRIV_TYPE_DEF(PRIV_ID_PLAINACCESS_ANY_SENSITIVE_RULE, "PLAINACCESS ANY SENSITIVE RULE")
...
/* scheduler */
OB_SYS_PRIV_TYPE_DEF(PRIV_ID_CREATE_ANY_JOB, "CREATE ANY JOB")
