...
enum ObRoutineFlag
{
  ...
  SP_FLAG_ANALYZED = SP_FLAG_ASYNC_COMMIT * 2,
  SP_FLAG_MAY_ACCESS_UNSYNC_PACKAGE_VAR = SP_FLAG_ANALYZED * 2,
  SP_FLAG_MAY_ACCESS_SYNC_PACKAGE_VAR = SP_FLAG_MAY_ACCESS_UNSYNC_PACKAGE_VAR * 2,
};
