...
enum ObDDLType
{
  ...
  DDL_MANUAL_SPLIT_WITHOUT_PK_BY_RANGE = 104,
  DDL_MANUAL_SPLIT_WITHOUT_PK_NON_RANGE = 105,
  ...
  */
  ...
  static inline bool is_verifying_checksum_error_needed(share::ObDDLType type)
  {
    ...
    switch (type) {
      ...
      case DDL_MANUAL_SPLIT_WITHOUT_PK_BY_RANGE:
      case DDL_MANUAL_SPLIT_WITHOUT_PK_NON_RANGE:
