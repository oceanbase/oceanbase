...
int ObServiceNameProxy::check_is_service_name_enabled(const uint64_t tenant_id)
{
  ...
  } else if (!((tenant_data_version >= MOCK_DATA_VERSION_4_2_1_9 && tenant_data_version < DATA_VERSION_4_2_0_0)
      || tenant_data_version >= DATA_VERSION_4_2_4_0)) {
    ret = OB_NOT_SUPPORTED;
    LOG_WARN("tenant_data_version should be [4.2.1.9, 4.2.0.0) or [4.2.4.0, +infinity)",
  ...
  } else if (!((meta_tenant_data_version >= MOCK_DATA_VERSION_4_2_1_9 && meta_tenant_data_version < DATA_VERSION_4_2_0_0)
      || meta_tenant_data_version >= DATA_VERSION_4_2_4_0)) {
    ret = OB_NOT_SUPPORTED;
    LOG_WARN("meta_tenant_data_version should be [4.2.1.9, 4.2.0.0) or [4.2.4.0, +infinity)",
