...
enum SystemTriggerEvent
{
  ...
  SYS_TRIGGER_CREATE = 2,
  SYS_TRIGGER_ALTER = 3,
  SYS_TRIGGER_DROP = 4,
  SYS_TRIGGER_TRUNCATE = 5,
  SYS_TRIGGER_RENAME = 6,
  SYS_TRIGGER_COMMENT = 7,
  SYS_TRIGGER_ANALYZE = 8,
  SYS_TRIGGER_AUDIT = 9,
  SYS_TRIGGER_NOAUDIT = 10,
  SYS_TRIGGER_GRANT = 11,
  SYS_TRIGGER_REVOKE = 12,
  SYS_TRIGGER_DDL = 13,
};
