...
# generate pl_parser
  ...
  if [ -d "../../../close_modules/oracle_pl/pl/parser" ]; then
    ...
    sed  "s/init_oracle_pl_non_reserved_keywords_tree/init_oracle_pl_latin1_non_reserved_keywords_tree/g" -i ../../../src/pl/parser/pl_non_reserved_keywords_oracle_latin1_mode.c
    ...
    sed  "s/init_oracle_pl_reserved_keywords_tree/init_oracle_pl_latin1_reserved_keywords_tree/g" -i ../../../src/pl/parser/pl_non_reserved_keywords_oracle_latin1_mode.c
...
UTF8_CHAR ({U_2}{U}|{U_3}{U}{U}|{u_except_space}|{U_3_2}{U}{U}|{u_except_comma_parenthesis}|{U_4}{U}{U}{U})" > ../../../src/pl/parser/pl_parser_oracle_utf8_mode.txt
    ...
    sed  "s/init_oracle_pl_non_reserved_keywords_tree/init_oracle_pl_utf8_non_reserved_keywords_tree/g" -i ../../../src/pl/parser/pl_non_reserved_keywords_oracle_utf8_mode.c
    ...
    sed  "s/init_oracle_pl_reserved_keywords_tree/init_oracle_pl_utf8_reserved_keywords_tree/g" -i ../../../src/pl/parser/pl_non_reserved_keywords_oracle_utf8_mode.c
    ##6.clean useless files
...
GB_CHAR ({GB_1_1}{GB_2}|{g_except_space}|{GB_1_3}{GB_2}|{g_except_comma_parenthesis}|{GB_1_5}{GB_2}|{GB_1}{GB_3}{GB_1}{GB_3})" > ../../../src/pl/parser/pl_parser_oracle_gbk_mode.txt
    ...
    sed  "s/init_oracle_pl_non_reserved_keywords_tree/init_oracle_pl_gbk_non_reserved_keywords_tree/g" -i ../../../src/pl/parser/pl_non_reserved_keywords_oracle_gbk_mode.c
    ...
    sed  "s/init_oracle_pl_reserved_keywords_tree/init_oracle_pl_gbk_reserved_keywords_tree/g" -i ../../../src/pl/parser/pl_non_reserved_keywords_oracle_gbk_mode.c
    ##6.clean useless files
...
HK_CHAR ({HK_1_1}{HK_2fb}|{HK_1_1}{HK_2sb}|{g_except_space_comma_parenthesis}|{HK_1_2}{HK_2sb}|{HK_1_3}{HK_2fb}|{HK_1_3}{HK_2sb})" > ../../../src/pl/parser/pl_parser_oracle_hkscs_mode.txt
    ...
    sed  "s/init_oracle_pl_non_reserved_keywords_tree/init_oracle_pl_hkscs_non_reserved_keywords_tree/g" -i ../../../src/pl/parser/pl_non_reserved_keywords_oracle_hkscs_mode.c
    ...
    sed  "s/init_oracle_pl_reserved_keywords_tree/init_oracle_pl_hkscs_reserved_keywords_tree/g" -i ../../../src/pl/parser/pl_non_reserved_keywords_oracle_hkscs_mode.c
    ##6.clean useless files
