                                                ...
                                                common::ObObj &result)
{
  ...
  } else if (lib::is_oracle_mode() && !params.at(0).is_null() &&
  ...
  } else if (lib::is_mysql_mode() && !params.at(0).is_null() &&
                                                ...
                                                StatTable &stat_table)
{
  ...
  LOG_TRACE("succeed to get common table stale percent", K(stat_table), K(partition_stat_infos));
  return ret;
}
