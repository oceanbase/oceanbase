    ...
    const AshReportParams &ash_report_params, ObSqlString &sql_string)
{
  ...
  } else if (OB_FAIL(sql_string.append_fmt(data_version >= DATA_VERSION_4_2_5_0   ? ASH_VIEW_SQL_425
    ...
    const AshReportParams &ash_report_params, ObSqlString &sql_string)
{
  ...
  if (OB_FAIL(GET_MIN_DATA_VERSION(MTL_ID(), data_version))) {
    ...
    LOG_WARN("failed to assign query string", K(ret));
             ...
             OB_FAIL(sql_string.append_fmt(data_version >= DATA_VERSION_4_2_5_0   ? WR_VIEW_SQL_425
