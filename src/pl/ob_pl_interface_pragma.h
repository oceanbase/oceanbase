...
#undef DEFINE_DBMS_VECTOR_MYSQL_INTERFACE
  ...
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_ALTER_MODEL_PARAMETER_MYSQL, "DBMS_AI_SERVICE_ALTER_MODEL_PARAMETER_MYSQL", (ObDBMSAiService::alter_model_parameter))
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_DROP_MODEL_PARAMETER_MYSQL, "DBMS_AI_SERVICE_DROP_MODEL_PARAMETER_MYSQL", (ObDBMSAiService::drop_model_parameter))
