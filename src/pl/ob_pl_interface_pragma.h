...
#define DEFINE_DBMS_VECTOR_MYSQL_INTERFACE(symbol, func) \
  ...
  DEFINE_DBMS_VECTOR_MYSQL_INTERFACE(DBMS_VECTOR_MYSQL_TRIGGER_ASYNC_TASK_WITH_DATABASE, ObDBMSVectorMySql::trigger_async_task_with_database)
...
#undef DEFINE_DBMS_VECTOR_MYSQL_INTERFACE
  ...
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_REGISTER_PROVIDER_MYSQL, "DBMS_AI_SERVICE_REGISTER_PROVIDER_MYSQL", (ObDBMSAiService::register_provider))
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_UNREGISTER_PROVIDER_MYSQL, "DBMS_AI_SERVICE_UNREGISTER_PROVIDER_MYSQL", (ObDBMSAiService::unregister_provider))
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_ALTER_PROVIDER_MYSQL, "DBMS_AI_SERVICE_ALTER_PROVIDER_MYSQL", (ObDBMSAiService::alter_provider))
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_CREATE_AI_GATEWAY_MYSQL, "DBMS_AI_SERVICE_CREATE_AI_GATEWAY_MYSQL", (ObDBMSAiService::create_ai_gateway))
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_ALTER_AI_GATEWAY_MYSQL, "DBMS_AI_SERVICE_ALTER_AI_GATEWAY_MYSQL", (ObDBMSAiService::alter_ai_gateway))
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_DROP_AI_GATEWAY_MYSQL, "DBMS_AI_SERVICE_DROP_AI_GATEWAY_MYSQL", (ObDBMSAiService::drop_ai_gateway))
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_ALTER_MODEL_PROFILE_MYSQL, "DBMS_AI_SERVICE_ALTER_MODEL_PROFILE_MYSQL", (ObDBMSAiService::alter_model_profile))
  INTERFACE_DEF(INTERFACE_DBMS_AI_SERVICE_DROP_MODEL_PROFILE_MYSQL, "DBMS_AI_SERVICE_DROP_MODEL_PROFILE_MYSQL", (ObDBMSAiService::drop_model_profile))
