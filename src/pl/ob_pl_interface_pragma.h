...
#undef DEFINE_DEBUG_INTERFACE
  ...
  INTERFACE_DEF(INTERFACE_DBMS_SQL_RETURN_RESULT, "DBMS_SQL_RETURN_RESULT", (ObPLDbmsSql::return_result))
  // end of dbms_sql
...
#undef PREFIX
  ...
  INTERFACE_DEF(INTERFACE_XML_TYPE_TOOBJECT, "XML_TYPE_TOOBJECT", (ObXmlType::to_object))
  //end of xmltype
  ...
  INTERFACE_DEF(INTERFACE_DBMS_XMLPARSER_PARSEBUFFER, "DBMS_XMLPARSER_PARSEBUFFER", (ObDbmsXmlParser::parse_buffer))
  ...
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_GETFIRSTCHILD, "DBMS_XMLDOM_GETFIRSTCHILD", (ObDbmsXmlDom::get_first_child))
  ...
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_APPENDCHILD, "DBMS_XMLDOM_APPENDCHILD", (ObDbmsXmlDom::append_child))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_CREATEELEMENT, "DBMS_XMLDOM_CREATEELEMENT", (ObDbmsXmlDom::create_element))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_CREATETEXTNODE, "DBMS_XMLDOM_CREATETEXTNODE", (ObDbmsXmlDom::create_text_node))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_MAKECHARACTERDATA, "DBMS_XMLDOM_MAKECHARACTERDATA", (ObDbmsXmlDom::make_character_data))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_MAKENODE, "DBMS_XMLDOM_MAKENODE", (ObDbmsXmlDom::make_node))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_REMOVECHILD, "DBMS_XMLDOM_REMOVECHILD", (ObDbmsXmlDom::remove_child))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_SETATTRIBUTE, "DBMS_XMLDOM_SETATTRIBUTE", (ObDbmsXmlDom::set_attribute))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_GETDATA, "DBMS_XMLDOM_GETDATA", (ObDbmsXmlDom::get_data))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_GETDOCUMENTELEMENT, "DBMS_XMLDOM_GETDOCUMENTELEMENT", (ObDbmsXmlDom::get_document_element))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_GETLOCALNAME, "DBMS_XMLDOM_GETLOCALNAME", (ObDbmsXmlDom::get_local_name))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_GETNODENAME, "DBMS_XMLDOM_GETNODENAME", (ObDbmsXmlDom::get_node_name))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_GETNODETYPE, "DBMS_XMLDOM_GETNODETYPE", (ObDbmsXmlDom::get_node_type))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_GETXMLTYPE, "DBMS_XMLDOM_GETXMLTYPE", (ObDbmsXmlDom::get_xml_type))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_ISNULL, "DBMS_XMLDOM_ISNULL", (ObDbmsXmlDom::is_null))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_NEWDOMDOCUMENT, "DBMS_XMLDOM_NEWDOMDOCUMENT", (ObDbmsXmlDom::new_dom_document))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_SETCHARSET, "DBMS_XMLDOM_SETCHARSET", (ObDbmsXmlDom::set_charset))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_SETVERSION, "DBMS_XMLDOM_SETVERSION", (ObDbmsXmlDom::set_version))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_WRITETOBUFFER, "DBMS_XMLDOM_WRITETOBUFFER", (ObDbmsXmlDom::write_to_buffer))
  INTERFACE_DEF(INTERFACE_DBMS_XMLDOM_WRITETOCLOB, "DBMS_XMLDOM_WRITETOCLOB", (ObDbmsXmlDom::write_to_clob))
  //end of dbms_xmldom
...
#define DEFINE_DBMS_MVIEW_INTERFACE(symbol, func) \
  ...
  DEFINE_DBMS_MVIEW_INTERFACE(DBMS_MVIEW_REFRESH_REPORT, ObDBMSMView::refresh_report)
  DEFINE_DBMS_MVIEW_INTERFACE(DBMS_MVIEW_KILL_REFRESH, ObDBMSMView::kill)
  DEFINE_DBMS_MVIEW_INTERFACE(DBMS_MVIEW_SET_REFRESH_PARAMS, ObDBMSMView::set_refresh_params)
  DEFINE_DBMS_MVIEW_INTERFACE(DBMS_MVIEW_EXPLAIN_REFRESH, ObDBMSMView::explain_refresh)
...
#define DEFINE_DBMS_MVIEW_MYSQL_INTERFACE(symbol, func) \
  ...
  DEFINE_DBMS_MVIEW_MYSQL_INTERFACE(DBMS_MVIEW_MYSQL_REFRESH_REPORT, ObDBMSMViewMysql::refresh_report)
  DEFINE_DBMS_MVIEW_MYSQL_INTERFACE(DBMS_MVIEW_MYSQL_KILL_REFRESH, ObDBMSMViewMysql::kill)
  DEFINE_DBMS_MVIEW_MYSQL_INTERFACE(DBMS_MVIEW_MYSQL_SET_REFRESH_PARAMS, ObDBMSMViewMysql::set_refresh_params)
  DEFINE_DBMS_MVIEW_MYSQL_INTERFACE(DBMS_MVIEW_MYSQL_EXPLAIN_REFRESH, ObDBMSMViewMysql::explain_refresh)
...
#define DEFINE_DBMS_VECTOR_MYSQL_INTERFACE(symbol, func) \
  ...
  DEFINE_DBMS_VECTOR_MYSQL_INTERFACE(DBMS_VECTOR_MYSQL_TRIGGER_ASYNC_TASK, ObDBMSVectorMySql::trigger_async_task)
...
#ifdef OB_BUILD_ORACLE_PL
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_OB_LOADJAR, "DBMS_JAVA_OB_LOADJAR", (ObDBMSJava::ob_loadjar))
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_OB_DROPJAR, "DBMS_JAVA_OB_DROPJAR", (ObDBMSJava::ob_dropjar))
#endif // OB_BUILD_ORACLE_PL
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_GRANT_PERMISSION, "DBMS_JAVA_GRANT_PERMISSION", (ObDBMSJava::grant_permission))
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_GRANT_PERMISSION_WITH_KEY, "DBMS_JAVA_GRANT_PERMISSION_WITH_KEY", (ObDBMSJava::grant_permission_with_key))
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_RESTRICT_PERMISSION, "DBMS_JAVA_RESTRICT_PERMISSION", (ObDBMSJava::restrict_permission))
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_RESTRICT_PERMISSION_WITH_KEY, "DBMS_JAVA_RESTRICT_PERMISSION_WITH_KEY", (ObDBMSJava::restrict_permission_with_key))
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_REVOKE_PERMISSION, "DBMS_JAVA_REVOKE_PERMISSION", (ObDBMSJava::revoke_permission))
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_DISABLE_PERMISSION, "DBMS_JAVA_DISABLE_PERMISSION", (ObDBMSJava::disable_permission))
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_ENABLE_PERMISSION, "DBMS_JAVA_ENABLE_PERMISSION", (ObDBMSJava::enable_permission))
  INTERFACE_DEF(INTERFACE_DBMS_JAVA_DELETE_PERMISSION, "DBMS_JAVA_DELETE_PERMISSION", (ObDBMSJava::delete_permission))
  // end of dbms_java
