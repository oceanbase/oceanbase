...
enum ObPLOpaqueType
{
  ...
  PL_XMLDOM_ATTR_TYPE = 8, // FARM COMPAT WHITELIST
  PL_XMLDOM_CHARACTERDATA_TYPE = 9, // FARM COMPAT WHITELIST
  PL_XMLDOM_ELEMENT_TYPE = 10, // FARM COMPAT WHITELIST
  PL_XMLDOM_TEXT_TYPE = 11 // FARM COMPAT WHITELIST
};
