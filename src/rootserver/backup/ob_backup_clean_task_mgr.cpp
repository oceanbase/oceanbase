...
int ObBackupCleanTaskMgr::check_backup_set_dir_empty_()
{
  ...
  } else if (OB_FAIL(io_adapter.is_empty_directory(set_path.get_ptr(), backup_dest_.get_storage_info(), is_empty))) {
...
int ObBackupCleanTaskMgr::check_backup_piece_dir_empty_()
{
  ...
  } else if (OB_FAIL(io_adapter.is_empty_directory(piece_path.get_ptr(), backup_dest_.get_storage_info(), is_empty))) {
