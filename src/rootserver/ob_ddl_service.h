...
public:
  ...
  int check_table_exists(const uint64_t tenant_id,
                         ...
                         const share::schema::ObTableSchema **table_schema);
  int create_hidden_table(const obrpc::ObCreateHiddenTableArgV2 &create_hidden_table_arg,
  ...
  */
  ...
  int alter_table_column(
      ...
      common::ObIArray<share::schema::ObTableSchema> *global_idx_schema_array);
