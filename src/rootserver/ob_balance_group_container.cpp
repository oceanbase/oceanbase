...
int64_t ShardGroupContainerBuilder::SameRangePartInfo::to_string(char* buf, const int64_t buf_len) const
{
  int64_t pos = 0;
  J_OBJ_START();
  J_KV(K_(pkey), K_(tablegroup_id), K_(table_id), K_(all_tg_idx), K_(part_idx));
  J_OBJ_END();
  return pos;
}
