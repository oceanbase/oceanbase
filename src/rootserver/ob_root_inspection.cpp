...
int ObRootInspection::check_in_compatibility_mode_(const uint64_t &tenant_id, bool &in_compatibility_mode)
{
  int ret = OB_SUCCESS;
...
bool ObRootInspection::need_ignore_error_message_(const uint64_t &tenant_id)
{
  int ret = OB_SUCCESS;
  bool ignore = false;
