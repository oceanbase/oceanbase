...
int ObSensitiveRuleDDLService::handle_sensitive_rule_ddl(const ObSensitiveRuleDDLArg &arg)
{
  ...
  } else if ((is_oracle_mode && !((data_version >= DATA_VERSION_4_4_2_0 && data_version < DATA_VERSION_4_5_0_0)))
             || (!is_oracle_mode
                                                           ...
                                                           share::schema::ObSchemaGetterGuard &schema_guard)
{
  ...
  if (OB_UNLIKELY(!is_valid_tenant_id(tenant_id))) {
    ...
    LOG_WARN("failed to get min data version", K(ret));
  } else if ((is_ora_mode && !((data_version >= DATA_VERSION_4_4_2_0 && data_version < DATA_VERSION_4_5_0_0)))
             || (!is_ora_mode
                 && !((data_version >= MOCK_DATA_VERSION_4_3_5_3 && data_version < DATA_VERSION_4_4_0_0)
                      || (data_version >= DATA_VERSION_4_4_2_0 && data_version < DATA_VERSION_4_5_0_0)))) {
    ret = OB_NOT_SUPPORTED;
