...
RPC_F(obrpc::OB_BATCH_DETECT_SESSION_ALIVE, obrpc::ObBatchDetectSessionAliveArg, obrpc::ObBatchDetectSessionAliveResult, ObBatchDetectSessionAliveProxy);
...
RPC_F(obrpc::OB_CHECK_TENANT_CONFIG_AND_INFO, obrpc::ObCheckTenantConfigAndInfoArg, obrpc::ObCheckTenantConfigAndInfoResult, ObCheckTenantConfigAndInfoProxy);
...
RPC_F(obrpc::OB_ASYNC_GET_INSPECTION_STATUS, obrpc::ObGetInspectionStatusArg, obrpc::ObGetInspectionStatusResult, ObAsyncGetInspectionStatusProxy);
