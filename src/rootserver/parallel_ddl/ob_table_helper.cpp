...
int ObTableHelper::inner_generate_table_schema_(const ObCreateTableArg &arg, ObTableSchema &new_table)
{
  ...
  if (OB_SUCC(ret) && compat_version >= DATA_VERSION_5_0_1_0) {
    if (OB_FAIL(ObMergeEngineUtil::init_merge_engine_upper_version(new_table, arg.schema_.get_merge_engine_type()))) {
