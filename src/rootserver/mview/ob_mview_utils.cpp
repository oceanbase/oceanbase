    ...
    share::schema::ObSchemaType &schema_type)
{
  ...
  if (OB_FAIL(GET_MIN_DATA_VERSION(tenant_id, data_version))) {
    ...
    ret = OB_NOT_SUPPORTED;
    LOG_WARN("referring functions/types in materialized view definition is not supported before 4.3.5.5 or between 4.4.0.0 and 4.4.2.0 or between 4.5.0.0 and 4.5.1.0");
