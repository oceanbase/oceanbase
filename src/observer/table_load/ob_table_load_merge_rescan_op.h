...
class ObTableLoadMergeRescanOp final : public ObTableLoadMergeTableBaseOp
{
  friend class ObTableLoadParallelMerger;

public:
  ObTableLoadMergeRescanOp(ObTableLoadMergeTableBaseOp *parent);
  virtual ~ObTableLoadMergeRescanOp();
