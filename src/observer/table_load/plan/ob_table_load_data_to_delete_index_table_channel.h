...
class ObTableLoadDataToDeleteIndexTableChannel : public ObTableLoadTableChannel
{
public:
  ObTableLoadDataToDeleteIndexTableChannel(ObTableLoadTableOp *up_table_op,
                                           ObTableLoadTableOp *down_table_op);
  virtual ~ObTableLoadDataToDeleteIndexTableChannel();
...
private:
  int create_row_projector() override;
