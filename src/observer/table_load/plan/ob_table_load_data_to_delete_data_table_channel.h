...
namespace observer
{
class ObTableLoadDataToDeleteDataTableChannel : public ObTableLoadTableChannel
{
public:
  ObTableLoadDataToDeleteDataTableChannel(ObTableLoadTableOp *up_table_op,
                                     ObTableLoadTableOp *down_table_op)
    : ObTableLoadTableChannel(up_table_op, down_table_op)
  {
  }
  virtual ~ObTableLoadDataToDeleteDataTableChannel() = default;
