...
namespace observer
{
class ObTableLoadDataToInsertDataTableChannel : public ObTableLoadTableChannel
{
public:
  ObTableLoadDataToInsertDataTableChannel(ObTableLoadTableOp *up_table_op,
                                          ObTableLoadTableOp *down_table_op)
    : ObTableLoadTableChannel(up_table_op, down_table_op)
  {
  }
  virtual ~ObTableLoadDataToInsertDataTableChannel() = default;
