...
class ObTableLoadDataTableInsertRowHandler : public ObTableLoadTableDMLRowHandler
{
public:
  ObTableLoadDataTableInsertRowHandler(ObTableLoadTableOp *table_op);
  virtual ~ObTableLoadDataTableInsertRowHandler() = default;
  int init() override;
