...
class ObTableLoadDataToInsertIndexTableChannel : public ObTableLoadTableChannel
{
public:
  ObTableLoadDataToInsertIndexTableChannel(ObTableLoadTableOp *up_table_op,
                                           ObTableLoadTableOp *down_table_op);
  virtual ~ObTableLoadDataToInsertIndexTableChannel();
