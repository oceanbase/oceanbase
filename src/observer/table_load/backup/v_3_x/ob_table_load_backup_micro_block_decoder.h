...
#include "observer/table_load/backup/v_3_x/encoding/ob_icolumn_decoder.h"
#include "observer/table_load/backup/v_3_x/encoding/ob_encoding_allocator.h"
...
public:
  ...
  // performance critical, do not check parameters
  int quick_compare(const common::ObObj &left, const int64_t row_id,
