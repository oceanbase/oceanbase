...
{
struct ObTableLoadBackupRowHeaderDummy
{
  int8_t row_flag_;
  ...
  DISALLOW_COPY_AND_ASSIGN(ObTableLoadBackupRowHeaderDummy);
};

class ObTableLoadBackupRowHeader
{
public:
  ObTableLoadBackupRowHeader() { memset(this, 0, sizeof(*this)); }
  ...
  ObTableLoadBackupRowHeader &operator=(const ObTableLoadBackupRowHeader &src)
  {
...
{
public:
  static const uint8_t STORE_TEXT_STORE_VERSION = 1;
  enum ObStoreAttr
  {
...
private:
  ...
  const ObTableLoadBackupRowHeader *row_header_;
  bool is_first_row_;
};
