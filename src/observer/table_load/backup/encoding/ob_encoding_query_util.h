...
template <> struct ObCmpTypeToAvxOpMap<ObWhiteFilterOperatorType::WHITE_OP_EQ> { constexpr static int value_ = 0; };
template <> struct ObCmpTypeToAvxOpMap<ObWhiteFilterOperatorType::WHITE_OP_LT> { constexpr static int value_ = 1; };
template <> struct ObCmpTypeToAvxOpMap<ObWhiteFilterOperatorType::WHITE_OP_LE> { constexpr static int value_ = 2; };
template <> struct ObCmpTypeToAvxOpMap<ObWhiteFilterOperatorType::WHITE_OP_GE> { constexpr static int value_ = 5; };
template <> struct ObCmpTypeToAvxOpMap<ObWhiteFilterOperatorType::WHITE_OP_GT> { constexpr static int value_ = 6; };
template <> struct ObCmpTypeToAvxOpMap<ObWhiteFilterOperatorType::WHITE_OP_NE> { constexpr static int value_ = 4; };
