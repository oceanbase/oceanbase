...
ObMySQLUserTable::ObMySQLUserTable() : ObVirtualTableScannerIterator(), tenant_id_(OB_INVALID_ID)
{}
...
#define COLUMN_SET_WITH_TYPE(COL_NAME, TYPE, VALUE)                                                        \
  case (COL_NAME): {                                                                                       \
    ...
    break;                                                                                                 \
                    ...
                    NO_EXIST_PRIV_CASE(REPL_SLAVE);
                    NO_EXIST_PRIV_CASE(REPL_CLIENT);
                    ...
                    NO_EXIST_PRIV_CASE(CREATE_TABLESPACE);
