...
#ifndef OB_ALL_VIRTUAL_ELECTION_INFO_H_
#define OB_ALL_VIRTUAL_ELECTION_INFO_H_

#include "share/ob_virtual_table_scanner_iterator.h"
#include "share/ob_scanner.h"
#include "common/row/ob_row.h"
#include "share/ob_define.h"
#include "election/ob_election_info.h"

namespace oceanbase {
namespace observer {
class ObGVElectionInfo : public common::ObVirtualTableScannerIterator {
public:
  ObGVElectionInfo() : ObVirtualTableScannerIterator()
  {
    reset();
  }
  explicit ObGVElectionInfo(election::ObElectionMgr* election_mgr)
      : ObVirtualTableScannerIterator(), election_mgr_(election_mgr)
  {
    reset();
  }
  virtual ~ObGVElectionInfo()
  {
    destroy();
  }
...
private:
  ...
  election::ObElectionInfoIterator election_info_iter_;

private:
  DISALLOW_COPY_AND_ASSIGN(ObGVElectionInfo);
};
