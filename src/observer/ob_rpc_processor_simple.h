...
OB_DEFINE_PROCESSOR_S(Srv, OB_GET_LS_LOCATION, ObGetLSLocationP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_NOTIFY_BACKUP_ARCHIVE, ObRpcNotifyBackupArchiveP);
OB_DEFINE_PROCESSOR_S(Srv, OB_BACKUP_ARCHIVE_RESULT_REPORT, ObRpcBackupArchiveResultReportP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_CHECK_TENANT_CONFIG_AND_INFO, ObCheckTenantConfigAndInfoP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_CHANGE_LS_SYNC_MODE, ObRpcChangeLSSyncModeP);
OB_DEFINE_PROCESSOR_S(Srv, OB_GET_LS_SYNC_SCN, ObRpcGetLSSyncScnP);
OB_DEFINE_PROCESSOR_S(Srv, OB_GET_LS_STANDBY_SYNC_SCN, ObRpcGetLSStandbySyncScnP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_CLEAR_SYNC_STANDBY_DEST_CACHE, ObClearSyncStandbyDestCacheP);
OB_DEFINE_PROCESSOR_S(Srv, OB_TABLET_MAJOR_FREEZE, ObRpcTabletMajorFreezeP);
OB_DEFINE_PROCESSOR_S(Srv, OB_TRUNCATE_TABLET_FREEZE, ObRpcTruncateTabletFreezeP);
