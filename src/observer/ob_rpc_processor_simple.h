...
#ifdef OB_BUILD_SHARED_STORAGE
OB_DEFINE_PROCESSOR_S(Srv, OB_SS_HA_COPY_MACRO_BLOCKS, ObRpcSSHACopyMacroBlocksP);
OB_DEFINE_PROCESSOR_S(Srv, OB_SS_HA_DELETE_MACRO_BLOCKS, ObRpcSSHADeleteMacroBlocksP);
#endif
