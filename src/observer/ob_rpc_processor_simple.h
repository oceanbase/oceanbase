...
OB_DEFINE_PROCESSOR_S(Srv, OB_SYNC_TABLET_AUTOINC_SEQ_CACHE, ObRpcSyncTabletAutoincSeqCacheP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_NOTIFY_UPLOAD_ROOT_KEY, ObRpcUploadRootKeyP);
#endif
#endif
...
OB_DEFINE_PROCESSOR_S(Srv, OB_CHECK_TABLET_EXIST, ObCheckTabletExistP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_LS_REPLACE_REPLICA, ObRpcLSReplaceReplicaP);
...
OB_DEFINE_PROCESSOR_OBADMIN(Srv, OB_EXEC_SWITCH_REPLICA_ROLE, ObAdminSwitchReplicaRoleP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_DETECT_SSLOG_LS, ObRpcDetectSSlogLSP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_SERVER_UPDATE_CATALOG_STAT_CACHE, ObUpdateLocalCatalogStatCacheP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_CHECK_SERVER_ALIVE, ObCheckServerAliveP);
OB_DEFINE_PROCESSOR_S(Srv, OB_PRE_PROCESS_SERVER, ObPreProcessServerP);
#ifdef OB_BUILD_TDE_SECURITY
OB_DEFINE_PROCESSOR_S(Srv, OB_SET_MASTER_KEY, ObSetMasterKeyP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_GET_UNIT_INFO, ObRpcGetUnitInfoP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_REFRESH_FULLTEXT_DICT, ObRpcRefreshFulltextDictP);
#ifdef OB_BUILD_SHARED_STORAGE
...
OB_DEFINE_PROCESSOR_S(Srv, OB_FLUSH_SS_LOCAL_CACHE, ObRpcFlushSSLocalCacheP);
OB_DEFINE_PROCESSOR_S(Srv, OB_PREWARM_SS_LOCAL_CACHE, ObRpcPrewarmSSLocalCacheP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_TABLET_SPLIT_SCHEDULE, ObRpcTabletSplitScheduleP);
OB_DEFINE_PROCESSOR_S(Srv, OB_GET_MIN_SS_GC_LAST_SUCC_SCN, ObRpcGetMinSSGCLastSuccScnP);
OB_DEFINE_PROCESSOR_S(Srv, OB_GET_SS_GC_LAST_SUCC_SCNS, ObRpcGetSSGCLastSuccScnsP);
OB_DEFINE_PROCESSOR_S(Srv, OB_ADJUST_SS_GC_TABLET_VERSION_RETENTION_SCN, ObRpcAdjustSSGCTabletVersionRetentionScnP);
OB_DEFINE_PROCESSOR_S(Srv, OB_PUSH_SS_GC_LAST_SUCC_SCN, ObRpcPushSSGCLastSuccScnP);
OB_DEFINE_PROCESSOR_S(Srv, OB_DEL_SS_MACRO_CACHE, ObDelSSMacroCacheP);
OB_DEFINE_PROCESSOR_S(Srv, OB_DEL_SS_TABLET_MACRO_CACHE, ObDelSSTabletMacroCacheP);
OB_DEFINE_PROCESSOR_S(Srv, OB_GET_SS_GC_DETECT_INFOS, ObRpcGetSSGCDetectInfosP);
OB_DEFINE_PROCESSOR_S(Srv, OB_GET_SS_GC_START_SCN_ITEMS, ObRpcGetSSGCStartScnItemsP);
#endif
...
OB_DEFINE_PROCESSOR_S(Srv, OB_FORCE_REMOVE_LS_REPLICA, ObForceRemoveLSReplicaP);
#ifdef OB_BUILD_SPM
...
OB_DEFINE_PROCESSOR_S(Srv, OB_BATCH_DETECT_SESSION_ALIVE, ObRpcBatchDetectSessionAliveP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_TABLE_MAJOR_FREEZE, ObRpcTableMajorFreezeP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_NOTIFY_LOGSERVICE_ACCESS_POINT, ObNotifyLogServiceAccessPointP);
...
OB_DEFINE_PROCESSOR_S(Srv, OB_BATCH_GET_TABLET_RANDOM, ObRpcBatchGetTabletRandomP);
