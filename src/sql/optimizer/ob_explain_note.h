...
#define INSERTUP_OPT_FOR_COLUMN_STROE_ENABLED  "Optimization of insert on duplicate key update for column stroe is enabled"
#define INSERTUP_OPT_FOR_COLUMN_STROE_DISABLED  "Optimization of insert on duplicate key update for column stroe is disabled, because %s"
