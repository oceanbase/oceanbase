                                                 ...
                                                 bool is_outerjoin_filter)
{
  ...
  */
  if (OB_SUCC(ret) && ctx.get_compat_version() >= COMPAT_VERSION_4_2_5) {
                                             ...
                                             common::ObIArray<ObExprSelPair> &all_predicate_sel)
{
  ...
  if (OB_ISNULL(base_table_meta) || OB_ISNULL(log_plan = ctx.get_plan())) {
    ...
    } else if (OB_FAIL(ctx.get_compat_version() < COMPAT_VERSION_4_2_4 ?
                                           ...
                                           double *null_sel_ptr)
{
  ...
  if (OB_FAIL(get_column_basic_info(table_metas, ctx, expr, &ndv, &num_null, NULL, &row_count))) {
    ...
    if (1.0 == ndv && 1.0 == row_count && ctx.check_opt_compat_version(COMPAT_VERSION_4_2_5_BP7)) {
...

{
  ...
  } else if (IS_ANTI_JOIN(ctx.get_join_type()) && ctx.get_compat_version() >= COMPAT_VERSION_4_2_5) {
