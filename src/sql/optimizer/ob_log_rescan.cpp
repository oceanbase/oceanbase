...
int ObLogRescan::do_re_est_cost(EstimateCostInfo &param, double &card, double &op_cost, double &cost)
{
  int ret = OB_SUCCESS;
...
int ObLogRescan::get_plan_item_info(PlanText &plan_text,
                                    ObSqlPlanItem &plan_item)
{
  ...
  if (OB_SUCC(ret)) {
    BEGIN_BUF_PRINT;
    BUF_PRINTF("rescan_cnt=%ld", rescan_cnt_);
