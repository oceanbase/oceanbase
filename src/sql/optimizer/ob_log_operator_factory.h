...
// Hybrid fusion operator (used to handle global fusion / rerank for hybrid search in PX/distributed scenarios)
LOG_OP_DEF(LOG_HYBRID_FUSION, "HYBRID FUSION")
LOG_OP_DEF(LOG_RESCAN, "RESCAN")
