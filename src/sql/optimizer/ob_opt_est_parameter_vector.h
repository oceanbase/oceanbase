...
const static double VECTOR_ROW_STORE_PROJECT_COLUMN_RND_LOB_COST = 6.5 * DEFAULT_CPU_SPEED;
const static double VECTOR_ROW_STORE_PROJECT_COLUMN_RND_JSON_COST = 9.7 * DEFAULT_CPU_SPEED;
const static double VECTOR_ROW_STORE_PROJECT_COLUMN_RND_GIS_COST = 8.9 * DEFAULT_CPU_SPEED;
//column store
...
const static double VECTOR_COLUMN_STORE_PROJECT_COLUMN_RND_LOB_COST = 6.5 * DEFAULT_CPU_SPEED;
const static double VECTOR_COLUMN_STORE_PROJECT_COLUMN_RND_JSON_COST = 9.7 * DEFAULT_CPU_SPEED;
const static double VECTOR_COLUMN_STORE_PROJECT_COLUMN_RND_GIS_COST = 8.9 * DEFAULT_CPU_SPEED;
...
//external table cost params
const static double VECTOR_EXTERNAL_TABLE_CPU_PER_BYTE_COST = 0.00293 * DEFAULT_CPU_SPEED;
const static double VECTOR_EXTERNAL_TABLE_LOCAL_IO_PER_BYTE_COST = 0.000299 * DEFAULT_DISK_SEQ_READ_SPEED;
const static double VECTOR_EXTERNAL_TABLE_NETWORK_IO_PER_BYTE_COST = 0.007063 * DEFAULT_NETWORK_SPEED;
...
const static ObOptCostModelParameter cost_params_vector(
   ...
   VECTOR_EXTERNAL_TABLE_CPU_PER_BYTE_COST,
   VECTOR_EXTERNAL_TABLE_LOCAL_IO_PER_BYTE_COST,
   VECTOR_EXTERNAL_TABLE_NETWORK_IO_PER_BYTE_COST,
