...
LIB_CACHE_MISS_EVENT(LOCAL_PLAN_NOT_EXISTS, CACHE_OBJ_LEVEL, "Not exist local in plan_set_id: %ld. Detail info: %s")
...
LIB_CACHE_MISS_EVENT(REMOTE_PLAN_NOT_EXISTS, CACHE_OBJ_LEVEL, "Not exist remote in plan_set_id: %ld. Detail info: %s")
LIB_CACHE_MISS_EVENT(EXPIRED_PHY_PLAN, 1, "Expired physical plan, plan_id: %ld. Detail info: %s")
