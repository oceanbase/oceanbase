...
#define LASTED_COMPAT_VERSION     COMPAT_VERSION_4_3_0
  ...
  static const int64_t UNSET_VECTOR_PROBES = -1;
  ...
  void merge_vector_probes_hint(int64_t vector_probes);
  void reset_vector_probes_hint() { vector_probes_ = -1; }
...
public:
  ...
  ObPhyPlanHint(const ObGlobalHint &global_hint)
      : read_consistency_(global_hint.read_consistency_),
        ...
        vector_probes_(global_hint.vector_probes_),
  ...
  TO_STRING_KV(K_(read_consistency), K_(query_timeout), K_(vector_probes), K_(plan_cache_policy),
