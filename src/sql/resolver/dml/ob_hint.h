...
#define COMPAT_VERSION_4_2_3_BP1  (oceanbase::common::cal_version(4, 2, 3, 1))
#define LASTED_COMPAT_VERSION     COMPAT_VERSION_4_2_3_BP1
#define DEFAULT_USED_VERSION COMPAT_VERSION_4_2_3
