...
int ObPhyPlanHint::deep_copy(const ObPhyPlanHint &other, ObIAllocator &allocator)
{
  ...
  vector_probes_ = other.vector_probes_;
...
void ObGlobalHint::merge_vector_probes_hint(int64_t vector_probes)
{
  if (vector_probes > 0) {
    if (vector_probes_ < 0) {
      vector_probes_ = vector_probes;
    } else {
      vector_probes_ = std::min(vector_probes_, vector_probes);
    }
  }
}
...
bool ObGlobalHint::has_hint_exclude_concurrent() const
{
  ...
  return -1 != frozen_version_
         ...
         || UNSET_VECTOR_PROBES != vector_probes_
...
void ObGlobalHint::reset()
{
  ...
  vector_probes_ = UNSET_VECTOR_PROBES;
  tx_id_ = -1;
  tm_sessid_ = -1;
...
int ObGlobalHint::merge_global_hint(const ObGlobalHint &other)
{
  ...
  merge_vector_probes_hint(other.vector_probes_);
...
int ObGlobalHint::print_global_hint(PlanText &plan_text) const
{
  ...
  if (OB_SUCC(ret) && UNSET_VECTOR_PROBES != vector_probes_) {
    PRINT_GLOBAL_HINT_NUM("PROBES", vector_probes_);
  }
