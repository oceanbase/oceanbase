                                                  ...
                                                  bool &is_enable)
{
  ...
  } else if (T_WHERE_SCOPE != scope || !is_root_condition || (T_OP_IN != op_type && T_OP_NOT_IN != op_type) ||
                                           ...
                                           bool &is_const)
{
  ...
  if (OB_ISNULL(node)) {
    ...
    /* is_const = false*/
                                            ...
                                            nchar_collation, server_collation, param_type.obj_type_,
                                            param_type.coll_type_, param_type.coll_level_))) {
