...
inline static bool data_version_after_4_2_0_0(int64_t tenant_id)
{
  int ret = OB_SUCCESS;
  bool bret = false;
  ...
  {
    bret = data_version >= DATA_VERSION_4_2_0_0;
  }
  return bret;
}
    ...
    switch (parse_tree.type_) {
      ...
      case T_SHOW_PARAMETERS: {
        ...
        if (OB_UNLIKELY(parse_tree.num_child_ != 2 || nullptr == parse_tree.children_)) {
          ...
          } else if (data_version_after_4_2_0_0(show_tenant_id)) {
...
DEFINE_SHOW_CLAUSE_SET(SHOW_PARAMETERS_WITH_DEFAULT_VALUE,
                      ...
                      R"(SELECT "ZONE", "SVR_TYPE", "SVR_IP", "SVR_PORT", "NAME", "DATA_TYPE", "VALUE", "INFO", "SECTION", "SCOPE", "SOURCE", "EDIT_LEVEL", "DEFAULT_VALUE", "ISDEFAULT" FROM %s.%s WHERE (NAME NOT LIKE '\_%%' ESCAPE '\' or OR ISDEFAULT=0) and (tenant_id = %ld or tenant_id is null))",
                      "name");
