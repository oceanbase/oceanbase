      ...
      case T_SHOW_WISHES: {
        [&] {
          if (is_oracle_mode) {
            ...
            show_resv_ctx.stmt_type_ = stmt::T_SHOW_WISHES;
            GEN_SQL_STEP_1(ObShowSqlSet::SHOW_WISHES);
            GEN_SQL_STEP_2(ObShowSqlSet::SHOW_WISHES, OB_SYS_DATABASE_NAME, OB_SHOW_WISHES_TNAME);
          }
        }();
        break;
      }
...
DEFINE_SHOW_CLAUSE_SET(SHOW_WISHES, "SELECT WISHES", "SELECT WISHES FROM %s.%s", NULL, NULL);
