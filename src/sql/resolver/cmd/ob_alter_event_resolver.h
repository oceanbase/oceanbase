...
#ifndef _OB_ALTER_EVENT_RESOLVER_H
#define _OB_ALTER_EVENT_RESOLVER_H 1
...
namespace sql
{
class ObAlterEventResolver: public ObCMDResolver
{
public:
  explicit ObAlterEventResolver(ObResolverParams &params);
  virtual ~ObAlterEventResolver() = default;
...
private:
  ...
  // disallow copy
  DISALLOW_COPY_AND_ASSIGN(ObAlterEventResolver);
};
}//namespace sql
}//namespace oceanbase
#endif // _OB_ALTER_EVENT_RESOLVER_H
