...
#define DECLARE_SHOW_CLAUSE_SET(SHOW_STMT_TYPE)     \
  ...
  DECLARE_SHOW_CLAUSE_SET(SHOW_EXTENDED_COLUMNS);
  ...
  DECLARE_SHOW_CLAUSE_SET(SHOW_SENSITIVE_RULES_LIKE);
  DECLARE_SHOW_CLAUSE_SET(SHOW_SENSITIVE_RULES_FROM_TABLE_LIKE);
  DECLARE_SHOW_CLAUSE_SET(SHOW_SENSITIVE_RULES_FROM_DATABASE_LIKE);
};// ObShowSqlSet
