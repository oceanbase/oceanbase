...
public:
  ...
  {}
  const obrpc::ObPurgeTableArg& get_purge_table_arg() const
  {
  ...
  inline bool get_is_object_name() const;
...
inline bool ObPurgeTableStmt::get_is_object_name() const
{
  return purge_table_arg_.is_object_name_;
}
/**
 * Purge index
 */
...
public:
  ...
  {}
  const obrpc::ObPurgeIndexArg& get_purge_index_arg() const
  {
...
inline void ObPurgeIndexStmt::set_is_object_name(const bool is_object_name)
{
  purge_index_arg_.is_object_name_ = is_object_name;
}

inline bool ObPurgeIndexStmt::get_is_object_name() const
{
  return purge_index_arg_.is_object_name_;
}
...
public:
  ...
  {}
  const obrpc::ObPurgeDatabaseArg& get_purge_database_arg() const
  {
  ...
  uint64_t get_tenant_id() const
  {
    return purge_db_arg_.tenant_id_;
  }
...
inline void ObPurgeDatabaseStmt::set_is_object_name(const bool is_object_name)
{
  purge_db_arg_.is_object_name_ = is_object_name;
}
/**
 * purge tenant
 */
...
public:
  ...
  {}
  const obrpc::ObPurgeTenantArg& get_purge_tenant_arg() const
  {
  ...
  uint64_t get_tenant_id() const
  {
    return purge_tenant_arg_.tenant_id_;
  }
...
public:
  ...
  {}
  const obrpc::ObPurgeRecycleBinArg& get_purge_recyclebin_arg() const
  {
  ...
  {
    purge_recyclebin_arg_.expire_time_ = expire_time;
  }
  inline void set_purge_num(const int64_t purge_num)
  {
    purge_recyclebin_arg_.purge_num_ = purge_num;
  }
  uint64_t get_tenant_id() const
  {
    return purge_recyclebin_arg_.tenant_id_;
  }
  virtual obrpc::ObDDLArg& get_ddl_arg()
  {
    return purge_recyclebin_arg_;
