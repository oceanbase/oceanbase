...
public:
  ...
  {
    drop_dblink_arg_.tenant_id_ = id;
  }
  inline void set_dblink_name(const common::ObString& name)
  {
    drop_dblink_arg_.dblink_name_ = name;
  }

  obrpc::ObDropDbLinkArg& get_drop_dblink_arg()
  {
    return drop_dblink_arg_;
  }
