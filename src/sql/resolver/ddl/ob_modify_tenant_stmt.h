...
public:
  ...
  {
    modify_tenant_arg_.tenant_schema_.set_rewrite_merge_version(version);
  }
  void set_storage_format_version(const int64_t version)
  {
    modify_tenant_arg_.tenant_schema_.set_storage_format_version(version);
  }
  void set_storage_format_work_version(const int64_t version)
  {
    modify_tenant_arg_.tenant_schema_.set_storage_format_work_version(version);
  }
  void set_progressive_merge_num(const int64_t progressive_merge_num)
  {
