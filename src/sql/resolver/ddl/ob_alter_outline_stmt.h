...
public:
  ...
  {
    return alter_outline_arg_.alter_outline_info_.get_sql_text_str();
  }
  ...
  {
    return alter_outline_arg_.alter_outline_info_.get_outline_target_str();
  }
  ...
  obrpc::ObAlterOutlineArg& get_alter_outline_arg()
  {
