...
// NOTE: OB_ERR_CONSTRAINT_NAME_DUPLICATE's __ORA_USER_ERROR_MSG contains '%.*s',
// so LOG_USER_ERROR without params would produce '(null)'. We use FORWARD_USER_ERROR
// with ob_oracle_strerror() to pass the plain oracle_str_error (without %.*s).
