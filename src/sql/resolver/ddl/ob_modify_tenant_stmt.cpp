...
namespace sql {
int64_t ObModifyTenantStmt::to_string(char* buf, const int64_t buf_len) const
{
  int64_t pos = 0;
  J_OBJ_START();
  J_KV(K_(modify_tenant_arg));
  J_OBJ_END();
  return pos;
}

ObModifyTenantSpecialOption::ObModifyTenantSpecialOption() : progressive_merge_num_(-1)
{}
