...
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_ALTER_TYPE, no_priv_needed, 238)
...
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_FLASHBACK_STANDBY_LOG, get_sys_tenant_alter_system_priv, 377)
...
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_HBASE_GET, err_stmt_type_priv, 398)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_HBASE_BATCH_PUT, err_stmt_type_priv, 399)
...
//routine load kafka
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_CREATE_ROUTINE_LOAD, no_priv_needed, 404)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_PAUSE_ROUTINE_LOAD, no_priv_needed, 405)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_RESUME_ROUTINE_LOAD, no_priv_needed, 406)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_STOP_ROUTINE_LOAD, no_priv_needed, 407)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_BACKUP_VALIDATE, get_sys_tenant_alter_system_priv, 408)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_REFRESH_FULLTEXT_DICT, get_sys_tenant_alter_system_priv, 409)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_BACKUP_ARCHIVELOG_ALL, get_sys_tenant_alter_system_priv, 410)
