...
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_HBASE_GET, err_stmt_type_priv, 394)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_HBASE_BATCH_PUT, err_stmt_type_priv, 395)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_HBASE_BATCH_DELETE, err_stmt_type_priv, 396)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_HBASE_BATCH_GET, err_stmt_type_priv, 397)
