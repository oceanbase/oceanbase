...
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_CREATE_SENSITIVE_RULE, get_sensitive_rule_need_privs, 392)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_DROP_SENSITIVE_RULE, get_sensitive_rule_need_privs, 393)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_ALTER_SENSITIVE_RULE, get_sensitive_rule_need_privs, 394)
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_SHOW_SENSITIVE_RULES, no_priv_needed, 395)
