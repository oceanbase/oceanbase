...
OB_STMT_TYPE_DEF_UNKNOWN_AT(T_SHOW_CHECK_TABLE, err_stmt_type_priv, 322)
...
OB_STMT_TYPE_DEF(T_EVENT_JOB_CREATE, no_priv_needed, 343, ACTION_TYPE_EXECUTE_PROCEDURE)
OB_STMT_TYPE_DEF(T_EVENT_JOB_ALTER, no_priv_needed, 344, ACTION_TYPE_EXECUTE_PROCEDURE)
OB_STMT_TYPE_DEF(T_EVENT_JOB_DROP, no_priv_needed, 345, ACTION_TYPE_EXECUTE_PROCEDURE)
