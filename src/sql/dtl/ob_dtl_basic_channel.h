...
static DtlWriterType msg_writer_map[] =
{
  ...
  MAX_WRITER,  //PX_VECTOR,
  MAX_WRITER, //PX_FIXED_VECTOR
  MAX_WRITER,  //PX_VECTOR_ROW,
  MAX_WRITER, // DH_SP_WINFUNC_PX_PIECE_MSG
  MAX_WRITER, // DH_SP_WINFUNC_PX_WHOLE_MSG
  MAX_WRITER, // DH_RD_WINFUNC_PX_PIECE_MSG
  MAX_WRITER, // DH_RD_WINFUNC_PX_WHOLE_MSG
  MAX_WRITER, // DH_JOIN_FILTER_COUNT_ROW_PIECE_MSG,
  MAX_WRITER, // DH_JOIN_FILTER_COUNT_ROW_WHOLE_MSG,
  CONTROL_WRITER, // DH_STATISTICS_COLLECTOR_PIECE_MSG,
  CONTROL_WRITER, // DH_STATISTICS_COLLECTOR_WHOLE_MSG,
};
