...
enum ObHybridSearchTopKDynamicPruningLevel {
  HYBRID_SEARCH_TOPK_DYNAMIC_PRUNING_DISABLED = 0,
  HYBRID_SEARCH_TOPK_DYNAMIC_PRUNING_BASIC = 1,
  HYBRID_SEARCH_TOPK_DYNAMIC_PRUNING_WITH_MATCH_PHRASE = 2
};
