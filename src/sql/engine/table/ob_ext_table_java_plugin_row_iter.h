...
class ObExtTableJavaPluginRowIterator final : public sql::ObExternalTableRowIterator
{
public:
  ObExtTableJavaPluginRowIterator();
  virtual ~ObExtTableJavaPluginRowIterator();
...
private:
  ...
  ObArray<sql::ObArrowDataLoader*>      plugin_column_loaders_;
