                       ...
                       ObExpr &rt_expr) const
{
  ...
  if (OB_FAIL(GET_MIN_DATA_VERSION(MTL_ID(), data_version))) {
  ...
  } else if (OB_UNLIKELY((data_version < MOCK_DATA_VERSION_4_3_5_4)
    ...
    ret = OB_NOT_SUPPORTED;
    LOG_WARN("data version below 4.3.5.4 or between 4.4.0.0 and 4.4.2.0 or between 4.5.0.0 and 4.5.1.0, not support this function", K(ret));
    LOG_USER_ERROR(OB_NOT_SUPPORTED, "data version below 4.3.5.4 or between 4.4.0.0 and 4.4.2.0 or between 4.5.0.0 and 4.5.1.0, mds_concat_ws func is not supported");
  } else {
