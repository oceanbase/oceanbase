...
public:
  ...
  virtual int calc_result5(common::ObObj& result, const common::ObObj& bits, const common::ObObj& on,
...
private:
  ...
  // helper func
  static int export_set(ObString& ret_str, const uint64_t bits, const ObString& on, const ObString& off,
