...
void ObExprOperatorFactory::register_expr_operators()
{
  ...
  */
  [&]() {
    ...
    REG_OP(ObExprExists, EAGER_EVALUATION);
    REG_OP(ObExprNotExists, EAGER_EVALUATION);
...
// 注册oracle系统函数
  ...
  REG_OP_ORCL(ObExprExists, EAGER_EVALUATION);
  REG_OP_ORCL(ObExprNotExists, EAGER_EVALUATION);
