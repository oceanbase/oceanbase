...
public:
  ...
  virtual int calc(common::ObObj& result, const common::ObObj& obj1, const common::ObObj& obj2,
      common::ObExprCtx& expr_ctx) const = 0;
  virtual const common::ObIArray<common::ObString>& get_str_values() const
  {
    return str_values_;
  }
...
public:
  ...
  static int init_enum_set_info(common::ObIAllocator* allocator, ObExpr& expr, const ObExprOperatorType type,
