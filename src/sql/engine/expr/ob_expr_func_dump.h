...
private:
  ...
  int calc_otimestamp(const common::ObObj& input, const int64_t fmt_enum, int64_t& start_pos, int64_t& print_value_len,
      common::ObString& output) const;

  int calc_string(const common::ObObj& input, const int64_t fmt_enum, int64_t& start_pos, int64_t& print_value_len,
      common::ObString& output) const;

  int calc_double(const common::ObObj& input, const int64_t fmt_enum, int64_t& start_pos, int64_t& print_value_len,
      common::ObString& output) const;
  int calc_interval(const common::ObObj& input, const int64_t fmt_enum, int64_t& start_pos, int64_t& print_value_len,
      common::ObString& output) const;
