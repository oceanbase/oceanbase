...
public:
  ...
  static int calc(common::ObObj& result, const common::ObString obj1, const common::ObString obj2,
      common::ObIAllocator* allocator, bool is_oracle_mode = false, const int64_t max_result_len = 0);
  // Check result length with OB_MAX_PACKET_LENGTH.
  // %result type is set to ObLongTextType
  static int calc(common::ObObj& result, const char* obj1_ptr, const int32_t this_len, const char* obj2_ptr,
      const int32_t other_len, common::ObIAllocator* allocator);
