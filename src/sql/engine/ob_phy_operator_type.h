...
PHY_OP_DEF(PHY_CONNECT_BY) /*90*/// FARM COMPAT WHITELIST
...
PHY_OP_DEF(PHY_NEW_OP_ADAPTER) // FARM COMPAT WHITELIST
PHY_OP_DEF(PHY_FAKE_TABLE)  /* for testing only*/ // FARM COMPAT WHITELIST
...
// Hybrid fusion operator (global fusion / rerank for hybrid search)
PHY_OP_DEF(PHY_HYBRID_FUSION)
PHY_OP_DEF(PHY_RESCAN)
PHY_OP_DEF(PHY_STATISTICS_COLLECTOR)
PHY_OP_DEF(PHY_EXTERNAL_ROW_SAMPLE_SCAN)
PHY_OP_DEF(PHY_EXTERNAL_BLOCK_SAMPLE_SCAN)
PHY_OP_DEF(PHY_PX_ORDERED_RECEIVE)
PHY_OP_DEF(PHY_END)
#endif /*PHY_OP_DEF*/
