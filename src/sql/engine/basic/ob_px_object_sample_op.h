...
#ifndef OCEANBASE_SQL_ENGINE_PX_OBJECT_SAMPLE_OP_H_
#define OCEANBASE_SQL_ENGINE_PX_OBJECT_SAMPLE_OP_H_
...
class ObPxObjectSampleSpec : public ObOpSpec
{
OB_UNIS_VERSION_V(1);
public:
  ObPxObjectSampleSpec(common::ObIAllocator &alloc, const ObPhyOperatorType type);
...
class ObPxObjectSampleOp : public ObOperator
{
public:
  ObPxObjectSampleOp(ObExecContext &exec_ctx, const ObOpSpec &spec, ObOpInput *input);
