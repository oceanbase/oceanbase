...
struct ObCompactRow
{
  ...
  inline const ObBitVector *nulls() const {
    return reinterpret_cast<const ObBitVector *>(payload_);
  }
  inline ObBitVector *nulls() { return reinterpret_cast<ObBitVector *>(payload_); }
