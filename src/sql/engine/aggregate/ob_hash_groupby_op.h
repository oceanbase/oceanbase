...
public:
  LlcEstimate()
    : avg_group_mem_(0), llc_map_(), est_cnt_(0), check_cnt_(0), enabled_(false)
  {}
...
public:
  ...
  int bypass_add_llc_map(uint64_t hash_val, bool is_permuted);
  int bypass_add_llc_map_batch(bool is_permuted);
  int check_llc_ndv();
