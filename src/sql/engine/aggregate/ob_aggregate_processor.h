...
public:
  ...
  static void llc_add_value(const uint64_t value, const common::ObString &llc_bitmap_buf) { llc_add_value(value, const_cast<char*>(llc_bitmap_buf.ptr()), llc_bitmap_buf.length()); }
  static void llc_add_value(const uint64_t value, char *llc_bitmap_buf, int64_t size);
