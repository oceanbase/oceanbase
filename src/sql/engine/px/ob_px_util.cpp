                                                    ...
                                                    DASTabletLocIArray &dst_locations)
{
  ...
  } else if (base_order_arr->count() > 0 && base_order_arr->count() != dst_locations.count()) {
                                       ...
                                       ObExprFrameInfo &expr_frame_info)
{
  ...
  OZ(serialize_frame_info(buf, buf_len, pos, expr_frame_info.const_frame_, frames, frame_count));
  OZ(serialize_frame_info(buf, buf_len, pos, expr_frame_info.param_frame_, frames, frame_count));
  OZ(serialize_frame_info(buf, buf_len, pos, expr_frame_info.dynamic_frame_, frames, frame_count));
  OZ(serialize_frame_info(buf, buf_len, pos, expr_frame_info.datum_frame_, frames, frame_count, true));
  ...
  ObExprFrameInfo &expr_frame_info)
{
  ...
  len += get_serialize_frame_info_size(expr_frame_info.const_frame_, frames, frame_count);
  len += get_serialize_frame_info_size(expr_frame_info.param_frame_, frames, frame_count);
  len += get_serialize_frame_info_size(expr_frame_info.dynamic_frame_, frames, frame_count);
  len += get_serialize_frame_info_size(expr_frame_info.datum_frame_, frames, frame_count, true);
