...
public:
  ...
  int init(uint64_t session_id, uint64_t tenant_id, const uint64_t* trace_id, uint64_t qc_id, int64_t sqc_id,
      int64_t worker_id, int64_t dfo_id, int64_t start_time, int64_t thread_id);
  ...
  inline void set_worker_id(int64_t worker_id)
  {
  ...
  inline uint64_t get_qc_id() const
  {
    return qc_id_;
  }
  ...
  inline int64_t get_worker_id() const
  {
    return worker_id_;
  }
  ...
  inline int64_t get_thread_id() const
  {
    return thread_id_;
  }
