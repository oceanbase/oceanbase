...
private:
  ...
  int check_rownum_push_down(ObSelectStmt* select_stmt, ObSelectStmt* view_stmt, bool& can_be);
  int check_where_condition_push_down(
      ObSelectStmt* select_stmt, ObSelectStmt* view_stmt, bool& transform_having, bool& can_be);
  int check_window_function_push_down(ObSelectStmt* view_stmt, bool& can_be);
  int check_distinct_push_down(ObSelectStmt* view_stmt, bool& need_distinct, bool& can_be);
  int is_select_item_same(ObSelectStmt* select_stmt, ObSelectStmt* view_stmt, bool& is_same,
      common::ObIArray<int64_t>& select_offset, common::ObIArray<SelectItem>& const_select_items);
  int do_transform(ObSelectStmt* select_stmt, ObSelectStmt* view_stmt, bool need_distinct, bool transform_having,
      const TableItem* view_table_item, common::ObIArray<int64_t>& select_offset,
      common::ObIArray<SelectItem>& const_select_items);
  int push_down_stmt_exprs(ObSelectStmt* select_stmt, ObSelectStmt* view_stmt, bool need_distinct,
      bool transform_having, common::ObIArray<int64_t>& select_offset,
      common::ObIArray<SelectItem>& const_select_items);
  ...
  int recursive_adjust_select_item(ObSelectStmt* view_stmt, common::ObIArray<int64_t>& select_offset,
      common::ObIArray<SelectItem>& const_select_items);
  int reset_set_stmt_select_list(ObSelectStmt* select_stmt, ObIArray<int64_t>& select_offset);
