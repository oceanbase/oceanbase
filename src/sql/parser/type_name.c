...
const char* get_type_name(int type)
{
	...
	case T_FUN_SYS_VALIDATE_PASSWORD_STRENGTH : return "T_FUN_SYS_VALIDATE_PASSWORD_STRENGTH";
	case T_FUN_SYS_UUID_SHORT : return "T_FUN_SYS_UUID_SHORT";
	...
	case T_FUN_SYS_TO_BASE64 : return "T_FUN_SYS_TO_BASE64";
	case T_FUN_SYS_FROM_BASE64 : return "T_FUN_SYS_FROM_BASE64";
