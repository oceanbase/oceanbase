...
static const NonReservedKeyword MYSQL_NON_RESERVED_KEYWORDS[] =
{
  ...
  {"json_extract", JSON_EXTRACT_FUNC},
  ...
  {"sql_tsi_millisecond", SQL_TSI_MILLISECOND},
  {"sql_tsi_minute", SQL_TSI_MINUTE},
  {"sql_tsi_month", SQL_TSI_MONTH},
  {"sql_tsi_nanosecond", SQL_TSI_NANOSECOND},
  ...
  {"vector", VECTOR},
  {"vended_credential_enabled", VENDED_CREDENTAIL_ENABLED},
  {"verbose", VERBOSE},
  {"verify", VERIFY},
  {"version", VERSION},
  {"view", VIEW},
