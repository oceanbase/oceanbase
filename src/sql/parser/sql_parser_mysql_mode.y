...
SEGMENTED_LIMIT_PUSHDOWN NO_SEGMENTED_LIMIT_PUSHDOWN
// optimize hint
...
//-----------------------------non_reserved keyword begin-------------------------------------------
        ...
        ARBITRATION ARRAY ASCII ASIS AT AUTHORS AUTO AUTOEXTEND_SIZE AUTO_INCREMENT AUTO_INCREMENT_MODE AUTO_INCREMENT_CACHE_SIZE
        AVG AVG_ROW_LENGTH ACTIVATE AVAILABILITY ARCHIVELOG ASYNCHRONOUS AUDIT ADMIN AUTO_REFRESH
...
| SEGMENTED_LIMIT_PUSHDOWN opt_qb_name
{
  malloc_non_terminal_node($$, result->malloc_pool_, T_SEGMENTED_LIMIT_PUSHDOWN, 1, $2);
}
| NO_SEGMENTED_LIMIT_PUSHDOWN opt_qb_name
{
  malloc_non_terminal_node($$, result->malloc_pool_, T_NO_SEGMENTED_LIMIT_PUSHDOWN, 1, $2);
}
| MV_REWRITE
{
