...
//-----------------------------non_reserved keyword begin-------------------------------------------
        ...
        EXTENDED_NOADDR EXTENT_SIZE EXTRACT EXCEPT EXPIRED ENCODING EMPTY_FIELD_AS_NULL EXTERNAL EXTERNAL_TABLE_ERROR
...
| SHOW EXTERNAL_TABLE_ERROR opt_show_condition
{ malloc_non_terminal_node($$, result->malloc_pool_, T_SHOW_EXTERNAL_TABLE_ERROR, 1, $3); }
/*
