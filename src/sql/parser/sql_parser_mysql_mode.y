...
%token <non_reserved_keyword>
        ...
        ARBITRATION ASCII AT ATTRIBUTE AUTHORS AUTO AUTOEXTEND_SIZE AUTO_INCREMENT AUTO_INCREMENT_MODE AVG AVG_ROW_LENGTH
...
%type <node> path_info opt_attribute
...
%type <node> ls_attr_list ls_attr
...
|
ALTER SYSTEM alter_or_change_or_modify EXTERNAL_STORAGE_DEST path_info opt_set opt_attribute
{
  (void)($3);
  (void)($6);
  malloc_non_terminal_node($$, result->malloc_pool_, T_CHANGE_EXTERNAL_STORAGE_DEST, 2, $5, $7);
}
|
...
|
ALTER SYSTEM ADD REPLICA ls SERVER opt_equal_mark STRING_VALUE REPLICA_TYPE opt_equal_mark STRING_VALUE opt_data_source opt_paxos_replica_num opt_tenant_name
{
  (void)($7);
  (void)($10);
...
|
ALTER SYSTEM REMOVE REPLICA ls SERVER opt_equal_mark STRING_VALUE opt_paxos_replica_num opt_tenant_name
{
  (void)($7);
  malloc_non_terminal_node($$, result->malloc_pool_, T_REMOVE_LS_REPLICA, 4, $5, $8, $9, $10);
}
|
ALTER SYSTEM MIGRATE REPLICA ls SOURCE opt_equal_mark STRING_VALUE DESTINATION opt_equal_mark STRING_VALUE opt_data_source opt_tenant_name
{
  (void)($7);
  (void)($10);
...
|
ALTER SYSTEM MODIFY REPLICA ls SERVER opt_equal_mark STRING_VALUE REPLICA_TYPE opt_equal_mark STRING_VALUE opt_paxos_replica_num opt_tenant_name
{
  (void)($7);
  (void)($10);
...
|
ALTER SYSTEM MODIFY ls PAXOS_REPLICA_NUM opt_equal_mark INTNUM opt_tenant_name
{
  (void)($6);
  malloc_non_terminal_node($$, result->malloc_pool_, T_MODIFY_LS_PAXOS_REPLICA_NUM, 3, $4, $7, $8);
}
|
ALTER SYSTEM CANCEL REPLICA TASK TASK_ID opt_equal_mark STRING_VALUE opt_tenant_name
{
  (void)($7);
 ...
 *===========================================================*/
alter_ls_stmt:
ALTER SYSTEM CREATE LS ls_attr_list opt_tenant_name
{
 (void)($1);
...
| ALTER SYSTEM MODIFY ls ls_attr_list opt_tenant_name
{
  (void)($1);
  ParseNode *ls_attr = NULL;
  merge_nodes(ls_attr, result, T_LS_ATTR_LIST, $5);
...
| ALTER SYSTEM DROP ls opt_tenant_name
{
  (void)($1);
  ParseNode *op_node = NULL;
  malloc_terminal_node(op_node, result->malloc_pool_, T_INT);
