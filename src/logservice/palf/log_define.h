...
const int64_t PALF_FETCH_SRC_STAGNANT_THRESHOLD_US = 5LL * 1000 * 1000;     // 5s, fetch src stagnant threshold
const int64_t PALF_STAGNANT_AVOID_TTL_US           = 30LL * 1000 * 1000;     // 30s, stagnant parent avoidance TTL
const int64_t PALF_PARENT_CANDIDATE_MIN_ACK_ADVANCE_US = 5LL * 1000 * 1000; // 5s, max time since last ack advance for parent candidate
