...
public:
  ...
  OB_INLINE share::schema::ObLocalSessionVar &get_local_session_var() { return local_session_vars_; }
  OB_INLINE share::schema::ObLocalSessionVar const &get_local_session_var() const { return local_session_vars_; }
...
private:
  ...
  uint64_t sub_type_;
  uint64_t srs_id_;
  share::schema::ObLocalSessionVar local_session_vars_;
