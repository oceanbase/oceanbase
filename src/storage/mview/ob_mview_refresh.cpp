...
int ObMViewRefresher::prepare_for_refresh()
{
  ...
  } else if ((data_version_ >= MOCK_DATA_VERSION_4_3_5_3 && data_version_ < DATA_VERSION_4_4_0_0)
             || (data_version_ >= MOCK_DATA_VERSION_4_4_2_0 && data_version_ < DATA_VERSION_4_5_0_0)
             || (data_version_ >= DATA_VERSION_4_5_1_0)) {
...
int ObMViewRefresher::fast_refresh()
{
  ...
  if (OB_SUCC(ret)) {
    WITH_MVIEW_TRANS_INNER_MYSQL_GUARD(trans)
    {
      ...
      } else if (data_version_ < MOCK_DATA_VERSION_4_3_5_3
                 || (data_version_ >= DATA_VERSION_4_4_0_0 && data_version_ < MOCK_DATA_VERSION_4_4_2_0)
                 || (data_version_ >= DATA_VERSION_4_5_0_0 && data_version_ < DATA_VERSION_4_5_1_0)) {
