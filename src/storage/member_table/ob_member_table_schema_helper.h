...
#ifndef OCEANBASE_STORAGE_OB_MEMBER_TABLE_SCHEMA_HELPER
#define OCEANBASE_STORAGE_OB_MEMBER_TABLE_SCHEMA_HELPER
...
struct ObMemberTableSchemaDef final
{
public:
  ObMemberTableSchemaDef();
  ~ObMemberTableSchemaDef();

  enum class MEMBER_TABLE_SCHEMA_COL_IDX : int64_t
  {
    TABLET_ID = 0,
  ...
  enum class MEMBER_SSTABLE_COL_IDX : int64_t
  {
    TABLET_ID = 0,
    REORGANIZATION_SCN = 1,
    DATA_TYPE = 2,
...
public:
  static constexpr const char *MEMBER_TABLE_NAME = "member_table";
  ...
  static constexpr int64_t MEMBER_ROW_COLUMN_CNT = 4;
  static constexpr int64_t MEMBER_MULTI_VERSION_ROW_COLUMN_CNT = MEMBER_ROW_COLUMN_CNT
      + ObMultiVersionExtraRowkeyIds::MAX_EXTRA_ROWKEY;
  static constexpr int64_t MEMBER_SCHEMA_VERSION = 1;
  static constexpr uint64_t MEMBER_TABLE_ID = 90000;
...
class ObMemberTableSchemaHelper
{
public:
  static ObMemberTableSchemaHelper &get_instance();
  ObMemberTableSchemaHelper();
  ~ObMemberTableSchemaHelper();
  ObMemberTableSchemaHelper(const ObMemberTableSchemaHelper&) = delete;
  ObMemberTableSchemaHelper &operator=(const ObMemberTableSchemaHelper&) = delete;
...
private:
  ...
  common::ObSEArray<uint64_t, static_cast<int64_t>(ObMemberTableSchemaDef::MEMBER_SSTABLE_COL_IDX::MAX_COLUMN_IDX)> column_ids_;
};
} // namespace storage
} // namespace oceanbase
