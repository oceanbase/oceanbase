...
#ifndef OCEABASE_STORAGE_MEMBER_TABLE_SERVICE_
#define OCEABASE_STORAGE_MEMBER_TABLE_SERVICE_
...
class ObMemberTableService final : public lib::ThreadPool
{
public:
  ObMemberTableService();
  ~ObMemberTableService();
  static int mtl_init(ObMemberTableService *&rebuild_service);
...
private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ObMemberTableService);
};
