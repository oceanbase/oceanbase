...
#ifndef OCEANBASE_STORAGE_OB_MICRO_BLOCK_INDEX_ITERATOR_H
#define OCEANBASE_STORAGE_OB_MICRO_BLOCK_INDEX_ITERATOR_H
...
public:
  ...
  int get_next(blocksstable::ObMicroIndexInfo &micro_index_info);
private:
...
#endif /* OCEANBASE_STORAGE_OB_MICRO_BLOCK_INDEX_ITERATOR_H */
