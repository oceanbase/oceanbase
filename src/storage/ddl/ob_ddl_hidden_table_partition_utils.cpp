    ...
    int64_t &target_part_idx)
{
  ...
  } else if (cluster_version < CLUSTER_VERSION_4_3_5_5) {
    ret = OB_NOT_SUPPORTED;
    LOG_WARN("version lower than 4.3.5.5 does not support direct load hidden table partition pruning", KR(ret), K(cluster_version));
