...
protected:
  ...
  int check_lock_exist_(ObLockContext &ctx,
  ...
  int check_lock_exist_(ObLockContext &ctx,
                        const uint64_t &lock_id,
                        bool &exist);
  int check_owner_exist_(ObLockContext &ctx,
                         const uint32_t client_session_id,
                         const uint64_t client_session_create_ts,
                         bool &exist);
  int check_lock_exist_(ObLockContext &ctx,
                        ...
                        bool &exist);
  int remove_lock_id_(ObLockContext &ctx, const int64_t raw_owner_id, const uint64_t &lock_id);
  int remove_lock_id_(ObLockContext &ctx,
