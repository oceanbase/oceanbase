...
public:
  ...
  void on_lock_conflict(ObSArray<storage::ObRowConflictInfo> &cflict_infos, ObTxDesc *tx, uint32_t session_id);
  ...
  // handle execution result at end_stmt
  void handle_exec_result(int exec_errcode, ObTxDesc &tx);
