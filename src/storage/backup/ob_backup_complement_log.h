...
private:
  ...
  int generate_ls_copy_task_(const share::ObLSID &ls_id);
...
private:
  ...
  // piece_end
  int copy_piece_end_file_(const ObTenantArchivePieceAttr &piece_attr, const share::ObBackupDest &src, const share::ObBackupDest &dest);
