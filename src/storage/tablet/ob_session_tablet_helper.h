...
/// Remove matching GTT v2 entries from every observer's local session map
/// after the durable delete has committed. During upgrade this entry point
/// retains the legacy creator-side delete behavior for compatibility.
