...
public:
  ...
  static const int64_t MAJOR_RECYCLE_TRIGGER_THRESHOLD = MAX_SSTABLE_CNT * 70 / 100;  // 89, trigger when total >= 70%
  static const int64_t MAJOR_RECYCLE_TARGET_THRESHOLD = MAX_SSTABLE_CNT * 30 / 100;   // 38, target total after recycle
