...
#ifndef OCEANBASE_STORAGE_FTS_ANALYZER_FILTER_OB_POSSESSIVE_ENGLISH_FILTER_H_
#define OCEANBASE_STORAGE_FTS_ANALYZER_FILTER_OB_POSSESSIVE_ENGLISH_FILTER_H_
...
struct ObPossessiveEnglishFilterSpec : public ObTokenFilterSpec
{
  ObPossessiveEnglishFilterSpec()
  {
    type_ = ObTokenFilterType::TOKEN_FILTER_TYPE_POSSESSIVE_ENGLISH;
  }
};
...
class ObPossessiveEnglishFilter : public ObITokenFilter
{
public:
  ObPossessiveEnglishFilter();
  ~ObPossessiveEnglishFilter() override;
...
private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ObPossessiveEnglishFilter);
};

} // namespace storage
} // namespace oceanbase

#endif // OCEANBASE_STORAGE_FTS_ANALYZER_FILTER_OB_POSSESSIVE_ENGLISH_FILTER_H_
