...
public:
  ...
  palf::SCN get_latest_frozen_scn();
...
private:
  ...
  int get_latest_freeze_scn(palf::SCN &freeze_scn);
  ...
  int prepare_new_info_list(const palf::SCN &min_major_snapshot);
  ...
  private:
    ...
    int get_freeze_info(palf::SCN &min_major_snapshot,
