...
#ifndef OB_STORAGE_COMPACTION_MEMBER_TABLE_MINOR_FILTER_H_
#define OB_STORAGE_COMPACTION_MEMBER_TABLE_MINOR_FILTER_H_
...
class ObMemberTableFilter : public ObICompactionFilter
{
public:
  ObMemberTableFilter()
    : ObICompactionFilter(),
