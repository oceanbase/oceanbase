...
int ObInitialCompleteMigrationDag::fill_dag_key(char *buf, const int64_t buf_len) const
{
  ...
  if (!is_inited_) {
    ...
    int64_t pos = 0;
    ret = databuff_printf(buf, buf_len, pos, "ObInitialCompleteMigrationDag: ls_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, self_ctx->arg_.ls_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
        ", migration_type = %s", ObMigrationOpType::get_str(self_ctx->arg_.type_));
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
...
int ObFinishCompleteMigrationDag::fill_dag_key(char *buf, const int64_t buf_len) const
{
  ...
  if (!is_inited_) {
    ...
    int64_t pos = 0;
    ret = databuff_printf(buf, buf_len, pos, "ObFinishCompleteMigrationDag: ls_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, self_ctx->arg_.ls_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
        ", migration_type = %s", ObMigrationOpType::get_str(self_ctx->arg_.type_));
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
