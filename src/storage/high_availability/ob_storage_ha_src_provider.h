...
private:
  ...
  int check_ls_info_valid_(const obrpc::ObFetchLSMetaInfoResp &ls_info, bool &is_valid) const;
  int check_replica_validity_(const obrpc::ObFetchLSMetaInfoResp &ls_info) const;
