...
int ObInitialMigrationDag::fill_dag_key(char *buf, const int64_t buf_len) const
{
  ...
  if (!is_inited_) {
    ...
    int64_t pos = 0;
    ret = databuff_printf(buf, buf_len, pos, "ObInitialMigrationDag: ls_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, ctx->arg_.ls_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
        ", migration_type = %s", ObMigrationOpType::get_str(ctx->arg_.type_));
    if (OB_FAIL(ret)) {
...
int ObStartMigrationDag::fill_dag_key(char *buf, const int64_t buf_len) const
{
  ...
  if (!is_inited_) {
    ...
    int64_t pos = 0;
    ret = databuff_printf(buf, buf_len, pos, "ObStartMigrationDag: ls_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, ctx->arg_.ls_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
        ", migration_type = %s", ObMigrationOpType::get_str(ctx->arg_.type_));
    if (OB_FAIL(ret)) {
...
int ObSysTabletsMigrationDag::fill_dag_key(char *buf, const int64_t buf_len) const
{
  ...
  if (!is_inited_) {
    ...
    int64_t pos = 0;
    ret = databuff_printf(buf, buf_len, pos, "ObSysTabletsMigrationDag: ls_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, ctx->arg_.ls_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
        ", migration_type = %s", ObMigrationOpType::get_str(ctx->arg_.type_));
    if (OB_FAIL(ret)) {
...
int ObTabletMigrationDag::fill_dag_key(char *buf, const int64_t buf_len) const
{
  ...
  if (!is_inited_) {
    ...
    int64_t pos = 0;
    ret = databuff_printf(buf, buf_len, pos, "ObTabletMigrationDag: log_stream_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, ctx->arg_.ls_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, ", tablet_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, copy_tablet_ctx_.tablet_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
        ", migration_type = %s", ObMigrationOpType::get_str(ctx->arg_.type_));
    if (OB_FAIL(ret)) {
  ...
  if (!is_inited_) {
    ...
    while (OB_SUCC(ret)) {
      ...
      if (OB_FAIL(tablet_group_ctx_->get_next_tablet_id(logic_tablet_id))) {
        ...
        if (OB_FAIL(tablet_migration_dag->init(logic_tablet_id.tablet_id_, tablet_handle, dag_net, tablet_group_ctx_))) {
...
int ObDataTabletsMigrationDag::fill_dag_key(char *buf, const int64_t buf_len) const
{
  ...
  if (!is_inited_) {
    ...
    int64_t pos = 0;
    ret = databuff_printf(buf, buf_len, pos, "ObDataTabletsMigrationDag: log_stream_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, ctx->arg_.ls_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
        ", migration_type = %s", ObMigrationOpType::get_str(ctx->arg_.type_));
    if (OB_FAIL(ret)) {
      ...
      if (ObDagType::DAG_TYPE_MIGRATION_FINISH != child_dag->get_type()) {
        ...
        if (OB_FAIL(ObStorageHADagUtils::get_ls(ctx_->arg_.ls_id_, ls_handle_))) {
          ...
          LOG_WARN("failed to append tablet list", K(ret), KPC(ctx_));
            ...
            ctx_->tenant_id_, tablet_id_array, ctx_->minor_src_, ctx_->local_rebuild_seq_,
...
int ObTabletGroupMigrationDag::fill_dag_key(char *buf, const int64_t buf_len) const
{
  ...
  if (!is_inited_) {
    ...
    int64_t pos = 0;
    ret = databuff_printf(buf, buf_len, pos, "ObTabletGroupMigrationDag: log_stream_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, ctx->arg_.ls_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
        ", migration_type = %s, first_tablet_id = ", ObMigrationOpType::get_str(ctx->arg_.type_));
  ...
  if (is_inited_) {
    ...
    if (OB_FAIL(ObStorageHADagUtils::get_ls(ctx_->arg_.ls_id_, ls_handle_))) {
      ...
      LOG_WARN("failed to append tablet list", K(ret), KPC(ctx_));
        ...
        ctx_->tenant_id_, tmp_tablet_id_array, ctx_->minor_src_, ctx_->local_rebuild_seq_, ctx_->arg_.type_,
        ls_handle_.get_ls(), &ctx_->ha_table_info_mgr_, ha_tablets_builder_))) {
      LOG_WARN("failed to init ha tablets builder", K(ret), KPC(ctx_));
    } else {
      is_inited_ = true;
  ...
  if (!is_inited_) {
    ...
    while (OB_SUCC(ret)) {
      ...
      if (OB_FAIL(tablet_group_ctx_->get_next_tablet_id(logic_tablet_id))) {
        ...
        LOG_WARN("failed to alloc tablet migration dag ", K(ret));
      } else if (OB_FAIL(tablet_migration_dag->init(logic_tablet_id.tablet_id_, tablet_handle, dag_net, tablet_group_ctx_))) {
...
int ObMigrationFinishDag::fill_dag_key(char *buf, const int64_t buf_len) const
{
  ...
  if (!is_inited_) {
    ...
    int64_t pos = 0;
    ret = databuff_printf(buf, buf_len, pos, "ObMigrationFinishDag: ls_id = ");
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos, ctx->arg_.ls_id_);
    OB_SUCCESS != ret ? : ret = databuff_printf(buf, buf_len, pos,
        ", migration_type = %s", ObMigrationOpType::get_str(ctx->arg_.type_));
    if (OB_FAIL(ret)) {
