    ...
    ObITask *child_task)
{
  ...
  } else if (FALSE_IT(init_param.macro_block_reuse_mgr_ = ObITable::is_major_sstable(copy_table_key.table_type_) && !ls_->is_cs_replica() ? &tablet_restore_ctx_->macro_block_reuse_mgr_ : nullptr)) {
