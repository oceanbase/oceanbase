...
public:
  ...
  void set_merge_scn(const palf::SCN merge_scn) { merge_scn_ = merge_scn; }
  palf::SCN get_merge_scn() const { return merge_scn_; }
...
private:
  int get_trans_status_with_scn(
    const palf::SCN scn,
      ...
      int64_t &status,
      palf::SCN &trans_version_at_merge_scn);
