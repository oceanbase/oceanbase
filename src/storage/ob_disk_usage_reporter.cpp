                                                    ...
                                                    const int64_t seq_num)
{
  ...
  ObFunction<int(const hash::HashMapPair<ObDiskUsageReportKey, std::pair<int64_t, int64_t>> &pair)> copy_result =
      [&result_arr](const hash::HashMapPair<ObDiskUsageReportKey, std::pair<int64_t, int64_t>> &pair) {
    int ret = OB_SUCCESS;
