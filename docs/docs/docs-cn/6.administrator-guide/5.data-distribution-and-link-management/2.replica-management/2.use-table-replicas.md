...
租户级副本变更操作，请参见 [Locality 管理](/docs-cn/6.administrator-guide/5.data-distribution-and-link-management/3.locality-management/1.locality-management-overview/) 章节。
