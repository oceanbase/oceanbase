...
* MySQL 模式
  ...
  MySQL 模式下 `CREATE SYNONYM` 语句的更多信息，请参见《SQL 参考》文档中的 [CREATE SYNONYM](/docs-cn/10.sql-reference/5.sql-statement/17.create-synonym/) 章节。
...
* MySQL 模式
  ...
  MySQL 模式下 `DROP SYNONYM` 语句的更多信息，请参见《SQL 参考》文档中的 [DROP SYNONYM](/docs-cn/10.sql-reference/5.sql-statement/33.drop-synonym/) 章节。
