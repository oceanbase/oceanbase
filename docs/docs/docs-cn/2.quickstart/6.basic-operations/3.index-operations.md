...
2. 执行以下命令，创建表 test 的索引。
   ...
   更多 `CREATE INDEX` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中的 [CREATE INDEX](/docs-cn/10.sql-reference/5.sql-statement/12.create-index/)[CREATE INDEX](t1944404.html#topic-2616628)章节。
