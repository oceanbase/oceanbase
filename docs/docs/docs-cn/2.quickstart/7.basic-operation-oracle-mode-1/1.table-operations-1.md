...
更多 `CREATE TABLE` 语句相关的语法说明请参见《SQL 参考（Oracle 模式）》中 [CREATE TABLE](/docs-cn/11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/14.create-table-1/)章节。
...
更多 `ALTER TABLE` 语句相关的语法说明请参见《SQL 参考（Oracle 模式）》中 [ALTER TABLE](/docs-cn/11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/5.alter-table-1/)章节。
...
更多 `DROP TABLE` 语句相关的语法说明请参见《SQL 参考（Oracle 模式）》中 [DROP TABLE](/docs-cn/11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/24.drop-table-1/)章节。
