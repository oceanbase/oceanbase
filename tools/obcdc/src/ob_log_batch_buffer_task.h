...
#ifndef OCEANBASE_LIBOBLOG_BATCH_BUFFER_TASK_H_
#define OCEANBASE_LIBOBLOG_BATCH_BUFFER_TASK_H_
...
public:
  ...
  TO_STRING_KV(N_BUF, ((uint64_t)(batch_buf_)),
               N_BUF_LEN, batch_size_,
               N_COUNT, subtask_count_);
private:
