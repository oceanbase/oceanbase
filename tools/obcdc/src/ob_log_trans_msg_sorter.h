...
#ifndef OCEANBASE_LIBOBLOG_BINLOG_SORTER_
#define OCEANBASE_LIBOBLOG_BINLOG_SORTER_
...
private:
  struct StmtSequerenceCompFunc
  {
    ...
    {
        return task1->get_row_sql_no() > task2->get_row_sql_no();
    }
  };
...
#endif // end OCEANBASE_LIBOBLOG_BINLOG_SORTER_
