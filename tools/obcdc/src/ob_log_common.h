...
#ifndef OCEANBASE_LIBOBLOG_COMMON_H__
#define OCEANBASE_LIBOBLOG_COMMON_H__
...
#define DEFAULT_LOG_FILE DEFAULT_LOG_DIR "liboblog.log"
#define DEFAULT_STDERR_LOG_FILE DEFAULT_LOG_DIR "liboblog.log.stderr"
#define DEFAULT_LOG_FILE_NAME "liboblog.log"
#define DEFAULT_STDERR_LOG_FILE_NAME "liboblog.log.stderr"
#define DEFAULT_TIMEZONE_INFO "+8:00"
#define DEFAULT_PID_FILE_DIR "./run/"
#define DEFAULT_PID_FILE DEFAULT_PID_FILE_DIR "liboblog.pid"
#define DEFAULT_CONFIG_FPATN "etc/liboblog.conf"
...
// column id of table __all_ddl_operation(used by liboblog)
