...
if (((OB_BUILD_OPENSOURCE AND NOT BUILD_CDC_ONLY) OR OB_BUILD_STANDALONE) AND NOT "${ARCHITECTURE}" STREQUAL "loongarch64")
...
## server
if (NOT OB_BUILD_OPENSOURCE AND NOT ${ARCHITECTURE} STREQUAL "loongarch64")
install(PROGRAMS
